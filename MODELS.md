...
| Qwen3-Coder-Plus (`qwen3-coder-plus`) | ga | 2025-09-23 | 1M | $0.57 | $2.29 | mixture-of-experts | Agentic coding and long-code repository tasks | prev: qwen-coder-plus → superseded by: qwen3-coder-next |
...
| Qwen-Plus (`qwen-plus`) | ga | 2025-09-16 | 1M | $0.40 | $1.20 | Qwen3 dense/MoE transformer | Balanced mid-tier workhorse with long context | prev: qwen-plus-2025-04-28 |
...
| Qwen3-Max (`qwen3-max`) | ga | 2025-09-05 | 262.1K | $0.86 | $3.44 | mixture-of-experts | Flagship general-purpose Qwen for complex tasks | prev: qwen2.5-max → superseded by: qwen3.7-max |
...
| Qwen-Turbo (`qwen-turbo`) | ga | 2025-04-29 | 1M | $0.05 | $0.20 | Qwen3 lightweight | Ultra-cheap, high-throughput text tasks | superseded by: qwen-flash |
...
| Nova 2 Lite (`amazon.nova-2-lite-v1:0`) | ga | 2025-12-02 | 1M | $0.30 | $2.50 | Multimodal reasoning foundation model with adjustable thinking | Fast, cost-effective reasoning for everyday workloads | prev: amazon.nova-lite-v1:0 |
...
| Nova Lite (`amazon.nova-lite-v1:0`) | ga | 2024-12-03 | 300K | $0.06 | $0.24 | transformer | Low-cost multimodal at high throughput | superseded by: amazon.nova-2-lite-v1:0 |
| Nova Micro (`amazon.nova-micro-v1:0`) | ga | 2024-12-03 | 128K | $0.04 | $0.14 | Text-only transformer foundation model | Ultra-low-cost, lowest-latency text tasks | superseded by: amazon.nova-2-lite-v1:0 |
| Nova Pro (`amazon.nova-pro-v1:0`) | ga | 2024-12-03 | 300K | $0.80 | $3.20 | Multimodal understanding foundation model | Balanced multimodal accuracy at moderate cost | superseded by: amazon.nova-2-pro-v1:0 |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Claude Opus 5.5 (`claude-opus-5-5`) | ga | 2026-09-22 | 1M | $4.00 | $20.00 | — | Agentic coding and reasoning at Fable-class quality | prev: claude-opus-5 |
| Claude Fable 5.1 (`claude-fable-5-1`) | ga | 2026-09-01 | 1M | $10.00 | $50.00 | Adaptive-thinking transformer with new tokenizer | Long-running agents, coding, deep knowledge work | prev: claude-fable-5 |
...
| Claude Sonnet 5 (`claude-sonnet-5`) | ga | 2026-06-30 | 1M | $3.00 | $15.00 | Adaptive-thinking transformer with new tokenizer | Cost-efficient agents and everyday coding | prev: claude-sonnet-4-6 |
...
| Claude Haiku 4.5 (`claude-haiku-4-5`) | ga | 2025-10-01 | 200K | $1.00 | $5.00 | Extended-thinking transformer | Low-cost, high-throughput chat and classification | prev: claude-haiku-4 |
...
| Command A (`command-a-03-2025`) | ga | 2025-03-13 | 256K | $2.50 | $10.00 | Dense 111B parameters | Enterprise RAG, tool use and multilingual chat | prev: command-r-plus-08-2024 → superseded by: command-a-plus-05-2026 |
...
| Command R+ 08-2024 (`command-r-plus-08-2024`) | deprecated | 2024-08-30 | 128K | $2.50 | $10.00 | Dense 104B parameters | Legacy RAG and tool-use enterprise workflows | prev: command-r-plus → superseded by: command-a-03-2025 |
...
| DeepSeek V4 Flash (`deepseek-v4-flash`) | ga | 2026-07-31 | 1.0M | $0.22 | $0.66 | Sparse MoE — 284B total / 13B active | High-throughput long-context inference on a budget | prev: deepseek-chat → superseded by: deepseek-flash |
| DeepSeek V4 Pro (`deepseek-v4-pro`) | ga | 2026-04-24 | 1.0M | $0.66 | $1.98 | Sparse MoE — 1.6T total / 49B active with CSA+HCA hybrid attention | Frontier open-weight reasoning at 1M context | prev: deepseek-v3.2-exp → superseded by: deepseek-v4.1-flash |
...
| Gemini 3 Pro (`gemini-3-pro`) | ga | 2025-11-18 | 1.0M | $2.00 | $12.00 | Sparse Mixture-of-Experts multimodal transformer (details undisclosed) | Frontier reasoning, multimodal, agentic coding | prev: gemini-2.5-pro → superseded by: gemini-3.1-pro-preview |
...
| Gemini 2.5 Flash-Lite (`gemini-2.5-flash-lite`) | ga | 2025-06-17 | 1.0M | $0.10 | $0.40 | Sparse mixture-of-experts multimodal transformer | High-volume classification and simple extraction | prev: gemini-2.0-flash-lite → superseded by: gemini-3.1-flash-lite-preview |
| Gemini 2.5 Pro (`gemini-2.5-pro`) | ga | 2025-06-17 | 1.0M | $1.25 | $10.00 | Sparse Mixture-of-Experts multimodal transformer (details undisclosed) | Balanced reasoning and multimodal analysis | prev: gemini-1.5-pro → superseded by: gemini-3-pro |
...
| Gemini 3.1 Pro (`gemini-3.1-pro-preview`) | preview | 2026-02-19 | 1.0M | $2.00 | $12.00 | Sparse Mixture-of-Experts multimodal transformer (details undisclosed) | Highest-accuracy reasoning and long-context tasks | prev: gemini-3-pro → superseded by: gemini-3.1-pro |
...
| Llama 3.3 70B Instruct (`llama-3.3-70b-instruct`) | deprecated | 2024-12-06 | 131.1K | $0.10 | $0.32 | Dense decoder-only transformer, 70B parameters | Cost-efficient open-weights text generation | prev: llama-3.1-70b-instruct → superseded by: llama-4-maverick-17b-128e-instruct-fp8 |
...
| Phi-4-reasoning (`phi-4-reasoning`) | ga | 2025-04-30 | 32.8K | $0.13 | $0.50 | Dense decoder-only transformer, 14B parameters, SFT+RL reasoning training | Small-model reasoning for math and code | prev: phi-4 |
...
| Phi-4 (`phi-4`) | ga | 2024-12-12 | 16.4K | $0.13 | $0.50 | Dense decoder-only transformer, 14B parameters | Small-model reasoning, math, and code generation | prev: phi-3.5-medium-instruct → superseded by: phi-4-reasoning |
...
| Phi-4-reasoning-vision-15B (`phi-4-reasoning-vision-15b`) | preview | 2026-03-01 | 32.8K | — | — | 15B parameter multimodal reasoning transformer with adaptive thinking | Adaptive reasoning over text and images | prev: phi-4-reasoning |
...
| Mistral Medium 3.5 (`mistral-medium-3-5`) | ga | 2026-04-29 | 262.1K | $1.50 | $7.50 | Dense 128B parameters | Unified reasoning, instruct and coding workhorse | prev: mistral-medium-2508 |
...
| Mistral Small 4 (`mistral-small-2603`) | ga | 2026-03-16 | 262.1K | $0.15 | $0.60 | Sparse MoE — 119B total / 6.5B active | Budget MoE unifying vision, reasoning and coding | prev: mistral-small-2506 |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K3 (`kimi-k3`) | ga | 2026-07-16 | 1.0M | $3.00 | $15.00 | Sparse MoE — 2.8T total, 896 experts, 16 active per token | Flagship 1M-context multimodal reasoning | prev: kimi-k2.6 |
| Kimi K2.7 Code (`kimi-k2.7-code`) | ga | 2026-06-12 | 262.1K | $0.95 | $4.00 | Sparse MoE — 1T total / 32B active | End-to-end agentic coding over long contexts | prev: kimi-k2.6 → superseded by: kimi-k2.8-preview |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262.1K | $0.95 | $4.00 | Sparse MoE — 1T total / 32B active | Balanced open-weight multimodal agent model | prev: kimi-k2.5 → superseded by: kimi-k3 |
...
| Kimi K2.5 (`kimi-k2.5`) | ga | 2025-09-09 | 262.1K | $0.60 | $3.00 | Sparse MoE — 1T total / 32B active | Cheap high-throughput text agent workflows | prev: kimi-k2 → superseded by: kimi-k2.6 |
...
| Nemotron 3 Ultra (`nvidia/nemotron-3-ultra-550b-a55b`) | ga | 2026-06-04 | 1M | $0.50 | $2.50 | hybrid Mamba-Transformer mixture-of-experts | Frontier open-weight reasoning for agentic pipelines | prev: nvidia/llama-3.1-nemotron-ultra-253b-v1 |
...
| Nemotron 3 Super 120B A12B (`nvidia/nemotron-3-super-120b-a12b`) | ga | 2026-03-11 | 1M | $0.09 | $0.40 | hybrid Mamba-Transformer mixture-of-experts | Cost-efficient open-weight reasoning at 12B active | prev: nvidia/llama-3.3-nemotron-super-49b-v1 → superseded by: nvidia/nemotron-3-ultra-550b-a55b |
...
| Nemotron 3 Nano 30B A3B (`nvidia/nemotron-3-nano-30b-a3b`) | ga | 2025-12-15 | 128K | $0.05 | $0.20 | hybrid Mamba-Transformer mixture-of-experts | Small, fast open reasoning model for edge or agents | prev: nvidia/nemotron-nano-9b-v2 → superseded by: nvidia/nemotron-3-super-120b-a12b |
...
| Sonar Pro (`sonar-pro`) | ga | 2025-03-07 | 200K | $3.00 | $15.00 | Search-augmented LLM | Deeper retrieval with 200K context and richer citations | prev: sonar → superseded by: low |
| Sonar Deep Research (`sonar-deep-research`) | ga | 2025-02-14 | 128K | $2.00 | $8.00 | Agentic research pipeline | Long-form multi-source research reports | superseded by: high |
| Sonar Reasoning Pro (`sonar-reasoning-pro`) | ga | 2025-02-01 | 128K | $2.00 | $8.00 | DeepSeek-R1-based | Multi-step reasoning grounded in web search | prev: sonar-reasoning → superseded by: medium |
| Sonar (`sonar`) | ga | 2025-01-27 | 128K | $1.00 | $1.00 | Search-augmented LLM | Lightweight, grounded web-search answers | prev: llama-3.1-sonar-small-128k-online → superseded by: fast |
