...
_Last refreshed: 2026-06-08 by genai-model-catalog routine._
...
| Qwen3-Coder-Next (`qwen3-coder-next`) | ga | 2026-02-04 | 262K | $0.11 | $0.80 | Sparse MoE (80B total, 3B active) | Open-weights agentic coding for local/CLI use | prev: `qwen3-coder-plus` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Command A+ (`command-a-plus-05-2026`) | ga | 2026-05-20 | 128K | $2.50 | $10.00 | 218B sparse MoE, 25B active parameters, 128 experts (8 active per token) plus 1 shared expert | Sovereign enterprise agentic workflows with citations | prev: `command-a-reasoning-08-2025` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Gemini 3.5 Flash (`gemini-3.5-flash`) | ga | 2026-05-19 | 1M | $1.50 | $9.00 | Sparse mixture-of-experts transformer | Fast multimodal agents and coding | prev: `gemini-3-flash` |
| Gemini 3.1 Flash-Lite (`gemini-3.1-flash-lite`) | ga | 2026-05-07 | 1M | $0.25 | $1.50 | Distilled sparse mixture-of-experts | Highest-volume, cost-sensitive multimodal tasks | prev: `gemini-3.1-flash-lite-preview` |
| Gemini 3.1 Pro (`gemini-3.1-pro-preview`) | preview | 2026-02-19 | 1M | $2.00 | $12.00 | Sparse mixture-of-experts transformer with thinking | Frontier multimodal reasoning with large context | prev: `gemini-3-pro` |
...
| Gemini 2.5 Pro (`gemini-2.5-pro`) | deprecated | 2025-06-17 | 1M | $1.25 | $10.00 | Sparse mixture-of-experts transformer | Legacy production migrating to Gemini 3.x | prev: `gemini-1.5-pro` → superseded by: `gemini-3.1-pro-preview` |

## Meta

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Llama 4 Maverick (`llama-4-maverick`) | ga | 2025-04-05 | 1M | $0.15 | $0.60 | MoE, 17B active / 400B total, 128 experts, early-fusion multimodal | Flagship open-weight multimodal MoE | prev: `llama-3.3-70b` |
...
| Phi-4-reasoning-plus (`phi-4-reasoning-plus`) | ga | 2025-04-30 | 32K | — | — | Dense decoder-only transformer (14B, RoPE, MHA) | Open-weight math, science, code reasoning at 14B | prev: `phi-4` → superseded by: `phi-4-reasoning-vision-15b` |
...
| Phi-4-multimodal (`phi-4-multimodal-instruct`) | ga | 2025-02-26 | 131K | $0.05 | $0.10 | Multimodal transformer with mixture-of-LoRAs integrating speech, vision, and text, 5.6B parameters | Unified text, vision, and audio understanding | — |
...
| MAI-Code-1-Flash (`mai-code-1-flash`) | preview | 2026-06-02 | 256K | $0.75 | $4.50 | Dense coding-focused decoder, ~5B parameters with adaptive thinking | Fast cost-efficient coding in GitHub Copilot | — |
| MAI-Thinking-1 (`mai-thinking-1`) | preview | 2026-06-02 | 256K | — | — | Sparse Mixture-of-Experts with 35B active parameters, trained without distillation | Flagship enterprise reasoning and complex problem solving | prev: `mai-1-preview` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Mistral Medium 3.5 (`mistral-medium-2604`) | ga | 2026-04-29 | 262K | $1.50 | $7.50 | Dense transformer, 128B parameters, custom vision encoder | Unified chat, reasoning, coding, vision flagship | prev: `mistral-medium-2508` |
| Mistral Small 4 (`mistral-small-2603`) | ga | 2026-03-16 | 262K | $0.15 | $0.60 | Sparse Mixture-of-Experts, 119B total / ~6B active (128 experts, 4 active) | Cheap unified reasoning, vision, code MoE | prev: `mistral-small-2506` |
| Mistral Large 3 (`mistral-large-2512`) | ga | 2025-12-02 | 262K | $0.50 | $1.50 | Multimodal granular MoE, 41B active / 675B total, FP8 instruct | General-purpose flagship MoE chat and agents | prev: `mistral-large-2411` |
| Magistral Medium 1.2 (`magistral-medium-2509`) | ga | 2025-09-18 | 131K | $2.00 | $5.00 | Reasoning model with vision encoder | Vision-capable reasoning and math | prev: `magistral-medium-2507` → superseded by: `mistral-medium-2604` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262K | $0.95 | $4.00 | 1T-parameter MoE, 32B active per token, 61 layers, 384 experts (8 selected + 1 shared), MLA attention, MoonViT 400M vision encoder | Agentic coding and long-horizon multi-agent workflows | prev: `kimi-k2.5` |
| Kimi K2.5 (`kimi-k2.5`) | ga | 2026-01-27 | 262K | $0.60 | $3.00 | 1T-parameter MoE, 32B active, 61 layers (1 dense + 60 MoE), 384 experts, MLA attention with 64 heads, MoonViT vision encoder | Cost-efficient multimodal agent and coding tasks | prev: `kimi-k2-thinking` → superseded by: `kimi-k2.6` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Nemotron 3 Ultra (`nvidia/nemotron-3-ultra-550b-a55b`) | ga | 2026-06-04 | 1M | $0.60 | $2.60 | Hybrid Mamba2-Transformer Latent MoE; 550B total / 55B active | Flagship reasoning for complex agentic workflows | prev: `nvidia/llama-3.1-nemotron-ultra-253b-v1` |
...
| Nemotron Nano 9B v2 (`nvidia/nvidia-nemotron-nano-9b-v2`) | ga | 2025-09-05 | 131K | $0.04 | $0.16 | Hybrid Mamba-Transformer dense model | Edge and on-device reasoning and code generation | → superseded by: `nvidia/nemotron-3-nano-omni-30b-a3b-reasoning` |
| Llama 3.1 Nemotron Ultra 253B v1 (`nvidia/llama-3.1-nemotron-ultra-253b-v1`) | deprecated | 2025-04-07 | 131K | $0.60 | $1.80 | Dense transformer derived from Llama 3.1 405B via Neural Architecture Search | Reasoning, RAG, and tool-calling on Llama base | → superseded by: `nvidia/nemotron-3-ultra-550b-a55b` |
...
| Grok 4.20 Multi-Agent Beta (`grok-4.20-multi-agent-beta-0309`) | preview | 2026-03-09 | 2M | $2.00 | $6.00 | Multi-agent system orchestrating 4-16 reasoning agents in parallel | Multi-agent deep research with 2M context | prev: `grok-4.20` |
