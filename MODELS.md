...
_Last refreshed: 2026-07-30 by genai-model-catalog routine._
...
| Qwen3.5-Omni-Flash (`qwen3.5-omni-flash`) | ga | 2026-03-30 | 131.1K | $0.10 | $0.80 | Thinker-Talker MoE 30B total / 3B active with Hybrid-Atte... | Low-cost end-to-end omni-modal apps with speech output | prev: `qwen3-omni-flash` |
...
| Qwen3-Max (`qwen3-max`) | ga | 2025-09-23 | 262.1K | $1.20 | $6.00 | Mixture-of-Experts (~1T total parameters) | Flagship frontier reasoning and agentic workflows | prev: `qwen-max` → superseded by: `qwen3.7-max` |
| Qwen3-VL (`qwen3-vl-plus`) | ga | 2025-09-23 | 262.1K | $0.20 | $1.60 | MoE 235B total / ~22B active | Multimodal image, document, and video understanding | prev: `qwen-vl-max` → superseded by: `qwen3.7-plus` |
...
| Nova Premier (`amazon.nova-premier-v1:0`) | ga | 2025-10-31 | 1M | $2.50 | $12.50 | Transformer, multimodal foundation model | Complex reasoning, agentic workflows, model distillation | prev: `amazon.nova-pro-v1:0` → superseded by: `amazon.nova-2-pro-v1:0` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Claude Opus 5 (`claude-opus-5`) | ga | 2026-07-24 | 1M | $5.00 | $25.00 | Transformer LLM using the newer tokenizer introduced with... | Complex agentic coding and enterprise reasoning | prev: `claude-opus-4-8` |
| Claude Sonnet 5 (`claude-sonnet-5`) | ga | 2026-06-30 | 1M | $2.00 | $10.00 | Transformer LLM using the newer tokenizer introduced with... | Speed/intelligence balance, near-Opus coding quality | prev: `claude-sonnet-4-6` |
| Claude Fable 5 (`claude-fable-5`) | ga | 2026-06-09 | 1M | $10.00 | $50.00 | Transformer LLM using the newer tokenizer introduced with... | Most demanding reasoning and long-horizon agentic work | prev: `claude-mythos-preview` |
| Claude Opus 4.8 (`claude-opus-4-8`) | ga | 2026-05-28 | 1M | $5.00 | $25.00 | Transformer LLM using the newer tokenizer introduced with... | High-capability agentic workloads on prior Opus generation | prev: `claude-opus-4-7` → superseded by: `claude-opus-5` |
...
| Claude Haiku 4.5 (`claude-haiku-4-5`) | ga | 2025-10-01 | 200K | $1.00 | $5.00 | Transformer LLM using the pre-4.7 tokenizer (same as Clau... | Fastest and most cost-effective for simple tasks | prev: `claude-3-5-haiku-20241022` |
...
| Command A+ (`command-a-plus-05-2026`) | ga | 2026-05-20 | 128K | $2.50 | $10.00 | 218B sparse Mixture-of-Experts transformer with 25B activ... | Open-weight enterprise agentic workflows | prev: `command-a-03-2025` |
...
| Rerank 4 Fast (`rerank-v4.0-fast`) | ga | 2025-12-11 | 32.8K | — | — | Distilled multilingual cross-encoder reranker with 32K co... | Low-latency, high-throughput multilingual reranking for production RAG | prev: `rerank-v3.5` |
...
| Embed 4 (`embed-v4.0`) | ga | 2025-04-15 | 128K | $0.12 | — | Multimodal encoder producing unified text+image dense emb... | Multimodal enterprise search and agentic RAG over interleaved text, images, PDFs, charts and tables | prev: `embed-english-v3.0` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DeepSeek V4 Flash (`deepseek-v4-flash`) | ga | 2026-04-24 | 1M | $0.14 | $0.28 | Mixture-of-Experts, 284B total / 13B active with Compress... | High-throughput low-cost reasoning with 1M context | prev: `deepseek-chat` |
| DeepSeek V4 Pro (`deepseek-v4-pro`) | ga | 2026-04-24 | 1M | $0.43 | $0.87 | Mixture-of-Experts, 1.6T total / 49B active with Compress... | Frontier open-weight reasoning and agentic MCP workloads | prev: `deepseek-reasoner` |
...
| Gemini 3.6 Flash (`gemini-3.6-flash`) | ga | 2026-07-21 | 1.05M | $1.50 | $7.50 | Sparse Mixture-of-Experts transformer with native multimo... | Balanced cost/quality for high-volume agentic workflows | prev: `gemini-3.5-flash` |
| Gemini 3.5 Flash (`gemini-3.5-flash`) | ga | 2026-05-19 | 1.05M | $1.50 | $9.00 | Sparse Mixture-of-Experts transformer with native multimo... | General-purpose agentic Flash workhorse | prev: `gemini-3.1-flash` → superseded by: `gemini-3.6-flash` |
| Gemini 3.1 Flash-Lite (`gemini-3.1-flash-lite`) | ga | 2026-05-07 | 1.05M | $0.25 | $1.50 | Transformer-based Mixture-of-Experts | Low-latency, high-volume, cost-sensitive workloads | prev: `gemini-2.5-flash-lite` → superseded by: `gemini-3.5-flash-lite` |
| Gemini 3.1 Pro (`gemini-3.1-pro`) | ga | 2026-02-19 | 1.05M | $2.00 | $12.00 | Sparse Mixture-of-Experts transformer with native multimo... | GA flagship reasoning and long-context tasks | prev: `gemini-3-pro` → superseded by: `gemini-3.5-pro-preview` |
...
| Gemini 3.1 Pro (`gemini-3.1-pro-preview`) | preview | 2026-02-19 | 1.05M | $2.00 | $12.00 | Transformer-based Mixture-of-Experts | Flagship reasoning, coding, and multimodal tasks | prev: `gemini-3-pro-preview` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Llama Guard 4 12B (`meta-llama/Llama-Guard-4-12B`) | ga | 2025-04-29 | 131.1K | $0.20 | $0.20 | Dense 12B classifier fine-tuned from Llama 4 Scout backbo... | Multimodal content-safety classification and guardrails for Llama-family deployments | prev: `meta-llama/Llama-Guard-3-8B` |
| Llama 4 Maverick (`meta-llama/Llama-4-Maverick-17B-128E-Instruct`) | ga | 2025-04-05 | 1M | $0.27 | $0.85 | Mixture-of-experts, 17B active parameters, 128 experts, 4... | Flagship open-weight multimodal chat and coding on Together AI serverless | prev: `meta-llama/Llama-3.3-70B-Instruct` |
| Llama 4 Maverick (`llama-4-maverick-17b-128e-instruct`) | ga | 2025-04-05 | 1.05M | $0.20 | $0.60 | Mixture-of-experts with 17B active parameters, 128 expert... | Flagship multimodal chat and production assistants on Groq LPU inference | prev: `llama-3.3-70b` → superseded by: `meta-llama/Llama-4-Maverick-17B-128E-Instruct` |
| Llama 4 Maverick (`llama-4-maverick`) | ga | 2025-04-05 | 1.05M | $0.19 | $0.60 | Mixture-of-Experts (MoE), 128 experts, 17B active / ~400B... | Open-weight generalist for reasoning and coding | prev: `llama-3.3-70b` → superseded by: `meta-llama/Llama-4-Maverick-17B-128E-Instruct` |
| Llama 4 Scout (`meta-llama/Llama-4-Scout-17B-16E-Instruct`) | ga | 2025-04-05 | 10M | $0.18 | $0.59 | Mixture-of-experts, 17B active parameters, 16 experts, 10... | Long-context multimodal reasoning on a single GPU (Together AI serverless) | prev: `meta-llama/Llama-3.3-70B-Instruct` |
| Llama 4 Scout (`llama-4-scout-17b-16e-instruct`) | ga | 2025-04-05 | 10.49M | $0.11 | $0.34 | Mixture-of-experts with 17B active parameters, 16 experts... | Long-context multimodal reading and retrieval on Groq LPU | prev: `llama-3.3-70b` → superseded by: `meta-llama/Llama-4-Scout-17B-16E-Instruct` |
| Llama 4 Scout (`llama-4-scout`) | ga | 2025-04-05 | 10.49M | $0.08 | $0.30 | Mixture-of-Experts (MoE), 16 experts, 17B active / ~109B ... | Long-document processing with open weights | prev: `llama-3.3-70b` → superseded by: `meta-llama/Llama-4-Scout-17B-16E-Instruct` |
...
| Muse Spark 1.1 (`muse-spark-1.1`) | preview | 2026-07-09 | 1M | $1.25 | $4.25 | Multimodal reasoning model with agentic orchestration, to... | Agentic tasks, tool use, and computer use | prev: `muse-spark` |
...
| Llama 4 Behemoth (`meta-llama/Llama-4-Behemoth`) | preview | — | — | — | — | Mixture-of-experts teacher model, ~288B active / ~2T tota... | Teacher model for Llama 4 distillation | — |
| Muse Spark (`muse-spark`) | deprecated | 2026-04-08 | 1M | — | — | Natively multimodal reasoning model, closed-weight, Meta ... | First closed-weight Meta Superintelligence Labs model | prev: `meta-llama/Llama-4-Maverick-17B-128E-Instruct` → superseded by: `muse-spark-1.1` |
...
| Phi-4-reasoning-plus (`phi-4-reasoning-plus`) | ga | 2025-04-30 | 32.8K | — | — | Dense small language model, RL fine-tuned from Phi-4 (~14B) | Small open-weight reasoning with chain-of-thought | prev: `phi-4-reasoning` → superseded by: `phi-4-reasoning-vision-15b` |
| Phi-4-reasoning-plus (`microsoft/phi-4-reasoning-plus`) | ga | 2025-04-30 | 32.8K | — | — | 14B dense decoder-only transformer, SFT + RL fine-tuned f... | Open-weight small reasoning model for on-device | prev: `phi-4-reasoning` → superseded by: `microsoft/phi-4-reasoning-vision` |
...
| Phi-4-multimodal-instruct (`phi-4-multimodal-instruct`) | ga | 2025-02-26 | 131.1K | $0.08 | $0.32 | Dense small language model with vision and audio encoders | Small multimodal model with speech, vision, and text | prev: `phi-3.5-vision-instruct` |
| Phi-4-multimodal-instruct (`microsoft/phi-4-multimodal-instruct`) | ga | 2025-02-26 | 128K | $0.08 | $0.32 | 5.6B parameter unified multimodal transformer (text, visi... | Unified text, vision, and audio in a small model | — |
...
| Mistral Medium 3.5 (`mistral-medium-latest`) | ga | 2026-04-29 | 262.1K | $1.50 | $7.50 | 128B dense multimodal transformer with configurable reaso... | Agentic coding and mid-tier multimodal work | prev: `mistral-medium-2505` |
| Mistral Small 4 (`mistral-small-2603`) | ga | 2026-03-16 | 262.1K | $0.15 | $0.60 | Mixture-of-Experts, 119B total / ~6.5B active parameters ... | Low-cost multimodal MoE for high-volume workloads | prev: `mistral-small-2503` |
| Mistral Small 4 (`mistral-small-latest`) | ga | 2026-03-16 | 262.1K | $0.15 | $0.60 | Mixture-of-experts, ~119B total / ~6B active parameters, ... | Low-cost multimodal reasoning and coding | prev: `mistral-small-2506` |
...
| Mistral Large 3 (`mistral-large-latest`) | ga | 2025-12-04 | 262.1K | $0.50 | $1.50 | Sparse mixture-of-experts, ~675B total / ~41B active para... | Flagship general-purpose multimodal MoE | prev: `mistral-large-2411` |
...
| Mistral Large 3 (`mistral-large-2512`) | ga | 2025-12-01 | 256K | $0.50 | $1.50 | Sparse Mixture-of-Experts, 675B total / ~41B active param... | Flagship multimodal reasoning and agentic workloads | prev: `mistral-large-2411` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K3 (`kimi-k3`) | ga | 2026-07-16 | 1M | $3.00 | $15.00 | Sparse Mixture-of-Experts, 2.8T total / 104B active, 16 o... | Frontier open-weight reasoning, long context, agentic tasks | prev: `kimi-k2.6` |
| Kimi K2.7 Code (`kimi-k2.7-code`) | ga | 2026-06-12 | 262.1K | $0.95 | $4.00 | Mixture-of-Experts, 1T total / 32B active | Coding and agentic development workflows | prev: `kimi-k2.6` |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262.1K | $0.95 | $4.00 | Mixture-of-Experts, 1T total / 32B active | General-purpose multimodal chat, coding, long context | prev: `kimi-k2-0905` → superseded by: `kimi-k3` |
| Kimi K2 Thinking (`kimi-k2-thinking`) | ga | 2025-11-06 | 262.1K | $0.60 | $2.50 | Mixture-of-Experts, 1T total / 32B active, INT4 native | Long-horizon agentic reasoning with sustained tool use | prev: `kimi-k2` → superseded by: `kimi-k2.5` |
...
| Nemotron 3 Embed 8B (`nvidia/nemotron-3-embed-8b`) | ga | 2026-07-16 | 32.8K | — | — | Transformer text encoder with bidirectional attention, 40... | Multilingual retrieval embeddings for RAG | — |
...
| Nemotron 3 Nano Omni 30B A3B (`nvidia/nemotron-3-nano-omni-30b-a3b-reasoning`) | ga | 2026-04-28 | 300K | $0.07 | $0.30 | Hybrid Mamba-Transformer MoE, omni-modal (30B total, 3B a... | Multimodal document, audio and video agents | prev: `nvidia/nemotron-3-nano-30b-a3b` |
...
| Nemotron 3 Super 120B A12B (`nvidia/nemotron-3-super-120b-a12b`) | ga | 2026-03-11 | 262.1K | $0.09 | $0.45 | Hybrid Mamba-Transformer MoE (~120B total, 12B active) | High-accuracy reasoning for multi-agent apps | prev: `nvidia/llama-3_3-nemotron-super-49b-v1_5` |
| Nemotron 3 Nano 30B A3B (`nvidia/nemotron-3-nano-30b-a3b`) | ga | 2025-12-14 | 262.1K | $0.05 | $0.20 | Hybrid Mamba-Transformer MoE (30B total, 3B active) | Cost-efficient agentic workflows and coding | prev: `nvidia/nvidia-nemotron-nano-9b-v2` |
| Nemotron Nano 2 VL (`nvidia/nemotron-nano-12b-v2-vl`) | ga | 2025-10-28 | 131.1K | — | — | Hybrid Transformer-Mamba VLM built on Nemotron Nano V2 12... | open document intelligence and video understanding | prev: `nvidia/nvidia-nemotron-nano-9b-v2` → superseded by: `nvidia/nemotron-3-nano-omni-30b-a3b-reasoning` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| GPT-5.6 Luna (`gpt-5.6-luna`) | ga | 2026-07-09 | 1.05M | $0.20 | $1.20 | Mixture-of-experts transformer with dynamic routing and c... | Cost-efficient high-volume workloads | prev: `gpt-5.4-mini` |
| GPT-5.6 Sol (`gpt-5.6-sol`) | ga | 2026-07-09 | 1.05M | $5.00 | $30.00 | Mixture-of-experts transformer with dynamic routing and c... | Frontier intelligence, coding, cybersecurity, science | prev: `gpt-5.5` |
| GPT-5.6 Terra (`gpt-5.6-terra`) | ga | 2026-07-09 | 1.05M | $2.00 | $12.00 | Mixture-of-experts transformer with dynamic routing and c... | Balanced everyday work at mid-tier cost | prev: `gpt-5.5` |
...
| gpt-oss-120b (`gpt-oss-120b`) | ga | 2025-08-05 | 131.1K | $0.03 | $0.15 | Sparse Mixture-of-Experts (117B total, 5.1B active per to... | Self-hosted open-weight reasoning and tool use | — |
...
| Sonar (`sonar`) | ga | 2025-01-27 | 127.1K | $1.00 | $1.00 | Built on Llama 3.3 70B with live web retrieval | Lightweight, cost-effective web-grounded Q&A | — |
