...
_Last refreshed: 2026-06-09 by genai-model-catalog routine._
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Command A+ (`command-a-plus-05-2026`) | ga | 2026-05-20 | 128K | $2.50 | $10.00 | Decoder-only Sparse Mixture-of-Experts Transformer (128 experts, 8 active per token, 25B active / 218B total params) | Open-weight multimodal agentic enterprise workflows | prev: command-a-03-2025 |
...
| Command A (`command-a-03-2025`) | ga | 2025-03-13 | 256K | $2.50 | $10.00 | Dense decoder-only transformer, 111B parameters | Enterprise RAG, tool use, and agentic tasks | prev: command-r-plus-08-2024 → superseded by: command-a-plus-05-2026 |
| Command R7B (`command-r7b-12-2024`) | ga | 2024-12-13 | 128K | $0.04 | $0.15 | Dense decoder-only transformer, 7B parameters | Small, fast RAG and tool-use workloads | — |
...
| Gemini 3.5 Pro (`gemini-3.5-pro-preview`) | preview | 2026-05-19 | 2.09715M | — | — | — | Frontier reasoning and deep multimodal understanding | prev: gemini-3.1-pro-preview |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Llama 4 Maverick (`llama-4-maverick`) | ga | 2025-04-05 | 1.04858M | $0.15 | $0.60 | Mixture-of-Experts (400B total, 17B active, 128 routed + 1 shared expert) | High-quality multimodal chat and reasoning | prev: llama-3.3-70b |
...
| Phi-4-reasoning-plus (`phi-4-reasoning-plus`) | ga | 2025-04-30 | 32.768K | — | — | Dense decoder-only transformer | Open-weight reasoning for math and science | prev: phi-4 → superseded by: phi-4-reasoning-vision-15b |
...
| MAI-Code-1-Flash (`mai-code-1-flash`) | preview | 2026-06-02 | 256K | $0.75 | $4.50 | Sparse Mixture-of-Experts transformer (~137B total params) | Fast, low-cost coding inside Copilot and Foundry | — |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Mistral Medium 3.5 (`mistral-medium-2604`) | ga | 2026-04-28 | 262.144K | $1.50 | $7.50 | Dense 128B parameter transformer with retrained vision encoder | Agentic, coding, and complex multi-step reasoning workloads | prev: mistral-medium-2508 |
...
| Mistral Large 3 (`mistral-large-2512`) | ga | 2025-12-02 | 262.144K | $0.50 | $1.50 | Granular Mixture-of-Experts, 675B total / 41B active parameters | Frontier open-weight multimodal reasoning and agentic tasks | prev: mistral-large-2411 |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262.144K | $0.95 | $4.00 | Sparse MoE — 1T total / 32B active | Open-weight agentic coding and tool use | prev: kimi-k2.5 |
| Kimi K2.5 (`kimi-k2.5`) | ga | 2026-01-27 | 262.144K | $0.60 | $3.00 | Sparse MoE — 1T total / 32B active | Cost-efficient open-weight multimodal agent | prev: kimi-k2-thinking → superseded by: kimi-k2.6 |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Nemotron 3 Ultra (`nvidia/nemotron-3-ultra-550b-a55b`) | ga | 2026-06-04 | 1M | $0.50 | $2.50 | Hybrid Mamba-Transformer Mixture-of-Experts (LatentMoE) | Long-running agentic reasoning and orchestration | prev: nvidia/llama-3.1-nemotron-ultra-253b-v1 |
...
| Nemotron 3 Nano Omni 30B A3B Reasoning (`nvidia/nemotron-3-nano-omni-30b-a3b-reasoning`) | ga | 2026-04-28 | 256K | $0.07 | $0.30 | Hybrid Mamba-Transformer MoE multimodal (30B total, 3B active) | Unified multimodal agentic perception | prev: nvidia/nvidia-nemotron-nano-9b-v2 |
...
| gpt-oss-120b (`gpt-oss-120b`) | ga | 2025-08-05 | 131.072K | — | — | Mixture-of-Experts (128 experts, 4 active per token; 5.1B active / 117B total params) | Open-weight reasoning deployment on single GPU | — |
