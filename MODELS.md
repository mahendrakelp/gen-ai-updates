...
| Qwen3-VL-Plus (`qwen3-vl-plus`) | ga | 2025-09-23 | 262.1K | $0.21 | $0.88 | Multimodal transformer with vision encoder, Qwen3 base | Cost-efficient image and document understanding | prev: `qwen-vl-plus` → superseded by: `qwen3.7-plus` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Amazon Nova 2 Lite (`amazon.nova-2-lite-v1:0`) | ga | 2025-12-02 | 1M | $0.30 | $2.50 | Multimodal reasoning foundation model with extended thinking | Cost-effective everyday reasoning workloads | prev: `amazon.nova-lite-v1:0` |
...
| Amazon Nova Premier (`amazon.nova-premier-v1:0`) | ga | 2025-04-30 | 1M | $2.50 | $12.50 | Multimodal frontier foundation model | Complex tasks and model distillation teacher | prev: `amazon.nova-pro-v1:0` → superseded by: `amazon.nova-2-pro-preview-20251202-v1:0` |
| Amazon Nova Micro (`amazon.nova-micro-v1:0`) | ga | 2024-12-05 | 128K | $0.04 | $0.14 | Text-only transformer foundation model | Ultra low-latency low-cost text tasks | superseded by: `amazon.nova-2-lite-v1:0` |
| Amazon Nova Pro (`amazon.nova-pro-v1:0`) | ga | 2024-12-05 | 300K | $0.80 | $3.20 | Multimodal transformer foundation model | Balanced multimodal accuracy, speed and cost | superseded by: `amazon.nova-2-pro-preview-20251202-v1:0` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Claude Opus 5 (`claude-opus-5`) | ga | 2026-07-24 | 1M | $5.00 | $25.00 | Opus-class model with adaptive thinking and effort control | Complex reasoning and long-horizon agentic coding | prev: `claude-opus-4-8` |
| Claude Sonnet 5 (`claude-sonnet-5`) | ga | 2026-06-30 | 1M | $3.00 | $15.00 | Sonnet-class agentic model with adaptive thinking | Balanced agentic coding at Sonnet price point | prev: `claude-sonnet-4-6` |
...
| Claude Opus 4.8 (`claude-opus-4-8`) | ga | 2026-05-28 | 1M | $5.00 | $25.00 | Transformer LLM using the newer tokenizer introduced with Claude Opus 4.7 | Default server-side refusal fallback for Opus 5 | prev: `claude-opus-4-7` → superseded by: `claude-opus-5` |
...
| Claude Haiku 4.5 (`claude-haiku-4-5`) | ga | 2025-10-15 | 200K | $1.00 | $5.00 | Haiku-class small model with extended thinking | Fast, low-cost high-volume tasks and sub-agents | prev: `claude-haiku-3-5` |
...
| Command A+ (`command-a-plus-05-2026`) | ga | 2026-05-20 | 128K | $2.50 | $10.00 | Sparse Mixture-of-Experts with 218B total and 25B active parameters (128 experts, 8 activated per token plus 1 shared) | Sovereign agentic workflows and multimodal enterprise tasks | prev: `command-a-03-2025` |
...
| Command A Vision (`command-a-vision-07-2025`) | ga | 2025-07-31 | 128K | $2.50 | $10.00 | 112B vision-language model built on Command A with SigLIP2-patch16-512 vision encoder via a multimodal adapter | Enterprise document, chart, and image understanding | prev: `command-a-03-2025` → superseded by: `command-a-plus-05-2026` |
...
| Command A (`command-a-03-2025`) | ga | 2025-03-13 | 256K | $2.50 | $10.00 | 111B dense transformer | Enterprise RAG, tool use, and multilingual agents | prev: `command-r-plus-08-2024` → superseded by: `command-a-plus-05-2026` |
| Command R7B (`command-r7b-12-2024`) | ga | 2024-12-02 | 128K | $0.04 | $0.15 | 8B dense transformer | Fast, cost-efficient RAG and edge deployments | prev: `command-r-08-2024` |
...
| Command R+ (`command-r-plus-08-2024`) | ga | 2024-08-30 | 128K | $2.50 | $10.00 | 104B dense transformer | Retrieval-augmented generation and multi-step tool use | prev: `command-r-plus` → superseded by: `command-a-03-2025` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DeepSeek V4-Pro-0813 (`deepseek-v4-pro-0813`) | ga | 2026-08-13 | 1.05M | $1.74 | $3.48 | MoE 1.6T total / 49B active, DeepSeek Sparse Attention | Version-pinned V4 Pro snapshot for production | prev: `deepseek-v4-pro` |
| DeepSeek V4-Flash-0731 (`deepseek-v4-flash-0731`) | ga | 2026-07-31 | 1.05M | $0.14 | $0.28 | MoE 284B total / 13B active, DeepSeek Sparse Attention | Pinned snapshot for cheap 1M-context inference | prev: `deepseek-v4-flash` |
| DeepSeek V4 Flash (`deepseek-v4-flash`) | ga | 2026-04-24 | 1.05M | $0.44 | $1.32 | 284B-parameter Mixture-of-Experts with ~13B active per token, DeepSeek Sparse Attention | Cost-efficient reasoning and agentic work | prev: `deepseek-chat` |
| DeepSeek V4 Pro (`deepseek-v4-pro`) | ga | 2026-04-24 | 1.05M | $1.32 | $3.96 | 1.6T-parameter Mixture-of-Experts with ~49B active per token, DeepSeek Sparse Attention | Frontier reasoning and agentic coding | prev: `deepseek-v3.2-exp` |
...
| DeepSeek Chat (legacy alias) (`deepseek-chat`) | deprecated | 2024-12-26 | 1.05M | $0.14 | $0.28 | Alias — routed to V4 Flash non-thinking mode | Legacy non-thinking chat (retired) | prev: `deepseek-v3.2` → superseded by: `deepseek-v4-flash` |

## Google

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Gemini 3.7 Flash (`gemini-3.7-flash`) | ga | 2026-08-13 | 1M | $0.75 | $3.75 | Sparse mixture-of-experts, natively multimodal reasoning model (Gemini 3 series) | High-throughput coding and agentic workhorse | prev: `gemini-3.6-flash` |
| Gemini 3.5 Flash-Lite (`gemini-3.5-flash-lite`) | ga | 2026-07-21 | 1M | $0.30 | $2.50 | Distilled Gemini 3-family mixture-of-experts | Ultra-low-latency, high-throughput agentic tasks | prev: `gemini-3.1-flash-lite` |
...
| Gemini 3.1 Pro (`gemini-3.1-pro-preview`) | preview | 2026-02-19 | 1M | $2.00 | $12.00 | Sparse mixture-of-experts multimodal transformer with hybrid reasoning | Deep reasoning and complex agentic workflows | prev: `gemini-3-pro-preview` |
...
| Phi-4 (`microsoft/phi-4`) | ga | 2024-12-12 | 16.4K | $0.13 | $0.50 | 14B decoder-only transformer | Small-model math, science and coding on device or cheap serverless | prev: `microsoft/Phi-3-medium` → superseded by: `microsoft/phi-4-reasoning-plus` |
...
| MAI-Code-1-Flash (`mai-code-1-flash`) | preview | 2026-06-02 | 256K | $0.75 | $4.50 | sparse Mixture-of-Experts, 137B total / 5B active parameters | everyday developer coding workflows | superseded by: `mai-code-1.1-flash` |
...
| MAI-Thinking-1 (`mai-thinking-1`) | preview | 2026-06-02 | 256K | $2.00 | $8.00 | sparse Mixture-of-Experts, ~1T total parameters with 35B active | complex multi-step reasoning and coding | prev: `mai-1-preview` |
...
| Mistral Small 4 (`mistral-small-2603`) | ga | 2026-03-16 | 262.1K | $0.15 | $0.60 | mixture-of-experts, 119B total / 6.5B active parameters | Cheap multimodal reasoning and coding | prev: `mistral-small-2506` |
...
| Mistral Large 3 (`mistral-large-2512`) | ga | 2025-12-02 | 262.1K | $0.50 | $1.50 | sparse mixture-of-experts, 675B total / 41B active parameters | Frontier multimodal reasoning and enterprise workloads | prev: `mistral-large-2411` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K3 (`kimi-k3`) | ga | 2026-07-16 | 1.05M | $3.00 | $15.00 | 2.8T-parameter MoE with hybrid linear + full attention (Kimi Delta Attention) | long-horizon agentic coding and reasoning | prev: `kimi-k2.6` |
| Kimi K2.7 Code (`kimi-k2.7-code`) | ga | 2026-06-12 | 262.1K | $0.95 | $4.00 | 1T-parameter MoE with 32B active parameters | long-horizon coding and agentic task execution | prev: `kimi-k2.6` |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262.1K | $0.60 | $2.50 | 1T-parameter MoE with 32B active parameters, native INT4 quantization | general reasoning and cost-efficient coding | prev: `kimi-k2.5` → superseded by: `kimi-k3` |
...
| Nemotron 3 Ultra (`nvidia/nemotron-3-ultra-550b-a55b`) | ga | 2026-06-04 | 1M | $0.50 | $2.20 | Hybrid Mamba-Transformer Mixture-of-Experts | Long-running agentic reasoning and tool use | prev: `nvidia/llama-3.1-nemotron-ultra-253b-v1` |
...
| Nemotron 3 Super (`nvidia/nemotron-3-super-120b-a12b`) | ga | 2026-03-04 | 1M | $0.09 | $0.45 | Hybrid Mamba2-Transformer Latent Mixture-of-Experts with Multi-Token Prediction | Balanced reasoning and coding at mid-scale | prev: `nvidia/llama-3.3-nemotron-super-49b-v1` → superseded by: `nvidia/nemotron-3-ultra-550b-a55b` |
| Nemotron 3 Nano (`nvidia/nemotron-3-nano-30b-a3b`) | ga | 2025-12-15 | 262.1K | $0.05 | $0.20 | Hybrid Mamba-Transformer Mixture-of-Experts | Efficient on-device or edge agentic reasoning | prev: `nvidia/nemotron-nano-9b-v2` → superseded by: `nvidia/NVIDIA-Nemotron-3.5-Lightning-30B-A3B` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Sonar Reasoning Pro (`sonar-reasoning-pro`) | ga | 2025-02-24 | 128K | $2.00 | $8.00 | Powered by DeepSeek R1 with chain-of-thought | In-depth analytical reasoning over web sources | prev: `sonar-reasoning` → superseded by: `agent-api-medium` |
| Sonar Deep Research (`sonar-deep-research`) | ga | 2025-02-14 | 128K | $2.00 | $8.00 | Perplexity agentic research pipeline over reasoning backbone | Autonomous multi-source research reports | superseded by: `agent-api-high` |
| Sonar (`sonar`) | ga | 2025-01-21 | 127.1K | $1.00 | $1.00 | Built on Llama 3.3 70B, optimized for Perplexity search | Fast, low-cost web-grounded Q&A with citations | superseded by: `agent-api-fast` |
| Sonar Pro (`sonar-pro`) | ga | 2025-01-21 | 200K | $3.00 | $15.00 | Perplexity in-house model with proprietary search augmentation | Advanced grounded search with larger context | prev: `sonar` → superseded by: `agent-api-low` |
| Sonar Reasoning (`sonar-reasoning`) | ga | 2025-01-21 | 128K | $1.00 | $5.00 | Based on DeepSeek R1 with chain-of-thought | Multi-step reasoning with live web search | superseded by: `sonar-reasoning-pro` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Grok 4.6 (`grok-4.6`) | ga | 2026-08-12 | 500K | $2.00 | $6.00 | 1.5T-parameter V9 foundation with improved SFT and RL | Frontier flagship for coding and long-horizon agents | prev: `grok-4.5` |
...
| Grok 4.5 (`grok-4.5`) | ga | 2026-07-08 | 500K | $2.00 | $6.00 | 1.5T-parameter V9 architecture | Opus-class coding and agentic workflows | prev: `grok-4.3` → superseded by: `grok-4.6` |
| Grok Build 0.1 (`grok-build-0.1`) | ga | 2026-05-20 | 256K | $1.00 | $2.00 | Coding-specialized transformer trained for agentic tasks | MCP-native agentic coding CLI model | prev: `grok-code-fast-1` |
