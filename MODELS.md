...
_Last refreshed: 2026-09-16 by genai-model-catalog routine._

_Total models tracked: 321 across 14 providers._
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Qwen3.8-Flash (`qwen3.8-flash`) | ga | 2026-08-26 | 1M | $0.15 | $0.47 | Hybrid attention MoE, 125B main + 51B n-gram embeddings, 6B active per token | Low-cost high-throughput multimodal reasoning | prev: `qwen3.7-flash` |
...
| Qwen3.8-Max (`qwen3.8-max`) | ga | 2026-08-03 | 1M | $2.00 | $6.00 | Sparse Mixture-of-Experts with hybrid attention, 2.4T total parameters | Flagship coding, agentic, multimodal reasoning | prev: `qwen3.7-max` |
...
| Qwen3.7-Max (`qwen3.7-max`) | ga | 2026-05-19 | 992K | $1.25 | $3.75 | Sparse MoE | Agent-centric coding and long-horizon execution | prev: `qwen3-max` → superseded by: `qwen3.8-max` |
...
| Qwen3-Coder-Plus (`qwen3-coder-plus`) | ga | 2025-09-23 | 1M | $1.00 | $5.00 | Mixture-of-Experts (MoE) | Agentic coding and long-context repo understanding | prev: `qwen-coder-plus` → superseded by: `qwen3-coder-next` |
| Qwen3-Max (`qwen3-max`) | ga | 2025-09-23 | 262K | $0.78 | $3.90 | Mixture-of-Experts (MoE) | Flagship general-purpose reasoning and agentic tasks | prev: `qwen2.5-max` → superseded by: `qwen3.7-max` |
...
| Qwen3-VL-Plus (`qwen3-vl-plus`) | ga | 2025-09-23 | 262K | $0.20 | $1.60 | Vision-language transformer (parameter count not disclosed) | Document AI, OCR, UI understanding, vision agents | prev: `qwen-vl-plus` → superseded by: `qwen3.5-plus` |
...
| Qwen3-Omni (`qwen3-omni-flash`) | ga | 2025-09-15 | 66K | $0.10 | $0.80 | End-to-end omni-modal MoE (Qwen3-Omni-30B-A3B base) | End-to-end omni-modal chat with real-time speech | prev: `qwen2.5-omni` |
| Qwen-Flash (`qwen-flash`) | ga | 2025-07-28 | 1M | $0.15 | $0.47 | Qwen3 lightweight transformer | High-volume classification, extraction, summarization | prev: `qwen-turbo` |
| Qwen-Plus (`qwen-plus`) | ga | 2025-07-28 | 1M | $0.40 | $1.60 | Qwen3 dense/MoE transformer | Balanced quality and cost for production workloads | prev: `qwen-plus-2025-04-28` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Amazon Nova 2 Lite (`amazon.nova-2-lite-v1:0`) | ga | 2025-12-02 | 1M | $0.30 | $2.50 | Multimodal foundation model with extended thinking (reasoning) mode | Fast, cost-effective reasoning and agentic AI | prev: `amazon.nova-lite-v1:0` |
...
| Amazon Nova Pro (`amazon.nova-pro-v1:0`) | ga | 2024-12-03 | 300K | $0.80 | $3.20 | Multimodal foundation model | Balanced multimodal enterprise workloads | superseded by: `amazon.nova-2-pro-preview-20251202-v1:0` |
...
| Amazon Nova Premier (`amazon.nova-premier-v1:0`) | deprecated | 2025-04-30 | 1M | $2.50 | $12.50 | Multimodal foundation model (teacher model) | Complex reasoning and model distillation teacher | prev: `amazon.nova-pro-v1:0` → superseded by: `amazon.nova-2-pro-preview-20251202-v1:0` |
...
| Command A+ (`command-a-plus-05-2026`) | ga | 2026-05-20 | 128K | $2.50 | $10.00 | Sparse mixture-of-experts, 218B total parameters with 25B active | Sovereign, agentic enterprise workloads with vision | prev: `command-a-03-2025` |
...
| Command A Reasoning (`command-a-reasoning-08-2025`) | ga | 2025-08-21 | 256K | $2.50 | $10.00 | 111B-parameter dense transformer with hybrid reasoning | Complex agentic reasoning and tool use | prev: `command-a-03-2025` → superseded by: `command-a-plus-05-2026` |
| Command A Vision (`command-a-vision-07-2025`) | ga | 2025-07-31 | 128K | $2.50 | $10.00 | Command A backbone with vision encoder | Enterprise document, chart, and OCR understanding | prev: `command-a-03-2025` → superseded by: `command-a-plus-05-2026` |
...
| Command A (`command-a-03-2025`) | ga | 2025-03-13 | 256K | $2.50 | $10.00 | 111B-parameter dense transformer | Enterprise agentic tasks, RAG, multilingual | prev: `command-r-plus-08-2024` → superseded by: `command-a-plus-05-2026` |
...
| Rerank 3.5 (`rerank-v3.5`) | ga | 2024-12-03 | 4K | — | — | Cross-encoder reranker | Cross-encoder reranking for retrieval pipelines | prev: `rerank-v3.0` → superseded by: `rerank-v4-pro` |
...
| DeepSeek V4.1 Flash (`deepseek-flash`) | ga | 2026-09-10 | 1M | $0.15 | $0.60 | Sparse MoE, Causal Encoder-Decoder (CED), 552B total params, 8B active on input / 16B active on output | Fast, cheap agentic chat with native vision | prev: `deepseek-v4-flash` |
| DeepSeek V4-Pro (`deepseek-v4-pro`) | ga | 2026-08-13 | 1M | $1.32 | $3.96 | Mixture-of-Experts, 1.6T total / 49B active parameters, Compressed Sparse Attention + Heavily Compressed Attention | Frontier coding and long-context reasoning at low cost | prev: `deepseek-v3.2-exp` → superseded by: `deepseek-v4.1-flash` |
...
| DeepSeek V4-Flash (`deepseek-v4-flash`) | ga | 2026-07-31 | 1M | $0.44 | $0.66 | Mixture-of-Experts, 284B total / 13B active parameters, Compressed Sparse Attention | High-volume agents and cheap long-context inference | prev: `deepseek-v3.2-exp` → superseded by: `deepseek-flash` |
...
| DeepSeek V4-Flash Vision (experimental) (`deepseek-v4-flash-vision-exp`) | deprecated | 2026-08-21 | 1M | $0.22 | $0.66 | Sparse MoE, 284B total / 13B active per token, with vision encoder | Legacy image-in variant of V4 Flash | prev: `deepseek-v4-flash` → superseded by: `deepseek-flash` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Gemini 3.8 Flash (`gemini-3.8-flash`) | ga | 2026-09-02 | 1M | $0.75 | $3.75 | Sparse Mixture-of-Experts, natively multimodal transformer | High-intelligence workhorse coding and agents | prev: `gemini-3.7-flash` |
...
| Gemini 3.5 Flash-Lite (`gemini-3.5-flash-lite`) | ga | 2026-07-21 | 1M | $0.30 | $2.50 | Dense distilled transformer variant of Gemini 3.5 Flash | High-volume, low-reasoning tasks and translation | prev: `gemini-2.5-flash-lite` |
...
| Llama Guard 4 12B (`meta-llama/Llama-Guard-4-12B`) | ga | 2025-04-29 | 164K | $0.20 | $0.20 | Dense 12B early-fusion transformer, pruned from Llama 4 Scout for safety classification | Multimodal input/output safety classification | prev: `meta-llama/Llama-Guard-3-8B` |
...
| Llama 4 Maverick (`llama-4-maverick-17b-128e-instruct`) | ga | 2025-04-05 | 1M | $0.27 | $0.85 | MoE — 17B active / 400B total, 128 experts (early-fusion multimodal) | Open-weight multimodal chat and reasoning at low cost | prev: `llama-3.1-405b-instruct` → superseded by: `muse-spark-1.2` |
...
| Llama 4 Scout (`llama-4-scout-17b-16e-instruct`) | ga | 2025-04-05 | 10M | $0.08 | $0.30 | MoE — 17B active / 109B total, 16 experts (early-fusion multimodal) | Long-context document analysis on a single GPU | prev: `llama-3.3-70b-instruct` → superseded by: `meta-llama/Llama-4-Scout-17B-16E-Instruct` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| MAI-Code-1.1-Flash (`MAI-Code-1.1-Flash`) | ga | 2026-08-01 | 262K | $0.20 | $1.20 | Sparse mixture-of-experts (~137B total / ~5B active) | Fast, cheap agentic coding workflows | prev: `MAI-Code-1-Flash` |
...
| Phi-4 Reasoning Plus (`microsoft/Phi-4-reasoning-plus`) | ga | 2025-04-30 | 33K | — | — | 14B dense transformer fine-tuned with RL for reasoning | Open-weight reasoning at 14B parameters | prev: `microsoft/phi-4` → superseded by: `microsoft/phi-4-reasoning-vision` |
...
| Phi-4 Multimodal Instruct (`microsoft/Phi-4-multimodal-instruct`) | ga | 2025-02-01 | 131K | $0.08 | $0.32 | 5.6B multimodal transformer with Mixture-of-LoRAs vision/speech adapters | Small multimodal model with text, image, audio | prev: `microsoft/Phi-3.5-vision-instruct` → superseded by: `microsoft/Phi-4-reasoning-vision-15B` |
...
| Phi-4 (`microsoft/phi-4`) | ga | 2024-12-12 | 16K | $0.07 | $0.14 | 14B dense transformer | Compact reasoning and math on-device | prev: `microsoft/Phi-3-medium-4k-instruct` → superseded by: `microsoft/Phi-4-reasoning-plus` |
...
| MAI-Thinking-1 (`MAI-Thinking-1`) | preview | 2026-08-31 | 262K | $2.00 | $8.00 | Sparse mixture-of-experts, ~35B active / ~1T total parameters | Microsoft in-house reasoning across math and code | prev: `MAI-1-preview` |
...
| Mistral Small 4 (`mistral-small-2603`) | ga | 2026-03-16 | 262K | $0.15 | $0.60 | 119B parameters with 6.5B active (sparse) | Cheap open multimodal general-purpose model | prev: `mistral-small-2503` |
...
| Leanstral 1.5 (`leanstral-1-5`) | deprecated | 2026-06-30 | 262K | $0.00 | $0.00 | Sparse Mixture-of-Experts (~6.5B active / 119B total, 128 experts / 4 active per token) | Lean 4 formal proof engineering, automated theorem proving, and autoformalization | prev: `leanstral` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K3 (`kimi-k3`) | ga | 2026-07-16 | 1M | $3.00 | $15.00 | 2.8T-parameter Mixture-of-Experts (~104B active), native multimodal | Flagship reasoning, long-context agentic coding | prev: `kimi-k2.8-preview` |
| Kimi K2.7 Code (`kimi-k2.7-code`) | ga | 2026-06-12 | 262K | $0.95 | $4.00 | 1T-parameter MoE with 32B active, 384 experts | Token-efficient agentic coding workflows | prev: `kimi-k2.6` → superseded by: `kimi-k2.8-preview` |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262K | $0.95 | $4.00 | 1T-parameter Mixture-of-Experts, ~32B active per token | Cost-effective general-purpose agentic model | prev: `kimi-k2.5` → superseded by: `kimi-k2.7-code` |
| Kimi K2.5 (`kimi-k2.5`) | ga | 2026-01-27 | 262K | $0.60 | $3.00 | 1T-parameter native multimodal MoE | First native-multimodal 1T open agent model | prev: `kimi-k2-0905-preview` → superseded by: `kimi-k2.6` |
| Kimi K2 Thinking (`kimi-k2-thinking`) | ga | 2025-11-06 | 262K | $0.60 | $2.50 | 1T-parameter MoE with 32B active per token, INT4 QAT quantized | Deep reasoning with long-horizon tool orchestration | prev: `kimi-k2-instruct` → superseded by: `kimi-k3` |
...
| Kimi K2.8 Preview (`kimi-k2.8-preview`) | preview | 2026-09-11 | 1M | — | — | — | Mid-tier multimodal coding and agents | prev: `kimi-k2.7-code` → superseded by: `kimi-k3` |
...
| Nemotron 3 Ultra 550B-A55B (`nvidia/nemotron-3-ultra-550b-a55b`) | ga | 2026-06-04 | 262K | $0.50 | $2.20 | Hybrid Mamba-Transformer (Nemotron-H) mixture-of-experts, 550B total / 55B active parameters | Frontier open reasoning and agent orchestration | prev: `nvidia/llama-3.1-nemotron-ultra-253b-v1` |
...
| Nemotron 3 Nano Omni (`nvidia/nemotron-3-nano-omni`) | ga | 2026-04-28 | 262K | — | — | 30B-A3B hybrid Mamba-Transformer MoE with unified vision/audio/text encoders | Efficient multimodal agents unifying vision, audio, text | prev: `nvidia/nemotron-3-nano-30b-a3b` |
...
| Nemotron 3 Nano Omni 30B-A3B Reasoning (`nvidia/nemotron-3-nano-omni-30b-a3b-reasoning`) | ga | 2026-04-28 | 1M | $0.07 | $0.30 | MoE Hybrid Mamba-Transformer - 30B total / 3B active with unified vision/audio/video/text encoders | Multimodal document, audio, and video agents | prev: `nvidia/nemotron-3-nano-30b-a3b` |
...
| Nemotron 3 Super 120B-A12B (`nvidia/nemotron-3-super-120b-a12b`) | ga | 2026-03-11 | 1M | $0.09 | $0.40 | Hybrid Mamba-Transformer mixture-of-experts, 120B total / 12B active parameters | Enterprise agentic workflows and coding assistants | prev: `nvidia/llama-3.3-nemotron-super-49b-v1.5` → superseded by: `nvidia/nemotron-3-ultra-550b-a55b` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| GPT-6 Astra (`gpt-6-astra`) | ga | 2026-09-03 | 1M | $10.00 | $50.00 | — | Frontier reasoning, agentic coding, computer use | prev: `gpt-5.6-sol` |
...
| GPT-5.6 Luna (`gpt-5.6-luna`) | ga | 2026-07-09 | 1M | $0.20 | $1.20 | GPT-5.6 series cost-efficient model | High-volume, latency-sensitive workloads | prev: `gpt-5.5` |
| GPT-5.6 Sol (`gpt-5.6-sol`) | ga | 2026-07-09 | 1M | $5.00 | $30.00 | GPT-5.6 series flagship reasoning model | Previous-gen flagship for complex reasoning and coding | prev: `gpt-5.5` → superseded by: `gpt-6-astra` |
| GPT-5.6 Terra (`gpt-5.6-terra`) | ga | 2026-07-09 | 1M | $2.00 | $12.00 | GPT-5.6 series balanced reasoning model | Balanced intelligence and cost for production | prev: `gpt-5.5` |
...
| GPT-5.5 (`gpt-5.5`) | ga | 2026-04-24 | 1M | $5.00 | $30.00 | First full retrain since GPT-4.5; frontier reasoning model | Prior-generation flagship still in production use | prev: `gpt-5.4` → superseded by: `gpt-5.6-sol` |
| GPT-5.5 Pro (`gpt-5.5-pro`) | ga | 2026-04-24 | 1M | $30.00 | $180.00 | GPT-5.5 advanced reasoning variant | Maximum-quality reasoning for Pro/Business tier | prev: `gpt-5.5` → superseded by: `gpt-5.6-sol` |
...
| gpt-oss-120b (`gpt-oss-120b`) | ga | 2025-08-05 | 131K | $0.15 | $0.60 | Mixture-of-Experts transformer, 117B total / 5.1B active params | Self-hosted open-weight reasoning on a single H100 | — |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Sonar Deep Research (`sonar-deep-research`) | ga | 2025-03-07 | 128K | $2.00 | $8.00 | Search-augmented deep research agent with iterative web browsing | Exhaustive multi-step research reports | superseded by: `agent-api` |
| Sonar Reasoning Pro (`sonar-reasoning-pro`) | ga | 2025-03-07 | 128K | $2.00 | $8.00 | DeepSeek-R1 based reasoning with Perplexity retrieval layer | Premium reasoning with web search and citations | prev: `sonar-reasoning` → superseded by: `agent-api` |
| Sonar Reasoning (`sonar-reasoning`) | ga | 2025-01-28 | 127K | $1.00 | $5.00 | Post-trained DeepSeek-R1 variant | Chain-of-thought reasoning with live web search | superseded by: `sonar-reasoning-pro` |
| Sonar (`sonar`) | ga | 2025-01-21 | 128K | $1.00 | $1.00 | Search-augmented model built on Llama 3.3 70B | Fast web-grounded answers with citations | prev: `llama-3.1-sonar-small-128k-online` → superseded by: `agent-api` |
| Sonar Pro (`sonar-pro`) | ga | 2025-01-21 | 200K | $3.00 | $15.00 | Search-augmented proprietary Perplexity model with web grounding | Flagship web-grounded search with citations and images | prev: `sonar` → superseded by: `agent-api` |
