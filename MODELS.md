...
_Last refreshed: 2026-09-15 by genai-model-catalog routine._

_Total models tracked: 320 across 14 providers._
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Amazon Nova 2 Lite (`amazon.nova-2-lite-v1:0`) | ga | 2025-12-02 | 1M | $0.30 | $2.50 | Multimodal foundation model with extended thinking (reasoning) mode | Fast cost-effective reasoning for everyday workloads | prev: `amazon.nova-lite-v1:0` |
...
| Amazon Nova 2 Pro (Preview) (`amazon.nova-2-pro-preview-20251202-v1:0`) | preview | 2025-12-02 | 1M | $2.19 | $17.50 | Multimodal foundation model with extended thinking (reasoning) mode | Complex multi-step agentic reasoning tasks | prev: `amazon.nova-premier-v1:0` |
...
| Embed 4 (`embed-v4.0`) | ga | 2025-04-15 | 128K | $0.12 | — | Multimodal embedding model with Matryoshka representation learning | Multimodal enterprise retrieval and RAG | prev: `embed-english-v3.0` |
...
| DeepSeek V4-Pro-0813 (`deepseek-v4-pro`) | ga | 2026-08-13 | 1M | $0.66 | $1.98 | Sparse MoE, 1.6T total params / 49B active per token, hybrid CSA + HCA attention | Deep reasoning and long-horizon agentic coding | prev: `deepseek-v4-pro-0424` → superseded by: `deepseek-v4.1-flash` |
...
| Llama 4 Scout (`llama-4-scout-17b-16e-instruct`) | ga | 2025-04-05 | 10.5M | $0.08 | $0.30 | MoE — 17B active / 109B total, 16 experts (early-fusion multimodal) | Long-context document analysis on a single GPU | prev: `llama-3.3-70b-instruct` → superseded by: `meta-llama/Llama-4-Scout-17B-16E-Instruct` |
...
| MAI-Thinking-1 (`MAI-Thinking-1`) | preview | 2026-08-12 | 256K | $2.00 | $8.00 | Sparse mixture-of-experts, ~35B active parameters of ~1T total | Cost-efficient enterprise reasoning at scale | prev: `MAI-1-preview` |
...
| Mistral Medium 3.5 (`mistral-medium-2604`) | ga | 2026-04-29 | 262K | $1.50 | $7.50 | Dense 128B parameter transformer with custom vision encoder and reasoning toggle | Unified agentic coding, reasoning, and chat workhorse | prev: `mistral-medium-2508` |
...
| Mistral Small 4 (`mistral-small-2603`) | ga | 2026-03-16 | 262K | $0.15 | $0.60 | Hybrid MoE, 119B total parameters, 6.5B active per token | Cheap multimodal MoE with optional reasoning | prev: `mistral-small-2503` |
...
| Mistral Large 3 (`mistral-large-2512`) | ga | 2025-12-02 | 262K | $2.00 | $6.00 | Sparse mixture-of-experts, 675B total parameters, 41B active per token | Flagship open-weight multilingual + multimodal chat | prev: `mistral-large-2411` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K3 (`kimi-k3`) | ga | 2026-07-16 | 1M | $3.00 | $15.00 | 2.8T-parameter MoE with 104B active, 896 experts (16 activated), 93 layers (69 Kimi Delta Attention + 24 Gated MLA), MXFP4 quantization | Long-horizon agentic coding and multimodal reasoning | prev: `kimi-k2.7-code` |
| Kimi K2.7 Code (`kimi-k2.7-code`) | ga | 2026-06-12 | 262K | $0.95 | $4.00 | 1T-parameter MoE with 32B active, 384 experts | Long-horizon agentic software engineering | prev: `kimi-k2.6` |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262K | $0.60 | $2.50 | 1T-parameter MoE with 32B active, native INT4 quantization | General-purpose flagship with agent swarm | prev: `kimi-k2.5` → superseded by: `kimi-k3` |
...
| Nemotron 3 Ultra 550B-A55B (`nvidia/nemotron-3-ultra-550b-a55b`) | ga | 2026-06-04 | 1M | $0.50 | $2.20 | MoE Hybrid Mamba-Transformer (Latent MoE) - 550B total / 55B active; NVFP4 pre-training; MTP layers | Mission-critical long-horizon agentic reasoning | prev: `nvidia/llama-3_1-nemotron-ultra-253b-v1` |
...
| Nemotron 3 Super 120B-A12B (`nvidia/nemotron-3-super-120b-a12b`) | ga | 2026-03-10 | 1M | $0.09 | $0.40 | MoE Hybrid Mamba-Transformer (Latent MoE) - 120B total / 12B active; NVFP4 pre-training; MTP layers | High-throughput multi-agent reasoning and tool-calling | prev: `nvidia/llama-3.3-nemotron-super-49b-v1.5` → superseded by: `nvidia/nemotron-3-ultra-550b-a55b` |
| Nemotron 3 Nano 30B-A3B (`nvidia/nemotron-3-nano-30b-a3b`) | ga | 2025-12-15 | 1M | $0.05 | $0.20 | MoE Hybrid Mamba-Transformer - 31.6B total / 3.2B active; 23 Mamba-2+MoE layers + 6 Attention layers; 128 experts + 1 shared, 6 activated per token | Efficient specialized sub-agents on single GPU | prev: `nvidia/nemotron-nano-9b-v2` → superseded by: `nvidia/nemotron-3-super-120b-a12b` |
...
| Sonar Deep Research (`sonar-deep-research`) | ga | 2025-02-14 | 128K | $2.00 | $8.00 | Search-augmented deep research agent with iterative web browsing | Exhaustive multi-source research reports | superseded by: `agent-api` |
...
| Sonar Pro (`sonar-pro`) | ga | 2025-01-21 | 200K | $3.00 | $15.00 | Search-augmented proprietary Perplexity model with web grounding | Complex grounded queries with larger context | prev: `llama-3.1-sonar-large-128k-online` → superseded by: `agent-api` |
