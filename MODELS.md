...
_Last refreshed: 2026-09-12 by genai-model-catalog routine._

_Total models tracked: 318 across 14 providers._
...
| DeepSeek-V4-Pro (`deepseek-v4-pro`) | ga | 2026-04-24 | 1M | $0.66 | $1.98 | Sparse MoE with Hybrid Attention (CSA+HCA) and manifold-constrained hyper-connections — 1.6T total / 49B active | Frontier reasoning, agentic coding, long-context work | prev: `deepseek-v3.2` → superseded by: `deepseek-v4.1-flash` |
