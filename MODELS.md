...
_Last refreshed: 2026-08-18 by genai-model-catalog routine._
...
| Qwen3.8-Max (`qwen3.8-max`) | ga | 2026-08-03 | 1M | $2.00 | $6.00 | Sparse Mixture-of-Experts, 2.4T total parameters with 95B active per token | Flagship multimodal reasoning and long-context agent tasks | prev: `qwen3-max` |
...
| Qwen3.7-Plus (`qwen3.7-plus`) | ga | 2026-06-01 | 1M | $0.40 | $1.20 | Hybrid linear attention with sparse Mixture-of-Experts | Balanced default for agentic and multimodal workloads | prev: `qwen3.6-plus` |
...
| Qwen3-Coder-Plus (`qwen3-coder-plus`) | ga | 2025-09-23 | 1M | $1.00 | $5.00 | Sparse Mixture-of-Experts, 480B total parameters with 35B active | Autonomous coding agents with tool use | prev: `qwen2.5-coder` → superseded by: `qwen3-coder-next` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Nova 2 Lite (`amazon.nova-2-lite-v1:0`) | ga | 2025-12-02 | 1M | $0.30 | $2.50 | Multimodal foundation model with extended thinking | Fast cost-efficient reasoning across text image video | prev: `amazon.nova-lite-v1:0` |
...
| Nova 2 Pro (Preview) (`amazon.nova-2-pro-preview-20251202-v1:0`) | preview | 2025-12-02 | 1M | $2.19 | $17.50 | Multimodal foundation model with extended thinking | Complex multistep reasoning and agentic workflows | prev: `amazon.nova-pro-v1:0` |
| Nova Premier (`amazon.nova-premier-v1:0`) | deprecated | 2025-04-30 | 1M | $2.50 | $12.50 | Multimodal foundation model | Complex reasoning and model distillation teacher | prev: `amazon.nova-pro-v1:0` → superseded by: `amazon.nova-2-pro-preview-20251202-v1:0` |
| Nova Lite (`amazon.nova-lite-v1:0`) | deprecated | 2024-12-03 | 300K | $0.06 | $0.24 | Multimodal foundation model | Very low-cost multimodal input processing | superseded by: `amazon.nova-2-lite-v1:0` |
| Nova Micro (`amazon.nova-micro-v1:0`) | deprecated | 2024-12-03 | 128K | $0.04 | $0.14 | Text-only foundation model | Lowest latency and cheapest text-only tasks | superseded by: `amazon.nova-2-lite-v1:0` |
| Nova Pro (`amazon.nova-pro-v1:0`) | deprecated | 2024-12-03 | 300K | $0.80 | $3.20 | Multimodal foundation model | Balanced multimodal understanding at moderate cost | superseded by: `amazon.nova-2-pro-preview-20251202-v1:0` |
...
| Claude Fable 5 (`claude-fable-5`) | ga | 2026-06-09 | 1M | $10.00 | $50.00 | Mythos-class frontier model with newer tokenizer | Long-running agents needing highest capability | prev: `claude-mythos-preview` |
| Claude Sonnet 5 (`claude-sonnet-5`) | ga | 2026-06-01 | 1M | $2.00 | $10.00 | Sonnet-class agentic model with adaptive thinking | Best balance of speed and intelligence | prev: `claude-sonnet-4-6` |
...
| Command A+ (`command-a-plus-05-2026`) | ga | 2026-05-20 | 256K | $2.50 | $10.00 | Sparse Mixture-of-Experts, 218B total / 25B active parameters, 128 experts with 8 activated per token plus one shared expert | Enterprise agentic reasoning across vision and languages | prev: `command-a-03-2025` |
...
| Command A Reasoning (`command-a-reasoning-08-2025`) | ga | 2025-08-21 | 256K | $2.50 | $10.00 | 111B parameter dense transformer with controllable reasoning token budget | Enterprise reasoning, agents, and tool use | prev: `command-a-03-2025` → superseded by: `command-a-plus-05-2026` |
| Command A Vision (`command-a-vision-07-2025`) | ga | 2025-07-31 | 128K | $2.50 | $10.00 | 112B parameter multimodal transformer built on Command A backbone | Enterprise document, chart, and OCR understanding | prev: `command-a-03-2025` → superseded by: `command-a-plus-05-2026` |
...
| Command A (`command-a-03-2025`) | ga | 2025-03-13 | 256K | $2.50 | $10.00 | 111B parameter dense transformer optimized for enterprise agentic workloads | Enterprise agentic workflows and long-document analysis | prev: `command-r-plus-08-2024` → superseded by: `command-a-plus-05-2026` |
| Command R7B (`command-r7b-12-2024`) | ga | 2024-12-13 | 128K | $0.04 | $0.15 | 7B parameter dense transformer | High-volume low-cost RAG and tool use | prev: `command-r-08-2024` |
...
| Command R+ (`command-r-plus-08-2024`) | ga | 2024-08-30 | 128K | $2.50 | $10.00 | 104B parameter dense transformer tuned for RAG and tool use | RAG and multi-step tool use at scale | prev: `command-r-plus` → superseded by: `command-a-03-2025` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DeepSeek V4-Pro (`deepseek-v4-pro`) | ga | 2026-08-13 | 1M | $1.32 | $3.96 | Sparse MoE — 1.6T total / 49B active with Hybrid Attention (Compressed Sparse + Heavily Compressed Attention) | Complex reasoning and long-running agentic tasks | prev: `deepseek-v3.2` |
...
| DeepSeek V4-Flash (`deepseek-v4-flash`) | ga | 2026-07-31 | 1M | $0.44 | $1.32 | Sparse MoE — 284B total / 13B active with Hybrid Attention | Fast low-cost general-purpose inference | prev: `deepseek-v3.2` |
...
| DeepSeek R1-0528 (`deepseek-reasoner`) | deprecated | 2025-05-28 | 128K | $0.55 | $2.19 | Sparse MoE — 685B total / 37B active | Deep chain-of-thought reasoning | prev: `deepseek-r1` → superseded by: `deepseek-v4-pro` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Gemini 3.5 Flash-Lite (`gemini-3.5-flash-lite`) | ga | 2026-07-21 | 1.0M | $0.30 | $2.50 | Distilled Gemini 3-family mixture-of-experts | High-volume, low-latency subagent workloads | prev: `gemini-2.5-flash-lite` |
...
| Gemini 3.7 Flash (`gemini-3.7-flash`) | preview | 2026-08-13 | 1.0M | $0.75 | $3.75 | Sparse mixture-of-experts, natively multimodal reasoning model (Gemini 3 series) | Fast, low-cost coding and agent workflows | prev: `gemini-3.6-flash` |
...
| Gemini 3.1 Pro (`gemini-3.1-pro-preview`) | preview | 2026-02-19 | 1.0M | $2.00 | $12.00 | Sparse mixture-of-experts multimodal transformer with hybrid reasoning | Flagship reasoning, long context, agentic coding | prev: `gemini-3-pro-preview` |
...
| Llama Guard 4 12B (`meta-llama/Llama-Guard-4-12B`) | ga | 2025-04-29 | 163.8K | $0.20 | $0.20 | Dense 12B pruned from Llama 4 Scout MoE (shared-expert distillation) | Multimodal input and output safety classification | prev: `meta-llama/Llama-Guard-3-11B-Vision` |
...
| Llama 4 Maverick (`meta-llama/Llama-4-Maverick-17B-128E-Instruct`) | ga | 2025-04-05 | 1M | $0.27 | $0.85 | Sparse MoE — 400B total / 17B active, 128 experts, early-fusion multimodal | Flagship multimodal assistant and coding | prev: `meta-llama/Meta-Llama-3.1-405B-Instruct` |
...
| Llama 4 Scout (`meta-llama/Llama-4-Scout-17B-16E-Instruct`) | ga | 2025-04-05 | 10M | $0.10 | $0.30 | Sparse MoE — 109B total / 17B active, 16 experts, iRoPE long-context | Long-context multimodal on single GPU | prev: `meta-llama/Meta-Llama-3.1-70B-Instruct` |
...
| Llama 4 Behemoth (`meta-llama/Llama-4-Behemoth`) | preview | — | — | — | — | Sparse MoE — ~2T total / 288B active, 16 experts | STEM-heavy teacher model for distillation | prev: `meta-llama/Meta-Llama-3.1-405B-Instruct` → superseded by: `muse-spark-1.1` |
...
| Phi-4-multimodal-instruct (`microsoft/Phi-4-multimodal-instruct`) | ga | 2025-02-26 | 131.1K | $0.08 | $0.32 | Multimodal decoder with unified vision/audio adapters on Phi-4 backbone | Cheap multimodal (text+image+audio) small-model workloads | prev: `microsoft/phi-4` → superseded by: `microsoft/Phi-4-reasoning-vision-15B` |
...
| MAI-Thinking-1 (`mai-thinking-1`) | preview | 2026-06-02 | 256K | $2.00 | $8.00 | Sparse Mixture of Experts — ~1T total / 35B active parameters | Frontier reasoning, long-context agentic coding and math | prev: `mai-1-preview` |
...
| MAI-1-preview (`mai-1-preview`) | preview | 2025-08-28 | — | — | — | Mixture of Experts text foundation model | Instruction following and everyday chat | superseded by: `mai-thinking-1` |
| MAI-Voice-1 (`MAI-Voice-1`) | preview | 2025-08-28 | — | $22.00 | $22.00 | Transformer-based speech generation model | Expressive natural speech generation and podcast narration | superseded by: `mai-voice-2` |
...
| Ministral 3 8B (`ministral-8b-latest`) | ga | 2025-12-04 | 131.1K | $0.15 | $0.15 | Dense transformer, 8B parameters | Edge and on-device inference with 128K context | prev: `ministral-8b-2410` |
...
| Mistral Large 3 (`mistral-large-2512`) | ga | 2025-12-02 | 262.1K | $0.50 | $1.50 | Sparse mixture-of-experts transformer, 675B total / 41B active parameters | Flagship multilingual multimodal reasoning at scale | prev: `mistral-large-2411` |
...
| Codestral 2508 (`codestral-2508`) | ga | 2025-08-01 | 262.1K | $0.30 | $0.90 | Dense transformer optimized for code with fill-in-the-middle support | Low-latency code completion and fill-in-the-middle | prev: `codestral-2501` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K3 (`kimi-k3`) | ga | 2026-07-16 | 1.0M | $3.00 | $15.00 | Sparse MoE - 2.8T total / ~104B active (16 of 896 experts, KDA + AttnRes) | Frontier open reasoning at 1M context | prev: `kimi-k2.7-code` |
| Kimi K2.7 Code (`kimi-k2.7-code`) | ga | 2026-06-12 | 262.1K | $0.95 | $4.00 | Sparse MoE - 1T total / 32B active | Agentic coding at repository scale | prev: `kimi-k2.6` |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262.1K | $0.95 | $4.00 | Sparse MoE - 1T total / 32B active (384 experts, 8 routed + 1 shared, 61 layers, MLA) | Open-weight multimodal agent tasks | prev: `kimi-k2.5` → superseded by: `kimi-k3` |
| Kimi K2.5 (`kimi-k2.5`) | ga | 2026-01-27 | 262.1K | $0.60 | $3.00 | Sparse MoE - 1T total / 32B active (384 experts, 8 active, 61 layers) | Low-cost open agentic workloads | prev: `kimi-k2-thinking` → superseded by: `kimi-k2.6` |
...
| Nemotron 3 Ultra 550B A55B (`nvidia/nemotron-3-ultra-550b-a55b`) | ga | 2026-06-04 | 1M | $0.50 | $2.20 | Hybrid Transformer-Mamba mixture-of-experts (550B total, 55B active) | Frontier open reasoning and agent orchestration | prev: `nvidia/Nemotron-4-340B-Instruct` |
...
| Nemotron 3 Super 120B A12B (`nvidia/nemotron-3-super-120b-a12b`) | ga | 2026-03-11 | 1M | $0.09 | $0.45 | Hybrid Mamba2-Transformer LatentMoE with Multi-Token Prediction (120B total, 12B active) | Balanced open model for coding and multi-agent apps | prev: `nvidia/llama-3.3-nemotron-super-49b-v1` → superseded by: `nvidia/nemotron-3-ultra-550b-a55b` |
...
| Nemotron 3 Nano 30B A3B (`nvidia/nemotron-3-nano-30b-a3b`) | ga | 2025-12-15 | 1M | $0.05 | $0.20 | Hybrid Mamba-Transformer MoE, 23 Mamba-2 + 23 MoE + 6 Attention layers (31.6B total, 3.6B active) | Efficient always-on agents and edge inference | prev: `nvidia/nemotron-nano-9b-v2` → superseded by: `nvidia/NVIDIA-Nemotron-3.5-Lightning-30B-A3B` |
...
| GPT-5.6 Luna (`gpt-5.6-luna`) | ga | 2026-07-09 | 1.1M | $0.20 | $1.20 | Fast, cost-efficient variant of the GPT-5.6 family | High-volume, cost-sensitive text and vision tasks | prev: `gpt-5.1-mini` |
| GPT-5.6 Sol (`gpt-5.6-sol`) | ga | 2026-07-09 | 1.1M | $5.00 | $30.00 | Frontier multimodal reasoning model with extended thinking | Frontier agentic coding and long-horizon reasoning | prev: `gpt-5.5` |
| GPT-5.6 Terra (`gpt-5.6-terra`) | ga | 2026-07-09 | 1.1M | $2.00 | $12.00 | Mid-tier variant of the GPT-5.6 family | Balanced production workloads at mid-tier price | prev: `gpt-5.1` |
...
| GPT-5.5 Pro (`gpt-5.5-pro`) | ga | 2026-04-24 | 1.1M | $30.00 | $180.00 | Pro variant of GPT-5.5 with extended reasoning compute | Deepest reasoning on frontier math and science | prev: `gpt-5-pro` → superseded by: `gpt-5.6-sol` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Sonar Deep Research (`sonar-deep-research`) | ga | 2025-03-07 | 128K | $2.00 | $8.00 | Perplexity agentic research pipeline over reasoning backbone | exhaustive multi-source research reports | superseded by: `agent-api-high` |
| Sonar Pro (`sonar-pro`) | ga | 2025-03-07 | 200K | $3.00 | $15.00 | Perplexity in-house model with proprietary search augmentation | advanced grounded search with deeper citations | prev: `sonar` → superseded by: `agent-api-low` |
| Sonar Reasoning Pro (`sonar-reasoning-pro`) | ga | 2025-02-24 | 128K | $2.00 | $8.00 | DeepSeek R1 fine-tuned with Perplexity search and Chain-of-Thought | chain-of-thought reasoning over live web results | prev: `sonar-reasoning` → superseded by: `agent-api-medium` |
| Sonar (`sonar`) | ga | 2025-02-11 | 128K | $1.00 | $1.00 | Fine-tuned Llama 3.3 70B optimized for Perplexity search | fast real-time web-grounded search answers | superseded by: `agent-api-fast` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Grok 4.6 (`grok-4.6`) | ga | 2026-08-12 | 500K | $2.00 | $6.00 | Post-training refinement of the 1.5T-parameter Grok 4.5 foundation | Frontier reasoning, agentic coding, long-running agents | prev: `grok-4.5` |
...
| Grok 4.5 (`grok-4.5`) | ga | 2026-07-08 | 500K | $2.00 | $6.00 | 1.5T-parameter model with configurable reasoning | General-purpose reasoning and agentic tool use | prev: `grok-4` → superseded by: `grok-4.6` |
