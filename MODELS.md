...
_Last refreshed: 2026-07-31 by genai-model-catalog routine._

_Total models tracked: 210 across 14 providers._
...
| Qwen3-Max (`qwen3-max`) | ga | 2025-09-23 | 262.144K | $1.20 | $6.00 | Mixture-of-Experts (~1T total parameters) | Flagship frontier reasoning and agentic workflows | prev: `qwen-max` → superseded by: `qwen3.7-max` |
| Qwen3-VL (`qwen3-vl-plus`) | ga | 2025-09-23 | 262.144K | $0.20 | $1.60 | MoE 235B total / ~22B active | Multimodal image, document, and video understanding | prev: `qwen-vl-max` → superseded by: `qwen3.7-plus` |
...
| Qwen3.8-Max-Preview (`qwen3.8-max-preview`) | preview | 2026-07-19 | 983.616K | — | — | Sparse MoE (~2.4T total parameters, multimodal) | Next-gen flagship reasoning and agentic tasks | prev: `qwen3.7-max` |
...
| Nova 2 Lite (`amazon.nova-2-lite-v1:0`) | ga | 2025-12-02 | 1M | $0.30 | $2.50 | Transformer, multimodal reasoning model | Fast, cost-effective reasoning for everyday workloads | prev: `amazon.nova-lite-v1:0` |
| Nova Pro (`amazon.nova-pro-v1:0`) | ga | 2024-12-05 | 300K | $0.80 | $3.20 | Transformer, multimodal foundation model | Balanced multimodal accuracy, speed, and cost | superseded by: `amazon.nova-2-pro-v1:0` |
| Nova Lite (`amazon.nova-lite-v1:0`) | ga | 2024-12-03 | 300K | $0.06 | $0.24 | Transformer-based multimodal foundation model | Low-cost multimodal understanding at scale | superseded by: `amazon.nova-2-lite-v1:0` |
| Nova Micro (`amazon.nova-micro-v1:0`) | ga | 2024-12-03 | 128K | $0.04 | $0.14 | Text-only lightweight foundation model | Cheapest, lowest-latency text-only tasks | superseded by: `amazon.nova-2-lite-v1:0` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Claude Opus 5 (`claude-opus-5`) | ga | 2026-07-24 | 1M | $5.00 | $25.00 | Transformer LLM using the newer tokenizer introduced with Claude Opus 4.7 | Complex agentic coding and enterprise reasoning | prev: `claude-opus-4-8` |
| Claude Sonnet 5 (`claude-sonnet-5`) | ga | 2026-06-30 | 1M | $2.00 | $10.00 | Transformer LLM using the newer tokenizer introduced with Claude Opus 4.7 | Speed/intelligence balance, near-Opus coding quality | prev: `claude-sonnet-4-6` |
| Claude Fable 5 (`claude-fable-5`) | ga | 2026-06-09 | 1M | $10.00 | $50.00 | Transformer LLM using the newer tokenizer introduced with Claude Opus 4.7 (produces ~30% more tokens per input than pre-4.7 models) | Most demanding reasoning and long-horizon agentic work | prev: `claude-mythos-preview` |
...
| Claude Haiku 4.5 (`claude-haiku-4-5`) | ga | 2025-10-01 | 200K | $1.00 | $5.00 | Transformer LLM using the pre-4.7 tokenizer (same as Claude Sonnet 4.6 and earlier) | Fastest and most cost-effective for simple tasks | prev: `claude-3-5-haiku-20241022` |
...
| Rerank 4 Pro (`rerank-v4.0-pro`) | ga | 2025-12-11 | 32.768K | — | — | Multilingual cross-encoder reranker with 32K context | State-of-the-art multilingual enterprise reranking for complex agentic and semi-structured (JSON) retrieval | prev: `rerank-v3.5` |
...
| Command A (`command-a-03-2025`) | ga | 2025-03-13 | 256K | $2.50 | $10.00 | 111B dense transformer | Enterprise RAG, agents, and multilingual tool use | prev: `command-r-plus-08-2024` → superseded by: `command-a-plus-05-2026` |
...
| Rerank 3.5 (`rerank-v3.5`) | ga | 2024-12-02 | 4.096K | — | — | Multilingual cross-encoder reranker | Multilingual enterprise RAG reranking with reasoning over complex queries | prev: `rerank-v3.0` → superseded by: `rerank-v4.0-pro` |
...
| DeepSeek V4 Pro (`deepseek-v4-pro`) | ga | 2026-04-24 | 1M | $0.43 | $0.87 | Mixture-of-Experts, 1.6T total / 49B active with Compressed Sparse Attention + Heavily Compressed Attention | Frontier open-weight reasoning and agentic MCP workloads | prev: `deepseek-reasoner` |
| DeepSeek V4-Flash-0731 (`deepseek-v4-flash-0731`) | preview | 2026-07-31 | 1M | $0.14 | $0.28 | Mixture-of-Experts — 284B total / 13B active | Agentic workflows with OpenAI-Responses drop-in | prev: `deepseek-v4-flash` |
| DeepSeek Reasoner (legacy alias) (`deepseek-reasoner`) | deprecated | 2025-01-20 | 131.072K | $0.14 | $0.28 | Sparse MoE - 671B total / 37B active (DeepSeek-R1) | Legacy R1-style reasoning endpoint (retired July 24, 2026) | prev: `deepseek-r1` → superseded by: `deepseek-v4-pro` |
| DeepSeek Chat (legacy alias) (`deepseek-chat`) | deprecated | 2024-12-26 | 131.072K | $0.14 | $0.28 | Sparse MoE - 671B total / 37B active (DeepSeek-V3) | Legacy V3 chat endpoint (retired July 24, 2026) | prev: `deepseek-v3.2` → superseded by: `deepseek-v4-flash` |

## Google

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Gemini 3.5 Flash-Lite (`gemini-3.5-flash-lite`) | ga | 2026-07-21 | 1.04858M | $0.30 | $2.50 | Distilled Gemini 3.5 sparse Mixture-of-Experts transformer | Low-cost high-throughput subagent and extraction workloads | prev: `gemini-3.1-flash-lite` |
| Gemini 3.6 Flash (`gemini-3.6-flash`) | ga | 2026-07-21 | 1.04858M | $1.50 | $7.50 | Sparse Mixture-of-Experts transformer with native multimodal encoders | Balanced cost/quality for high-volume agentic workflows | prev: `gemini-3.5-flash` |
| Gemini 3.5 Flash (`gemini-3.5-flash`) | ga | 2026-05-19 | 1.04858M | $1.50 | $9.00 | Sparse Mixture-of-Experts transformer with native multimodal encoders | General-purpose agentic Flash workhorse | prev: `gemini-3.1-flash` → superseded by: `gemini-3.6-flash` |
| Gemini 3.1 Flash-Lite (`gemini-3.1-flash-lite`) | ga | 2026-05-07 | 1.04858M | $0.25 | $1.50 | Transformer-based Mixture-of-Experts | Low-latency, high-volume, cost-sensitive workloads | prev: `gemini-2.5-flash-lite` → superseded by: `gemini-3.5-flash-lite` |
| Gemini 3.1 Pro (`gemini-3.1-pro`) | ga | 2026-02-19 | 1.04858M | $2.00 | $12.00 | Sparse Mixture-of-Experts transformer with native multimodal encoders | GA flagship reasoning and long-context tasks | prev: `gemini-3-pro` → superseded by: `gemini-3.5-pro-preview` |
...
| Gemini 3.1 Pro (`gemini-3.1-pro-preview`) | preview | 2026-02-19 | 1.04858M | $2.00 | $12.00 | Transformer-based Mixture-of-Experts | Flagship reasoning, coding, and multimodal tasks | prev: `gemini-3-pro-preview` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Muse Image (`muse-image`) | ga | 2026-07-07 | — | — | — | — | Text-to-image with multi-photo blending | — |
...
| Llama 4 Maverick (`meta-llama/Llama-4-Maverick-17B-128E-Instruct`) | ga | 2025-04-05 | 1M | $0.27 | $0.85 | Mixture-of-experts, 17B active parameters, 128 experts, 400B total, early-fusion multimodal | Flagship open-weight multimodal chat and coding on Together AI serverless | prev: `meta-llama/Llama-3.3-70B-Instruct` |
...
| Llama 4 Maverick (`llama-4-maverick`) | ga | 2025-04-05 | 1.04858M | $0.19 | $0.60 | Mixture-of-Experts (MoE), 128 experts, 17B active / ~400B total parameters | Open-weight generalist for reasoning and coding | prev: `llama-3.3-70b` → superseded by: `meta-llama/Llama-4-Maverick-17B-128E-Instruct` |
| Llama 4 Scout (`meta-llama/Llama-4-Scout-17B-16E-Instruct`) | ga | 2025-04-05 | 10M | $0.18 | $0.59 | Mixture-of-experts, 17B active parameters, 16 experts, 109B total, early-fusion multimodal, iRoPE | Long-context multimodal reasoning on a single GPU (Together AI serverless) | prev: `meta-llama/Llama-3.3-70B-Instruct` |
| Llama 4 Scout (`llama-4-scout-17b-16e-instruct`) | ga | 2025-04-05 | 10.4858M | $0.11 | $0.34 | Mixture-of-experts with 17B active parameters, 16 experts, 109B total parameters, early-fusion multimodality | Long-context multimodal reading and retrieval on Groq LPU | prev: `llama-3.3-70b` → superseded by: `meta-llama/Llama-4-Scout-17B-16E-Instruct` |
| Llama 4 Scout (`llama-4-scout`) | ga | 2025-04-05 | 10.4858M | $0.08 | $0.30 | Mixture-of-Experts (MoE), 16 experts, 17B active / ~109B total parameters | Long-document processing with open weights | prev: `llama-3.3-70b` → superseded by: `meta-llama/Llama-4-Scout-17B-16E-Instruct` |
...
| Muse Spark 1.1 (`muse-spark-1.1`) | preview | 2026-07-09 | 1M | $1.25 | $4.25 | Multimodal reasoning model with agentic orchestration, tool/function calling, structured outputs, and web-search grounding | Agentic tasks, tool use, and computer use | prev: `muse-spark` |
...
| Muse Spark (`muse-spark`) | deprecated | 2026-04-08 | 1M | — | — | Natively multimodal reasoning model, closed-weight, Meta Superintelligence Labs stack (internal codename Avocado) | First closed-weight Meta Superintelligence Labs model | prev: `meta-llama/Llama-4-Maverick-17B-128E-Instruct` → superseded by: `muse-spark-1.1` |
...
| Phi-4-reasoning-plus (`phi-4-reasoning-plus`) | ga | 2025-04-30 | 32.768K | — | — | Dense small language model, RL fine-tuned from Phi-4 (~14B) | Small open-weight reasoning with chain-of-thought | prev: `phi-4-reasoning` → superseded by: `phi-4-reasoning-vision-15b` |
| Phi-4-reasoning-plus (`microsoft/phi-4-reasoning-plus`) | ga | 2025-04-30 | 32.768K | — | — | 14B dense decoder-only transformer, SFT + RL fine-tuned from Phi-4 | Open-weight small reasoning model for on-device | prev: `phi-4-reasoning` → superseded by: `microsoft/phi-4-reasoning-vision` |
...
| Phi-4-multimodal-instruct (`phi-4-multimodal-instruct`) | ga | 2025-02-26 | 131.072K | $0.08 | $0.32 | Dense small language model with vision and audio encoders | Small multimodal model with speech, vision, and text | prev: `phi-3.5-vision-instruct` |
...
| Mistral Medium 3.5 (`mistral-medium-2604`) | ga | 2026-04-29 | 256K | $1.50 | $7.50 | Dense 128B parameter transformer with Pixtral vision encoder | Unified chat, reasoning, vision and coding endpoint | prev: `mistral-medium-2505` |
...
| Mistral Small 4 (`mistral-small-2603`) | ga | 2026-03-16 | 262.144K | $0.15 | $0.60 | Mixture-of-Experts, 119B total / ~6.5B active parameters (128 experts, top-4) | Low-cost multimodal MoE for high-volume workloads | prev: `mistral-small-2503` |
...
| Mistral Large 3 (`mistral-large-2512`) | ga | 2025-12-01 | 256K | $0.50 | $1.50 | Sparse Mixture-of-Experts, 675B total / ~41B active parameters | Flagship multimodal reasoning and agentic workloads | prev: `mistral-large-2411` |
...
| Kimi K2.7 Code (`kimi-k2.7-code`) | ga | 2026-06-12 | 262.144K | $0.95 | $4.00 | Mixture-of-Experts, 1T total / 32B active | Coding and agentic development workflows | prev: `kimi-k2.6` |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262.144K | $0.95 | $4.00 | Mixture-of-Experts, 1T total / 32B active | General-purpose multimodal chat, coding, long context | prev: `kimi-k2-0905` → superseded by: `kimi-k3` |
| Kimi K2 Thinking (`kimi-k2-thinking`) | ga | 2025-11-06 | 262.144K | $0.60 | $2.50 | Mixture-of-Experts, 1T total / 32B active, INT4 native | Long-horizon agentic reasoning with sustained tool use | prev: `kimi-k2` → superseded by: `kimi-k2.5` |
...
| Nemotron 3 Super 120B A12B (`nvidia/nemotron-3-super-120b-a12b`) | ga | 2026-03-11 | 262.144K | $0.09 | $0.45 | Hybrid Mamba-Transformer MoE (~120B total, 12B active) | High-accuracy reasoning for multi-agent apps | prev: `nvidia/llama-3_3-nemotron-super-49b-v1_5` |
| Nemotron 3 Nano 30B A3B (`nvidia/nemotron-3-nano-30b-a3b`) | ga | 2025-12-14 | 262.144K | $0.05 | $0.20 | Hybrid Mamba-Transformer MoE (30B total, 3B active) | Cost-efficient agentic workflows and coding | prev: `nvidia/nvidia-nemotron-nano-9b-v2` |
...
| GPT-5.6 Luna (`gpt-5.6-luna`) | ga | 2026-07-09 | 1.05M | $0.20 | $1.20 | Mixture-of-experts transformer with dynamic routing and configurable reasoning effort | Cost-efficient high-volume workloads | prev: `gpt-5.4-mini` |
| GPT-5.6 Sol (`gpt-5.6-sol`) | ga | 2026-07-09 | 1.05M | $5.00 | $30.00 | Mixture-of-experts transformer with dynamic routing and configurable reasoning effort | Frontier intelligence, coding, cybersecurity, science | prev: `gpt-5.5` |
| GPT-5.6 Terra (`gpt-5.6-terra`) | ga | 2026-07-09 | 1.05M | $2.00 | $12.00 | Mixture-of-experts transformer with dynamic routing and configurable reasoning effort | Balanced everyday work at mid-tier cost | prev: `gpt-5.5` |
...
| GPT-5.5 Pro (`gpt-5.5-pro`) | ga | 2026-04-24 | 1.05M | $30.00 | $180.00 | — | Deepest multi-step reasoning and highest-value tasks | prev: `gpt-5` → superseded by: `gpt-5.6-sol` |
...
| gpt-oss-120b (`gpt-oss-120b`) | ga | 2025-08-05 | 131.072K | $0.03 | $0.15 | Sparse Mixture-of-Experts (117B total, 5.1B active per token, 128 experts, top-4 routing) | Self-hosted open-weight reasoning and tool use | — |
...
| Sonar Pro (`sonar-pro`) | ga | 2025-03-07 | 200K | $3.00 | $15.00 | Perplexity proprietary search-augmented LLM | Deep web research with citation-rich answers | prev: `sonar` |
...
| Sonar (`sonar`) | ga | 2025-01-27 | 127.072K | $1.00 | $1.00 | Built on Llama 3.3 70B with live web retrieval | Lightweight, cost-effective web-grounded Q&A | — |
...
| Grok 4.5 (`grok-4.5`) | ga | 2026-07-08 | 500K | $2.00 | $6.00 | 1.5T-parameter V9 foundation with configurable reasoning | Frontier multimodal reasoning, coding, and agentic workflows | prev: `grok-4.3` |
...
| Grok 4 Fast (Reasoning) (`grok-4-fast-reasoning`) | ga | 2025-09-20 | 2M | $0.20 | $0.50 | — | High-throughput reasoning with 2M context at low cost | prev: `grok-4-0709` → superseded by: `grok-4.3` |
