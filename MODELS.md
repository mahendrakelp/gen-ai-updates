...
_Last refreshed: 2026-06-30 by genai-model-catalog routine._
...
| Qwen3.6-Flash (`qwen3.6-flash`) | ga | 2026-04-27 | 1M | $0.19 | $1.12 | Multimodal Mixture-of-Experts (parameters undisclosed) | Low-latency multimodal workloads with vision and video input | prev: qwen3.5-flash |
| Qwen3.5-Omni-Plus (`qwen3.5-omni-plus`) | ga | 2026-03-30 | 262K | $0.40 | $4.80 | Hybrid-Attention Mixture-of-Experts (30B total, 3B active) | Native omni-modal text, audio, image, video | prev: qwen3-omni |
| Qwen3-Coder-Next (`qwen3-coder-next`) | ga | 2026-02-04 | 262K | $0.11 | $0.80 | Sparse MoE (80B total, 3B active) | Open-weight agentic coding for local development | prev: qwen3-coder-flash |
...
| Qwen3-VL-Plus (`qwen3-vl-plus`) | ga | 2025-09-23 | 262K | $0.20 | $1.60 | Vision-language MoE (235B-A22B and dense 2B/4B/8B/32B variants) | Affordable multimodal understanding across image and video | prev: qwen2.5-vl → superseded by: qwen3.7-plus |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Claude Sonnet 5 (`claude-sonnet-5`) | ga | 2026-06-30 | 1M | $2.00 | $10.00 | — | Agentic coding and tool use at Sonnet price | prev: claude-sonnet-4-6 |
...
| Cohere Transcribe (`cohere-transcribe-03-2026`) | ga | 2026-03-26 | — | — | — | 2B encoder-decoder cross-attention transformer with Fast-Conformer encoder (>90% params in encoder) | Real-time enterprise speech-to-text and meeting transcription | — |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DeepSeek V4 Flash (`deepseek-v4-flash`) | preview | 2026-04-24 | 1M | $0.14 | $0.28 | Sparse MoE — 284B total / 13B active per token, hybrid Compressed Sparse Attention (CSA) + Heavily Compressed Attention (HCA) | Cost-efficient high-volume chat, coding, and agents | prev: deepseek-v3.2 |
| DeepSeek V4 Pro (`deepseek-v4-pro`) | preview | 2026-04-24 | 1M | $0.43 | $0.87 | Sparse MoE — 1.6T total / 49B active per token, hybrid Compressed Sparse Attention (CSA) + Heavily Compressed Attention (HCA) | Frontier reasoning, agentic coding, complex SWE tasks | prev: deepseek-v3.2 |
...
| DeepSeek Reasoner (legacy alias) (`deepseek-reasoner`) | deprecated | 2025-12-01 | 1M | $0.14 | $0.28 | Alias routing to deepseek-v4-flash thinking mode (Sparse MoE — 284B total / 13B active) | Legacy compatibility for thinking-mode reasoning | prev: deepseek-r1 → superseded by: deepseek-v4-pro |

## Google

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Gemini 3.5 Flash (`gemini-3.5-flash`) | ga | 2026-05-19 | 1.0M | $1.50 | $9.00 | Sparse mixture-of-experts transformer with thinking | Frontier agents and coding at Flash speed | prev: gemini-3-flash |
...
| Gemini 3.1 Pro (`gemini-3.1-pro`) | ga | 2026-02-19 | 1.0M | $2.00 | $12.00 | Sparse mixture-of-experts transformer with thinking | Deep reasoning, long-context, agentic coding | prev: gemini-2.5-pro |
...
| Gemini 3 Flash (`gemini-3-flash-preview`) | preview | 2026-06-22 | 1.0M | $0.50 | $3.00 | Sparse mixture-of-experts transformer with thinking | Computer Use agents and budget-friendly preview workloads | prev: gemini-2.5-flash → superseded by: gemini-3.5-flash |
| Gemini 3.5 Pro (`gemini-3.5-pro-preview`) | preview | 2026-05-19 | 2.1M | — | — | Sparse mixture-of-experts transformer with thinking | Frontier reasoning, deep multimodal, very long context | prev: gemini-3.1-pro |
...
| Gemini 3.1 Pro (`gemini-3.1-pro-preview`) | preview | 2026-02-19 | 1.0M | $2.00 | $12.00 | Sparse mixture-of-experts transformer with thinking | Deep reasoning, long-context, agentic coding | prev: gemini-2.5-pro |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Llama 4 Maverick (`llama-4-maverick`) | ga | 2025-04-05 | 1.0M | $0.17 | $0.60 | Mixture-of-Experts (400B total, 17B active, 128 routed + 1 shared expert) | High-quality open multimodal chat and vision | prev: llama-3.3-70b |
...
| Muse Spark (`muse-spark`) | preview | 2026-04-08 | 1M | — | — | Natively multimodal reasoning model with multi-agent inference (parameters undisclosed) | Meta's frontier proprietary multimodal reasoning model | — |
| Llama 4 Behemoth (`llama-4-behemoth`) | preview | — | — | — | — | Mixture-of-Experts (~2T total, 288B active, 16 experts) | Teacher model for Scout and Maverick codistillation | → superseded by: muse-spark |

## Microsoft

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| MAI-Code-1-Flash (`mai-code-1-flash`) | ga | 2026-06-02 | 256K | $0.75 | $4.50 | Sparse Mixture-of-Experts transformer (~137B total / 5B active params) | Fast, low-cost coding inside Copilot and Foundry | — |
| Phi-4-reasoning-vision-15B (`phi-4-reasoning-vision-15b`) | ga | 2026-03-04 | 16K | — | — | Phi-4-Reasoning backbone with SigLIP-2 vision encoder, mid-fusion | Open multimodal reasoning at compact size | prev: phi-4-reasoning |
...
| Phi-4-reasoning-plus (`phi-4-reasoning-plus`) | ga | 2025-04-30 | 33K | — | — | Dense decoder-only transformer (14B params), fine-tuned from Phi-4 | Open-weight reasoning for math and science | prev: phi-4 → superseded by: phi-4-reasoning-vision-15b |
...
| MAI-Image-2.5 (`mai-image-2.5`) | preview | 2026-06-02 | — | $5.00 | $47.00 | Diffusion-based text-to-image | High-fidelity image generation and editing | prev: mai-image-2 |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Mistral Medium 3.5 (`mistral-medium-2604`) | ga | 2026-04-29 | 262K | $1.50 | $7.50 | Dense 128B parameter multimodal transformer with retrained vision encoder | Unified agentic, coding, and multi-step reasoning workloads | prev: mistral-medium-2508 |
| Mistral Small 4 (`mistral-small-2603`) | ga | 2026-03-16 | 262K | $0.15 | $0.60 | Mixture-of-Experts, 119B total / 6.5B active parameters (128 experts, 4 active) | Low-cost hybrid reasoning, vision, and coding workloads | prev: mistral-small-2506 |
| Devstral 2 (`devstral-2-2512`) | ga | 2025-12-09 | 262K | $0.40 | $2.00 | Dense transformer, 123B parameters | Agentic coding and multi-file edits | prev: devstral-medium-2507 |
| Devstral Small 2 (`devstral-small-2-2512`) | ga | 2025-12-09 | 262K | $0.10 | $0.30 | Dense transformer, 24B parameters | Local low-cost agentic coding on consumer hardware | prev: devstral-small-2507 |
| Mistral Large 3 (`mistral-large-2512`) | ga | 2025-12-02 | 262K | $0.50 | $1.50 | Granular Mixture-of-Experts, 675B total / 41B active params, plus 2.5B vision encoder | Frontier open-weight multimodal and agentic tasks | prev: mistral-large-2411 |
...
| Magistral Medium 1.2 (`magistral-medium-2509`) | deprecated | 2025-09-18 | 131K | $2.00 | $5.00 | Reasoning model trained via reinforcement learning on Mistral Medium 3 | Math and code reasoning with image input support | prev: magistral-medium-2507 → superseded by: mistral-medium-2604 |

## Moonshot

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K2.7 Code (`kimi-k2.7-code`) | ga | 2026-06-12 | 262K | $0.95 | $4.00 | Sparse MoE - 1T total / 32B active, 384 experts, MoonViT vision encoder (inherited from K2.6) | Long-horizon agentic coding and software engineering | prev: kimi-k2.6 |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262K | $0.95 | $4.00 | Sparse MoE - 1T total / 32B active, 384 experts (8+1 shared), 61 layers, MLA, MoonViT vision encoder | Open-weight agentic coding, general chat, and tool use | prev: kimi-k2.5 → superseded by: kimi-k2.7-code |
| Kimi K2.5 (`kimi-k2.5`) | ga | 2026-01-26 | 262K | $0.60 | $3.00 | Sparse MoE - 1T total / 32B active, 384 experts, MoonViT vision encoder | Cost-efficient open-weight multimodal agent | prev: kimi-k2-thinking → superseded by: kimi-k2.6 |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Nemotron 3 Ultra (`nvidia/nemotron-3-ultra-550b-a55b`) | ga | 2026-06-04 | 1M | $0.50 | $2.20 | Hybrid Mamba-Transformer Mixture-of-Experts with LatentMoE and MTP layers, NVFP4-pretrained (550B total / 55B active) | Long-running agentic reasoning at frontier scale | prev: nvidia/llama-3.1-nemotron-ultra-253b-v1 |
...
| Nemotron 3 Nano Omni 30B A3B Reasoning (`nvidia/nemotron-3-nano-omni-30b-a3b-reasoning`) | ga | 2026-04-28 | 256K | $0.07 | $0.30 | Hybrid Mamba-Transformer MoE backbone with C-RADIOv4-H vision encoder and Parakeet-TDT-0.6B-v2 audio encoder (30B total / 3B active) | Unified multimodal agentic perception across documents, audio, video | prev: nvidia/nvidia-nemotron-nano-9b-v2 |
...
| Nemotron 3 Super 120B A12B (`nvidia/nemotron-3-super-120b-a12b`) | ga | 2026-03-11 | 1M | $0.10 | $0.50 | Hybrid Mamba-Transformer Mixture-of-Experts with LatentMoE (120B total / 12B active) | Mid-tier agentic reasoning, coding, planning | prev: nvidia/llama-3.3-nemotron-super-49b-v1 |
...
| GPT-5.5 (`gpt-5.5`) | ga | 2026-04-23 | 1.1M | $5.00 | $30.00 | — | Agentic coding and complex reasoning | prev: gpt-5.4 |
...
| gpt-oss-120b (`gpt-oss-120b`) | ga | 2025-08-05 | 131K | — | — | Mixture-of-Experts transformer (128 experts, 4 active per token; ~5.1B active / 117B total params) | Open-weight reasoning deployment on single GPU | — |
| GPT-5.6 Sol (`gpt-5.6-sol`) | preview | 2026-06-26 | 1.5M | $5.00 | $30.00 | — | Frontier agentic coding, biology, and cybersecurity | prev: gpt-5.5 |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Grok 4.3 (`grok-4.3`) | ga | 2026-04-30 | 1M | $1.25 | $2.50 | Pre-trained model at Grok 4.20 scale with improved architecture and configurable chain-of-thought reasoning, December 2025 knowledge cutoff | Flagship reasoning and agentic workflows | prev: grok-4.20 |
| Grok Voice Think Fast 1.0 (`grok-voice-think-fast-1.0`) | ga | 2026-04-23 | — | — | — | Voice-native model with background reasoning for real-time conversation | Full-duplex voice agents for enterprise workflows | — |
| Grok 4.20 (`grok-4.20`) | ga | 2026-03-10 | 2M | $2.00 | $6.00 | Multi-variant LLM with reasoning, non-reasoning, and multi-agent modes | Long-context reasoning over 2M tokens | prev: grok-4-0709 → superseded by: grok-4.3 |
...
| Grok 4.20 Multi-Agent Beta (`grok-4.20-multi-agent-beta-0309`) | preview | 2026-03-09 | 2M | $2.00 | $6.00 | Four-agent collaborative architecture (Grok, Harper, Benjamin, Lucas) for orchestrated multi-agent research | Collaborative multi-agent reasoning and research | prev: grok-4.20 |
