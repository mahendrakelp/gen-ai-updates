...
_Last refreshed: 2026-06-06 by genai-model-catalog routine._

## Alibaba

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Qwen3.7-Plus (`qwen3.7-plus`) | ga | 2026-06-02 | 1M | $0.40 | $1.60 | Mixture-of-Experts (closed, multimodal) | Multimodal GUI agents and visual workflows | prev: `qwen3-vl-plus` |
...
| Nova 2 Sonic (`amazon.nova-2-sonic-v1:0`) | ga | 2025-12-02 | 1M | — | — | Speech-to-speech foundation model | Real-time speech-to-speech conversational AI | prev: `amazon.nova-sonic-v1:0` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Command A+ (`command-a-plus-05-2026`) | ga | 2026-05-20 | 256K | $2.50 | $10.00 | 218B sparse MoE, 25B active parameters, 128 experts (8 active per token) | Sovereign enterprise agentic workflows with citations | prev: `command-a-reasoning-08-2025` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Phi-4-Reasoning-Vision-15B (`phi-4-reasoning-vision-15b`) | ga | 2026-03-04 | 16.4K | — | — | Mid-fusion multimodal: Phi-4-Reasoning backbone + SigLIP-2 vision encoder, 15B parameters | Multimodal reasoning over charts, diagrams, GUIs | prev: `phi-4-reasoning` |
...
| Phi-4-multimodal (`phi-4-multimodal-instruct`) | ga | 2025-02-26 | 131.1K | $0.08 | $0.32 | Multimodal transformer with mixture-of-LoRAs integrating speech, vision, and text, 5.6B parameters | Unified text, vision, and audio understanding | — |
...
| MAI-Code-1-Flash (`mai-code-1-flash`) | preview | 2026-06-02 | 256K | $0.75 | $4.50 | 5B parameter dense coding model | Fast cost-efficient coding in Copilot | — |
| MAI-Thinking-1 (`mai-thinking-1`) | preview | 2026-06-02 | 256K | — | — | 35B active parameter MoE, trained without distillation | Enterprise reasoning and complex problem solving | prev: `mai-1-preview` |
...
| Mistral Small 4 (`mistral-small-2603`) | ga | 2026-03-16 | 262.1K | $0.15 | $0.60 | Sparse Mixture-of-Experts, 119B total / ~6B active (128 experts, 4 active) | Cheap unified reasoning, vision, code MoE | prev: `mistral-small-2506` |
| Mistral Large 3 (`mistral-large-2512`) | ga | 2025-12-02 | 262.1K | $0.50 | $1.50 | Multimodal granular MoE, 41B active / 675B total, FP8 instruct | General-purpose flagship MoE chat and agents | prev: `mistral-large-2411` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262.1K | $0.95 | $4.00 | 1T-parameter MoE, 32B active per token, MoonViT 400M vision encoder, MLA attention | Agentic coding and long-horizon multi-agent workflows | prev: `kimi-k2.5` |
| Kimi K2.5 (`kimi-k2.5`) | ga | 2026-01-27 | 262.1K | $0.60 | $2.50 | 1T-parameter MoE, 32B active, 61 layers (1 dense + 60 MoE), 384 experts, MLA attention with 64 heads | Cost-efficient multimodal agent and coding tasks | prev: `kimi-k2-thinking` → superseded by: `kimi-k2.6` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Nemotron 3 Ultra (`nvidia/nemotron-3-ultra-550b-a55b`) | ga | 2026-06-01 | 1M | $0.60 | $2.60 | Hybrid Mamba2-Transformer Latent MoE; 550B total / 55B active | Flagship reasoning for complex agentic workflows | prev: `nvidia/llama-3.1-nemotron-ultra-253b-v1` |
...
| Llama 3.1 Nemotron Ultra 253B v1 (`nvidia/llama-3.1-nemotron-ultra-253b-v1`) | deprecated | 2025-04-07 | 131.1K | $0.60 | $1.80 | Dense transformer derived from Llama 3.1 405B via Neural Architecture Search | Reasoning, RAG, and tool-calling on Llama base | → superseded by: `nvidia/nemotron-3-ultra-550b-a55b` |
| Llama 3.3 Nemotron Super 49B v1 (`nvidia/llama-3.3-nemotron-super-49b-v1`) | deprecated | 2025-03-18 | 131.1K | $0.10 | $0.40 | Dense transformer derived from Llama 3.3 70B Instruct via NAS | Mid-size reasoning, RAG, and tool calling | → superseded by: `nvidia/nemotron-3-super-120b-a12b` |
...
| Grok 4.1 Fast (`grok-4-1-fast`) | ga | 2025-11-19 | 2M | $0.20 | $0.50 | — | High-throughput cheap workhorse with long context | prev: `grok-3-mini` |
