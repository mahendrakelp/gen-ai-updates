...
_Last refreshed: 2026-07-28 by genai-model-catalog routine._
...
| Qwen3.6-Flash (`qwen3.6-flash`) | ga | 2026-04-27 | 1M | $0.19 | $1.13 | Sparse MoE | High-volume, low-latency text workloads | prev: `qwen-flash` |
...
| Qwen3-Coder-Next (`qwen3-coder-next`) | ga | 2026-02-04 | 262.1K | $0.11 | $0.80 | Sparse MoE (coder-tuned) | Cost-efficient coding-agent workloads | prev: `qwen3-coder-plus` |
| Qwen3-Max (`qwen3-max`) | ga | 2025-09-24 | 262.1K | $1.20 | $6.00 | MoE — 1T+ total parameters | Flagship reasoning, coding, and agentic workflows | prev: `qwen2.5-max` → superseded by: `qwen3.7-max` |
| Qwen3-VL-Plus (`qwen3-vl-plus`) | ga | 2025-09-23 | 262.1K | $0.20 | $1.60 | MoE — 235B total / 22B active | Multimodal vision, visual coding, long-video understanding | prev: `qwen2.5-vl-plus` → superseded by: `qwen3.7-plus` |
...
| Qwen3-Coder (`qwen3-coder-480b-a35b-instruct`) | ga | 2025-07-22 | 1.05M | $0.22 | $1.80 | MoE (480B total, 35B active) | Open-weight agentic coding at scale | — |
| Qwen3-Coder-Plus (`qwen3-coder-plus`) | ga | 2025-07-22 | 262.1K | $1.50 | $7.50 | MoE — 480B total / 35B active | Agentic coding and long-context repository reasoning | prev: `qwen2.5-coder-plus` → superseded by: `qwen3-coder-next` |
...
| Qwen3.8-Max-Preview (`qwen3.8-max-preview`) | preview | 2026-07-19 | 983.6K | — | — | Sparse MoE (~2.4T total parameters) | Next-gen flagship reasoning and agentic tasks | prev: `qwen3.7-max` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Amazon Nova 2 Lite (`amazon.nova-2-lite-v1:0`) | ga | 2025-12-02 | 1M | $0.33 | $2.75 | Transformer, multimodal reasoning model | Cost-effective multimodal reasoning at scale | prev: `amazon.nova-lite-v1:0` |
...
| Amazon Nova Premier (`amazon.nova-premier-v1:0`) | deprecated | 2025-04-30 | 1M | $2.50 | $12.50 | Transformer, multimodal foundation model | Complex reasoning and teacher model for distillation | prev: `amazon.nova-pro-v1:0` → superseded by: `amazon.nova-2-pro-preview-20251202-v1:0` |
| Amazon Nova Pro (`amazon.nova-pro-v1:0`) | deprecated | 2024-12-03 | 300K | $0.80 | $3.20 | Transformer, multimodal foundation model | General-purpose multimodal workloads on Bedrock | → superseded by: `amazon.nova-2-pro-preview-20251202-v1:0` |

## Anthropic

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Claude Opus 5 (`claude-opus-5`) | ga | 2026-07-24 | 1M | $5.00 | $25.00 | Transformer LLM using the newer tokenizer introduced with Claude Opus 4.7 | Complex agentic coding and enterprise work | prev: `claude-opus-4-8` |
| Claude Sonnet 5 (`claude-sonnet-5`) | ga | 2026-06-30 | 1M | $2.00 | $10.00 | Transformer LLM using the newer tokenizer introduced with Claude Opus 4.7 | Best combination of speed and intelligence | prev: `claude-sonnet-4-6` |
| Claude Fable 5 (`claude-fable-5`) | ga | 2026-06-09 | 1M | $10.00 | $50.00 | Transformer LLM using the newer tokenizer introduced with Claude Opus 4.7 (produces ~30% more tokens per input than pre-4.7 models) | Next-generation intelligence for long-running agents | prev: `claude-opus-4-8` |
...
| Claude Haiku 4.5 (`claude-haiku-4-5`) | ga | 2025-10-15 | 200K | $1.00 | $5.00 | Transformer LLM using the pre-4.7 tokenizer (same as Claude Sonnet 4.6 and earlier) | Fastest model with near-frontier intelligence | prev: `claude-haiku-3-5` |
...
| Command A Reasoning (`command-a-reasoning-08-2025`) | ga | 2025-08-21 | 256K | $2.50 | $10.00 | 111B-parameter dense decoder-only transformer with hybrid reasoning | Enterprise reasoning and agentic customer service | prev: `command-a-03-2025` → superseded by: `command-a-plus-05-2026` |
| Command A Vision (`command-a-vision-07-2025`) | ga | 2025-07-31 | 128K | $2.50 | $10.00 | 112B multimodal model combining SigLIP2 vision encoder with 111B Command A text tower | Enterprise document, chart, and OCR understanding | prev: `command-a-03-2025` → superseded by: `command-a-plus-05-2026` |
| Command A (`command-a-03-2025`) | ga | 2025-03-13 | 256K | $2.50 | $10.00 | 111B-parameter dense decoder-only transformer with three-layer sliding window attention (4096-token windows) | Enterprise RAG, tool use, agents, multilingual | prev: `command-r-plus-08-2024` → superseded by: `command-a-plus-05-2026` |
| Command R7B (12-2024) (`command-r7b-12-2024`) | ga | 2024-12-13 | 128K | $0.04 | $0.15 | 7-8B-parameter dense decoder-only transformer | Small fast on-device RAG, tool use, agents | prev: `command-r-08-2024` |
...
| Command R+ (08-2024) (`command-r-plus-08-2024`) | ga | 2024-08-30 | 128K | $2.50 | $10.00 | 104B-parameter dense decoder-only transformer | Prior-gen flagship for RAG and tool use | prev: `command-r-plus` → superseded by: `command-a-03-2025` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DeepSeek V4 Flash (`deepseek-v4-flash`) | ga | 2026-04-24 | 1.05M | $0.14 | $0.28 | Sparse MoE with hybrid attention (CSA + HCA) - 284B total / 13B active | Fast, cheap chat, extraction, and classification at scale | prev: `deepseek-chat` |
| DeepSeek V4 Pro (`deepseek-v4-pro`) | ga | 2026-04-24 | 1.05M | $0.43 | $0.87 | Sparse MoE with hybrid attention (CSA + HCA) - 1.6T total / 49B active | Advanced reasoning, coding, and long-running agentic tasks | prev: `deepseek-reasoner` |
| DeepSeek Reasoner (legacy alias) (`deepseek-reasoner`) | deprecated | 2025-01-20 | 131.1K | $0.14 | $0.28 | Sparse MoE - 671B total / 37B active (DeepSeek-R1) | Legacy R1-style reasoning endpoint (retired July 24, 2026) | prev: `deepseek-r1` → superseded by: `deepseek-v4-pro` |
| DeepSeek Chat (legacy alias) (`deepseek-chat`) | deprecated | 2024-12-26 | 131.1K | $0.14 | $0.28 | Sparse MoE - 671B total / 37B active (DeepSeek-V3) | Legacy V3 chat endpoint (retired July 24, 2026) | prev: `deepseek-v3.2` → superseded by: `deepseek-v4-flash` |

## Google

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Gemini 3.5 Flash-Lite (`gemini-3.5-flash-lite`) | ga | 2026-07-21 | 1.05M | $0.30 | $2.50 | Distilled Gemini 3.5 sparse Mixture-of-Experts transformer | Low-cost high-throughput subagent workloads | prev: `gemini-3.1-flash-lite` |
| Gemini 3.6 Flash (`gemini-3.6-flash`) | ga | 2026-07-21 | 1.05M | $1.50 | $7.50 | Sparse Mixture-of-Experts transformer with native multimodal encoders | Efficient multimodal flash flagship for agents | prev: `gemini-3.5-flash` |
| Gemini 3.5 Flash (`gemini-3.5-flash`) | ga | 2026-05-19 | 1.05M | $1.50 | $9.00 | Sparse Mixture-of-Experts transformer with native multimodal encoders | General-purpose agentic Flash workhorse | prev: `gemini-3.1-flash` → superseded by: `gemini-3.6-flash` |
| Gemini 3.1 Flash-Lite (`gemini-3.1-flash-lite`) | ga | 2026-05-07 | 1.05M | $0.25 | $1.50 | Transformer-based Mixture-of-Experts | Cheapest 1M-context tier for extraction and light agents | prev: `gemini-2.5-flash-lite` → superseded by: `gemini-3.5-flash-lite` |
| Gemini 3.1 Pro (`gemini-3.1-pro`) | ga | 2026-02-19 | 1.05M | $2.00 | $12.00 | Sparse Mixture-of-Experts transformer with native multimodal encoders | GA flagship reasoning and long-context tasks | prev: `gemini-3-pro` → superseded by: `gemini-3.5-pro-preview` |
...
| Gemini 3.1 Pro (`gemini-3.1-pro-preview`) | preview | 2026-02-19 | 1.05M | $2.00 | $12.00 | Transformer-based Mixture-of-Experts | Frontier reasoning, complex agentic and multimodal tasks | prev: `gemini-3-pro-preview` |
...
| Gemini 2.5 Flash-Lite (`gemini-2.5-flash-lite`) | deprecated | 2025-07-22 | 1.05M | $0.10 | $0.40 | Distilled sparse mixture-of-experts | Highest-volume, lowest-latency legacy batch workloads | prev: `gemini-2.0-flash-lite` → superseded by: `gemini-3.1-flash-lite` |
| Gemini 2.5 Flash (`gemini-2.5-flash`) | deprecated | 2025-06-17 | 1.05M | $0.30 | $2.50 | Sparse mixture-of-experts transformer | legacy low-cost multimodal workhorse | prev: `gemini-1.5-flash` → superseded by: `gemini-3.5-flash` |
| Gemini 2.5 Pro (`gemini-2.5-pro`) | deprecated | 2025-06-17 | 1.05M | $1.25 | $10.00 | Transformer-based Mixture-of-Experts | legacy long-context multimodal reasoning | prev: `gemini-1.5-pro` → superseded by: `gemini-3.1-pro-preview` |

## Meta

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Llama 4 Maverick (`meta-llama/Llama-4-Maverick-17B-128E-Instruct`) | ga | 2025-04-05 | 1M | $0.20 | $0.60 | Mixture-of-experts, 17B active parameters, 128 experts, 400B total, early-fusion multimodal | Flagship open-weight multimodal chat and coding | prev: `meta-llama/Llama-3.3-70B-Instruct` |
| Llama 4 Maverick (`llama-4-maverick-17b-128e-instruct`) | ga | 2025-04-05 | 1.05M | $0.20 | $0.80 | Mixture-of-experts with 17B active parameters, 128 experts, 400B total parameters, early-fusion multimodality | Flagship multimodal chat and production assistants | prev: `llama-3.3-70b` → superseded by: `meta-llama/Llama-4-Maverick-17B-128E-Instruct` |
| Llama 4 Scout (`meta-llama/Llama-4-Scout-17B-16E-Instruct`) | ga | 2025-04-05 | 10M | — | — | Mixture-of-experts, 17B active parameters, 16 experts, 109B total, early-fusion multimodal, iRoPE | Long-context multimodal reasoning on a single GPU | prev: `meta-llama/Llama-3.3-70B-Instruct` |
| Llama 4 Scout (`llama-4-scout-17b-16e-instruct`) | ga | 2025-04-05 | 10.49M | $0.10 | $0.30 | Mixture-of-experts with 17B active parameters, 16 experts, 109B total parameters, early-fusion multimodality | Long-context multimodal reading and retrieval | prev: `llama-3.3-70b` → superseded by: `meta-llama/Llama-4-Scout-17B-16E-Instruct` |
...
| Llama 3.3 70B Instruct (`meta-llama/Llama-3.3-70B-Instruct`) | ga | 2024-12-06 | 128K | — | — | Dense decoder-only transformer with GQA, 70B parameters | Multilingual dialogue and instruction following | prev: `meta-llama/Llama-3.1-70B-Instruct` → superseded by: `meta-llama/Llama-4-Maverick-17B-128E-Instruct` |
| Muse Spark 1.1 (`muse-spark-1.1`) | preview | 2026-07-09 | 1.05M | $1.25 | $4.25 | Multimodal reasoning model with agentic orchestration, tool/function calling, structured outputs, and web-search grounding | Agentic tool use, coding, and computer use | prev: `muse-spark` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| MAI-Code-1-Flash (`mai-code-1-flash`) | ga | 2026-06-02 | 256K | $0.75 | $4.50 | Sparse Mixture-of-Experts transformer, 137B total / 5B active | Low-latency code generation and agentic coding | — |
...
| Phi-4-reasoning-plus (`phi-4-reasoning-plus`) | ga | 2025-04-30 | 32.8K | — | — | Dense decoder-only transformer, 14B parameters, RoPE positional embeddings | Open-weight reasoning at 14B scale for math, science, and coding with structured chain-of-thought | prev: `phi-4-reasoning` → superseded by: `phi-4-reasoning-vision-15b` |
| Phi-4-reasoning-plus (`microsoft/phi-4-reasoning-plus`) | ga | 2025-04-30 | 32.8K | — | — | 14B dense decoder-only transformer, SFT + RL fine-tuned from Phi-4 | Open-weight small reasoning model for on-device | prev: `phi-4-reasoning` → superseded by: `microsoft/phi-4-reasoning-vision` |
| Phi-4-mini-instruct (`phi-4-mini-instruct`) | ga | 2025-02-27 | 128K | $0.07 | $0.23 | 3.8B dense decoder-only transformer | Ultra-low-cost instruction following at 128K context | prev: `phi-3.5-mini` → superseded by: `phi-4-mini-flash-reasoning` |
...
| Phi-4 (`phi-4`) | ga | 2024-12-12 | 16.4K | $0.07 | $0.14 | 14B parameter dense decoder-only transformer | Compact, capable open-weight model for low-latency scenarios | prev: `phi-3.5` → superseded by: `phi-4-reasoning` |
...
| MAI-Thinking-1 (`mai-thinking-1`) | preview | 2026-06-02 | 256K | — | — | Sparse Mixture-of-Experts, ~35B active / ~1T total parameters | Frontier reasoning, math, software engineering | prev: `mai-1-preview` |
...
| Mistral Medium 3.5 (`mistral-medium-2604`) | ga | 2026-04-29 | 262.1K | $1.50 | $7.50 | Dense 128B transformer with vision encoder | Agentic coding, multi-tool orchestration, long-horizon tasks | prev: `mistral-medium-2508` |
...
| Mistral Small 4 (`mistral-small-2603`) | ga | 2026-03-16 | 262.1K | $0.15 | $0.60 | Sparse Mixture-of-Experts, 119B total / 6.5B active parameters | Cost-efficient multimodal reasoning and agentic coding | prev: `mistral-small-2506` |
...
| Mistral Large 3 (`mistral-large-2512`) | ga | 2025-12-04 | 262.1K | $0.50 | $1.50 | Sparse Mixture-of-Experts, 675B total / 41B active parameters | Flagship multimodal reasoning, coding, multilingual | prev: `mistral-large-2411` |
...
| Codestral 2508 (`codestral-2508`) | ga | 2025-08-01 | 262.1K | $0.30 | $0.90 | Dense transformer optimized for code | Low-latency code completion and fill-in-the-middle | prev: `codestral-2501` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K3 (`kimi-k3`) | ga | 2026-07-16 | 1.05M | $3.00 | $15.00 | Sparse MoE with Kimi Delta Attention + Attention Residuals (2.8T total / 104B active, 896 experts / 16 active) | Flagship multimodal reasoning at frontier scale | prev: `kimi-k2.6` |
| Kimi K2.7 Code (`kimi-k2.7-code`) | ga | 2026-06-12 | 262.1K | $0.95 | $4.00 | Sparse MoE (1T total / 32B active, 384 experts) | Long-horizon autonomous coding agents | prev: `kimi-k2.6` |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262.1K | $0.95 | $4.00 | Sparse MoE (1T total / 32B active) | Open-weight frontier reasoning and coding | prev: `kimi-k2.5` → superseded by: `kimi-k3` |
| Kimi K2.5 (`kimi-k2.5`) | ga | 2026-01-26 | 262.1K | $0.60 | $3.00 | Sparse MoE (1T total / 32B active) | Cost-efficient open agentic reasoning | prev: `kimi-k2-thinking` → superseded by: `kimi-k2.6` |
| Kimi K2 Thinking (`kimi-k2-thinking`) | deprecated | 2025-11-06 | 262.1K | $0.60 | $2.50 | Sparse MoE (1T total / 32B active) | Legacy long-horizon reasoning agent | prev: `kimi-k2` → superseded by: `kimi-k2.5` |
...
| Nemotron 3 Ultra 550B A55B (`nvidia/nemotron-3-ultra-550b-a55b`) | ga | 2026-06-04 | 1M | $0.50 | $2.20 | Hybrid Mamba-Transformer LatentMoE with Multi-Token Prediction, pre-trained in NVFP4 | long-running open reasoning agents at frontier scale | prev: `nvidia/llama-3.1-nemotron-ultra-253b-v1` |
...
| Nemotron 3 Nano Omni 30B A3B Reasoning (`nvidia/nemotron-3-nano-omni-30b-a3b-reasoning`) | ga | 2026-04-28 | 300K | $0.07 | $0.30 | Hybrid MoE Transformer-Mamba with Conv3D video layers and Efficient Video Sampling | omni-modal perception sub-agent in enterprise agent systems | prev: `nvidia/nemotron-nano-12b-v2-vl` |
...
| Nemotron 3 Super 120B A12B (`nvidia/nemotron-3-super-120b-a12b`) | ga | 2026-03-11 | 1M | $0.09 | $0.45 | LatentMoE hybrid: interleaved Mamba-2, MoE, and Attention layers with Multi-Token Prediction | efficient agentic reasoning at production scale | prev: `nvidia/llama-3_3-nemotron-super-49b-v1_5` |
| Nemotron 3 Nano 30B A3B (`nvidia/nemotron-3-nano-30b-a3b`) | ga | 2025-12-14 | 262.1K | $0.05 | $0.20 | Hybrid Mamba2 + Attention with 128-expert sparse MoE (~3B active) | compact open MoE for specialized agentic systems | prev: `nvidia/nvidia-nemotron-nano-9b-v2` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| GPT-5.6 Luna (`gpt-5.6-luna`) | ga | 2026-07-09 | 1.05M | $1.00 | $6.00 | Mixture-of-experts transformer with dynamic routing and configurable reasoning effort | High-volume, latency-sensitive chat and classification | prev: `gpt-5.4-mini` |
| GPT-5.6 Sol (`gpt-5.6-sol`) | ga | 2026-07-09 | 1.05M | $5.00 | $30.00 | Mixture-of-experts transformer with dynamic routing and configurable reasoning effort | Frontier reasoning, coding, complex agentic workflows | prev: `gpt-5.5-pro` |
| GPT-5.6 Terra (`gpt-5.6-terra`) | ga | 2026-07-09 | 1.05M | $2.50 | $15.00 | Mixture-of-experts transformer with dynamic routing and configurable reasoning effort | Balanced everyday reasoning, coding, and agents | prev: `gpt-5.5` |
...
| gpt-oss-120b (`gpt-oss-120b`) | ga | 2025-08-05 | 131.1K | $0.03 | $0.15 | Sparse Mixture-of-Experts (117B total, 5.1B active per token, 128 experts, top-4 routing) | Self-hosted open-weight reasoning and tool use | — |
...
| Sonar Deep Research (`sonar-deep-research`) | ga | 2025-03-07 | 128K | $2.00 | $8.00 | Agentic research pipeline over Perplexity reasoning model with iterative web search | Exhaustive multi-source research reports | — |
| Sonar Reasoning Pro (`sonar-reasoning-pro`) | ga | 2025-03-07 | 128K | $2.00 | $8.00 | DeepSeek R1 fine-tuned with chain-of-thought for search-augmented reasoning | Multi-step reasoning grounded in live search | prev: `sonar-reasoning` |
| Sonar (`sonar`) | ga | 2025-01-21 | 127.1K | $1.00 | $1.00 | Fine-tuned Llama 3.3 70B optimized for web-grounded QA | Fast, low-cost web-grounded Q&A | — |
| Sonar Pro (`sonar-pro`) | ga | 2025-01-21 | 200K | $3.00 | $15.00 | Perplexity in-house search-augmented model with agentic retrieval | Flagship search-grounded answers with citations | prev: `sonar` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Grok 4.5 (`grok-4.5`) | ga | 2026-07-08 | 500K | $2.00 | $6.00 | 1.5T-parameter V9 foundation with configurable reasoning | Frontier coding, agents, and knowledge work | prev: `grok-4.3` |
...
| Grok 4.3 (`grok-4.3`) | ga | 2026-04-30 | 1M | $1.25 | $2.50 | Reasoning-first transformer with prompt caching | Long-context reasoning and agentic tool calling | prev: `grok-4.20` → superseded by: `grok-4.5` |
