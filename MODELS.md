...
_Last refreshed: 2026-08-10 by genai-model-catalog routine._
...
| Qwen3-Coder-Plus (`qwen3-coder-plus`) | ga | 2025-09-23 | 1M | $0.65 | $3.25 | Proprietary variant of the open-weight Qwen3-Coder 480B A35B Mixture-of-Experts | Autonomous coding agents and tool-driven programming | prev: qwen2.5-coder-plus → superseded by: qwen3-coder-next |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Nova 2 Lite (`amazon.nova-2-lite-v1:0`) | ga | 2025-12-02 | 1M | $0.30 | $2.50 | Multimodal reasoning transformer with extended thinking | Fast, low-cost reasoning at scale | prev: amazon.nova-lite-v1:0 |
...
| Nova Premier (`amazon.nova-premier-v1:0`) | ga | 2025-04-30 | 1M | $2.50 | $12.50 | Transformer-based multimodal foundation model | Long-document analysis and model distillation teacher | prev: amazon.nova-pro-v1:0 → superseded by: amazon.nova-2-pro-v1:0 |
...
| Nova Micro (`amazon.nova-micro-v1:0`) | ga | 2024-12-03 | 128K | $0.04 | $0.14 | Transformer-based foundation model | High-throughput text tasks at lowest cost | superseded by: amazon.nova-2-lite-v1:0 |
| Nova Pro (`amazon.nova-pro-v1:0`) | ga | 2024-12-03 | 300K | $0.80 | $3.20 | Transformer-based multimodal foundation model | Balanced multimodal accuracy, speed, and cost | superseded by: amazon.nova-2-pro-v1:0 |
...
| Nova 2 Pro (Preview) (`amazon.nova-2-pro-preview-20251202-v1:0`) | preview | 2025-12-02 | 1M | $1.25 | $10.00 | Transformer, multimodal reasoning model | Complex multimodal reasoning and agentic workflows | prev: amazon.nova-pro-v1:0 |

## Anthropic

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Claude Opus 5 (`claude-opus-5`) | ga | 2026-07-24 | 1M | $5.00 | $25.00 | hybrid reasoning | Premium agentic coding and enterprise reasoning | prev: claude-opus-4-8 |
| Claude Sonnet 5 (`claude-sonnet-5`) | ga | 2026-06-30 | 1M | $3.00 | $15.00 | hybrid reasoning | Best price-performance for coding and agentic work | prev: claude-sonnet-4-6 |
| Claude Fable 5 (`claude-fable-5`) | ga | 2026-06-09 | 1M | $10.00 | $50.00 | hybrid reasoning | Frontier long-horizon agentic and reasoning work | prev: claude-mythos-preview |
...
| Claude Haiku 4.5 (`claude-haiku-4-5`) | ga | 2025-10-15 | 200K | $1.00 | $5.00 | hybrid reasoning | Fastest and most cost-effective production workhorse | prev: claude-3-5-haiku-20241022 |
...
| Command A+ (`command-a-plus-05-2026`) | ga | 2026-05-20 | 256K | $2.50 | $10.00 | 218B sparse Mixture-of-Experts transformer with 25B active parameters (128 experts, 8 activated per token plus one shared expert) | Open-weight enterprise agents with native citations | prev: command-a-03-2025 |
...
| Command A Reasoning (`command-a-reasoning-08-2025`) | ga | 2025-08-21 | 256K | $2.50 | $10.00 | 111B parameter hybrid reasoning model based on the Command A architecture | Complex multi-step enterprise reasoning and agentic workflows | prev: command-a-03-2025 → superseded by: command-a-plus-05-2026 |
...
| Embed v4 (`embed-v4.0`) | ga | 2025-04-15 | 128K | $0.12 | — | Multimodal embedding model with Matryoshka nested representations across four output sizes | Multimodal semantic search over text, PDFs, and images | prev: embed-english-v3.0 |
| Command A (`command-a-03-2025`) | ga | 2025-03-13 | 256K | $2.50 | $10.00 | 111B parameter dense decoder-only transformer | Enterprise RAG, tool use, and multilingual agents | prev: command-r-plus-08-2024 → superseded by: command-a-plus-05-2026 |
...
| Rerank 3.5 (`rerank-v3.5`) | ga | 2024-12-02 | 4K | — | — | Multilingual cross-encoder reranker | Multilingual search result reranking for RAG pipelines | prev: rerank-v3.0 → superseded by: rerank-v4.0-pro |
...
| DeepSeek V4-Flash (`deepseek-v4-flash`) | ga | 2026-04-24 | 1.0M | $0.14 | $0.28 | Hybrid-attention Mixture-of-Experts, 284B total parameters with 13B active per token | High-volume agents and cost-efficient long-context tasks | prev: deepseek-v3.2 |
| DeepSeek V4-Pro (`deepseek-v4-pro`) | ga | 2026-04-24 | 1.0M | $0.43 | $0.87 | Hybrid-attention Mixture-of-Experts, 1.6T total parameters with 49B active per token | Frontier reasoning, coding, and long-context agents | prev: deepseek-v3.2 |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Gemini 3.5 Flash-Lite (`gemini-3.5-flash-lite`) | ga | 2026-07-21 | 1.0M | $0.30 | $2.50 | Gemini 3 Flash-Lite efficiency-optimized variant | Low-latency, high-volume subagent automation | prev: gemini-2.5-flash-lite |
| Gemini 3.6 Flash (`gemini-3.6-flash`) | ga | 2026-07-21 | 1.0M | $1.50 | $7.50 | Gemini 3 Flash-class multimodal reasoning model | Everyday workhorse for coding and multimodal tasks | prev: gemini-3.5-flash |
...
| Gemini 3 Pro (`gemini-3-pro`) | ga | 2025-11-18 | 1.0M | $2.00 | $12.00 | Unified natively multimodal transformer (Gemini 3 family) | Deep multi-step reasoning across text, code and media | prev: gemini-2.5-pro → superseded by: gemini-3.1-pro |
...
| Gemini 3.1 Pro (`gemini-3.1-pro-preview`) | preview | 2026-02-20 | 1.0M | $2.00 | $12.00 | Transformer-based Mixture-of-Experts | Advanced reasoning, agentic coding, complex problem-solving | prev: gemini-3-pro-preview |
...
| Gemini 2.5 Pro (`gemini-2.5-pro`) | deprecated | 2025-03-25 | 1.0M | $1.25 | $10.00 | Sparse mixture-of-experts transformer, thinking model (Pathways/JAX training stack) | Legacy flagship reasoning; migration underway | prev: gemini-2.0-pro → superseded by: gemini-3-pro |
...
| Llama 4 Maverick (`meta-llama/Llama-4-Maverick-17B-128E-Instruct`) | ga | 2025-04-05 | 1.0M | $0.19 | $0.85 | Mixture-of-Experts, 17B active / ~400B total parameters, 128 experts, early-fusion natively multimodal | flagship open-weight multimodal reasoning and coding | prev: meta-llama/Meta-Llama-3.1-405B-Instruct |
...
| Llama 4 Scout (`meta-llama/Llama-4-Scout-17B-16E-Instruct`) | ga | 2025-04-05 | 10M | $0.18 | $0.59 | Mixture-of-Experts, 17B active / ~109B total parameters, 16 experts, early-fusion natively multimodal | ultra-long context on a single server GPU | prev: meta-llama/Meta-Llama-3.1-8B-Instruct |
...
| Llama 3.3 70B Instruct (`meta-llama/Llama-3.3-70B-Instruct`) | ga | 2024-12-06 | 128K | $0.88 | $0.88 | 70B dense decoder-only transformer, instruction-tuned, text in / text out | efficient dense text model near 405B quality | prev: meta-llama/Meta-Llama-3.1-70B-Instruct → superseded by: meta-llama/Llama-4-Scout-17B-16E-Instruct |
...
| Phi-4-multimodal-instruct (`phi-4-multimodal-instruct`) | ga | 2025-02-26 | 131K | $0.08 | $0.32 | Dense multimodal transformer with unified text/vision/speech encoder | Low-cost multimodal (text + vision + speech) inference | prev: phi-3.5-vision-instruct |
...
| Phi-4 (`phi-4`) | ga | 2024-12-12 | 16K | $0.20 | $0.20 | Dense 14B parameter decoder-only transformer | Low-cost general text generation and reasoning at 14B | prev: phi-3-medium → superseded by: phi-4-reasoning |
...
| MAI-Thinking-1 (`mai-thinking-1`) | preview | 2026-06-02 | 256K | — | — | Sparse Mixture-of-Experts, ~35B active / ~1T total parameters | Frontier reasoning, math, and complex problem solving | prev: mai-1-preview |
...
| Mistral Medium 3.5 (`mistral-medium-2604`) | ga | 2026-04-29 | 262K | $1.50 | $7.50 | Dense 128B transformer, 88 decoder layers, Grouped Query Attention | Balanced agentic coding and multimodal reasoning | prev: mistral-medium-2508 |
...
| Mistral Small 4 (`mistral-small-2603`) | ga | 2026-03-16 | 256K | $0.15 | $0.60 | Sparse Mixture-of-Experts, 119B total / 6.5B active parameters | Budget MoE unifying reasoning, coding, and vision | prev: mistral-small-2506 |
...
| Devstral 2 (`devstral-2512`) | ga | 2025-12-09 | 256K | $0.40 | $2.00 | Dense 123B transformer | Agentic software engineering across large repositories | prev: devstral-2507 → superseded by: mistral-medium-2604 |
...
| Mistral Large 3 (`mistral-large-2512`) | ga | 2025-12-02 | 256K | $0.50 | $1.50 | Sparse Mixture-of-Experts, 675B total / 41B active parameters with fused 2.5B vision encoder | Flagship multimodal reasoning and agentic workflows | prev: mistral-large-2411 |
...
| Magistral Medium 1.2 (`magistral-medium-2509`) | ga | 2025-09-01 | 131K | $2.00 | $5.00 | Dense reasoning model trained with RLVR on Mistral Medium 3 checkpoint | Transparent chain-of-thought math and science reasoning | prev: magistral-medium-2507 → superseded by: mistral-medium-2604 |
...
| Codestral 2508 (`codestral-2508`) | ga | 2025-08-01 | 256K | $0.30 | $0.90 | Dense transformer specialized for code | Low-latency code completion, FIM, and test generation | prev: codestral-2501 |
| Ministral 8B (`ministral-8b-2410`) | ga | 2024-10-16 | 131K | $0.10 | $0.10 | Dense 8B transformer with interleaved sliding-window attention | On-device and edge deployment | superseded by: ministral-8b-2512 |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K3 (`kimi-k3`) | ga | 2026-07-16 | 1.0M | $3.00 | $15.00 | Mixture-of-Experts with ~2.8T total parameters and native multimodal vision | Frontier long-context multimodal reasoning and coding | prev: kimi-k2.6 |
| Kimi K2.7 Code (`kimi-k2.7-code`) | ga | 2026-06-12 | 262K | $0.95 | $4.00 | 1T total-parameter Mixture-of-Experts with 32B active parameters and 384 experts | Long-horizon agentic software engineering | prev: kimi-k2.6 |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262K | $0.95 | $4.00 | 1T total-parameter MoE with 32B active, 384 experts (8+1 shared), 61 layers, MLA, and a 400M MoonViT vision encoder | Open-weight agentic workhorse for coding and orchestration | prev: kimi-k2.5 → superseded by: kimi-k3 |
| Kimi K2 Thinking (`kimi-k2-thinking`) | ga | 2025-11-06 | 262K | $0.60 | $2.50 | Trillion-parameter Mixture-of-Experts with 32B active parameters per forward pass | Agentic long-horizon step-by-step reasoning with tools | prev: kimi-k2-0711-preview → superseded by: kimi-k3 |
...
| Moonshot v1 128K (`moonshot-v1-128k`) | deprecated | — | 131K | — | — | — | Legacy compatibility for existing integrations | superseded by: kimi-k2.6 |
...
| Nemotron 3 Ultra 550B A55B (`nvidia/nemotron-3-ultra-550b-a55b`) | ga | 2026-06-04 | 1M | $0.50 | $2.20 | Hybrid Mamba-Transformer Latent Mixture-of-Experts with 550B total and 55B active parameters | long-running open agentic reasoning at scale | prev: nvidia/llama-3.1-nemotron-ultra-253b-v1 |
...
| Nemotron 3 Nano Omni 30B A3B Reasoning (`nvidia/Nemotron-3-Nano-Omni-30B-A3B-Reasoning-BF16`) | ga | 2026-04-29 | 262K | — | — | Nemotron 3 hybrid Mamba-Transformer Mixture-of-Experts backbone with C-RADIOv4-H vision encoder and Parakeet-TDT-0.6B-v2 audio encoder; 30B total / 3B active | Multimodal agent perception across vision, audio, video | — |
...
| Nemotron 3 Nano Omni 30B A3B Reasoning (`nvidia/nemotron-3-nano-omni-30b-a3b-reasoning`) | ga | 2026-04-28 | 300K | $0.07 | $0.30 | Mixture-of-Experts hybrid Transformer-Mamba backbone with Conv3D layers and Efficient Video Sampling, 30B total with 3B active | open multimodal perception sub-agent for agents | prev: nvidia/nemotron-3-nano-30b-a3b |
...
| Nemotron 3 Super 120B A12B (`nvidia/nemotron-3-super-120b-a12b`) | ga | 2026-03-11 | 1M | $0.09 | $0.45 | Hybrid Mamba-Transformer Mixture-of-Experts with multi-token prediction, 120B total and 12B active parameters | high-volume agentic workhorse and reasoning | prev: nvidia/llama-3_3-nemotron-super-49b-v1_5 → superseded by: nvidia/nemotron-3-ultra-550b-a55b |
| Nemotron 3 Super 120B A12B (`nvidia/NVIDIA-Nemotron-3-Super-120B-A12B-BF16`) | ga | 2026-03-11 | 262K | — | — | Hybrid Latent Mixture-of-Experts (LatentMoE) with Mamba-2, MoE, and Attention layers; MTP layers; NVFP4-trained; 120B total / 12B active | High-accuracy reasoning for multi-agent applications | — |
| Nemotron 3 Nano 30B A3B (`nvidia/nemotron-3-nano-30b-a3b`) | ga | 2025-12-15 | 262K | $0.05 | $0.20 | Hybrid Mamba-2 Transformer granular MoE, 31.6B total with 3.2B active, 6-of-128 experts per token | efficient on-device and edge agentic reasoning | prev: nvidia/nvidia-nemotron-nano-9b-v2 → superseded by: nvidia/nemotron-3-super-120b-a12b |
| Nemotron 3 Nano 30B A3B (`nvidia/NVIDIA-Nemotron-3-Nano-30B-A3B-BF16`) | ga | 2025-12-15 | 262K | — | — | Hybrid Mamba-Transformer Mixture-of-Experts; 23 Mamba-2 + MoE layers with 6 Attention layers; 128 experts + 1 shared, 5 activated per token; 30B total / 3.5B active | Compute-efficient reasoning and agent workflows | — |
...
| Llama Embed Nemotron 8B (`nvidia/llama-embed-nemotron-8b`) | ga | 2025-10-21 | 33K | — | — | Llama-3.1-8B decoder fine-tuned with bidirectional attention, 32 hidden layers, 4096-dim embeddings | multilingual retrieval and semantic embeddings | — |
...
| GPT-5.6 Luna (`gpt-5.6-luna`) | ga | 2026-07-09 | 1.1M | $0.20 | $1.20 | Mixture-of-experts transformer with dynamic routing and configurable reasoning effort | High-volume, cost-sensitive workloads | prev: gpt-5.5 |
| GPT-5.6 Sol (`gpt-5.6-sol`) | ga | 2026-07-09 | 1.1M | $5.00 | $30.00 | Mixture-of-experts transformer with dynamic routing and configurable reasoning effort | Frontier agentic coding and complex reasoning | prev: gpt-5.5 |
| GPT-5.6 Terra (`gpt-5.6-terra`) | ga | 2026-07-09 | 1.1M | $2.00 | $12.00 | Mixture-of-experts transformer with dynamic routing and configurable reasoning effort | Balanced everyday intelligence at mid cost | prev: gpt-5.5 |
...
| GPT-5.5 (`gpt-5.5`) | ga | 2026-04-23 | 1M | $5.00 | $30.00 | Unified system with router across fast and deep reasoning models | Agentic workflows with 1M context | prev: gpt-5.4 → superseded by: gpt-5.6-sol |
...
| gpt-oss-120b (`gpt-oss-120b`) | ga | 2025-08-05 | 131K | $0.03 | $0.15 | Mixture-of-Experts, 120B total / 5.1B active params, 36 layers, 128 experts top-4 routing, GQA, RoPE, RMSNorm, MXFP4 quantization | On-prem open-weight reasoning on single 80GB GPU | — |
...
| Sonar Reasoning Pro (`sonar-reasoning-pro`) | ga | 2025-03-07 | 128K | $2.00 | $8.00 | Powered by DeepSeek R1 with Chain-of-Thought | Multi-step reasoning with real-time web citations | prev: sonar-reasoning |
| Sonar Deep Research (`sonar-deep-research`) | ga | 2025-02-14 | 128K | $2.00 | $8.00 | Agentic research pipeline over Sonar search with reasoning model | Exhaustive multi-source research reports | — |
| Sonar (`sonar`) | ga | 2025-02-11 | 127K | $1.00 | $1.00 | Fine-tuned Llama 3.3 70B | Fast, low-cost web-grounded search answers | — |
| Sonar Pro (`sonar-pro`) | ga | 2025-01-21 | 200K | $3.00 | $15.00 | Perplexity in-house search-augmented LLM | Complex queries needing deeper grounded search | prev: sonar |
...
| Grok 4.5 (`grok-4.5`) | ga | 2026-07-08 | 500K | $2.00 | $6.00 | 1.5T-parameter V9 foundation with configurable reasoning | Opus-class reasoning and token-efficient coding agents | prev: grok-4.3 |
| Grok 4.3 (`grok-4.3`) | ga | 2026-04-30 | 1M | $1.25 | $2.50 | Reasoning-first transformer with prompt caching | Long-context multimodal agentic work with native video | prev: grok-4.20 → superseded by: grok-4.5 |
