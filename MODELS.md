...
_Last refreshed: 2026-08-27 by genai-model-catalog routine._
...
| Qwen3-VL (`qwen3-vl-plus`) | ga | 2025-09-23 | 131.1K | $0.20 | $1.60 | Qwen3 vision-language MoE | Multimodal vision-language reasoning | prev: `qwen2.5-vl` → superseded by: `qwen3.5-plus` |
...
| Qwen3-Omni (`qwen3-omni-flash`) | ga | 2025-09-15 | 65.5K | $0.43 | — | Qwen3 omni-modal transformer | Real-time any-to-any multimodal | prev: `qwen2.5-omni` |
...
| Qwen-Plus (`qwen-plus`) | ga | 2025-07-28 | 131.1K | $0.40 | $1.20 | Qwen3 mid-tier | Balanced cost/quality workhorse tier | prev: `qwen-plus-2025-04-28` |
...
| Amazon Nova Premier (`amazon.nova-premier-v1:0`) | ga | 2025-10-31 | 1M | $2.50 | $10.00 | Multimodal foundation model | complex reasoning, agentic workflows, distillation | prev: `amazon.nova-pro-v1:0` → superseded by: `amazon.nova-2-pro-v1:0` |
| Amazon Nova Lite (`amazon.nova-lite-v1:0`) | ga | 2024-12-03 | 300K | $0.06 | $0.24 | Multimodal transformer | low-cost multimodal at high volume | → superseded by: `amazon.nova-2-lite-v1:0` |
| Amazon Nova Micro (`amazon.nova-micro-v1:0`) | ga | 2024-12-03 | 128K | $0.035 | $0.14 | Text-only transformer | ultra-cheap text-only fast responses | → superseded by: `amazon.nova-2-lite-v1:0` |
| Amazon Nova Pro (`amazon.nova-pro-v1:0`) | ga | 2024-12-03 | 300K | $0.80 | $3.20 | Multimodal foundation model | balanced multimodal for complex enterprise tasks | → superseded by: `amazon.nova-premier-v1:0` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Claude Opus 5 (`claude-opus-5`) | ga | 2026-07-24 | 1M | $5.00 | $25.00 | Opus-tier reasoning model with default thinking | flagship reasoning at half of Fable price | prev: `claude-opus-4-8` |
| Claude Sonnet 5 (`claude-sonnet-5`) | ga | 2026-06-30 | 1M | $3.00 | $15.00 | Sonnet-tier model with adaptive thinking | balanced production workhorse | prev: `claude-sonnet-4-6` |
| Claude Fable 5 (`claude-fable-5`) | ga | 2026-06-09 | 1M | $10.00 | $50.00 | Mythos-class frontier model with adaptive thinking | autonomous long-horizon knowledge work | prev: `claude-opus-4-8` |
| Claude Haiku 4.5 (`claude-haiku-4-5`) | ga | 2025-10-15 | 200K | $1.00 | $5.00 | Haiku-class small model with extended thinking | fast cheap high-volume tasks | prev: `claude-haiku-4` |
...
| Command A Reasoning (`command-a-reasoning-08-2025`) | ga | 2025-08-01 | 256K | $2.50 | $10.00 | 111B dense transformer with reasoning post-training | Enterprise agentic reasoning workflows | prev: `command-a-03-2025` → superseded by: `command-a-plus-05-2026` |
...
| Command A (`command-a-03-2025`) | ga | 2025-03-13 | 256K | $2.50 | $10.00 | 111B dense transformer | Multilingual enterprise agents and RAG | prev: `command-r-plus-08-2024` → superseded by: `command-a-reasoning-08-2025` |
| Command R7B (`command-r7b-12-2024`) | ga | 2024-12-14 | 128K | $0.0375 | $0.15 | 7B dense transformer | Cheap fast RAG and on-device agents | prev: `command-r-08-2024` |
...
| Command R+ (`command-r-plus-08-2024`) | ga | 2024-08-30 | 128K | $2.50 | $10.00 | 104B dense transformer | Legacy RAG and multi-step tool use | prev: `command-r-plus-04-2024` → superseded by: `command-a-03-2025` |
...
| DeepSeek-V4-Pro (`deepseek-v4-pro`) | ga | 2026-08-13 | 1.0M | $0.66 | $1.98 | MoE, 1.6T total / 49B active | Flagship reasoning at long context | prev: `deepseek-v3.2` → superseded by: `deepseek-v4-pro-0813` |
...
| DeepSeek-V4-Flash-Vision-Exp (`deepseek-v4-flash-vision-exp`) | preview | 2026-08-21 | 1.0M | $0.22 | $0.66 | V4-Flash MoE with vision encoder | Cheap multimodal image and screenshot understanding | prev: `deepseek-v4-flash` |
| DeepSeek-V4-Flash (`deepseek-v4-flash`) | preview | 2026-07-31 | 1.0M | $0.22 | $0.66 | MoE, 284B total / 13B active | Low-cost high-volume reasoning at 1M context | prev: `deepseek-v3.2` → superseded by: `deepseek-v4-flash-0731` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Gemini 3.7 Flash (`gemini-3.7-flash`) | ga | 2026-08-13 | 1.0M | $0.75 | $3.75 | Gemini 3 Flash-tier transformer (MoE) | High-throughput coding and agent workflows | prev: `gemini-3.6-flash` |
...
| Gemini 2.5 Flash-Lite (`gemini-2.5-flash-lite`) | ga | 2025-07-22 | 1.0M | $0.10 | $0.40 | Gemini 2.5 lite transformer | Cheapest Gemini for high-volume tasks | prev: `gemini-2.0-flash-lite` → superseded by: `gemini-3.5-flash-lite` |
| Gemini 2.5 Flash (`gemini-2.5-flash`) | ga | 2025-06-17 | 1.0M | $0.30 | $2.50 | Gemini 2.5 Flash MoE transformer | Cost-efficient multimodal at scale | prev: `gemini-2.0-flash` → superseded by: `gemini-3.7-flash` |
| Gemini 2.5 Pro (`gemini-2.5-pro`) | ga | 2025-06-17 | 1.0M | $1.25 | $10.00 | Gemini 2.5 sparse MoE transformer | Mature reasoning workhorse with big context | prev: `gemini-2.0-pro` → superseded by: `gemini-3-pro` |
...
| Llama 4 Maverick (`llama-4-maverick-17b-128e-instruct`) | ga | 2025-04-05 | 1.0M | $0.20 | $0.60 | Mixture-of-experts transformer, 17B active / 400B total, 128 experts, early-fusion multimodal | Open-weight multimodal reasoning workhorse | prev: `llama-3.3-70b-instruct` → superseded by: `meta-llama/Llama-4-Maverick-17B-128E-Instruct` |
...
| Llama 4 Scout (`llama-4-scout-17b-16e-instruct`) | ga | 2025-04-05 | 10.5M | $0.11 | $0.34 | Mixture-of-experts transformer, 17B active / 109B total, 16 experts, early-fusion multimodal | Extreme long-context on a single GPU | prev: `llama-3.3-70b-instruct` → superseded by: `meta-llama/Llama-4-Scout-17B-16E-Instruct` |
...
| Llama 3.3 70B Instruct (`llama-3.3-70b-instruct`) | ga | 2024-12-06 | 131.1K | — | — | Dense decoder-only transformer, 70B parameters | Dense open-weight 70B text model, cheap to serve | prev: `llama-3.1-70b-instruct` → superseded by: `llama-4-scout-17b-16e-instruct` |
...
| Phi-4-mini-instruct (`phi-4-mini-instruct`) | ga | 2025-02-26 | 128K | $0.075 | $0.30 | 3.8B dense decoder-only transformer | Edge and low-latency chat/reasoning | prev: `phi-3-mini` → superseded by: `phi-4-mini-flash-reasoning` |
...
| Phi-4 (`microsoft/phi-4`) | ga | 2024-12-12 | 16.4K | $0.065 | $0.26 | 14B parameter dense decoder-only Transformer | Small, high-quality open text model for math/code | prev: `microsoft/Phi-3-medium` → superseded by: `microsoft/Phi-4-reasoning-plus` |
...
| Mistral Medium 3.5 (`mistral-medium-2604`) | ga | 2026-04-26 | 262.1K | $1.50 | $7.50 | Dense 128B multimodal with adjustable reasoning | Frontier multimodal agentic and coding tasks | prev: `mistral-medium-2508` |
...
| Mistral Small 4 (`mistral-small-2603`) | ga | 2026-03-01 | 262.1K | $0.15 | $0.60 | Hybrid MoE, 6.5B active / 119B total | Cheap hybrid instruct/reasoning/coding tier | prev: `mistral-small-2506` |
...
| Mistral Large 3 (`mistral-large-2512`) | ga | 2025-12-01 | 262.1K | $0.50 | $1.50 | Granular MoE, 41B active / 675B total | General-purpose multimodal MoE workhorse | prev: `mistral-large-2411` |
...
| Magistral Medium 1.2 (`magistral-medium-2509`) | ga | 2025-09-01 | 128K | $2.00 | $5.00 | Dense reasoning transformer with tokenized thinking chunks | Transparent multilingual chain-of-thought reasoning | prev: `magistral-medium-2506` → superseded by: `mistral-medium-2604` |
| Codestral 25.08 (`codestral-2508`) | ga | 2025-08-01 | 262.1K | $0.30 | $0.90 | Code-specialized transformer | IDE code completion with fill-in-the-middle | prev: `codestral-2405` |
...
| Kimi K2 Thinking (`kimi-k2-thinking`) | ga | 2025-11-06 | 256K | $0.60 | $2.50 | Mixture-of-Experts, ~1T total / ~32B active parameters | Agentic reasoning and long tool-chain tasks | prev: `kimi-k2-instruct-0905` → superseded by: `kimi-k2.6` |
...
| Moonshot v1 128k (`moonshot-v1-128k`) | ga | — | 128K | $2.00 | $5.00 | — | Long-context Chinese/English general chat | prev: `moonshot-v1-32k` → superseded by: `kimi-k2-instruct-0905` |
...
| GPT-5.6 Luna (`gpt-5.6-luna`) | ga | 2026-07-09 | 1.1M | $0.20 | $1.20 | Reasoning model, shared GPT-5.6 family stack | high-volume low-latency tasks | prev: `gpt-5-nano` |
| GPT-5.6 Sol (`gpt-5.6-sol`) | ga | 2026-07-09 | 1.1M | $5.00 | $30.00 | Reasoning model with optional max and ultra multi-agent modes | frontier agentic coding and reasoning | prev: `gpt-5.5` |
| GPT-5.6 Terra (`gpt-5.6-terra`) | ga | 2026-07-09 | 1.1M | $2.00 | $12.00 | Reasoning model, shared GPT-5.6 family stack | balanced everyday workloads | prev: `gpt-5.5` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Sonar Deep Research (`sonar-deep-research`) | ga | 2025-03-07 | 128K | $2.00 | $8.00 | Agentic research pipeline over Perplexity search with reasoning model backbone | long-form research reports with citations | → superseded by: `agent-api` |
| Sonar Reasoning Pro (`sonar-reasoning-pro`) | ga | 2025-03-07 | 128K | $2.00 | $8.00 | DeepSeek-R1 base with Perplexity search augmentation and Chain-of-Thought | grounded reasoning with real-time search | prev: `sonar-reasoning` → superseded by: `agent-api` |
| Sonar (`sonar`) | ga | 2025-01-27 | 128K | $1.00 | $1.00 | Perplexity search-augmented LLM built on a fine-tuned Llama base | cheap grounded question answering | → superseded by: `agent-api` |
| Sonar Pro (`sonar-pro`) | ga | 2025-01-21 | 200K | $3.00 | $15.00 | Perplexity search-augmented LLM optimized for advanced grounded answers | high-quality answers with web citations | prev: `sonar` → superseded by: `agent-api` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Grok 4.6 (`grok-4.6`) | ga | 2026-08-12 | 500K | $2.00 | $6.00 | Mixture-of-experts foundation model with reasoning post-training | flagship reasoning, coding, long agentic tasks | prev: `grok-4.5` |
...
| Grok 4.5 (`grok-4.5`) | ga | 2026-07-15 | 500K | $2.00 | $6.00 | V9 architecture, ~1.5T parameters | prior-gen general reasoning model | prev: `grok-4.3` → superseded by: `grok-4.6` |
...
| Grok Code Fast 1 (`grok-code-fast-1`) | ga | 2025-08-28 | 256K | $0.20 | $1.50 | New from-scratch architecture pre-trained on programming-heavy corpus | fast, cheap agentic coding in IDEs | → superseded by: `grok-4.3` |
