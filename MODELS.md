...
_Last refreshed: 2026-08-25 by genai-model-catalog routine._
...
| Qwen3-Coder-Plus (`qwen3-coder-plus`) | ga | 2025-09-23 | 1M | $1.00 | $5.00 | Mixture-of-Experts (MoE) | Autonomous coding agent and tool use | prev: qwen3-coder-480b-a35b-instruct → superseded by: qwen3-coder-next |
| Qwen3-Max (`qwen3-max`) | ga | 2025-09-23 | 262.1K | $1.20 | $6.00 | Mixture-of-Experts (MoE) | Flagship reasoning and long-context text tasks | prev: qwen3-235b-a22b-instruct-2507 → superseded by: qwen3.7-max |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Nova 2 Lite (`amazon.nova-2-lite-v1:0`) | ga | 2025-12-02 | 1M | $0.30 | $2.50 | Multimodal reasoning foundation model | Fast, cost-effective multimodal reasoning | prev: amazon.nova-lite-v1:0 |
...
| Nova Premier (`amazon.nova-premier-v1:0`) | ga | 2025-04-30 | 1M | $2.50 | $12.50 | Multimodal foundation model | Complex reasoning and model distillation teacher | prev: amazon.nova-pro-v1:0 → superseded by: amazon.nova-2-pro-preview-20251202-v1:0 |
...
| Nova Pro (`amazon.nova-pro-v1:0`) | ga | 2024-12-03 | 300K | $0.80 | $3.20 | Multimodal foundation model | Balanced multimodal accuracy, speed, and cost | superseded by: amazon.nova-2-pro-preview-20251202-v1:0 |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Claude Opus 5 (`claude-opus-5`) | ga | 2026-07-24 | 1M | $5.00 | $25.00 | Opus-tier reasoning model with default thinking | Premium complex reasoning at Opus tier price | prev: claude-opus-4-8 |
| Claude Sonnet 5 (`claude-sonnet-5`) | ga | 2026-06-30 | 1M | $2.00 | $10.00 | Sonnet-tier model with adaptive thinking | Coding, tool use, and long-running agent tasks | prev: claude-sonnet-4-6 |
| Claude Fable 5 (`claude-fable-5`) | ga | 2026-06-09 | 1M | $10.00 | $50.00 | Mythos-class frontier model with adaptive thinking | Frontier reasoning and long-horizon agentic work | prev: claude-opus-4-8 |
...
| Command A+ (`command-a-plus-05-2026`) | ga | 2026-05-20 | 128K | $2.50 | $10.00 | 218B sparse Mixture-of-Experts (25B active, 128 experts) | Unified flagship agentic enterprise workflows | prev: command-a-03-2025 |
...
| Command A Reasoning (`command-a-reasoning-08-2025`) | ga | 2025-08-21 | 256K | $2.50 | $10.00 | 111B dense decoder-only Transformer with reasoning | Advanced reasoning and agentic workflows | prev: command-a-03-2025 → superseded by: command-a-plus-05-2026 |
| Command A Vision (`command-a-vision-07-2025`) | ga | 2025-07-31 | 128K | $2.50 | $10.00 | 111B multimodal decoder-only Transformer | Enterprise document, chart, and OCR analysis | prev: command-a-03-2025 → superseded by: command-a-plus-05-2026 |
...
| Command A (`command-a-03-2025`) | ga | 2025-03-13 | 256K | $2.50 | $10.00 | 111B dense decoder-only Transformer | Enterprise RAG, agents, tool use | prev: command-r-plus-08-2024 → superseded by: command-a-plus-05-2026 |
...
| DeepSeek V4-Flash-Vision-Exp (`deepseek-v4-flash-vision-exp`) | preview | 2026-08-21 | 1M | $0.22 | $0.66 | Sparse MoE — 284B total / 13B active (multimodal) | — | prev: deepseek-v4-flash-0731 |
| DeepSeek V4-Flash (`deepseek-v4-flash`) | deprecated | 2026-04-24 | 1M | $0.22 | $0.66 | Mixture-of-Experts, 284B total / 13B active per token, Compressed Sparse Attention | Initial V4 workhorse, superseded by 0731 official build | prev: deepseek-ai/DeepSeek-V3.2 → superseded by: deepseek-v4-flash-0731 |
| DeepSeek V4-Pro (`deepseek-v4-pro`) | deprecated | 2026-04-24 | 1M | $0.66 | $1.98 | Mixture-of-Experts, 1.6T total / 49B active, Compressed Sparse Attention | Initial V4 flagship, superseded by 0813 build | prev: deepseek-reasoner → superseded by: deepseek-v4-pro-0813 |
...
| DeepSeek Chat (V3.2 alias) (`deepseek-chat`) | deprecated | 2024-12-26 | 1M | $0.14 | $0.28 | Alias routed to DeepSeek-V3.2 non-thinking mode | Legacy alias, retired 2026-07-24 | prev: deepseek-v3.2 → superseded by: deepseek-v4-flash-0731 |

## Google

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Gemini 3.7 Flash (`gemini-3.7-flash`) | ga | 2026-08-13 | 1M | $0.75 | $3.75 | Multimodal transformer optimized for agentic workhorse workloads | Fast agentic coding and multi-step workflows | prev: gemini-3.6-flash |
| Gemini 3.5 Flash-Lite (`gemini-3.5-flash-lite`) | ga | 2026-07-21 | 1M | $0.30 | $2.50 | Distilled Flash-Lite multimodal | Very cheap high-throughput Flash | prev: gemini-3.1-flash-lite |
| Gemini 3.6 Flash (`gemini-3.6-flash`) | ga | 2026-07-21 | 1M | $0.75 | $3.75 | Sparse mixture-of-experts multimodal transformer with hybrid reasoning | Token-efficient multimodal workhorse | prev: gemini-3.5-flash → superseded by: gemini-3.7-flash |
...
| Gemini 3.1 Flash-Lite (`gemini-3.1-flash-lite`) | ga | 2026-05-07 | 1M | $0.25 | $1.50 | Compact multimodal transformer tuned for efficiency | High-volume low-latency multimodal workloads | prev: gemini-2.5-flash-lite → superseded by: gemini-3.5-flash-lite |
...
| Gemini 2.5 Flash-Lite (`gemini-2.5-flash-lite`) | ga | 2025-09-25 | 1M | $0.10 | $0.40 | Sparse mixture-of-experts transformer, most efficient of the 2.5 family | Ultra-cheap high-throughput inference | prev: gemini-2.0-flash-lite → superseded by: gemini-3.5-flash-lite |
| Gemini 2.5 Flash (`gemini-2.5-flash`) | ga | 2025-05-20 | 1M | $0.30 | $2.50 | Sparse mixture-of-experts transformer with hybrid reasoning (thinking on/off) | General-purpose reasoning at low cost | prev: gemini-2.0-flash → superseded by: gemini-3.7-flash |
...
| Gemini 3.1 Pro (`gemini-3.1-pro`) | preview | 2026-02-19 | 1M | $2.00 | $12.00 | Sparse mixture-of-experts (MoE) transformer, natively multimodal; based on Gemini 3 Pro | Advanced reasoning and agentic tasks | prev: gemini-3-pro → superseded by: gemini-3.5-pro-preview |
| Gemini 3.1 Pro (`gemini-3.1-pro-preview`) | preview | 2026-02-19 | 1M | $2.00 | $12.00 | Sparse mixture-of-experts multimodal transformer with configurable thinking | Frontier reasoning, long-horizon agents, multimodal coding | prev: gemini-3-pro → superseded by: gemini-3.1-pro |
...
| Gemini 3 Pro (`gemini-3-pro`) | deprecated | 2025-11-18 | 1M | $2.00 | $12.00 | Natively multimodal reasoning model | Prior Pro flagship | prev: gemini-2.5-pro → superseded by: gemini-3.1-pro |
...
| Gemini 2.5 Pro (`gemini-2.5-pro`) | deprecated | 2025-06-17 | 1M | $1.25 | $10.00 | sparse mixture-of-experts transformer with thinking | Legacy flagship reasoning model | prev: gemini-1.5-pro → superseded by: gemini-3.1-pro |
...
| Muse Spark 1.2 (`muse-spark-1.2`) | ga | 2026-08-05 | 1M | $1.25 | $4.25 | Multimodal reasoning model | Multimodal agentic reasoning with 1M context | prev: muse-spark-1.1 |
...
| Phi-4-mini (`phi-4-mini`) | ga | 2025-02-26 | 128K | $0.07 | $0.23 | 3.8B dense decoder-only transformer with GQA | Fast, low-cost text tasks with long context | prev: phi-3-mini |
...
| Phi-4-mini-instruct (`phi-4-mini-instruct`) | ga | 2025-02-26 | 128K | $0.08 | $0.30 | 3.8B dense decoder-only transformer | Edge and low-latency chat/reasoning | prev: phi-3-mini → superseded by: phi-4-mini-flash-reasoning |
...
| Phi-4 (`phi-4`) | ga | 2024-12-12 | 16.4K | $0.13 | $0.50 | 14B dense decoder-only transformer | Reasoning, math, and code on constrained hardware | prev: phi-3 → superseded by: phi-4-reasoning |
...
| Mistral Medium 3.5 (2604) (`mistral-medium-2604`) | ga | 2026-04-30 | 262.1K | $1.50 | $7.50 | 128B dense instruction-tuned model | Agentic coding and multi-tool workflows | prev: mistral-medium-2508 |
...
| Mistral Small 4 (2603) (`mistral-small-2603`) | ga | 2026-03-16 | 262.1K | $0.15 | $0.60 | mixture-of-experts, 119B total / ~6B active parameters (128 experts, 4 active) | Unified reasoning, vision, and coding at low cost | prev: mistral-small-2506 |
...
| Mistral Large 3 (2512) (`mistral-large-2512`) | ga | 2025-12-01 | 262.1K | $0.50 | $1.50 | Sparse mixture-of-experts, 41B active / 675B total parameters | Flagship general-purpose enterprise workloads | prev: mistral-large-2411 |
...
| Codestral (2508) (`codestral-2508`) | ga | 2025-08-01 | 256K | $0.30 | $0.90 | Code-specialized transformer | Low-latency code completion and FIM | prev: codestral-2501 |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K3 (`kimi-k3`) | ga | 2026-07-16 | 1M | $3.00 | $15.00 | Mixture-of-Experts, 2.8T total parameters, ~104B active per token, Kimi Delta Attention (KDA) with Attention Residuals | Flagship long-context multimodal reasoning and agentic coding | prev: kimi-k2.6 |
| Kimi K2.7 Code (`kimi-k2.7-code`) | ga | 2026-06-12 | 262.1K | $0.95 | $4.00 | Mixture-of-Experts, 1T total parameters, ~32B active per token | Long-horizon coding, debugging and agentic engineering workflows | prev: kimi-k2.6 |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262.1K | $0.95 | $4.00 | Mixture-of-Experts, 1T total parameters, ~32B active, 384 experts (8+1), 61 layers, Multi-head Latent Attention | Multimodal coding, UI generation and multi-agent orchestration | prev: kimi-k2.5 → superseded by: kimi-k3 |
...
| Kimi K2 Thinking (`kimi-k2-thinking`) | deprecated | 2025-11-06 | 262.1K | $0.60 | $2.50 | Mixture-of-Experts, 1T total parameters, ~32B active, native INT4 quantization | Deep multi-step reasoning and long tool-use chains | prev: kimi-k2-instruct-0905 → superseded by: kimi-k2.5 |
...
| Llama 3.3 Nemotron Super 49B v1.5 (`nvidia/llama-3.3-nemotron-super-49b-v1.5`) | ga | 2025-07-25 | 131.1K | $0.10 | $0.40 | Dense Transformer derived from Llama-3.3-70B via Neural Architecture Search | Balanced reasoning and agentic tasks on single GPU | prev: nvidia/llama-3.3-nemotron-super-49b-v1 → superseded by: nvidia/nemotron-3-super-120b-a12b |
| Llama 3.1 Nemotron Ultra 253B v1 (`nvidia/llama-3.1-nemotron-ultra-253b-v1`) | ga | 2025-04-07 | 131.1K | $0.60 | $1.80 | Dense decoder-only Transformer derived from Llama-3.1-405B-Instruct via Neural Architecture Search | Flagship open reasoning at enterprise scale | superseded by: nvidia/nemotron-3-ultra-550b-a55b |
...
| GPT-5.6 Sol (`gpt-5.6-sol`) | ga | 2026-07-09 | 1.1M | $5.00 | $30.00 | Reasoning model with optional max and ultra multi-agent modes | Frontier reasoning, coding, cybersecurity, research | prev: gpt-5.5 |
| GPT-5.6 Terra (`gpt-5.6-terra`) | ga | 2026-07-09 | 1.1M | $2.00 | $12.00 | Reasoning model, shared GPT-5.6 family stack | Balanced workhorse for multi-step agent tasks | prev: gpt-5.5-mini |
...
| GPT-5.5 (`gpt-5.5`) | ga | 2026-04-23 | 1.1M | $5.00 | $30.00 | First full retrain since GPT-4.5; frontier reasoning model | Complex professional reasoning and multimodal workflows | prev: gpt-5.4 → superseded by: gpt-5.6-sol |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Sonar Deep Research (`sonar-deep-research`) | ga | 2025-03-07 | 128K | $2.00 | $8.00 | Sonar Deep Research (multi-step retrieval and synthesis agent) | Autonomous multi-step research and synthesis | superseded by: agent-api |
| Sonar Reasoning Pro (`sonar-reasoning-pro`) | ga | 2025-02-18 | 128K | $2.00 | $8.00 | DeepSeek R1 with Chain-of-Thought reasoning | Advanced multi-step reasoning with citations | prev: sonar-reasoning → superseded by: agent-api |
| Sonar (`sonar`) | ga | 2025-01-27 | 127.1K | $1.00 | $1.00 | In-house Sonar model built on Meta Llama 3.3 70B | Cost-effective grounded web search answers | superseded by: agent-api |
| Sonar Pro (`sonar-pro`) | ga | 2025-01-27 | 200K | $3.00 | $15.00 | Perplexity Sonar Pro (in-house, built on Llama base) | Complex multi-source enterprise search queries | prev: sonar → superseded by: agent-api |
| Sonar Reasoning (`sonar-reasoning`) | ga | 2025-01-27 | 127K | $1.00 | $5.00 | Fine-tuned DeepSeek R1 with Chain-of-Thought | Chain-of-thought reasoning with web search | superseded by: sonar-reasoning-pro |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Grok 4.6 (`grok-4.6`) | ga | 2026-08-12 | 500K | $2.00 | $6.00 | Mixture-of-experts foundation model with reasoning post-training | Long-running agents, coding, and knowledge work | prev: grok-4.5 |
...
| Grok 4.5 (`grok-4.5`) | ga | 2026-07-08 | 500K | $2.00 | $6.00 | V9 architecture, ~1.5T parameters | Coding, agents, and knowledge work | prev: grok-4.3 → superseded by: grok-4.6 |
...
| Grok 4.1 Fast (Non-Reasoning) (`grok-4-1-fast-non-reasoning`) | ga | 2025-11-19 | 2M | $0.20 | $0.50 | Unified reasoning/non-reasoning weights steered by system prompt | Low-latency instant replies at scale | prev: grok-4-fast-non-reasoning |
| Grok 4.1 Fast (Reasoning) (`grok-4-1-fast-reasoning`) | ga | 2025-11-19 | 2M | $0.20 | $0.50 | Unified reasoning/non-reasoning weights steered by system prompt | High-volume agentic tool calling and deep research | prev: grok-4-fast-reasoning |
