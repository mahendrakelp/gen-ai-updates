...
_Last refreshed: 2026-07-02 by genai-model-catalog routine._

## Alibaba

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Qwen3.7-Plus (`qwen3.7-plus`) | ga | 2026-06-01 | 1M | $0.40 | $1.60 | Multimodal MoE with early-fusion vision-language training (parameters undiscl... | Multimodal agent perceiving screens and GUIs | prev: `qwen3-vl-plus` |
| Qwen3.7-Max (`qwen3.7-max`) | ga | 2026-05-19 | 1M | $2.50 | $7.50 | Hybrid attention Mixture-of-Experts (~1.6T total parameters, active count und... | Flagship agentic reasoning and long-horizon coding | prev: `qwen3-max` |
...
| Qwen3.5-Omni-Plus (`qwen3.5-omni-plus`) | ga | 2026-04-22 | 256K | $0.40 | $4.80 | Hybrid-Attention Mixture-of-Experts (30B total, 3B active) | Native omni-modal understanding and speech output | prev: `qwen3-omni` |
| Qwen3-Coder-Next (`qwen3-coder-next`) | ga | 2026-02-04 | 256K | $0.11 | $0.80 | Sparse MoE (80B total / 3B active, 512 experts with 10 routed + 1 shared) bui... | Open-weight agentic coding for local development | prev: `qwen3-coder-flash` |
...
| Qwen3-Max (`qwen3-max`) | ga | 2025-09-23 | 256K | $0.78 | $3.90 | Dense and MoE hybrid (details undisclosed) | Prior-generation flagship reasoning (still GA, superseded by 3.7-Max) | prev: `qwen2.5-max` → superseded by: `qwen3.7-max` |
| Qwen3-VL-Plus (`qwen3-vl-plus`) | ga | 2025-09-23 | 256K | $0.20 | $1.60 | Vision-language MoE (235B-A22B and dense 2B/4B/8B/32B variants) | Affordable multimodal understanding across image and video | prev: `qwen2.5-vl` → superseded by: `qwen3.7-plus` |
...
| Amazon Nova 2 Pro (Preview) (`amazon.nova-2-pro-preview-20251202-v1:0`) | preview | 2025-12-02 | 1M | $2.19 | $17.50 | Multimodal reasoning transformer with adjustable reasoning effort (low/medium... | Complex agentic coding and multimodal planning | prev: `amazon.nova-premier-v1:0` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| North Mini Code 1.0 (`north-mini-code-1.0`) | ga | 2026-06-09 | 256K | — | — | Decoder-only Sparse Mixture-of-Experts Transformer - 128 experts, 8 active pe... | Open-weights agentic coding on a single H100 | — |
| Command A+ (`command-a-plus-05-2026`) | ga | 2026-05-20 | 128K | $2.50 | $10.00 | Decoder-only Sparse Mixture-of-Experts Transformer (128 experts, 8 active per... | Flagship open-weight multimodal enterprise agents | prev: `command-a-reasoning-08-2025` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DeepSeek V4 Flash (`deepseek-v4-flash`) | preview | 2026-04-24 | 1M | $0.14 | $0.28 | Sparse MoE — 284B total / 13B active per token, hybrid Compressed Sparse Atte... | Cost-efficient high-volume chat, coding, and agents | prev: `deepseek-v3.2` |
| DeepSeek V4 Pro (`deepseek-v4-pro`) | preview | 2026-04-24 | 1M | $0.43 | $0.87 | Sparse MoE — 1.6T total / 49B active per token, hybrid Compressed Sparse Atte... | Frontier reasoning, agentic coding, complex SWE tasks | prev: `deepseek-v3.2` |
| DeepSeek Chat (legacy alias) (`deepseek-chat`) | deprecated | 2025-12-01 | 1M | $0.14 | $0.28 | Alias routing to deepseek-v4-flash (Sparse MoE — 284B total / 13B active) | Legacy compatibility for non-thinking chat | prev: `deepseek-v3.2` → superseded by: `deepseek-v4-flash` |
| DeepSeek Reasoner (legacy alias) (`deepseek-reasoner`) | deprecated | 2025-12-01 | 1M | $0.14 | $0.28 | Alias routing to deepseek-v4-flash thinking mode (Sparse MoE — 284B total / 1... | Legacy compatibility for thinking-mode reasoning | prev: `deepseek-r1` → superseded by: `deepseek-v4-pro` |

## Google

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Gemini 3.5 Flash (`gemini-3.5-flash`) | ga | 2026-05-19 | 1M | $1.50 | $9.00 | Sparse mixture-of-experts transformer with thinking | Fast agentic execution, coding, and long tasks | prev: `gemini-3-flash-preview` |
...
| Llama 3.3 70B Instruct (`llama-3.3-70b`) | ga | 2024-12-06 | 128K | $0.20 | $0.20 | Dense transformer, 70B parameters, Grouped-Query Attention, text-only, traine... | Cost-efficient dense open-weight chat/coding at 70B | prev: `llama-3.1-70b` → superseded by: `llama-4-maverick` |
| Muse Spark (`muse-spark`) | preview | 2026-04-08 | 256K | — | — | Natively multimodal early-fusion frontier model (active/total parameters undi... | Frontier multimodal reasoning and health workloads | prev: `llama-4-maverick` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| MAI-Code-1-Flash (`mai-code-1-flash`) | ga | 2026-06-02 | 256K | $0.75 | $4.50 | Sparse Mixture-of-Experts transformer (~137B total / ~5B active params) | Low-latency agentic coding in GitHub Copilot | — |
| Phi-4-reasoning-vision-15B (`phi-4-reasoning-vision-15b`) | ga | 2026-03-04 | 33K | — | — | Dense 15B multimodal transformer with reasoning post-training | Open-weight multimodal reasoning at 15B scale | prev: `phi-4-reasoning` |
...
| Phi-4-reasoning-plus (`phi-4-reasoning-plus`) | ga | 2025-04-30 | 33K | — | — | Dense decoder-only transformer (14B parameters, RL post-trained) | Small-model math and science reasoning on commodity hardware | prev: `phi-4-reasoning` → superseded by: `phi-4-reasoning-vision-15b` |
...
| Phi-4-multimodal (`phi-4-multimodal-instruct`) | ga | 2025-02-26 | 128K | $0.08 | $0.32 | Dense decoder-only transformer with mixture-of-LoRAs (5.6B parameters) | Compact unified text, vision, and speech for edge | — |
| Phi-4 (`phi-4`) | ga | 2024-12-12 | 16K | $0.07 | $0.14 | Dense decoder-only transformer (14B parameters) | Cost-efficient small language model for reasoning | prev: `phi-3.5` |
...
| MAI-Thinking-1 (`mai-thinking-1`) | preview | 2026-06-02 | 256K | — | — | Sparse Mixture-of-Experts transformer (~35B active / ~1T total params) | Flagship enterprise reasoning across math and code | prev: `mai-1-preview` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Mistral Medium 3.5 (`mistral-medium-2604`) | ga | 2026-04-30 | 256K | $1.50 | $7.50 | Dense 128B transformer with custom vision encoder | Balanced flagship for coding and reasoning | prev: `mistral-medium-2508` |
| Mistral Small 4 (`mistral-small-2603`) | ga | 2026-03-16 | 256K | $0.15 | $0.60 | Sparse Mixture-of-Experts (~6.5B active / 119B total, 128 experts / 4 active)... | Cost-efficient multimodal MoE with reasoning toggle | prev: `mistral-small-2506` |
| Devstral Small 2 (`devstral-small-2-2512`) | ga | 2025-12-09 | 256K | $0.10 | $0.30 | Dense 24B transformer | Local, on-device coding agents and tight feedback loops where a 24B model fits on consumer GPUs. | prev: `devstral-small-2507` |
| Mistral Large 3 (`mistral-large-2512`) | ga | 2025-12-02 | 256K | $0.50 | $1.50 | Sparse Mixture-of-Experts (41B active / 675B total) with fused ~2.5B vision e... | Flagship open-weight multimodal MoE for RAG and agents | prev: `mistral-large-2411` |
| Codestral 2508 (`codestral-2508`) | ga | 2025-08-01 | 256K | $0.30 | $0.90 | Dense transformer optimized for code (parameter count not disclosed) | Low-latency code completion and FIM across 80+ languages | prev: `codestral-2501` |
...
| Magistral Medium 1.2 (`magistral-medium-2509`) | deprecated | 2025-09-18 | 128K | $2.00 | $5.00 | Reasoning model trained via reinforcement learning on Mistral Medium 3 | Math and code reasoning with image input | prev: `magistral-medium-2507` → superseded by: `mistral-medium-2604` |

## Moonshot

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K2.7 Code (`kimi-k2.7-code`) | ga | 2026-06-12 | 256K | $0.95 | $4.00 | Sparse MoE - 1T total / 32B active, 384 experts, MoonViT vision encoder (inhe... | Long-horizon agentic coding and software engineering | prev: `kimi-k2.6` |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 256K | $0.95 | $4.00 | Sparse MoE - 1T total / 32B active, 384 experts (8+1 shared), 61 layers, MLA,... | Open-weight agentic coding and general chat | prev: `kimi-k2.5` → superseded by: `kimi-k2.7-code` |
| Kimi K2.5 (`kimi-k2.5`) | ga | 2026-01-27 | 256K | $0.60 | $3.00 | Sparse MoE - 1T total / 32B active, 384 experts, MLA, SwiGLU, MoonViT vision ... | Cost-efficient open-weight multimodal agent | prev: `kimi-k2-thinking` → superseded by: `kimi-k2.6` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Nemotron 3 Ultra (`nvidia/nemotron-3-ultra-550b-a55b`) | ga | 2026-06-04 | 1M | $0.50 | $2.20 | Hybrid Mamba-Transformer Mixture-of-Experts with LatentMoE and MTP layers, NV... | Long-running agentic reasoning at frontier scale | prev: `nvidia/llama-3.1-nemotron-ultra-253b-v1` |
...
| Nemotron 3 Nano Omni 30B A3B Reasoning (`nvidia/nemotron-3-nano-omni-30b-a3b-reasoning`) | ga | 2026-04-28 | 256K | $0.07 | $0.30 | Hybrid Mamba-Transformer MoE backbone with C-RADIOv4-H vision encoder and Par... | Unified multimodal agentic perception | prev: `nvidia/nvidia-nemotron-nano-9b-v2` |
| Nemotron 3 Nano 4B (`nvidia/nemotron-3-nano-4b`) | ga | 2026-03-17 | 256K | — | — | Hybrid Mamba-2 + MLP with 4 attention layers (dense, ~3.97B params, compresse... | Edge and on-device agentic AI on Jetson and RTX | prev: `nvidia/nvidia-nemotron-nano-9b-v2` |
| Nemotron 3 Nano 30B A3B (`nvidia/nemotron-3-nano-30b-a3b`) | ga | 2026-03-11 | 1M | $0.05 | $0.20 | Hybrid Mamba-Transformer MoE (30B total / 3B active, 128 experts, top-6 routing) | Efficient high-volume agentic reasoning | prev: `nvidia/nvidia-nemotron-nano-9b-v2` |
| Nemotron 3 Super 120B A12B (`nvidia/nemotron-3-super-120b-a12b`) | ga | 2026-03-11 | 1M | $0.10 | $0.50 | Hybrid Mamba-Transformer Mixture-of-Experts with LatentMoE (120B total / 12B ... | Mid-tier agentic reasoning, coding, planning | prev: `nvidia/llama-3.3-nemotron-super-49b-v1` |
| Nemotron Nano 9B v2 (`nvidia/nvidia-nemotron-nano-9b-v2`) | ga | 2025-09-05 | 128K | $0.04 | $0.16 | Hybrid Mamba-Transformer dense model | Edge and on-device reasoning and code generation | → superseded by: `nvidia/nemotron-3-nano-4b` |
...
| Llama 3.1 Nemotron Ultra 253B v1 (`nvidia/llama-3.1-nemotron-ultra-253b-v1`) | deprecated | 2025-04-07 | 128K | $0.60 | $1.80 | Dense transformer (Llama 3.1 base, NAS-pruned) | Legacy Llama-based Nemotron reasoning | → superseded by: `nvidia/nemotron-3-ultra-550b-a55b` |
...
| gpt-oss-120b (`gpt-oss-120b`) | ga | 2025-08-05 | 128K | $0.03 | $0.15 | Mixture-of-Experts, 117B total parameters, 5.1B active per forward pass, nati... | Self-hostable open-weights reasoning at low cost | — |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Grok 4.3 (`grok-4.3`) | ga | 2026-04-30 | 1M | $1.25 | $2.50 | Grok 4.20-scale pretraining with improved architecture and configurable alway... | Flagship reasoning, agentic tool calling, long context | prev: `grok-4.20` |
...
| Grok 4.20 (`grok-4.20`) | ga | 2026-03-10 | 2M | $2.00 | $6.00 | Multi-variant LLM with reasoning, non-reasoning, and 4-agent collaborative modes | Long-context 2M reasoning with agentic tool calling | prev: `grok-4-0709` → superseded by: `grok-4.3` |
...
| Grok Build 0.1 (`grok-build-0.1`) | preview | 2026-05-29 | 256K | $1.00 | $2.00 | Coding-specialized model with always-on reasoning derived from the grok-code-... | Agentic coding, debugging, multi-step engineering | prev: `grok-code-fast-1` |
