...
_Last refreshed: 2026-08-15 by genai-model-catalog routine._
...
| Qwen3.8-Max (`qwen3.8-max`) | ga | 2026-08-03 | 1M | $2.00 | $6.00 | Sparse Mixture-of-Experts with hybrid attention (2.4T params, 95B active) | Long-horizon agentic coding and office automation | prev: `qwen3.7-max` |
...
| Qwen3.7-Max (`qwen3.7-max`) | ga | 2026-05-21 | 1M | $1.65 | $4.95 | MoE proprietary model | Agentic workflows and long-running autonomous tasks | prev: `qwen3.6-max` → superseded by: `qwen3.8-max` |
...
| Qwen3-VL-Plus (`qwen3-vl-plus`) | ga | 2025-09-23 | 262.1K | $0.21 | $0.88 | MoE — 235B total / 22B active, 128 experts (8 active per token) | Flagship open vision-language understanding and agents | prev: `qwen2.5-vl-72b-instruct` → superseded by: `qwen3.7-plus` |
...
| Qwen3-Coder-Plus (`qwen3-coder-plus`) | ga | 2025-07-22 | 262.1K | $0.65 | $3.25 | 480B Mixture-of-Experts, 35B active parameters | Agentic coding, repo-scale edits and PR generation | prev: `qwen2.5-coder-plus` → superseded by: `qwen3-coder-next` |
...
| Qwen-Plus (`qwen-plus`) | ga | — | 131.1K | $0.40 | $1.20 | Mixture-of-Experts (MoE) | Balanced cost and performance for general tasks | — |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Nova 2 Lite (`amazon.nova-2-lite-v1:0`) | ga | 2025-12-02 | 1M | $0.30 | $2.50 | Multimodal foundation model with extended thinking | Cost-effective high-volume reasoning and document processing | prev: `amazon.nova-lite-v1:0` |
...
| Nova Pro (`amazon.nova-pro-v1:0`) | ga | 2024-12-03 | 300K | $0.80 | $3.20 | Multimodal foundation model | Balanced accuracy, speed, and cost for general workloads | → superseded by: `amazon.nova-2-pro-preview-20251202-v1:0` |
...
| Nova 2 Pro (`amazon.nova-2-pro-preview-20251202-v1:0`) | preview | 2025-12-02 | 1M | $2.19 | $17.50 | Multimodal foundation model with extended thinking | Complex multistep agentic reasoning tasks | prev: `amazon.nova-pro-v1:0` |
| Nova Premier (`amazon.nova-premier-v1:0`) | deprecated | 2025-04-30 | 1M | $2.50 | $12.50 | Multimodal foundation model | Legacy multimodal reasoning; migrate to Nova 2 Pro | prev: `amazon.nova-pro-v1:0` → superseded by: `amazon.nova-2-pro-preview-20251202-v1:0` |

## Anthropic

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Claude Fable 5 (`claude-fable-5`) | ga | 2026-06-09 | 1M | $10.00 | $50.00 | Mythos-class frontier model with newer tokenizer | Highest-capability long-horizon agentic work | prev: `claude-opus-4-8` |
| Claude Opus 5 (`claude-opus-5`) | ga | 2026-06-04 | 1M | $5.00 | $25.00 | Opus-class model with adaptive thinking and effort control | Complex agentic coding and enterprise work | prev: `claude-opus-4-8` |
| Claude Sonnet 5 (`claude-sonnet-5`) | ga | 2026-06-04 | 1M | $2.00 | $10.00 | Sonnet-class agentic model with adaptive thinking | Best speed-intelligence balance for production | prev: `claude-sonnet-4-6` |
...
| Command A+ (`command-a-plus-05-2026`) | ga | 2026-05-20 | 128K | $2.50 | $10.00 | Sparse Mixture-of-Experts, 218B total / 25B active, 128 experts (8 active + 1 shared) | Enterprise agentic workflows and multilingual RAG | prev: `command-a-03-2025` |
...
| Embed v4 (`embed-v4.0`) | ga | 2025-04-15 | 128K | $0.12 | — | Multimodal embedding model with configurable output dimensions | Multimodal enterprise search embeddings | prev: `embed-english-v3.0` |
| Command A (`command-a-03-2025`) | ga | 2025-03-13 | 256K | $2.50 | $10.00 | Dense transformer, 111B parameters | Enterprise RAG, tool use, agentic tasks | prev: `command-r-plus-08-2024` → superseded by: `command-a-plus-05-2026` |
...
| Rerank 3.5 (`rerank-v3.5`) | deprecated | 2024-12-02 | 4.1K | — | — | Multilingual cross-encoder reranker | Legacy multilingual semantic reranking | prev: `rerank-v3.0` → superseded by: `rerank-v4.0-fast` |

## DeepSeek

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DeepSeek V4-Pro-0813 (`deepseek-v4-pro-0813`) | ga | 2026-08-13 | 1.05M | $0.43 | $0.87 | Mixture-of-Experts — 1.6T total / 49B active, hybrid Compressed Sparse Attention + Heavily Compressed Attention | Agentic coding, tool use, and long-context reasoning | prev: `deepseek-v4-pro` |
| DeepSeek-V4-Pro (`deepseek-v4-pro`) | ga | 2026-08-13 | 1M | $1.74 | $3.48 | Mixture-of-Experts, 1.6T total / 49B active parameters, DeepSeek Sparse Attention (DSA) | Frontier open agentic coding and reasoning | prev: `deepseek-reasoner` |
...
| DeepSeek-V4-Flash (`deepseek-v4-flash`) | preview | 2026-04-24 | 1M | $0.14 | $0.28 | Mixture-of-Experts with DeepSeek Sparse Attention (smaller sibling of V4-Pro) | Ultra-cheap million-token context inference | prev: `deepseek-chat` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Gemini 3.5 Flash-Lite (`gemini-3.5-flash-lite`) | ga | 2026-07-15 | 1M | $0.30 | $2.50 | Sparse Mixture-of-Experts transformer | Low-latency high-throughput agent workloads | prev: `gemini-3.1-flash-lite` |
| Gemini 3.7 Flash (`gemini-3.7-flash`) | ga | 2026-07-01 | 1M | $0.75 | $3.75 | Refinement of Gemini 3.6 Flash reasoning foundation | Most intelligent workhorse Flash model | prev: `gemini-3.6-flash` |
| Gemini 3.6 Flash (`gemini-3.6-flash`) | ga | 2026-06-10 | 1M | $0.75 | $3.75 | Sparse Mixture-of-Experts transformer | Workhorse coding and multimodal Flash model | prev: `gemini-3.5-flash` → superseded by: `gemini-3.7-flash` |
...
| Llama Guard 4 12B (`meta-llama/Llama-Guard-4-12B`) | ga | 2025-04-29 | 131.1K | $0.20 | $0.20 | Dense 12B classifier fine-tuned from Llama 4 Scout backbone for hazard taxonomy content moderation | Multimodal content-safety classification and guardrails for Llama-family deployments | prev: `meta-llama/Llama-Guard-3-8B` |
...
| Llama 4 Maverick (`meta-llama/Llama-4-Maverick-17B-128E-Instruct`) | ga | 2025-04-05 | 1M | $0.19 | $0.85 | Mixture-of-Experts, 17B active parameters with 128 experts (~400B total), early-fusion multimodality | Flagship open multimodal assistant | prev: `meta-llama/Llama-3.3-70B-Instruct` |
...
| Llama 4 Scout (`meta-llama/Llama-4-Scout-17B-16E-Instruct`) | ga | 2025-04-05 | 10M | $0.18 | $0.59 | Mixture-of-Experts, 17B active parameters with 16 experts, early-fusion multimodality | Long-context multimodal on efficient hardware | prev: `meta-llama/Llama-3.3-70B-Instruct` |
...
| Phi-4-Reasoning-Plus (`microsoft/Phi-4-reasoning-plus`) | ga | 2025-04-30 | 32K | — | — | 14B dense transformer post-trained with SFT + RL | Open-weight small reasoning model for math and science | prev: `microsoft/Phi-4-reasoning` → superseded by: `microsoft/phi-4-reasoning-vision` |
...
| Phi-4-multimodal-instruct (`microsoft/phi-4-multimodal-instruct`) | ga | 2025-02-26 | 128K | $0.08 | $0.32 | Dense multimodal transformer (5.6B parameters) | On-device multimodal text, image, and speech input | → superseded by: `microsoft/phi-4-reasoning-vision` |
...
| Phi-4 (`microsoft/phi-4`) | ga | 2024-12-12 | 16.4K | — | — | Dense decoder-only transformer (14B parameters) | Small-model complex math and reasoning | → superseded by: `microsoft/phi-4-reasoning-plus` |
| MAI-Thinking-1 (`mai-thinking-1`) | preview | 2026-08-11 | 256K | $2.00 | $8.00 | Mixture-of-Experts, ~1T total parameters with 35B active | Cost-efficient enterprise math, coding, and reasoning | prev: `mai-1-preview` |
...
| MAI-Code-1-Flash (`mai-code-1-flash`) | deprecated | 2026-06-02 | 256K | $0.75 | $4.50 | Sparse MoE transformer — 137B total parameters | Legacy fast coding on GitHub Copilot | → superseded by: `mai-code-1.1-flash` |
...
| Mistral Medium 3.5 (`mistral-medium-latest`) | ga | 2026-04-29 | 262.1K | $1.50 | $7.50 | 128B dense multimodal transformer with configurable reasoning | Agentic coding and mid-tier multimodal work | prev: `mistral-medium-2505` |
...
| Mistral Small 4 (`mistral-small-2603`) | ga | 2026-03-16 | 262.1K | $0.15 | $0.60 | Mixture-of-experts, 119B total parameters with 128 experts, 4 active (~6.5B active per token) | High-throughput multimodal production at low cost | prev: `mistral-small-2501` |
| Mistral Small 4 (`mistral-small-latest`) | ga | 2026-03-16 | 262.1K | $0.15 | $0.60 | Mixture-of-experts, ~119B total / ~6B active parameters, multimodal with configurable reasoning | Low-cost multimodal reasoning and coding | prev: `mistral-small-2506` |
...
| Mistral Large 3 (`mistral-large-latest`) | ga | 2025-12-04 | 262.1K | $0.50 | $1.50 | Sparse mixture-of-experts, ~675B total / ~41B active parameters, multimodal | Flagship general-purpose multimodal MoE | prev: `mistral-large-2411` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K3 (`kimi-k3`) | ga | 2026-07-16 | 1M | $3.00 | $15.00 | Sparse MoE, 2.8T parameters with Kimi Delta Attention and Stable LatentMoE | Frontier coding, long-horizon agentic reasoning | prev: `kimi-k2.6` |
| Kimi K2.7 Code (`kimi-k2.7-code`) | ga | 2026-06-12 | 262.1K | $0.95 | $4.00 | Sparse MoE, ~1T total / 32B active parameters, native multimodal | Long-horizon autonomous coding agents | prev: `kimi-k2.6` |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262.1K | $0.60 | $2.50 | Sparse MoE, 1T total / 32B active, 384 experts (8 activated) with MLA + SwiGLU | General agentic tasks with strong open-weight coding | prev: `kimi-k2.5` → superseded by: `kimi-k3` |
...
| Nemotron 3 Ultra (`nvidia/nemotron-3-ultra-550b-a55b`) | ga | 2026-06-04 | 1M | $0.50 | $2.20 | Hybrid Mamba-Transformer Mixture-of-Experts, 550B total / 55B active | Frontier reasoning and long-running agent orchestration | prev: `nvidia/nemotron-4-340b-instruct` |
...
| Nemotron 3 Nano Omni (`nvidia/nemotron-3-nano-omni-30b-a3b-reasoning`) | ga | 2026-04-29 | 260K | $0.07 | $0.30 | Omni-modal MoE, 30B total / 3B active parameters | Omni-modal agent perception in a single small model | prev: `nvidia/nemotron-3-nano-30b-a3b` |
...
| Nemotron 3 Super (`nvidia/nemotron-3-super-120b-a12b`) | ga | 2026-03-11 | 1M | $0.09 | $0.45 | Hybrid Mamba-Attention Mixture-of-Experts, 120B total / 12B active | Efficient reasoning and multi-agent tool calling | prev: `nvidia/nemotron-4-340b-instruct` → superseded by: `nvidia/nemotron-3-ultra-550b-a55b` |
...
| Nemotron 3 Nano (`nvidia/nemotron-3-nano-30b-a3b`) | ga | 2025-12-15 | 256K | $0.05 | $0.20 | Hybrid: 23 Mamba-2 + 23 MoE + 6 Attention layers, 30B total / 3.5B active | Cost-efficient always-on specialized sub-agents | prev: `nvidia/nemotron-mini-4b-instruct` → superseded by: `nvidia/nemotron-3-super-120b-a12b` |
...
| GPT-5.6 Luna (`gpt-5.6-luna`) | ga | 2026-07-09 | 1.05M | $0.20 | $1.20 | Fast, cost-efficient variant of the GPT-5.6 family | High-throughput cost-efficient inference | prev: `gpt-5.5` |
| GPT-5.6 Terra (`gpt-5.6-terra`) | ga | 2026-07-09 | 1.05M | $2.00 | $12.00 | Mid-tier variant of the GPT-5.6 family | Balanced everyday production workloads | prev: `gpt-5.5` |
...
| gpt-oss-120b (`gpt-oss-120b`) | ga | 2025-08-05 | 131.1K | $0.03 | $0.15 | Mixture-of-Experts, 120B total / 5.1B active params, 36 layers, 128 experts top-4 routing, GQA, RoPE, RMSNorm, MXFP4 quantization | On-prem open-weight reasoning on single 80GB GPU | — |
...
| GPT-5.6 Sol (`gpt-5.6-sol`) | preview | 2026-08-12 | 1.05M | $5.00 | $30.00 | Frontier multimodal reasoning model with extended thinking | Frontier reasoning and complex agentic tasks | prev: `gpt-5.5` |
...
| Sonar Deep Research (`sonar-deep-research`) | ga | 2025-03-07 | 128K | $2.00 | $8.00 | Agentic deep-research pipeline with iterative search and reasoning | Long autonomous research reports with citations | — |
| Sonar Pro (`sonar-pro`) | ga | 2025-03-07 | 200K | $3.00 | $15.00 | Search-augmented premium tier model with expanded retrieval | In-depth grounded answers with large context | prev: `sonar` |
| Sonar Reasoning Pro (`sonar-reasoning-pro`) | ga | 2025-03-07 | 128K | $2.00 | $8.00 | Reasoning model powered by DeepSeek R1 with Perplexity search | Complex multi-step grounded reasoning | prev: `sonar-reasoning` |
| Sonar (`sonar`) | ga | 2025-01-27 | 128K | $1.00 | $1.00 | Search-augmented model built on Llama 3.3 70B | Fast, cheap grounded web search answers | — |
