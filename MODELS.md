...
_Last refreshed: 2026-08-28 by genai-model-catalog routine._
...
| Qwen3.8-Max (`qwen3.8-max`) | ga | 2026-08-03 | 1M | $2.00 | $6.00 | Sparse MoE — 2.4T total / 95B active | Frontier multimodal reasoning and long-horizon agentic tasks | prev: qwen3.7-max |
...
| Qwen3-Coder-Plus (`qwen3-coder-plus`) | ga | 2025-09-23 | 1M | $0.65 | $3.25 | Sparse MoE — 480B total / 35B active (160 experts, 8 active) | Autonomous coding agents with tool use and long context | prev: qwen-coder-plus → superseded by: qwen3-coder-next |
| Qwen3-Max (`qwen3-max`) | ga | 2025-09-23 | 262K | $1.20 | $6.00 | Dense/MoE >1T parameters (Qwen3 series) | Flagship general-purpose reasoning and agents | prev: qwen2.5-max → superseded by: qwen3.7-max |
...
| Qwen3-VL-Plus (`qwen3-vl-plus`) | ga | 2025-09-23 | 262K | $0.21 | $0.63 | MoE VLM — Qwen3-VL-235B-A22B backbone | Vision-language understanding across images and video | prev: qwen-vl-plus → superseded by: qwen3.5-plus |
...
| Qwen3-Omni-Flash (`qwen3-omni-flash`) | ga | 2025-09-22 | 66K | $0.43 | — | Sparse MoE — 30B total / 3B active (A3B) | Realtime multimodal speech, video, and text interaction | prev: qwen2.5-omni |
...
| Qwen-Plus (`qwen-plus`) | ga | 2025-07-28 | 131K | $0.40 | $1.20 | Qwen3 mid-tier | Balanced cost/quality workhorse tier | prev: qwen-plus-2025-04-28 |
...
| Nova 2 Sonic (`amazon.nova-2-sonic-v1:0`) | ga | 2025-12-02 | 1M | $0.33 | $2.75 | Unified speech-to-speech transformer | Real-time speech-to-speech conversational voice AI | prev: amazon.nova-sonic-v1:0 |
| Nova Premier (`amazon.nova-premier-v1:0`) | ga | 2025-04-30 | 1M | $2.50 | $12.50 | Multimodal transformer | Complex reasoning, RAG, agentic workflows, model distillation teacher | prev: amazon.nova-pro-v1:0 → superseded by: amazon.nova-2-pro-v1:0 |
...
| Nova Lite (`amazon.nova-lite-v1:0`) | ga | 2024-12-03 | 300K | $0.06 | $0.24 | Multimodal transformer | Low-cost fast multimodal for high-volume workloads | → superseded by: amazon.nova-2-lite-v1:0 |
| Nova Micro (`amazon.nova-micro-v1:0`) | ga | 2024-12-03 | 128K | $0.04 | $0.14 | Text transformer | Cheapest lowest-latency text-only tasks | → superseded by: amazon.nova-2-lite-v1:0 |
| Nova Pro (`amazon.nova-pro-v1:0`) | ga | 2024-12-03 | 300K | $0.80 | $3.20 | Multimodal transformer | Balanced multimodal workhorse for enterprise applications | → superseded by: amazon.nova-premier-v1:0 |
...
| Command A Reasoning (`command-a-reasoning-08-2025`) | ga | 2025-08-21 | 256K | $2.50 | $10.00 | Dense 111B-parameter transformer with reasoning post-training | Enterprise agentic reasoning and complex multi-step workflows | prev: command-a-03-2025 → superseded by: command-a-plus-05-2026 |
...
| Command A (`command-a-03-2025`) | ga | 2025-03-13 | 256K | $2.50 | $10.00 | Dense 111B-parameter transformer | Enterprise RAG, agents, tool use, multilingual tasks | prev: command-r-plus-08-2024 → superseded by: command-a-reasoning-08-2025 |
| Command R7B (`command-r7b-12-2024`) | ga | 2024-12-13 | 128K | $0.04 | $0.15 | Dense 7B-parameter transformer | Low-cost RAG, chat, and on-device deployment | prev: command-r-08-2024 |
| Rerank v3.5 (`rerank-v3.5`) | ga | 2024-12-03 | 4K | — | — | Cross-encoder reranking model | Reranking retrieval candidates for RAG | prev: rerank-english-v3.0 → superseded by: rerank-v4.0-pro |
...
| Command R+ (`command-r-plus-08-2024`) | ga | 2024-08-30 | 128K | $2.50 | $10.00 | Dense 104B-parameter transformer | Complex RAG and multi-step tool use agents | prev: command-r-plus-04-2024 → superseded by: command-a-03-2025 |
...
| DeepSeek-V4-Pro (`deepseek-v4-pro`) | ga | 2026-08-13 | 1.0M | $1.32 | $3.96 | Sparse MoE — 1.6T total / 49B active, CSA+HCA attention | Frontier reasoning, coding, long-context agents | prev: deepseek-reasoner → superseded by: deepseek-v4-pro-0813 |
...
| DeepSeek-V4-Flash-Vision-Exp (`deepseek-v4-flash-vision-exp`) | preview | 2026-08-21 | 1.0M | $0.44 | $1.32 | V4-Flash MoE backbone with vision encoder (384 img-tokens) | Low-cost multimodal vision understanding, agents | prev: deepseek-v4-flash |
| DeepSeek-V4-Flash (`deepseek-v4-flash`) | preview | 2026-07-31 | 1.0M | $0.44 | $1.32 | Sparse MoE with hybrid thinking/non-thinking modes | High-volume cost-efficient chat and agents | prev: deepseek-chat → superseded by: deepseek-v4-flash-0731 |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Gemini 3.7 Flash (`gemini-3.7-flash`) | ga | 2026-08-13 | 1.0M | $0.75 | $3.75 | Gemini 3 Flash-tier transformer (MoE) | High-throughput coding and agentic workflows | prev: gemini-3.6-flash |
...
| Gemini 3.6 Flash (`gemini-3.6-flash`) | ga | 2026-07-21 | 1.0M | $1.50 | $7.50 | Natively multimodal reasoning model | General-purpose workhorse across coding and multimodal | prev: gemini-2.5-flash → superseded by: gemini-3.7-flash |
...
| Gemma 3 27B Instruct (`gemma-3-27b-it`) | ga | 2025-03-12 | 131K | — | — | dense decoder-only transformer with sliding-window + global attention; SigLIP vision encoder on 4B/12B/27B | Open-weights multimodal deployment | prev: gemma-2-27b-it → superseded by: gemma-4 |
...
| Gemini 3.1 Pro (`gemini-3.1-pro-preview`) | preview | 2026-02-19 | 1.0M | $2.00 | $12.00 | Natively multimodal reasoning model | Complex reasoning, agentic coding, long-horizon workflows | prev: gemini-3-pro-preview → superseded by: gemini-3.1-pro |
...
| Llama Guard 4 12B (`meta-llama/Llama-Guard-4-12B`) | ga | 2025-04-29 | 164K | $0.20 | $0.20 | Dense transformer decoder — 12B, safety classifier fine-tune | Input/output safety classification for LLM pipelines, multimodal | prev: meta-llama/Llama-Guard-3-8B |
...
| Llama 4 Maverick (`llama-4-maverick-17b-128e-instruct`) | ga | 2025-04-05 | 1M | $0.20 | $0.60 | Sparse MoE — 400B total / 17B active, 128 experts | General multimodal assistant with strong reasoning | prev: llama-3.3-70b-instruct → superseded by: meta-llama/Llama-4-Maverick-17B-128E-Instruct |
...
| Llama 4 Scout (`llama-4-scout-17b-16e-instruct`) | ga | 2025-04-05 | 10M | $0.11 | $0.34 | Sparse MoE — 109B total / 17B active, 16 experts | Very long context multimodal at low cost | prev: llama-3.3-70b-instruct → superseded by: meta-llama/Llama-4-Scout-17B-16E-Instruct |
...
| Llama 3.3 70B Instruct (`llama-3.3-70b-instruct`) | ga | 2024-12-06 | 131K | — | — | Dense decoder-only transformer, 70B parameters | Dense open-weight 70B text model, cheap to serve | prev: llama-3.1-70b-instruct → superseded by: llama-4-scout-17b-16e-instruct |
...
| Phi-4-reasoning-vision-15B (`microsoft/Phi-4-reasoning-vision-15B`) | ga | 2026-03-04 | 33K | — | — | 15B-parameter dense transformer with vision encoder, chain-of-thought post-training | Open-weight multimodal chain-of-thought on charts and diagrams | prev: microsoft/Phi-4-multimodal-instruct |
...
| Phi-4-reasoning (`phi-4-reasoning`) | ga | 2025-04-30 | 33K | — | — | 14B dense transformer, SFT + RL for reasoning | Small open-weights model with chain-of-thought reasoning | prev: phi-4 |
...
| Phi-4-mini (`microsoft/Phi-4-mini-instruct`) | ga | 2025-02-26 | 131K | $0.07 | $0.23 | 3.8B parameter dense decoder-only Transformer | Cheap on-device / edge text and function-calling | prev: microsoft/Phi-3.5-mini-instruct |
...
| Phi-4 (`phi-4`) | ga | 2024-12-12 | 16K | $0.12 | $0.50 | 14B dense decoder-only transformer | Small dense model for reasoning-heavy text tasks | prev: phi-3.5 → superseded by: phi-4-reasoning |
| Phi-4 (`microsoft/phi-4`) | ga | 2024-12-12 | 16K | $0.12 | $0.50 | 14.7B dense decoder-only transformer trained on synthetic + filtered web data | Cost-efficient reasoning and math for a 14B open model | prev: microsoft/Phi-3-medium-128k-instruct → superseded by: microsoft/Phi-4-reasoning-plus |
...
| MAI-Thinking-1 (`mai-thinking-1`) | preview | 2026-06-02 | 256K | $2.00 | $8.00 | Mixture-of-experts, 35B active / ~1T total parameters, trained from scratch on licensed data | Enterprise reasoning, math, and coding at scale | prev: mai-1-preview |
...
| MAI-Voice-1 (`mai-voice-1`) | preview | 2025-08-28 | — | $22.00 | $22.00 | Microsoft AI in-house neural speech-generation model | High-quality neural TTS in Copilot and Foundry | → superseded by: mai-voice-2 |
...
| Mistral Medium 3.5 (`mistral-medium-latest`) | ga | 2026-04-29 | 262K | $1.50 | $7.50 | 128B dense multimodal transformer | Unified chat, reasoning, coding, and vision workhorse | prev: mistral-medium-2508 |
...
| Mistral Medium 3.5 (`mistral-medium-2604`) | ga | 2026-04-29 | 262K | $1.50 | $7.50 | 128B dense transformer | Balanced mid-tier with configurable reasoning | prev: mistral-medium-2508 |
| Mistral Small 4 (`mistral-small-latest`) | ga | 2026-03-16 | 262K | $0.15 | $0.60 | mixture-of-experts, 119B total / ~6B active parameters (128 experts, 4 active) | High-throughput unified small model for production | prev: mistral-small-2506 |
| Mistral Small 4 (`mistral-small-2603`) | ga | 2026-03-16 | 262K | $0.15 | $0.60 | Sparse mixture-of-experts, 119B total / 6.5B active | High-throughput agents with optional reasoning | prev: mistral-small-2506 |
...
| Mistral Large 3 (`mistral-large-latest`) | ga | 2025-12-02 | 262K | $0.50 | $1.50 | sparse mixture-of-experts, 675B total / 41B active parameters | Flagship multimodal reasoning and agentic workflows | prev: mistral-large-2411 |
...
| Mistral Large 3 (`mistral-large-2512`) | ga | 2025-12-02 | 262K | $0.50 | $1.50 | Sparse mixture-of-experts, 675B total / 41B active | Flagship agentic and multimodal enterprise workloads | prev: mistral-large-2411 |
...
| Magistral Medium 1.2 (`magistral-medium-2509`) | ga | 2025-09-18 | 131K | $2.00 | $5.00 | Dense transformer tuned for reasoning with tokenized thinking chunks | Transparent multilingual chain-of-thought reasoning | prev: magistral-medium-2507 → superseded by: mistral-medium-2604 |
...
| Codestral 2508 (`codestral-2508`) | ga | 2025-08-01 | 256K | $0.30 | $0.90 | Code-specialized transformer | Low-latency code completion and fill-in-the-middle | prev: codestral-2501 |
...
| Magistral Medium (`magistral-medium-2506`) | deprecated | 2025-06-10 | 41K | $2.00 | $5.00 | — | Chain-of-thought reasoning for legal, finance, and research | → superseded by: magistral-medium-2509 |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K3 (`kimi-k3`) | ga | 2026-07-16 | 1.0M | $3.00 | $15.00 | Sparse MoE (Stable LatentMoE) — 2.8T total / ~104B active, 896 experts with 16 selected per token, Kimi Delta Attention | Frontier multimodal reasoning, long-horizon coding, agentic workflows | prev: kimi-k2-thinking |
| Kimi K2.7 Code (`kimi-k2.7-code`) | ga | 2026-06-12 | 262K | $0.95 | $4.00 | Sparse MoE — 1T total / 32B active, 384 experts | Long-horizon agentic coding workflows | prev: kimi-k2.6 |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262K | $0.95 | $4.00 | Sparse MoE — 1T total / 32B active, 384 experts, 8 selected + 1 shared | General-purpose multimodal agent with thinking mode | prev: kimi-k2-thinking → superseded by: kimi-k3 |
| Kimi K2.5 (`kimi-k2.5`) | ga | 2026-01-27 | 262K | $0.60 | $3.00 | Mixture-of-Experts, 1T total parameters, ~32B active, continued pretraining over ~15T mixed visual+text tokens | Budget multimodal reasoning and agentic tool-calling | prev: kimi-k2-thinking → superseded by: kimi-k2.6 |
| Kimi K2 Thinking (`kimi-k2-thinking`) | ga | 2025-11-06 | 262K | $0.60 | $2.50 | Sparse MoE — 1T total / 32B active per token, 384 experts, MLA attention | Agentic reasoning with hundreds of sequential tool calls | prev: kimi-k2-0905-preview → superseded by: kimi-k2.6 |
...
| Moonshot v1 128K (`moonshot-v1-128k`) | deprecated | 2024-01-31 | 131K | $2.00 | $5.00 | — | Legacy long-context chat completions before sunset | prev: moonshot-v1-32k → superseded by: kimi-k3 |
...
| Nemotron 3 Ultra (`nvidia/NVIDIA-Nemotron-3-Ultra-550B-A55B-BF16`) | ga | 2026-06-04 | 1M | — | — | Hybrid Mamba-2 + Attention + Latent MoE (550B total, 55B active) | Frontier agentic reasoning and long-context orchestration | prev: nvidia/Llama-3_1-Nemotron-Ultra-253B-v1 |
...
| Nemotron 3 Nano Omni (`nvidia/Nemotron-3-Nano-Omni-30B-A3B-Reasoning-BF16`) | ga | 2026-04-28 | 300K | — | — | Hybrid Mamba-Transformer MoE + C-RADIOv4-H vision + Parakeet-TDT audio encoders | Unified multimodal document, video and audio agents | prev: nvidia/NVIDIA-Nemotron-Nano-VL-8B-v2 |
...
| Nemotron 3 Super (`nvidia/NVIDIA-Nemotron-3-Super-120B-A12B-BF16`) | ga | 2026-03-11 | 1M | — | — | Hybrid Mamba-2 + Attention + Latent MoE (120B total, 12B active) | High-throughput agentic reasoning on single node | prev: nvidia/llama-3.3-nemotron-super-49b-v1 |
...
| Nemotron 3 Nano (`nvidia/NVIDIA-Nemotron-3-Nano-30B-A3B-BF16`) | ga | 2025-12-15 | 1M | — | — | Hybrid Mamba-2 + Attention + MoE (30B total, ~3B active) | Efficient on-device and edge agentic reasoning | prev: nvidia/Llama-3.1-Nemotron-Nano-8B-v1 |
...
| Nemotron Nano 9B V2 (`nvidia/nvidia-nemotron-nano-9b-v2`) | ga | 2025-08-18 | 131K | $0.04 | $0.16 | Hybrid Mamba-Transformer | Dense small-model reasoning with thinking budget control | → superseded by: nvidia/nemotron-3-nano-30b-a3b |
...
| GPT-5.6 Luna (`gpt-5.6-luna`) | ga | 2026-07-09 | 1.1M | $0.20 | $1.20 | Reasoning model, shared GPT-5.6 family stack | High-volume, latency-sensitive chat and classification | prev: gpt-5.4-nano |
| GPT-5.6 Sol (`gpt-5.6-sol`) | ga | 2026-07-09 | 1.1M | $5.00 | $30.00 | Reasoning model with optional max and ultra multi-agent modes | Frontier reasoning, agentic coding, deep research | prev: gpt-5.5 |
| GPT-5.6 Terra (`gpt-5.6-terra`) | ga | 2026-07-09 | 1.1M | $2.00 | $12.00 | Reasoning model, shared GPT-5.6 family stack | Balanced everyday coding, reasoning, and agentic work | prev: gpt-5.4 |
...
| GPT-5.5 Pro (`gpt-5.5-pro`) | ga | 2026-04-23 | 1.1M | $30.00 | $180.00 | Reasoning model tuned for deep deliberation | eval-proven cases where Sol underperforms | prev: gpt-5-pro → superseded by: gpt-5.6-sol |
...
| o3-pro (`o3-pro`) | ga | 2025-06-10 | 200K | $20.00 | $80.00 | — | Maximum-accuracy reasoning for evaluation-proven lifts | prev: o3 → superseded by: gpt-5.6-sol |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Sonar Reasoning Pro (`sonar-reasoning-pro`) | ga | 2025-03-07 | 128K | $2.00 | $8.00 | DeepSeek-R1 based with Perplexity search grounding | Chain-of-thought reasoning with live web search | prev: sonar-reasoning → superseded by: agent-api |
| Sonar Deep Research (`sonar-deep-research`) | ga | 2025-02-14 | 128K | $2.00 | $8.00 | Agentic research pipeline over Perplexity search + reasoning LLM | Autonomous multi-step research reports | → superseded by: agent-api |
| Sonar (`sonar`) | ga | 2025-02-11 | 128K | $1.00 | $1.00 | In-house fine-tune based on Llama 3.3 70B with retrieval | Fast web-grounded answers with citations | prev: llama-3.1-sonar-small-128k-online → superseded by: agent-api |
| Sonar Pro (`sonar-pro`) | ga | 2025-01-21 | 200K | $3.00 | $15.00 | Perplexity search-tuned LLM with enhanced retrieval pipeline | In-depth multi-step search with citations | prev: llama-3.1-sonar-large-128k-online → superseded by: agent-api |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Grok 4.6 (`grok-4.6`) | ga | 2026-08-12 | 500K | $2.00 | $6.00 | Dense/MoE transformer with configurable reasoning effort | Frontier reasoning, coding, agentic knowledge work | prev: grok-4.5 |
...
| Grok 4.5 (`grok-4.5`) | ga | 2026-07-08 | 500K | $2.00 | $6.00 | Mixture-of-Experts transformer | Agentic coding and software engineering workflows | prev: grok-4.3 → superseded by: grok-4.6 |
...
| Grok 4.3 (`grok-4.3`) | ga | 2026-04-30 | 1M | $1.25 | $2.50 | Reasoning-first transformer with prompt caching | large 1M-context reasoning at mid price | prev: grok-4 → superseded by: grok-4.5 |
