...
_Last refreshed: 2026-07-14 by genai-model-catalog routine._
...
| Qwen3.7-Max (`qwen3.7-max`) | ga | 2026-05-19 | 1M | $2.50 | $7.50 | Reasoning agent model | Flagship reasoning and agentic tasks | prev: `qwen3-max` |
...
| Qwen3.5-Omni-Flash (`qwen3.5-omni-flash`) | ga | 2026-03-30 | 262.144K | $0.10 | $0.80 | Thinker-Talker MoE 30B total / 3B active with Hybrid-Atte… | Real-time omni-modal input with speech output | prev: `qwen3-omni-30b-a3b` |
...
| Qwen3-VL-Max (`qwen-vl-max`) | ga | 2025-09-23 | 131.072K | $0.52 | $2.08 | Multimodal vision-language | Advanced vision-language understanding | — |
| Qwen3-VL-Plus (`qwen3-vl-plus`) | ga | 2025-09-23 | 262.144K | $0.20 | $1.60 | MoE 235B total / 22B active with Interleaved-MRoPE and De… | Document, chart, and GUI visual understanding | prev: `qwen-vl-plus` → superseded by: `qwen3.7-plus` |
| Qwen3-Max (`qwen3-max`) | ga | 2025-09-05 | 262.144K | $0.78 | $3.90 | Mixture-of-experts | General-purpose flagship instruction-following | prev: `qwen2.5-max` → superseded by: `qwen3.7-max` |
...
| Nova 2 Lite (`amazon.nova-2-lite-v1:0`) | ga | 2025-12-02 | 1M | $0.30 | $2.50 | Multimodal foundation model | Fast cost-effective reasoning for everyday workloads | prev: `amazon.nova-lite-v1:0` |
| Nova Premier (`amazon.nova-premier-v1:0`) | ga | 2025-10-31 | 1M | $2.50 | $12.50 | Multimodal foundation model | Complex reasoning and model distillation | prev: `amazon.nova-pro-v1:0` → superseded by: `amazon.nova-2-pro-v1:0` |
...
| Nova Micro (`amazon.nova-micro-v1:0`) | ga | 2024-12-03 | 128K | $0.035 | $0.14 | Text-only foundation model | Ultra-low-cost text-only workloads | → superseded by: `amazon.nova-2-lite-v1:0` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Claude Sonnet 5 (`claude-sonnet-5`) | ga | 2026-06-30 | 1M | $2.00 | $10.00 | Transformer with extended thinking | Balanced production workhorse | prev: `claude-sonnet-4-6` |
| Claude Fable 5 (`claude-fable-5`) | ga | 2026-06-09 | 1M | $10.00 | $50.00 | Transformer with extended thinking | Frontier long-horizon agentic reasoning | prev: `claude-opus-4-8` |
| Claude Opus 4.8 (`claude-opus-4-8`) | ga | 2026-05-28 | 1M | $5.00 | $25.00 | Transformer with extended thinking | Complex reasoning and long-running agent tasks | prev: `claude-opus-4-7` → superseded by: `claude-fable-5` |
...
| Claude Haiku 4.5 (`claude-haiku-4-5`) | ga | 2025-10-15 | 200K | $1.00 | $5.00 | Transformer | Cheap, fast text and vision workloads | prev: `claude-haiku-3-5` |
...
| North Mini Code (`north-mini-code-1.0`) | ga | 2026-06-09 | 256K | $0 | $0 | Sparse Mixture-of-Experts, 3B active / 30B total paramete… | Local and terminal-based agentic coding | — |
| Command A+ (`command-a-plus-05-2026`) | ga | 2026-05-20 | 128K | $2.50 | $10.00 | Sparse Mixture-of-Experts, 25B active / 218B total parame… | Sovereign agentic workflows with vision and multilingual | prev: `command-a-reasoning-08-2025` |
...
| Command A (`command-a-03-2025`) | ga | 2025-03-13 | 256K | $2.50 | $10.00 | Dense 111B transformer | High-throughput enterprise text tasks | prev: `command-r-plus-08-2024` → superseded by: `command-a-plus` |
| Command R7B (`command-r7b-12-2024`) | ga | 2024-12-13 | 128K | $0.0375 | $0.15 | Dense 7B transformer | Low-cost small-footprint deployments | — |
| Command R+ (`command-r-plus-08-2024`) | ga | 2024-08-30 | 128K | $2.50 | $10.00 | Dense transformer | Legacy retrieval-augmented generation | prev: `command-r-plus-04-2024` → superseded by: `command-a-03-2025` |

## DeepSeek

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DeepSeek V4 Flash (`deepseek-v4-flash`) | ga | 2026-04-22 | 1M | $0.14 | $0.28 | Mixture-of-Experts with Hybrid Attention, 13B active / 28… | Cheap high-throughput reasoning with 1M context | prev: `deepseek-chat` |
| DeepSeek V4 Pro (`deepseek-v4-pro`) | ga | 2026-04-22 | 1M | $0.43 | $0.87 | Mixture-of-Experts with Hybrid Attention (CSA+HCA), 49B a… | Frontier-tier open-weight reasoning and agentic coding | prev: `deepseek-v3.2` |
...
| Gemini 3.5 Flash (`gemini-3.5-flash`) | ga | 2026-05-19 | 1.04858M | $1.50 | $9.00 | Multimodal transformer | Fast, cheap agentic and coding workloads | prev: `gemini-3-flash` |
...
| Gemini 3.1 Flash-Lite (`gemini-3.1-flash-lite`) | preview | 2026-03-03 | 1.04858M | $0.25 | $1.50 | Multimodal transformer | Ultra-cheap high-volume classification and extraction | prev: `gemini-2.5-flash-lite` |
...
| Gemini 3.1 Pro (Preview) (`gemini-3.1-pro-preview`) | preview | 2026-02-19 | 1M | $2.00 | $12.00 | Sparse mixture-of-experts transformer with thinking | Complex reasoning, agentic workflows, long context | prev: `gemini-3-pro-preview` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Llama 4 Maverick (`llama-4-maverick`) | ga | 2025-04-05 | 1M | $0.19 | $0.60 | MoE, 17B active / ~400B total parameters, 128 routed expe… | Open-weight flagship for coding and multimodal tasks | prev: `llama-3.3-70b` → superseded by: `muse-spark-1.1` |
| Llama 4 Maverick (`llama-4-maverick-17b-128e`) | ga | 2025-04-05 | 1M | $0.19 | $0.60 | MoE, 17B active / ~400B total parameters, 128 routed expe… | Open-weight flagship multimodal chat, coding, and agents | prev: `llama-3.3-70b` |
...
| Llama 4 Scout (`llama-4-scout-17b-16e`) | ga | 2025-04-05 | 10M | $0.08 | $0.30 | MoE, 17B active / ~109B total parameters, 16 experts, nat… | Long-context document analysis and multimodal serving on a single GPU | prev: `llama-3.3-70b` |
...
| Muse Spark 1.1 (`muse-spark-1.1`) | preview | 2026-07-09 | 1M | $1.25 | $4.25 | Natively multimodal reasoning model with agentic multi-ag… | Agentic multimodal reasoning with tool and computer use | prev: `muse-spark` |
| Llama 4 Behemoth (`llama-4-behemoth`) | preview | — | — | — | — | MoE with ~2T total parameters, 288B active, 16 experts, n… | Teacher / distillation model for Llama 4 herd | prev: `llama-3.1-405b` → superseded by: `muse-spark-1.1` |
| Muse Spark (`muse-spark`) | deprecated | 2026-04-08 | 262.144K | — | — | Natively multimodal early-fusion frontier model (active/t… | First-generation Meta Superintelligence Labs frontier reasoning model (legacy) | prev: `llama-4-maverick-17b-128e` → superseded by: `muse-spark-1.1` |
...
| Phi-4-Reasoning-Vision-15B (`phi-4-reasoning-vision-15b`) | ga | 2026-03-04 | 16.384K | — | — | 15B multimodal reasoning SLM | structured multi-step visual reasoning at 15B scale | prev: `phi-4-reasoning` |
...
| Phi-4 (`phi-4`) | ga | 2024-12-12 | 16.384K | $0.065 | $0.14 | 14B dense transformer | complex reasoning in a small dense model | prev: `phi-3.5` → superseded by: `phi-4-reasoning` |
| MAI-Code-1-Flash (`mai-code-1-flash`) | preview | 2026-06-02 | 262.144K | $0.75 | $4.50 | Sparse Mixture-of-Experts, 137B total / ~5B active | fast, cheap coding inside Copilot workflows | — |
...
| MAI-Thinking-1 (`mai-thinking-1`) | preview | 2026-06-02 | 262.144K | — | — | 35B active parameters | frontier reasoning and multi-step problem solving | prev: `mai-1-preview` |
...
| Mistral Medium 3.5 (`mistral-medium-2604`) | ga | 2026-04-29 | 262.144K | $1.50 | $7.50 | Dense transformer, 128B parameters, native multimodal vis… | Enterprise agentic workflows, coding and complex multi-step reasoning | prev: `mistral-medium-2508` |
| Mistral Small 4 (`mistral-small-2603`) | ga | 2026-03-16 | 262K | $0.15 | $0.60 | Sparse Mixture-of-Experts, 6B active / 119B total | Unified reasoning, coding, and vision at throughput price | prev: `mistral-small-2503` |
| Devstral 2 (`devstral-2512`) | ga | 2025-12-09 | 262.144K | $0.40 | $0.90 | Dense 123B transformer optimized for agentic coding | Agentic coding - multi-file edits and long-running coding agents | prev: `devstral-medium-2507` |
| Devstral Small 2 (`devstral-small-2-2512`) | ga | 2025-12-09 | 262.144K | $0.10 | $0.30 | Dense 24B transformer | Local, on-device agentic coding on a single consumer GPU | prev: `devstral-small-2507` |
| Mistral Large 3 (`mistral-large-2512`) | ga | 2025-12-02 | 256K | $2.00 | $6.00 | Granular Mixture-of-Experts, 41B active / 675B total | Flagship multimodal reasoning and enterprise workloads | prev: `mistral-large-2411` |
| Magistral Medium 1.2 (`magistral-medium-2509`) | ga | 2025-09-18 | 131.072K | $2.00 | $5.00 | Dense transformer reasoning model with vision encoder, cl… | Transparent multilingual chain-of-thought reasoning with vision | prev: `magistral-medium-2507` → superseded by: `mistral-medium-2604` |
| Codestral 25.08 (`codestral-2508`) | ga | 2025-07-30 | 256K | $0.30 | $0.90 | Dense transformer optimized for code (parameter count not… | Low-latency code completion with fill-in-the-middle | prev: `codestral-2501` |
...
| Leanstral 1.5 (`leanstral-1-5`) | preview | 2026-06-30 | 262.144K | $0 | $0 | Sparse Mixture-of-Experts (~6.5B active / 119B total, 128… | Lean 4 formal proof engineering, automated theorem proving, and autoformalization | prev: `leanstral` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K2.7 Code (`kimi-k2.7-code`) | ga | 2026-06-12 | 262.144K | $0.95 | $4.00 | Mixture-of-Experts | agentic coding and long-horizon software tasks | prev: `kimi-k2.6` |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262.144K | $0.95 | $4.00 | Mixture-of-Experts, multimodal | long-horizon coding and multi-agent orchestration | prev: `kimi-k2.5` → superseded by: `kimi-k2.7-code` |
| Kimi K2.5 (`kimi-k2.5`) | ga | 2026-01-27 | 262.144K | $0.60 | $2.50 | Mixture-of-Experts, 1T total / 32B active, 384 experts | cost-efficient frontier open-weights multimodal | prev: `kimi-k2` → superseded by: `kimi-k2.6` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Nemotron 3 Ultra 550B-A55B (`nvidia/nemotron-3-ultra-550b-a55b`) | ga | 2026-06-04 | 1M | $0.50 | $2.20 | Hybrid Mamba-2 + Transformer Latent Mixture-of-Experts wi… | Frontier open reasoning and long-running agentic workflows | prev: `nvidia/llama-3_1-nemotron-ultra-253b-v1` |
...
| Nemotron 3.5 Content Safety (`nvidia/nemotron-3.5-content-safety`) | ga | 2026-06-04 | 128K | $0 | $0 | Gemma 3 4B IT fine-tuned (LoRA merged) for multimodal saf… | Multimodal multilingual content safety moderation | — |
| Nemotron 3 Nano Omni 30B-A3B Reasoning (`nvidia/nemotron-3-nano-omni-30b-a3b-reasoning`) | ga | 2026-04-28 | 256K | $0.07 | $0.30 | Hybrid Mamba-2 + Transformer MoE with unified vision/audi… | Unified multimodal agent perception across text, image, audio, and video | prev: `nvidia/nemotron-3-nano-30b-a3b` |
...
| Nemotron 3 Super 120B A12B (`nvidia/nemotron-3-super-120b-a12b`) | ga | 2026-03-11 | 1M | $0.15 | $0.65 | Hybrid Mamba-Transformer LatentMoE (120B total, 12B active) | Agentic reasoning at 1M context with efficient MoE | prev: `nvidia/llama-3.1-nemotron-ultra-253b-v1` |
| Nemotron 3 Nano 30B A3B (`nvidia/nemotron-3-nano-30b-a3b`) | ga | 2025-12-15 | 1M | $0.05 | $0.20 | Hybrid Mamba-2 + MoE (30B total, 3.5B active) | High-throughput multi-agent workloads | prev: `nvidia/nvidia-nemotron-nano-9b-v2` |
...
| Llama-3.3 Nemotron Super 49B v1.5 (`nvidia/llama-3_3-nemotron-super-49b-v1_5`) | ga | 2025-07-25 | 128K | — | — | Dense transformer derived from Meta Llama-3.3-70B-Instruc… | Reasoning and agentic RAG on Llama-derived architecture | prev: `nvidia/llama-3_3-nemotron-super-49b-v1` → superseded by: `nvidia/nemotron-3-super-120b-a12b` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| GPT-5.6 Luna (`gpt-5.6-luna`) | ga | 2026-07-09 | 1.05M | $1.00 | $6.00 | Transformer reasoning model | High-volume, cost-sensitive workloads | prev: `gpt-5.4-mini` |
| GPT-5.6 Sol (`gpt-5.6-sol`) | ga | 2026-07-09 | 1.05M | $5.00 | $30.00 | Transformer reasoning model | Frontier reasoning, coding, and agentic workflows | prev: `gpt-5.5` |
| GPT-5.6 Terra (`gpt-5.6-terra`) | ga | 2026-07-09 | 1.05M | $2.50 | $15.00 | Transformer reasoning model | Balanced everyday production workloads | prev: `gpt-5.5` |
...
| GPT-5.5 (`gpt-5.5`) | ga | 2026-04-24 | 1M | $5.00 | $30.00 | Transformer reasoning model | General-purpose flagship reasoning (prior gen) | prev: `gpt-5` → superseded by: `gpt-5.6-sol` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Sonar Pro Search (`sonar-pro-search`) | ga | 2025-10-30 | 200K | $3.00 | $15.00 | Search-grounded agentic LLM with multi-step tool use buil… | Agentic multi-step search with tool use | prev: `sonar-pro` |
| Sonar Deep Research (`sonar-deep-research`) | ga | 2025-03-07 | 128K | $2.00 | $8.00 | search-augmented deep research agent | multi-step retrieval and synthesized research reports | — |
| Sonar Reasoning Pro (`sonar-reasoning-pro`) | ga | 2025-03-07 | 128K | $2.00 | $8.00 | search-augmented reasoning LLM | chain-of-thought analysis with live search | prev: `sonar-reasoning` |
| Sonar (`sonar`) | ga | 2025-01-21 | 128K | $1.00 | $1.00 | search-augmented LLM | affordable fast search-augmented answers | — |
| Sonar Pro (`sonar-pro`) | ga | 2025-01-21 | 200K | $3.00 | $15.00 | search-augmented LLM | search-grounded factual answers with citations | prev: `sonar` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Grok 4.5 (`grok-4.5`) | ga | 2026-07-08 | 500K | $2.00 | $6.00 | V9 ninth-generation foundation model (~1.5T parameters), … | frontier coding, agentic engineering, and knowledge work | prev: `grok-4.3` |
| Grok 4.5 (`grok-4-5`) | ga | 2026-07-08 | 500K | $2.00 | $6.00 | — | Frontier coding, agentic tasks and knowledge work | prev: `grok-4.3` |
...
| Grok 4.3 (`grok-4-3`) | ga | 2026-04-30 | 1M | $1.25 | $2.50 | — | Mainstream production workloads with 1M context | prev: `grok-4-0709` → superseded by: `grok-4-5` |
