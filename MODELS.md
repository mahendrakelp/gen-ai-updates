...
_Last refreshed: 2026-06-25 by genai-model-catalog routine._

_Total models tracked: 109 across 14 providers._
...
| Qwen3-VL-Plus (`qwen3-vl-plus`) | ga | 2025-09-23 | 262.144K | $0.20 | $1.60 | Vision-language MoE (235B-A22B and dense 2B/4B/8B/32B variants) | Affordable multimodal understanding across image and video | prev: `qwen2.5-vl` → superseded by: `qwen3.7-plus` |
...
| Gemini 3.5 Pro (`gemini-3.5-pro-preview`) | preview | 2026-05-20 | 2.09715M | — | — | — | Frontier reasoning, deep multimodal, very long context | prev: `gemini-3.1-pro-preview` |
...
| Gemini 2.5 Pro (`gemini-2.5-pro`) | deprecated | 2025-06-17 | 1.04858M | $1.25 | $10.00 | Sparse mixture-of-experts transformer | Legacy long-context reasoning workloads | prev: `gemini-1.5-pro` → superseded by: `gemini-3.1-pro-preview` |

## Meta

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Llama 4 Maverick (`llama-4-maverick`) | ga | 2025-04-05 | 1.04858M | $0.17 | $0.60 | Mixture-of-Experts (400B total, 17B active, 128 routed + 1 shared expert) | High-quality open multimodal chat and vision | prev: `llama-3.3-70b` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Phi-4-reasoning-vision-15B (`phi-4-reasoning-vision-15b`) | ga | 2026-03-04 | 16.384K | — | — | Phi-4-Reasoning backbone with SigLIP-2 vision encoder, mid-fusion | Open multimodal reasoning at compact size | prev: `phi-4-reasoning` |
...
| Phi-4-reasoning-plus (`phi-4-reasoning-plus`) | ga | 2025-04-30 | 32.768K | — | — | Dense decoder-only transformer (14B params), fine-tuned from Phi-4 | Open-weight reasoning for math and science | prev: `phi-4` → superseded by: `phi-4-reasoning-vision-15b` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K2.7 Code (`kimi-k2.7-code`) | ga | 2026-06-12 | 262.144K | $0.95 | $4.00 | Sparse MoE - 1T total / 32B active, 384 experts, MoonViT vision encoder (inherited from K2.6) | Long-horizon agentic coding and software engineering | prev: `kimi-k2.6` |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262.144K | $0.95 | $4.00 | Sparse MoE - 1T total / 32B active, 384 experts (8+1 shared), 61 layers, MLA, MoonViT vision encoder | Open-weight agentic coding and tool use | prev: `kimi-k2.5` → superseded by: `kimi-k2.7-code` |
| Kimi K2.5 (`kimi-k2.5`) | ga | 2026-01-26 | 262.144K | $0.60 | $3.00 | Sparse MoE - 1T total / 32B active, 384 experts, MoonViT vision encoder | Cost-efficient open-weight multimodal agent | prev: `kimi-k2-thinking` → superseded by: `kimi-k2.6` |
...
| Nemotron 3 Nano 4B (`nvidia/nemotron-3-nano-4b`) | ga | 2026-03-17 | 262.144K | — | — | Hybrid Mamba-2 + MLP with 4 attention layers (dense, ~3.97B params, compressed from Nano 9B v2) | Edge and on-device agentic AI on Jetson and RTX | prev: `nvidia/nvidia-nemotron-nano-9b-v2` |
...
| gpt-oss-120b (`gpt-oss-120b`) | ga | 2025-08-05 | 131.072K | — | — | Mixture-of-Experts transformer (128 experts, 4 active per token; ~5.1B active / 117B total params) | Open-weight reasoning deployment on single GPU | — |
