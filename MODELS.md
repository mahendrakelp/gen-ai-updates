...
_Last refreshed: 2026-07-24 by genai-model-catalog routine._
...
| Qwen3.8-Max-Preview (`qwen3.8-max-preview`) | preview | 2026-07-19 | 983.6K | — | — | Sparse Mixture-of-Experts (2.4T total parameters, multimodal) | Frontier multimodal reasoning and long-context agentic workflows during preview | prev: qwen3.7-max |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DeepSeek V4 Flash (`deepseek-v4-flash`) | preview | 2026-04-24 | 1.0M | $0.14 | $0.28 | Sparse MoE - 284B total / 13B active, hybrid CSA+HCA attention | High-throughput, low-cost inference with reasoning | prev: deepseek-reasoner |
| DeepSeek V4 Pro (`deepseek-v4-pro`) | preview | 2026-04-24 | 1.0M | $0.43 | $0.87 | Sparse MoE - 1.6T total / 49B active, hybrid CSA+HCA attention | Frontier reasoning, agentic coding, long-context work | prev: deepseek-chat |
| DeepSeek Reasoner (legacy alias) (`deepseek-reasoner`) | deprecated | 2025-01-20 | 131.1K | $0.14 | $0.28 | Alias routing to deepseek-v4-flash thinking mode | Legacy compatibility routed to V4-Flash thinking mode | prev: deepseek-r1 → superseded by: deepseek-v4-flash |
| DeepSeek Chat (legacy alias) (`deepseek-chat`) | deprecated | 2024-12-26 | 131.1K | $0.14 | $0.28 | Alias routing to deepseek-v4-flash non-thinking mode | Legacy compatibility routed to V4-Flash non-thinking mode | prev: deepseek-v3.2 → superseded by: deepseek-v4-flash |

## Google

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Gemini 3.5 Flash-Lite (`gemini-3.5-flash-lite`) | ga | 2026-07-21 | 1.0M | $0.30 | $2.50 | Transformer-based Mixture-of-Experts | Low-cost high-throughput reasoning and long-context tasks | prev: gemini-3.1-flash-lite |
| Gemini 3.6 Flash (`gemini-3.6-flash`) | ga | 2026-07-21 | 1.0M | $1.50 | $7.50 | Transformer-based Mixture-of-Experts | Default agentic workhorse: coding, computer-use, spatial reasoning | prev: gemini-3.5-flash |
| Gemini 3.5 Flash (`gemini-3.5-flash`) | ga | 2026-05-19 | 1.0M | $1.50 | $9.00 | Transformer-based Mixture-of-Experts | High-throughput agentic and coding workloads | prev: gemini-3-flash-preview → superseded by: gemini-3.6-flash |
| Gemini 3.1 Flash-Lite (`gemini-3.1-flash-lite`) | ga | 2026-05-07 | 1.0M | $0.25 | $1.50 | Transformer-based Mixture-of-Experts | Cheapest 1M-context tier for extraction and light agents | prev: gemini-2.5-flash-lite → superseded by: gemini-3.5-flash-lite |
...
| Gemini 3.1 Pro (`gemini-3.1-pro-preview`) | preview | 2026-02-19 | 1.0M | $2.00 | $12.00 | Transformer-based Mixture-of-Experts | Frontier reasoning, complex agentic and multimodal tasks | prev: gemini-3-pro-preview |
...
| Llama 3.3 70B Instruct (`meta-llama/Llama-3.3-70B-Instruct`) | ga | 2024-12-06 | 131.1K | — | — | Dense transformer - 70B parameters | Cost-effective text generation and instruction following | prev: meta-llama/Llama-3.1-70B-Instruct → superseded by: meta-llama/Llama-4-Scout-17B-16E-Instruct |
| Muse Spark 1.1 (`muse-spark-1.1`) | preview | 2026-07-09 | 1.0M | $1.25 | $4.25 | Natively multimodal reasoning model, agentic tool-use optimized | Agentic multimodal reasoning with tool orchestration | prev: muse-spark |
...
| Mistral Medium 3.5 (`mistral-medium-latest`) | ga | 2026-04-29 | 262.1K | — | — | 128B dense transformer, multimodal (text + image inputs) | balanced merged model for reasoning, coding, and vision | prev: mistral-medium-2505 |
...
| Mistral Small 4 (`mistral-small-latest`) | ga | 2026-03-16 | 262.1K | $0.15 | $0.60 | 119B Mixture-of-Experts (6.5B active), multimodal (text + image) | cost-efficient multimodal reasoning and agentic coding | prev: mistral-small-2506 |
...
| Mistral Large 3 (`mistral-large-latest`) | ga | 2025-12-04 | 262.1K | $0.50 | $1.50 | 675B Mixture-of-Experts (41B active) with fused ~2.5B vision encoder | flagship agentic, multimodal, long-context enterprise workloads | prev: mistral-large-2411 |
...
| Magistral Small 1.2 (`magistral-small-latest`) | ga | 2025-09-18 | 131.1K | $0.50 | $1.50 | 24B dense transformer built on Mistral Small 3.2, SFT + RL for reasoning | open-weight chain-of-thought reasoning at 24B scale | prev: magistral-small-2507 |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K3 (`kimi-k3`) | ga | 2026-07-16 | 1.0M | $3.00 | $15.00 | MoE — ~2.8T total / ~32B active (16/896 experts, KDA + AttnRes) | Frontier long-horizon coding and agentic workflows | prev: kimi-k2.6 |
| Kimi K2.7 Code (`kimi-k2.7-code`) | ga | 2026-06-12 | 262.1K | $0.95 | $4.00 | MoE — 1T total / 32B active (384 experts) | Cost-efficient agentic coding and MCP tool use | prev: kimi-k2.6 |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262.1K | $0.95 | $4.00 | MoE — 1T total / 32B active (384 routed + 1 shared expert, 61 layers, MLA) | Open-weight agentic coding and multimodal tasks | prev: kimi-k2.5 → superseded by: kimi-k3 |
| Kimi K2.5 (`kimi-k2.5`) | ga | 2026-01-26 | 262.1K | $0.60 | $3.00 | MoE — 1T total / 32B active (384 experts, MLA) + 400M MoonViT vision encoder | Budget multimodal agentic and swarm workflows | prev: kimi-k2 → superseded by: kimi-k2.6 |
| Kimi K2 Thinking (`kimi-k2-thinking`) | deprecated | 2025-11-06 | 262.1K | $0.60 | $2.50 | Trillion-parameter Mixture-of-Experts, 32B activated params, reasoning-oriented | Legacy reasoning agent workloads (now superseded) | prev: kimi-k2 → superseded by: kimi-k3 |
...
| Nemotron 3 Nano 30B A3B (`nvidia/nemotron-3-nano-30b-a3b`) | ga | 2025-12-15 | 262.1K | $0.05 | $0.20 | Hybrid Mamba-2 + MoE Transformer (30B total / 3B active) | Cost-efficient small agent, debugging, and RAG tasks | prev: nvidia/llama-3_1-nemotron-nano-8b-v1 |
...
| Llama 3.3 Nemotron Super 49B V1.5 (`nvidia/llama-3_3-nemotron-super-49b-v1_5`) | ga | 2025-10-10 | 131.1K | $0.10 | $0.40 | Dense 49B transformer derived from Llama-3.3-70B-Instruct via Puzzle Neural Architecture Search (variable FFN widths, replaced attention blocks) | Balanced reasoning/chat and agentic workflows (RAG, tool calling) where single-GPU H100/H200 deployment and reliable tool use matter | prev: nvidia/llama-3.3-nemotron-super-49b-v1 → superseded by: nvidia/nemotron-3-super-120b-a12b |
...
| gpt-oss-120b (`gpt-oss-120b`) | ga | 2025-08-05 | 131.1K | $0.03 | $0.15 | Mixture-of-experts transformer, 117B total parameters with configurable reasoning tiers | Self-hosted open-weights reasoning on a single 80GB GPU | — |
...
| Sonar (`sonar`) | ga | 2025-01-21 | 127.1K | $1.00 | $1.00 | search-augmented LLM | Fast, cited web-grounded Q&A at low cost | — |
