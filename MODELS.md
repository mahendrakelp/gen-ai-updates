...
_Last refreshed: 2026-06-03 by genai-model-catalog routine._
...
| Qwen3.7-Plus (`qwen3.7-plus`) | preview | 2026-05-20 | 1M | $0.40 | $1.60 | Mixture-of-Experts (closed, multimodal) | Multimodal GUI agents and visual workflows | prev: qwen3-vl-plus |
...
| Gemini 3.1 Flash Lite (`gemini-3.1-flash-lite-preview`) | preview | 2026-03-03 | 1.0M | $0.25 | $1.50 | Distilled sparse mixture-of-experts | Highest-volume, cost-sensitive multimodal tasks | prev: gemini-2.5-flash-lite |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Llama 4 Maverick (`llama-4-maverick`) | ga | 2025-04-05 | 1.0M | $0.15 | $0.60 | MoE, 17B active / 400B total, 128 experts, early-fusion multimodal | Flagship open-weight multimodal MoE | prev: llama-3.3-70b |
...
| Llama 3.1 Nemotron Ultra 253B v1 (`nvidia/llama-3.1-nemotron-ultra-253b-v1`) | deprecated | 2025-04-07 | 131.1K | $0.60 | $1.80 | Dense transformer derived from Llama 3.1 405B via Neural Architecture Search | Reasoning, RAG, and tool-calling on Llama base | superseded by: nvidia/nemotron-3-ultra-500b-a50b |
