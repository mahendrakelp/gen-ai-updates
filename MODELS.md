...
_Last refreshed: 2026-09-17 by genai-model-catalog routine._
...
| Qwen3.8-Max (`qwen3.8-max`) | ga | 2026-08-03 | 1M | $2.00 | $6.00 | MoE 2.4T total / 95B active, 92 layers, hidden 8192 | Flagship coding, agentic workflows, long-context reasoning | prev: qwen3-max |
...
| Qwen3-Max (`qwen3-max`) | ga | 2025-09-23 | 262.1K | $0.78 | $3.90 | Mixture-of-Experts (MoE) | Flagship general-purpose reasoning and agentic tasks | prev: qwen2.5-max → superseded by: qwen3.7-max |
...
| Nova 2 Lite (`amazon.nova-2-lite-v1:0`) | ga | 2025-12-02 | 1M | $0.30 | $2.50 | Multimodal reasoning foundation model with adjustable thinking | Fast cost-effective everyday reasoning workloads | prev: amazon.nova-lite-v1:0 |
...
| Amazon Nova Lite (`amazon.nova-lite-v1:0`) | ga | 2024-12-03 | 300K | $0.06 | $0.24 | transformer | Fast, low-cost multimodal understanding | superseded by: amazon.nova-2-lite-v1:0 |
| Amazon Nova Micro (`amazon.nova-micro-v1:0`) | ga | 2024-12-03 | 128K | $0.04 | $0.14 | Text-only transformer foundation model | Low-latency, low-cost text-only tasks | superseded by: amazon.nova-2-lite-v1:0 |
| Nova Pro (`amazon.nova-pro-v1:0`) | ga | 2024-12-03 | 300K | $0.80 | $3.20 | Multimodal understanding foundation model | General multimodal understanding at balanced cost | superseded by: amazon.nova-2-pro-v1:0 |
...
| Nova 2 Pro (`amazon.nova-2-pro-v1:0`) | preview | 2025-12-02 | 1M | $2.19 | $17.50 | Multimodal reasoning foundation model with extended thinking | Complex multi-step agentic reasoning and analysis | prev: amazon.nova-premier-v1:0 |
| Nova Premier (`amazon.nova-premier-v1:0`) | deprecated | 2025-04-30 | 1M | $2.50 | $12.50 | Multimodal understanding foundation model | Legacy flagship multimodal reasoning and distillation | prev: amazon.nova-pro-v1:0 → superseded by: amazon.nova-2-pro-v1:0 |
...
| Claude Opus 5 (`claude-opus-5`) | ga | 2026-07-24 | 1M | $5.00 | $25.00 | Adaptive-thinking transformer | Complex agentic coding and enterprise work | prev: claude-opus-4-8 |
| Claude Sonnet 5 (`claude-sonnet-5`) | ga | 2026-06-30 | 1M | $2.00 | $10.00 | Adaptive-thinking transformer with new tokenizer | Best balance of speed and intelligence | prev: claude-sonnet-4-6 |
...
| Claude Haiku 4.5 (`claude-haiku-4-5`) | ga | 2025-10-15 | 200K | $1.00 | $5.00 | Extended-thinking transformer | Fast, cheap near-frontier tasks at scale | prev: claude-haiku-3-5 |
...
| Command A+ (`command-a-plus-05-2026`) | ga | 2026-05-20 | 128K | $2.50 | $10.00 | Sparse Mixture-of-Experts, 218B total / 25B active, 128 experts | Enterprise agentic reasoning, vision, multilingual | prev: command-a-reasoning-08-2025 |
...
| Command A Reasoning (`command-a-reasoning-08-2025`) | ga | 2025-08-21 | 256K | $2.50 | $10.00 | Dense transformer, reasoning-tuned | Complex agentic reasoning and tool use | prev: command-a-03-2025 → superseded by: command-a-plus-05-2026 |
| Command A Vision (`command-a-vision-07-2025`) | ga | 2025-07-01 | 128K | $2.50 | $10.00 | Multimodal vision-language transformer | Enterprise document, chart, image understanding | prev: command-a-03-2025 → superseded by: command-a-plus-05-2026 |
...
| Command A (`command-a-03-2025`) | ga | 2025-03-13 | 256K | $2.50 | $10.00 | 111B dense transformer | General enterprise agentic workloads | prev: command-r-plus → superseded by: command-a-plus-05-2026 |
...
| DeepSeek V4-Flash (`deepseek-v4-flash`) | ga | 2026-07-31 | 1.0M | $0.44 | $0.66 | Mixture-of-Experts, 284B total / 13B active parameters, Compressed Sparse Attention | High-volume agents and cheap long-context inference | prev: deepseek-v3.2-exp → superseded by: deepseek-flash |
...
| DeepSeek V4 Pro (`deepseek-v4-pro`) | ga | 2026-04-24 | 1.0M | $1.32 | $3.96 | Sparse MoE 1.6T total / 49B active, hybrid CSA + HCA attention | Flagship reasoning, coding, and agentic tasks | prev: deepseek-v3.2 → superseded by: deepseek-v4.1-flash |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Gemini 3.8 Flash (`gemini-3.8-flash`) | ga | 2026-09-02 | 1.0M | $0.75 | $3.75 | Distilled sparse MoE multimodal transformer | Fast cheap coding + agentic default | prev: gemini-3.6-flash |
...
| Gemini 3.5 Flash-Lite (`gemini-3.5-flash-lite`) | ga | 2026-07-21 | 1.0M | $0.30 | $2.50 | Distilled lightweight multimodal transformer | High-throughput low-latency production traffic | prev: gemini-3.1-flash-lite |
...
| Gemini 3.1 Pro (`gemini-3.1-pro`) | ga | 2026-02-19 | 1.0M | $2.00 | $12.00 | Sparse mixture-of-experts multimodal transformer | Frontier reasoning, coding, multimodal, long context | prev: gemini-2.5-pro → superseded by: gemini-3.1-ultra |
...
| Llama 4 Maverick (`llama-4-maverick-17b-128e-instruct`) | ga | 2025-04-05 | 1M | $0.27 | $0.85 | MoE 17B active / 128 experts / ~400B total | High-quality multimodal reasoning and coding | prev: llama-3.3-70b-instruct → superseded by: muse-spark-1.2 |
...
| Llama 4 Scout (`llama-4-scout-17b-16e-instruct`) | ga | 2025-04-05 | 10M | $0.08 | $0.30 | MoE 17B active / 16 experts / ~109B total | Ultra-long context multimodal at low cost | prev: llama-3.3-70b-instruct → superseded by: meta-llama/Llama-4-Scout-17B-16E-Instruct |
...
| Phi-4-multimodal-instruct (`phi-4-multimodal-instruct`) | ga | 2025-02-26 | 131.1K | $0.08 | $0.32 | 5.6B multimodal transformer | Small multimodal model for edge and low-cost inference | prev: phi-3.5-vision-instruct |
...
| MAI-Thinking-1 (`MAI-Thinking-1`) | preview | 2026-08-12 | 256K | $2.00 | $8.00 | Mixture-of-Experts (MoE) | Enterprise reasoning, math, and general intelligence workloads | prev: MAI-1-preview |
...
| Mistral Small 4 (`mistral-small-2603`) | ga | 2026-03-16 | 262.1K | $0.15 | $0.60 | 119B parameters with 6.5B active (sparse) | Cheap open multimodal general-purpose model | prev: mistral-small-2503 |
...
| Mistral Large 3 (`mistral-large-2512`) | ga | 2025-12-02 | 256K | $0.50 | $1.50 | 675B sparse mixture-of-experts with 41B active parameters | Flagship reasoning and complex agentic tasks | prev: mistral-large-2411 |
...
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262.1K | $0.95 | $4.00 | MoE 1T total / 32B active, 384 experts (8+1 shared), 61 layers, MLA | General-purpose chat, vision, and agents | prev: kimi-k2 → superseded by: kimi-k2.7-code |
...
| Kimi K2 Thinking (`kimi-k2-thinking`) | ga | 2025-11-06 | 262.1K | $0.60 | $2.50 | 1T-parameter MoE with 32B active per token, INT4 QAT quantized | Deep reasoning with long-horizon tool orchestration | prev: kimi-k2-instruct → superseded by: kimi-k3 |
...
| GPT-5.6 Luna (`gpt-5.6-luna`) | ga | 2026-07-09 | 1M | $0.20 | $1.20 | Fast, low-cost tier of GPT-5.6 family | High-volume, low-latency workloads | prev: gpt-5.5 |
| GPT-5.6 Sol (`gpt-5.6-sol`) | ga | 2026-07-09 | 1M | $5.00 | $30.00 | Frontier reasoning tier of GPT-5.6 family | Complex reasoning, coding, long-horizon agents | prev: gpt-5.5 → superseded by: gpt-6-astra |
| GPT-5.6 Terra (`gpt-5.6-terra`) | ga | 2026-07-09 | 1M | $2.00 | $12.00 | Balanced tier of GPT-5.6 family | Balanced everyday reasoning and coding | prev: gpt-5.5 |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Sonar Deep Research (`sonar-deep-research`) | ga | 2025-03-07 | 128K | $2.00 | $8.00 | Agentic research pipeline | Multi-step research synthesis reports | superseded by: agent-api |
| Sonar Pro (`sonar-pro`) | ga | 2025-03-07 | 200K | $3.00 | $15.00 | Search-augmented LLM | Advanced grounded search and citations | prev: sonar → superseded by: agent-api |
| Sonar Reasoning Pro (`sonar-reasoning-pro`) | ga | 2025-03-07 | 128K | $2.00 | $8.00 | DeepSeek-R1 CoT with search | Premier reasoning with multi-step search | prev: sonar-reasoning → superseded by: agent-api |
...
| Sonar (`sonar`) | ga | 2025-01-21 | 127.1K | $1.00 | $1.00 | Search-augmented LLM | Lightweight grounded search Q&A | prev: llama-3.1-sonar-small-128k-online → superseded by: agent-api |
...
| Grok 4.6 (`grok-4.6`) | ga | 2026-08-12 | 500K | $2.00 | $6.00 | Dense/MoE transformer with configurable reasoning effort | Flagship coding and agentic work | prev: grok-4.5 |
...
| Grok 4.5 (`grok-4.5`) | ga | 2026-07-08 | 500K | $2.00 | $6.00 | 1.5T-parameter Mixture-of-Experts (V9) | Prior flagship reasoning model | prev: grok-4.3 → superseded by: grok-4.6 |
...
| Grok Code Fast 1 (`grok-code-fast-1`) | ga | 2025-08-26 | 256K | $0.20 | $1.50 | Reasoning model optimized for agentic coding (formerly codename 'sonic') | Economical agentic coding | superseded by: grok-build-0.1 |
