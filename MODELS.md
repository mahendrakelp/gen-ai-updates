...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Qwen3.8-27B (`qwen3.8-27b`) | ga | 2026-08-14 | 262K | $0.40 | $3.00 | Dense 27.78B-parameter model, 64 layers, hidden size 5120; hybrid attention a... | Open-weight dense VL for single-GPU deployment | prev: `qwen3.6-27b` |
| Qwen3.8-2.4T-A95B (`qwen3.8-2.4t-a95b`) | ga | 2026-08-13 | 262K | — | — | Open-weights Mixture-of-Experts checkpoint with 2.4T total / ~95B active para... | Open-weights Max-class reasoning and agentic work | prev: `qwen3.7-max` |
...
| Qwen3-VL-235B-A22B-Instruct (`qwen3-vl-235b-a22b-instruct`) | ga | 2025-09-23 | 262K | — | — | Sparse MoE — 235B total / 22B active; Interleaved-MRoPE + DeepStack visual en... | Visual agents, document/OCR, hours-long video understanding | prev: `qwen2.5-vl-72b-instruct` |
...
| Qwen3-Coder-Plus (`qwen3-coder-plus`) | ga | 2025-07-22 | 1.0M | $0.65 | $3.25 | Sparse MoE — 480B total / 35B active (8 of 160 experts); backed by open-weigh... | Repository-scale agentic coding and tool-driven workflows | prev: `qwen-coder-plus` → superseded by: `qwen3-coder-next` |
...
| Amazon Nova Canvas (`amazon.nova-canvas-v1:0`) | deprecated | 2024-12-03 | — | — | — | Diffusion image generation model | Studio-quality image generation from text or image prompts | — |
...
| Claude Mythos 5 (`claude-mythos-5`) | preview | 2026-06-09 | 1M | $10.00 | $50.00 | Same underlying model as Claude Fable 5; uses the newer tokenizer introduced ... | Defensive cybersecurity workflows | prev: `claude-mythos-preview` → superseded by: `claude-mythos-5-1` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Gemini 3.8 Flash (`gemini-3.8-flash`) | ga | 2026-09-02 | 1.0M | $0.75 | $3.75 | Sparse Mixture-of-Experts, natively multimodal transformer | High-throughput agentic coding and enterprise workflows | prev: `gemini-3.7-flash` |
| Gemini 3.7 Flash (`gemini-3.7-flash`) | ga | 2026-08-13 | 1.0M | $0.75 | $3.75 | Sparse Mixture-of-Experts, natively multimodal transformer | Coding and agent workflows where the 3.8 upgrade is not yet needed; strong AutomationBench performance | prev: `gemini-3.6-flash` → superseded by: `gemini-3.8-flash` |
| Gemini 3.5 Flash-Lite (`gemini-3.5-flash-lite`) | ga | 2026-07-21 | 1.0M | $0.30 | $2.50 | Dense distilled transformer variant of Gemini 3.5 Flash | High-volume, low-latency tasks: agentic search, document processing, translation, classification | prev: `gemini-3.1-flash-lite` |
| Gemini 3.6 Flash (`gemini-3.6-flash`) | ga | 2026-07-21 | 1.0M | $0.75 | $3.75 | Natively multimodal reasoning model | Stable Flash tier, recommended 2.5 Flash migration path | prev: `gemini-3.5-flash` → superseded by: `gemini-3.8-flash` |
...
| Gemini 3.1 Pro (`gemini-3.1-pro-preview`) | preview | 2026-02-19 | 1.0M | $2.00 | $12.00 | Sparse Mixture-of-Experts, natively multimodal transformer | Frontier reasoning, coding, and multimodal analysis | prev: `gemini-2.5-pro` → superseded by: `gemini-3.1-pro` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Muse Glimmer 30B (`meta/muse-glimmer-30b`) | ga | 2026-08-10 | 131K | — | — | Dense decoder-only multimodal transformer — 30B (28B text decoder + 2B vision... | On-device agentic tasks — tool use, multi-step reasoning, and multimodal understanding on consumer GPUs | prev: `meta-llama/Llama-4-Scout-17B-16E-Instruct` |
...
| Muse Spark 1.1 (`muse-spark-1.1`) | ga | 2026-07-09 | 1.0M | $1.25 | $4.25 | Closed-weights multimodal reasoning model from Meta Superintelligence Labs | Multimodal agentic reasoning via Meta Model API | prev: `muse-spark` → superseded by: `muse-spark-1.2` |
...
| Llama Guard 4 12B (`meta-llama/Llama-Guard-4-12B`) | ga | 2025-04-29 | 164K | $0.20 | $0.20 | Dense early-fusion multimodal transformer (12B), pruned from Llama 4 Scout pr... | Multimodal safety classifier for LLM inputs and outputs | prev: `meta-llama/Llama-Guard-3-8B` |
| Llama 4 Maverick (`llama-4-maverick`) | ga | 2025-04-05 | 1M | $0.19 | $0.60 | Mixture-of-Experts (128 experts, 17B active / ~400B total), natively multimod... | Multimodal assistant and coding at flagship scale | prev: `llama-3-3-70b` → superseded by: `muse-spark-1.2` |
...
| Llama 4 Maverick (`meta-llama/Llama-4-Maverick-17B-128E-Instruct`) | ga | 2025-04-05 | 1M | $0.22 | $0.88 | Mixture-of-Experts (17B active, 400B total, 128 experts) with early-fusion mu... | Flagship multimodal chat, coding, and assistants | prev: `meta-llama/Llama-3.3-70B-Instruct` |
| Llama 4 Scout (`llama-4-scout`) | ga | 2025-04-05 | 10M | $0.08 | $0.30 | Mixture-of-Experts (16 experts, 17B active / 109B total), iRoPE for long cont... | Long-context multimodal work on a single GPU | prev: `llama-3-3-70b` → superseded by: `muse-glimmer-30b` |
...
| Llama 4 Scout (`meta-llama/Llama-4-Scout-17B-16E-Instruct`) | ga | 2025-04-05 | 10M | $0.11 | $0.34 | Mixture-of-Experts (17B active, 109B total, 16 experts) with early-fusion mul... | Long-context multimodal on a single H100 GPU | prev: `meta-llama/Llama-3.3-70B-Instruct` |
...
| Phi-4 Reasoning Plus (`phi-4-reasoning-plus`) | ga | 2025-04-30 | 32K | — | — | 14B parameter dense decoder-only Transformer fine-tuned with RL for chain-of-... | Small open reasoning model for math, science, and code | prev: `phi-4` → superseded by: `phi-4-reasoning-vision-15b` |
...
| Phi-4 Multimodal Instruct (`phi-4-multimodal-instruct`) | ga | 2025-02-26 | 128K | $0.08 | $0.32 | 5.6B parameter multimodal model using mixture-of-LoRAs for speech, vision, an... | On-device text, image, and speech understanding | prev: `phi-3.5-vision-instruct` |
...
| MAI-Code-1.1-Flash (`MAI-Code-1.1-Flash`) | preview | 2026-08-11 | 256K | $0.20 | $1.20 | Sparse Mixture-of-Experts Transformer (137B total parameters on prior MAI-Cod... | Fast, low-cost agentic coding workflows | prev: `MAI-Code-1-Flash` |
...
| MAI-1-preview (`MAI-1-preview`) | preview | 2025-08-28 | — | — | — | Mixture-of-Experts Transformer, pre- and post-trained on ~15,000 NVIDIA H100 ... | General-purpose foundation model preview | → superseded by: `MAI-Thinking-1` |
...
| MAI-Code-1-Flash (`mai-code-1-flash`) | deprecated | 2026-05-19 | 256K | $0.75 | $4.50 | Sparse MoE, 137B total / 5B active parameters | Fast agentic coding inside Copilot workflows | → superseded by: `mai-code-1.1-flash` |
...
| Mistral Small 4 (`mistral-small-latest`) | ga | 2026-03-16 | 262K | $0.15 | $0.60 | Hybrid MoE with 128 experts (4 active per token + 1 shared), 119B total / 6.5... | Unified small model for coding, reasoning, and vision | prev: `mistral-small-2506` |
...
| Mistral Large 3 (`mistral-large-latest`) | ga | 2025-12-02 | 262K | $0.50 | $1.50 | Sparse Mixture-of-Experts, 675B total / 41B active parameters, trained on 3,0... | Flagship open-weight frontier reasoning and coding | prev: `mistral-large-2411` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K3 (`kimi-k3`) | ga | 2026-07-16 | 1.0M | $3.00 | $15.00 | Sparse MoE — 2.8T total / 104B active, 16 of 896 experts routed per token, Ki... | Frontier multimodal reasoning and long-horizon agentic coding | prev: `kimi-k2.6` |
| Kimi K2.7 Code (`kimi-k2.7-code`) | ga | 2026-06-12 | 262K | $0.95 | $4.00 | Sparse MoE — ~1T total / 32B active, native multimodal (text + image), always... | Token-efficient agentic coding over long contexts | prev: `kimi-k2.6` |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262K | $0.95 | $4.00 | Sparse MoE — 1T total / 32B active, 384 experts (8 routed + 1 shared), MoonVi... | Workhorse multimodal agentic coding and orchestration | prev: `kimi-k2.5` → superseded by: `kimi-k3` |
...
| Kimi K2 Thinking Turbo (`kimi-k2-thinking-turbo`) | ga | 2025-11-06 | 262K | $1.15 | $8.00 | 1T-parameter Mixture-of-Experts (32B active per token) with always-on thinkin... | faster interleaved reasoning with tool use | prev: `kimi-k2-instruct-0905` |
...
| Nemotron 3 Embed 1B (NVFP4) (`nvidia/nemotron-3-embed-1b-nvfp4`) | ga | 2026-07-17 | 33K | $0.00 | $0.00 | Transformer encoder with bidirectional attention masking, NVFP4 (4-bit) quant... | Blackwell-optimized 4-bit deployment for high-throughput embedding on GB200 / RTX PRO 6000 | prev: `nvidia/nemotron-3-embed-1b-bf16` |
| Nemotron 3 Embed 8B (`nvidia/nemotron-3-embed-8b-bf16`) | ga | 2026-07-17 | 33K | $0.00 | $0.00 | Transformer encoder with bidirectional attention masking (adapted from Minist... | Accuracy-first multilingual dense retrieval for production RAG, agentic retrieval, code retrieval, and agent memory | — |
...
| Nemotron 3 Ultra 550B A55B (`nvidia/NVIDIA-Nemotron-3-Ultra-550B-A55B-BF16`) | ga | 2026-06-04 | 1M | — | — | Hybrid Transformer-Mamba Mixture-of-Experts (550B total / 55B active) with La... | Frontier reasoning and long-running agent orchestration | prev: `nvidia/Llama-3_1-Nemotron-Ultra-253B-v1` |
...
| Cosmos 3 (`nvidia/cosmos-3`) | ga | 2026-06-01 | — | — | — | Mixture-of-transformers omnimodel with native vision reasoning and multimodal... | World simulation and synthetic data for physical AI | prev: `nvidia/cosmos-1` |
| Cosmos 3 Super (`nvidia/Cosmos3-Super`) | ga | 2026-06-01 | — | — | — | Mixture-of-Transformers (64B total: 32B autoregressive reasoner + 32B diffusi... | Physical-AI world modeling and synthetic data | prev: `nvidia/Cosmos-1.0` |
| Nemotron-Labs-3-Elastic 30B-A3B (`nvidia/nemotron-labs-3-elastic-30b-a3b`) | ga | 2026-05-07 | 131K | — | — | Hybrid Mamba2-Transformer MoE with elastic post-training; 52-layer parent (23... | Elastic 3-in-1 reasoning checkpoint sliced to 30B/23B/12B for cost-adaptive deployment | prev: `nvidia/nemotron-3-nano-30b-a3b` |
| Nemotron 3 Nano Omni (`nvidia/nemotron-3-nano-omni`) | ga | 2026-04-28 | 262K | — | — | Nemotron 3 Nano 30B-A3B hybrid Mamba-Transformer MoE backbone + C-RADIOv4-H v... | Efficient omni-modal edge agents (vision, audio, video, text) | prev: `nvidia/nemotron-3-nano-30b-a3b` |
| Nemotron 3 Nano Omni 30B A3B Reasoning (`nvidia/nemotron-3-nano-omni-30b-a3b-reasoning`) | ga | 2026-04-28 | 1M | $0.07 | $0.30 | Hybrid Mixture-of-Experts (30B total, 3B active) with integrated vision and a... | Multimodal edge agents seeing hearing and reasoning | prev: `nvidia/nemotron-nano-12b-v2-vl` |
| Nemotron 3 Nano Omni 30B A3B Reasoning (`nvidia/Nemotron-3-Nano-Omni-30B-A3B-Reasoning-BF16`) | ga | 2026-04-28 | 300K | — | — | Hybrid MoE Transformer-Mamba (30B / ~3B active) with Conv3D video layers and ... | Multimodal perception sub-agent for enterprise agents | prev: `nvidia/NVIDIA-Nemotron-Nano-9B-v2` |
...
| Nemotron-Cascade 2 30B-A3B (`nvidia/nemotron-cascade-2-30b-a3b`) | ga | 2026-03-20 | 262K | — | — | Hybrid Mamba-Transformer Mixture-of-Experts, 30B total / 3B active, 52 layers... | High-intelligence-density open reasoning at 3B active parameters for math, code, and agentic workflows with single-GPU deployment | prev: `nvidia/nemotron-3-nano-30b-a3b` |
| Nemotron 3 Nano 4B (`nvidia/nemotron-3-nano-4b`) | ga | 2026-03-16 | 262K | — | — | Hybrid Mamba-Transformer (Mamba-2 + MLP + small number of attention layers), ... | On-device / edge deployment on Jetson, DGX Spark, and RTX GPUs where privacy, latency, and offline operation matter | prev: `nvidia/nvidia-nemotron-nano-9b-v2` |
| Nemotron 3 Super 120B A12B (`nvidia/nemotron-3-super-120b-a12b`) | ga | 2026-03-11 | 1M | $0.09 | $0.40 | Hybrid Mamba2-Transformer LatentMoE with Multi-Token Prediction, NVFP4 pretra... | Agentic reasoning with 1M-token long-context workloads | prev: `nvidia/llama-3.3-nemotron-super-49b-v1.5` → superseded by: `nvidia/nemotron-3-ultra-550b-a55b` |
...
| Nemotron 3 Nano 30B-A3B (`nvidia/NVIDIA-Nemotron-3-Nano-30B-A3B-BF16`) | ga | 2025-12-15 | 1M | — | — | Hybrid Mamba-2 + Transformer Mixture-of-Experts (30B total, 3.5B active; 128 ... | Cost-efficient edge and multi-agent deployments | prev: `nvidia/Llama-3_1-Nemotron-Nano-8B-v1` |
| Nemotron Nano 2 VL (`nvidia/nemotron-nano-12b-v2-vl`) | ga | 2025-10-28 | 131K | — | — | Hybrid Transformer-Mamba multimodal model with RADIOv2.5 vision encoder, MLP ... | open document intelligence and video understanding | prev: `nvidia/nvidia-nemotron-nano-9b-v2` → superseded by: `nvidia/nemotron-3-nano-omni-30b-a3b-reasoning` |
...
| Llama 3.3 Nemotron Super 49B v1.5 (`nvidia/llama-3_3-nemotron-super-49b-v1_5`) | ga | 2025-10-10 | 131K | $0.10 | $0.40 | Neural Architecture Search compression of Meta Llama-3.3-70B-Instruct with re... | single-GPU reasoning and tool-calling on Llama base | prev: `nvidia/llama-3.3-nemotron-super-49b-v1` → superseded by: `nvidia/nemotron-3-super-120b-a12b` |
...
| Llama 3.3 Nemotron Super 49B v1.5 (`nvidia/llama-3.3-nemotron-super-49b-v1.5`) | ga | 2025-07-25 | 131K | $0.10 | $0.40 | Dense Transformer derived from Llama-3.3-70B-Instruct via Neural Architecture... | Reasoning and agentic RAG on a single H100 | prev: `nvidia/llama-3.3-nemotron-super-49b-v1` → superseded by: `nvidia/NVIDIA-Nemotron-3-Super-120B-A12B-BF16` |
| Llama 3.1 Nemotron Ultra 253B v1 (`nvidia/llama-3.1-nemotron-ultra-253b-v1`) | ga | 2025-04-08 | 131K | $0.60 | $1.80 | Neural-Architecture-Search-optimized dense transformer derived from Llama-3.1... | Frontier-class reasoning, RAG, and enterprise tool use | → superseded by: `nvidia/nemotron-3-ultra-550b-a55b` |
| Llama 3.3 Nemotron Super 49B v1 (`nvidia/llama-3.3-nemotron-super-49b-v1`) | ga | 2025-03-18 | 131K | $0.10 | $0.40 | Dense Transformer derived from Llama-3.3-70B-Instruct via Neural Architecture... | Reasoning and RAG in single-GPU footprint | → superseded by: `nvidia/llama-3.3-nemotron-super-49b-v1.5` |
...
| Nemotron-Labs-TwoTower 30B-A3B (`nvidia/nemotron-labs-twotower-30b-a3b`) | preview | 2026-07-01 | 131K | — | — | Block-wise autoregressive diffusion: frozen Nemotron-3-Nano-30B-A3B AR contex... | High-throughput diffusion language generation research | prev: `nvidia/nemotron-3-nano-30b-a3b` |
