...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DeepSeek V4 Flash (`deepseek-v4-flash`) | preview | 2026-04-24 | 1.05M | $0.14 | $0.28 | MoE, 284B total / 13B active | low-cost high-throughput reasoning and coding; drop-in successor to deepseek-chat/reasoner | prev: deepseek-chat |
| DeepSeek V4 Pro (`deepseek-v4-pro`) | preview | 2026-04-24 | 1.05M | $0.43 | $0.87 | MoE, 1.6T total / 49B active, 384 routed experts + 1 shared, CSA/HCA hybrid attention | frontier open-weight reasoning and agentic coding | prev: deepseek-reasoner |
| DeepSeek Reasoner (legacy alias) (`deepseek-reasoner`) | deprecated | 2025-01-20 | 131.1K | $0.14 | $0.28 | MoE | legacy chain-of-thought reasoning alias; maps to V4 Flash thinking mode | prev: deepseek-r1 → superseded by: deepseek-v4-flash |
| DeepSeek Chat (legacy alias) (`deepseek-chat`) | deprecated | 2024-12-26 | 131.1K | $0.14 | $0.28 | MoE | legacy general chat alias; maps to V4 Flash non-thinking mode | prev: deepseek-v3.2 → superseded by: deepseek-v4-flash |
