...
| Phi-4-multimodal (`phi-4-multimodal-instruct`) | ga | 2025-02-26 | 131K | $0.08 | $0.32 | Multimodal transformer with mixture-of-LoRAs integrating speech, vision, and text, 5.6B parameters | Unified text, vision, and audio understanding | — |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Nemotron 3 Ultra (`nvidia/nemotron-3-ultra-550b-a55b`) | ga | 2026-06-01 | 1M | — | — | Hybrid Mamba2-Transformer Latent MoE; 550B total / 55B active | Flagship reasoning for complex agentic workflows | prev: nvidia/llama-3.1-nemotron-ultra-253b-v1 |
