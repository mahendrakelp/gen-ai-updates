...
_Last refreshed: 2026-05-29 by genai-model-catalog routine._
...
| Qwen3-Max (`qwen3-max`) | ga | 2025-09-23 | 262K | $0.78 | $3.90 | Sparse MoE, ~1T total parameters | General-purpose reasoning and instruction following | prev: qwen2.5-max → superseded by: qwen3.7-max |
| Qwen3-VL-Plus (`qwen3-vl-plus`) | ga | 2025-09-23 | 262K | $0.20 | $1.60 | Sparse MoE multimodal (based on Qwen3-VL-235B-A22B family) | Multimodal vision, image, and video understanding | prev: qwen-vl-plus |
| Qwen3-235B-A22B-Thinking-2507 (`qwen3-235b-a22b-thinking-2507`) | ga | 2025-07-25 | 262K | — | — | Sparse MoE - 235B total / 22B active | Open-weights SOTA reasoning and math | prev: qwen3-235b-a22b |

## Amazon

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Nova 2 Lite (`amazon.nova-2-lite-v1:0`) | ga | 2025-12-02 | 1M | $0.30 | $2.50 | Transformer-based multimodal foundation model with extended thinking | Cost-effective reasoning for everyday agentic workloads | prev: amazon.nova-lite-v1:0 |
...
| Nova 2 Pro (`amazon.nova-2-pro-preview-20251202-v1:0`) | preview | 2025-12-02 | 1M | $2.19 | $17.50 | Transformer-based multimodal foundation model with extended thinking | Most intelligent Nova for complex multistep agents | prev: amazon.nova-pro-v1:0 |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Command A+ (`command-a-plus-05-2026`) | ga | 2026-05-20 | 128K | $2.50 | $10.00 | Decoder-only Sparse Mixture-of-Experts Transformer, 218B total / 25B active parameters, 128 experts (8 active per token) + 1 shared expert | Enterprise agentic workflows with vision and reasoning | prev: command-a-03-2025 |
...
| Command A Vision (`command-a-vision-07-2025`) | ga | 2025-07-31 | 128K | $2.50 | $10.00 | 112B-parameter multimodal model: SigLIP2 vision encoder fused with the 111B Command A text tower | Enterprise document, chart and OCR understanding | prev: command-a-03-2025 |
| Command A (`command-a-03-2025`) | ga | 2025-03-13 | 256K | $2.50 | $10.00 | Dense 111B-parameter Transformer with sliding-window attention (4096) plus periodic global attention layers without positional embeddings | Enterprise tool use, RAG and multilingual agents | prev: command-r-plus-08-2024 → superseded by: command-a-plus-05-2026 |
...
| Gemini 3.1 Flash Lite (`gemini-3.1-flash-lite-preview`) | preview | 2026-03-03 | 1M | $0.25 | $1.50 | — | Ultra-cheap, fast multimodal high-volume tasks | prev: gemini-2.5-flash-lite |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Llama 4 Maverick (`llama-4-maverick`) | ga | 2025-04-05 | 1M | $0.15 | $0.60 | Sparse MoE - 400B total / 17B active / 128 experts, early-fusion native multimodality | Multimodal assistant and general-purpose chat | prev: llama-3.3-70b |
| Llama 4 Scout (`llama-4-scout`) | ga | 2025-04-05 | 10M | $0.08 | $0.30 | Sparse MoE - 109B total / 17B active / 16 experts, early-fusion native multimodality | Long-context multimodal tasks on single GPU | prev: llama-3.3-70b |
...
| Mistral Small 4 (`mistral-small-2603`) | ga | 2026-03-16 | 262K | $0.15 | $0.60 | Mixture-of-Experts, 6B active / 119B total parameters, 128 experts | Cheap unified reasoning, vision, and coding | prev: mistral-small-2506 |
| Mistral Large 3 (`mistral-large-2512`) | ga | 2025-12-02 | 262K | $0.50 | $1.50 | Mixture-of-Experts, 41B active / 675B total parameters | Flagship multimodal general-purpose tasks | prev: mistral-large-2411 |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262K | $0.95 | $4.00 | Sparse MoE - 1T total / 32B active, 384 routed + 1 shared expert, 8 active per token, MLA attention, 61 layers | Long-horizon agentic coding and multimodal orchestration | prev: kimi-k2.5 |
| Kimi K2.5 (`kimi-k2.5`) | ga | 2026-01-27 | 262K | $0.60 | $2.50 | Sparse MoE - 1T total / 32B active, 384 experts, 8 active per token, MLA attention, 61 layers, MoonViT vision encoder (400M) | Cost-efficient multimodal agentic intelligence | prev: kimi-k2-0905-preview → superseded by: kimi-k2.6 |
| Kimi K2 Thinking (`kimi-k2-thinking`) | deprecated | 2025-11-06 | 262K | $0.60 | $2.50 | Sparse MoE - 1T total / 32B active, 384 experts, 8 active per token, MLA attention, INT4 native | Open-weight reasoning with interleaved tool use | prev: kimi-k2-0905-preview → superseded by: kimi-k2.6 |

## NVIDIA

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Nemotron 3 Nano Omni 30B A3B Reasoning (`nvidia/nemotron-3-nano-omni-30b-a3b-reasoning`) | ga | 2026-04-28 | — | — | — | Hybrid Mamba-Transformer MoE with vision/audio encoders (C-RADIOv4-H + Parakeet-TDT) | Multimodal agent reasoning on a single GPU | prev: nvidia/nvidia-nemotron-nano-9b-v2 |
...
| NVIDIA Nemotron Nano 9B v2 (`nvidia/nvidia-nemotron-nano-9b-v2`) | ga | 2025-09-05 | 131K | — | — | Hybrid Mamba-Transformer | Efficient on-device reasoning and chat | superseded by: nvidia/nemotron-3-nano-30b-a3b |
| Llama 3.1 Nemotron Ultra 253B v1 (`nvidia/llama-3.1-nemotron-ultra-253b-v1`) | ga | 2025-04-07 | 131K | — | — | Dense decoder-only transformer (NAS-compressed from Llama 3.1 405B) | Large-scale reasoning, RAG, and tool-calling | — |
| Llama 3.3 Nemotron Super 49B v1 (`nvidia/llama-3.3-nemotron-super-49b-v1`) | ga | 2025-03-18 | 131K | — | — | Dense decoder-only transformer (NAS-derived from Llama 3.3 70B) | Single-GPU reasoning and chat workloads | — |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Sonar Deep Research (`sonar-deep-research`) | ga | 2025-03-07 | 128K | $2.00 | $8.00 | Agentic research model running iterative web searches and synthesis over Sonar base | Autonomous multi-step deep research reports | — |
| Sonar Pro (`sonar-pro`) | ga | 2025-03-07 | 200K | $3.00 | $15.00 | Perplexity-developed LLM with real-time web search and citation grounding | Complex multi-step search-grounded queries | prev: sonar |
| Sonar (`sonar`) | ga | 2025-01-21 | 127K | $1.00 | $1.00 | Built on Llama 3.3 70B with Perplexity post-training for search-grounded answers | Fast, low-cost search-grounded answers | — |
| Sonar Reasoning Pro (`sonar-reasoning-pro`) | ga | — | 127K | $2.00 | $8.00 | Built on DeepSeek R1 with Chain-of-Thought, augmented with Perplexity real-time web search | Advanced reasoning with web-grounded citations | prev: sonar-reasoning |
