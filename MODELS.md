...
_Last refreshed: 2026-08-22 by genai-model-catalog routine._
...
| Qwen3.8-Max (`qwen3.8-max`) | ga | 2026-08-03 | 1M | $2.00 | $6.00 | MoE — 2.4T total / 95B active | Flagship reasoning, long-context multimodal work | prev: qwen3.7-max |
...
| Qwen3-Coder-Plus (`qwen3-coder-plus`) | ga | 2025-09-23 | 1M | $0.65 | $3.25 | MoE (proprietary variant of Qwen3-Coder-480B-A35B: 480B total / 35B active) | Autonomous coding agents with tool use | prev: qwen2.5-coder → superseded by: qwen3-coder-next |
...
| Amazon Nova 2 Sonic (`amazon.nova-2-sonic-v1:0`) | ga | 2025-12-02 | 1M | $0.33 | $2.75 | Speech-to-speech foundation model with bidirectional streaming | Real-time speech-to-speech conversational AI | prev: amazon.nova-sonic-v1:0 |
...
| Claude Sonnet 5 (`claude-sonnet-5`) | ga | 2026-06-30 | 1M | $2.00 | $10.00 | Sonnet-class agentic model with adaptive thinking | Balanced speed and intelligence for production workloads | prev: claude-sonnet-4-6 |
| Claude Fable 5 (`claude-fable-5`) | ga | 2026-06-09 | 1M | $10.00 | $50.00 | Mythos-class frontier model with newer tokenizer | Long-running agents and hardest reasoning tasks | prev: claude-opus-4-8 |
...
| Claude Haiku 4.5 (`claude-haiku-4-5`) | ga | 2025-10-15 | 200K | $1.00 | $5.00 | Haiku-class small model with extended thinking | Fast, high-volume tasks and subagent work | prev: claude-haiku-3-5 |
...
| Command A+ (`command-a-plus-05-2026`) | ga | 2026-05-20 | 128K | $2.50 | $10.00 | Sparse Mixture-of-Experts, 218B total parameters with 25B active per token | Frontier agentic, multilingual, multimodal enterprise workloads | prev: command-a-03-2025 |
...
| Command A Reasoning (`command-a-reasoning-08-2025`) | ga | 2025-08-01 | 256K | $2.50 | $10.00 | 111B parameter dense transformer | Multi-step reasoning, agentic workflows, document review | prev: command-a-03-2025 → superseded by: command-a-plus-05-2026 |
| Command A Vision (`command-a-vision-07-2025`) | ga | 2025-07-01 | 128K | $2.50 | $10.00 | 111B parameter dense transformer with vision encoder | Enterprise document, chart, and OCR understanding | prev: command-a-03-2025 → superseded by: command-a-plus-05-2026 |
| Embed v4.0 (`embed-v4.0`) | ga | 2025-04-15 | 128K | $0.12 | — | Multimodal embedding model with Matryoshka-style variable output dimensions | Multimodal RAG and semantic search embeddings | prev: embed-english-v3.0 |
| Command A (`command-a-03-2025`) | ga | 2025-03-13 | 256K | $2.50 | $10.00 | 111B parameter dense transformer | General-purpose agentic, multilingual, coding tasks | prev: command-r-plus-08-2024 → superseded by: command-a-plus-05-2026 |
...
| Rerank v3.5 (`rerank-v3.5`) | ga | 2024-12-03 | 4.1K | — | — | Cross-encoder reranking model | Reordering retrieved passages for RAG relevance | prev: rerank-english-v3.0 → superseded by: rerank-v4-pro |
...
| DeepSeek V4-Flash (`deepseek-v4-flash`) | ga | 2026-04-24 | 1.0M | $0.44 | $1.32 | Sparse MoE — 284B total / 13B active (top-6 of 256 routed experts + 1 shared); FP4 expert weights, FP8 elsewhere | Low-cost high-throughput agents and long-context coding | prev: deepseek-v3.2 |
| DeepSeek V4-Pro (`deepseek-v4-pro`) | ga | 2026-04-24 | 1.0M | $1.32 | $3.96 | Sparse MoE — 1.6T total / 49B active; hybrid Compressed Sparse Attention (CSA) + Heavily Compressed Attention (HCA); Manifold-Constrained Hyper-Connections (mHC) | Flagship reasoning, agentic tool-use, long-context coding | prev: deepseek-v3.2 |
| DeepSeek V3.2 (`deepseek-ai/DeepSeek-V3.2`) | ga | 2025-12-01 | 163.8K | $0.21 | $0.31 | Sparse MoE — 671B total / 37B active; DeepSeek Sparse Attention (DSA) | Verified-baseline reasoning model with efficient sparse attention | prev: deepseek-v3.1 → superseded by: deepseek-v4-pro |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Gemini 3.7 Flash (`gemini-3.7-flash`) | ga | 2026-08-13 | 1.0M | $0.75 | $3.75 | algorithmic improvement on Gemini 3.6 Flash (transformer with thinking); details in 3.6 Flash model card | fast, low-cost coding and agent workflows | prev: gemini-3.6-flash |
| Gemini 3.5 Flash-Lite (`gemini-3.5-flash-lite`) | ga | 2026-07-21 | 1.0M | $0.30 | $2.50 | Distilled Flash-Lite multimodal | high-volume classification, extraction, and summarization | prev: gemini-3.1-flash-lite |
...
| Gemma 3 27B Instruct (`gemma-3-27b-it`) | ga | 2025-03-12 | 131.1K | — | — | dense decoder-only transformer with sliding-window + global attention; SigLIP vision encoder on 4B/12B/27B | self-hosted multilingual multimodal inference | prev: gemma-2-27b-it |
...
| Gemini 3.1 Pro (`gemini-3.1-pro-preview`) | preview | 2026-02-19 | 1.0M | $2.00 | $12.00 | sparse mixture-of-experts transformer with thinking (chain-of-thought) inference | frontier reasoning, agentic coding, complex multimodal tasks | prev: gemini-3-pro |
...
| Gemini 2.5 Pro (`gemini-2.5-pro`) | deprecated | 2025-06-17 | 1.0M | $1.25 | $10.00 | sparse mixture-of-experts transformer with thinking | legacy production workloads pending migration to Gemini 3 | prev: gemini-1.5-pro → superseded by: gemini-3.1-pro-preview |
...
| Llama 4 Maverick (`meta-llama/Llama-4-Maverick-17B-128E-Instruct`) | ga | 2025-04-05 | 1M | $0.22 | $0.88 | Sparse MoE (early-fusion multimodal) — ~400B total / 17B active, 128 experts | Flagship natively multimodal MoE for general chat and vision | prev: meta-llama/Llama-3.3-70B-Instruct |
...
| Llama 4 Scout (`meta-llama/Llama-4-Scout-17B-16E-Instruct`) | ga | 2025-04-05 | 10M | $0.11 | $0.34 | Sparse MoE (early-fusion multimodal) — 109B total / 17B active, 16 experts | Long-context multimodal work; single-GPU deployable | prev: meta-llama/Llama-3.3-70B-Instruct |
...
| Llama 3.3 70B Instruct (`meta-llama/Llama-3.3-70B-Instruct`) | ga | 2024-12-06 | 128K | $0.90 | $0.90 | Dense transformer with Grouped-Query Attention — 70B parameters | Popular dense text-only workhorse and fine-tuning base | prev: meta-llama/Llama-3.1-70B-Instruct → superseded by: meta-llama/Llama-4-Scout-17B-16E-Instruct |
...
| MAI-Voice-1 (`MAI-Voice-1`) | ga | 2026-04-06 | — | $22.00 | $22.00 | generative text-to-speech neural model | Low-latency expressive voice generation for agents | superseded by: mai-voice-2 |
...
| MAI-Thinking-1 (`MAI-Thinking-1`) | preview | 2026-08-12 | 262.1K | $2.00 | $8.00 | Sparse Mixture-of-Experts Transformer (35B active / 1T total parameters) | Enterprise reasoning, math, and code at scale | prev: MAI-1-preview |
...
| Mistral Medium 3.5 (`mistral-medium-2604`) | ga | 2026-04-28 | 262.1K | $1.50 | $7.50 | Dense 128B-parameter transformer with vision encoder | Agentic harnesses, coding, multi-step reasoning | prev: mistral-medium-2505 |
| Mistral Small 4 (`mistral-small-2603`) | ga | 2026-03-16 | 262.1K | $0.15 | $0.60 | Sparse Mixture-of-Experts, 119B total / 6B active (128 experts, 4 active) | Budget-friendly hybrid chat, coding, and reasoning | prev: mistral-small-2506 |
...
| Ministral 3 8B (`ministral-8b-2512`) | ga | 2025-12-01 | 262.1K | $0.15 | $0.15 | 8B dense transformer with interleaved sliding-window attention | Edge and on-device inference with reasoning | prev: ministral-8b-2410 |
| Mistral Large 3 (`mistral-large-2512`) | ga | 2025-12-01 | 262.1K | $0.50 | $1.50 | Granular sparse Mixture-of-Experts, 675B total / 41B active parameters | Flagship reasoning, agentic workflows, multimodal analysis | prev: mistral-large-2411 |
...
| Magistral Medium (`magistral-medium-2506`) | ga | 2025-06-10 | 41.0K | $2.00 | $5.00 | — | Chain-of-thought reasoning for legal, finance, and research | — |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K3 (`kimi-k3`) | ga | 2026-07-16 | 1.0M | $3.00 | $15.00 | MoE — 2.8T total / 104B active, 896 experts (16 active), Kimi Delta Attention + MLA | Frontier reasoning, long-context agentic coding | prev: kimi-k2.6 |
| Kimi K2.7 Code (`kimi-k2.7-code`) | ga | 2026-06-12 | 262.1K | $0.95 | $4.00 | MoE — 1T total / 32B active, Multi-head Latent Attention | End-to-end agentic coding over long contexts | prev: kimi-k2.6 |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262.1K | $0.95 | $4.00 | MoE — 1T total / 32B active, 384 experts, native INT4 | General-purpose multimodal + agentic tasks | prev: kimi-k2.5 → superseded by: kimi-k3 |
...
| Kimi K2.5 (`kimi-k2.5`) | deprecated | 2026-02-15 | 262.1K | $0.60 | $3.00 | MoE — 1T total / 32B active | Legacy cost-optimized reasoning workloads | prev: kimi-k2-thinking → superseded by: kimi-k2.6 |
...
| Nemotron 3 Embed 1B (`nvidia/nemotron-3-embed-1b`) | ga | — | 8.2K | — | — | 1B-parameter text embedding model | Multilingual retrieval and RAG embeddings | — |
...
| GPT-5.6 Luna (`gpt-5.6-luna`) | ga | 2026-07-09 | 1.1M | $0.20 | $1.20 | Fast, cost-efficient variant of the GPT-5.6 family | High-volume, cost-sensitive classification and extraction | prev: gpt-5.5-nano |
| GPT-5.6 Sol (`gpt-5.6-sol`) | ga | 2026-07-09 | 1.1M | $5.00 | $30.00 | Unified reasoning model with configurable reasoning effort and Pro mode | Frontier coding, agentic and reasoning workloads | prev: gpt-5.5 |
| GPT-5.6 Terra (`gpt-5.6-terra`) | ga | 2026-07-09 | 1.1M | $2.00 | $12.00 | Mid-tier variant of the GPT-5.6 family | Balanced everyday production workhorse | prev: gpt-5.5-mini |
...
| o3 (`o3`) | ga | 2025-04-16 | 200K | $2.00 | $8.00 | reasoning model with configurable effort levels | Deep multi-step reasoning across math, science, code | prev: o1 → superseded by: gpt-5.6-sol |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Sonar Deep Research (`sonar-deep-research`) | ga | 2025-03-07 | 128K | $2.00 | $8.00 | Perplexity deep-research agent with web search | Autonomous multi-search research reports | superseded by: agent-api-high |
| Sonar Reasoning Pro (`sonar-reasoning-pro`) | ga | 2025-02-18 | 128K | $2.00 | $8.00 | Built on DeepSeek R1 (R1-1776), fine-tuned by Perplexity | Multi-step reasoning with grounded web search | prev: sonar-reasoning → superseded by: agent-api-medium |
...
| Sonar (`sonar`) | ga | 2025-01-21 | 128K | $1.00 | $1.00 | Built on Meta Llama 3.3 70B, fine-tuned by Perplexity | Fast, low-cost web-grounded Q&A with citations | superseded by: agent-api-fast |
| Sonar Pro (`sonar-pro`) | ga | 2025-01-21 | 200K | $3.00 | $15.00 | Perplexity fine-tuned model with live web search | Advanced grounded search with deeper retrieval | prev: sonar → superseded by: agent-api-low |
...
| Grok 4.3 (`grok-4.3`) | ga | 2026-04-30 | 1M | $1.25 | $2.50 | Reasoning-first transformer with prompt caching | cost-efficient long-context workloads | prev: grok-4 → superseded by: grok-4.5 |
