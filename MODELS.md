...
_Last refreshed: 2026-08-31 by genai-model-catalog routine._
...
| Qwen3.7-Max (`qwen3.7-max`) | ga | 2026-05-20 | 262K | $1.25 | $3.75 | Mixture-of-Experts | Reasoning and agentic tasks at lower cost than flagship | prev: qwen3-max → superseded by: qwen3.8-max |
...
| Qwen3-Max (`qwen3-max`) | ga | 2025-09-23 | 262K | $1.20 | $6.00 | Mixture-of-Experts transformer (Qwen3 series) | Flagship agentic reasoning and complex tasks | prev: qwen-max → superseded by: qwen3.7-max |
| Qwen3-VL 235B Instruct (`qwen3-vl-235b-a22b-instruct`) | ga | 2025-09-23 | 262K | — | — | Mixture-of-Experts, 235B total / 22B active parameters | Multimodal vision, video, and GUI agent tasks | prev: qwen2.5-vl-72b-instruct |
| Qwen3-VL-Plus (`qwen3-vl-plus`) | ga | 2025-09-23 | 262K | $0.20 | $1.60 | Qwen3-VL multimodal transformer | Multimodal vision, video and document understanding | prev: qwen-vl-plus → superseded by: qwen3.5-plus |
| Qwen3-Omni 30B Instruct (`qwen3-omni-30b-a3b-instruct`) | ga | 2025-09-22 | 33K | — | — | MoE Thinker-Talker design, 30B total / 3B active parameters | End-to-end omni-modal chat with speech output | prev: qwen2.5-omni-7b |
| Qwen3-Omni-Flash (`qwen3-omni-flash`) | ga | 2025-09-22 | 66K | $0.43 | — | Qwen3-Omni any-to-any multimodal | Realtime any-to-any multimodal (audio, vision, text) | prev: qwen2.5-omni |
...
| Claude Fable 5 (`claude-fable-5`) | ga | 2026-06-09 | 1M | $10.00 | $50.00 | Hybrid reasoning model with adaptive thinking | long-horizon agents and demanding reasoning | prev: claude-opus-4-8 |
...
| Rerank 3.5 (`rerank-v3.5`) | ga | 2024-12-03 | 4K | — | — | Cross-encoder reranking model | Multilingual reranking for search and RAG pipelines | prev: rerank-english-v3.0 → superseded by: rerank-v4-pro |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DeepSeek V4 Pro (`deepseek-v4-pro`) | ga | 2026-08-13 | 1M | $0.66 | $1.98 | Mixture-of-Experts transformer (1.6T total / ~49B active) with hybrid Compressed Sparse + Heavily Compressed Attention | Frontier reasoning, coding, and long-context agents | prev: deepseek-reasoner → superseded by: deepseek-v4-pro-0813 |
...
| DeepSeek V4 Flash (`deepseek-v4-flash`) | ga | 2026-07-31 | 1M | $0.22 | $0.66 | Mixture-of-Experts transformer (284B total / ~13B active) with hybrid Compressed Sparse + Heavily Compressed Attention | Cheap high-volume coding and agent workloads | prev: deepseek-chat → superseded by: deepseek-v4-flash-0731 |
...
| DeepSeek V4 Flash Vision (Experimental) (`deepseek-v4-flash-vision-exp`) | preview | 2026-08-21 | 1M | $0.22 | $0.66 | Mixture-of-Experts transformer (284B total / ~13B active) with native vision encoder | Multimodal document, chart, and screenshot understanding | prev: deepseek-v4-flash |
...
| DeepSeek-V3.2 (`deepseek-chat`) | deprecated | 2025-12-01 | 131K | $0.14 | $0.28 | Sparse MoE — 671B total / 37B active with DSA | Prior-generation chat and reasoning (retired) | prev: deepseek-v3.1-terminus → superseded by: deepseek-v4-flash |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Gemini 3.7 Flash (`gemini-3.7-flash`) | ga | 2026-08-13 | 1M | $0.75 | $3.75 | Sparse mixture-of-experts multimodal transformer | High-throughput coding and agentic workloads | prev: gemini-3.6-flash |
| Gemini 3.5 Flash-Lite (`gemini-3.5-flash-lite`) | ga | 2026-07-21 | 1M | $0.30 | $2.50 | Distilled Flash-Lite multimodal | High-volume, low-latency agentic and extraction tasks | prev: gemini-2.5-flash-lite |
| Gemini 3.6 Flash (`gemini-3.6-flash`) | ga | 2026-07-21 | 1M | $1.50 | $7.50 | Natively multimodal reasoning model | Balanced Flash tier with computer-use tooling | prev: gemini-3.5-flash → superseded by: gemini-3.7-flash |
| Gemini 3.5 Flash (`gemini-3.5-flash`) | ga | 2026-05-19 | 1M | $1.50 | $9.00 | Sparse mixture-of-experts (MoE) transformer with thinking-levels; based on Gemini 3 Flash | Coding and agentic Flash workhorse | prev: gemini-3.1-flash → superseded by: gemini-3.6-flash |
| Gemini 3.1 Flash-Lite (`gemini-3.1-flash-lite`) | ga | 2026-05-07 | 1M | $0.25 | $1.50 | Compact multimodal transformer distilled from Gemini 3.1 family | Low-latency, high-volume multimodal workloads at lowest cost | prev: gemini-2.5-flash-lite → superseded by: gemini-3.5-flash-lite |
...
| Gemini 2.5 Flash-Lite (`gemini-2.5-flash-lite`) | ga | 2025-07-22 | 1M | $0.10 | $0.40 | Sparse mixture-of-experts multimodal transformer | Ultra-low-cost high-volume multimodal tasks | prev: gemini-2.0-flash-lite → superseded by: gemini-3.5-flash-lite |
| Gemini 2.5 Flash (`gemini-2.5-flash`) | ga | 2025-06-17 | 1M | $0.30 | $2.50 | sparse mixture-of-experts | Cost-efficient multimodal workhorse at scale | prev: gemini-2.0-flash → superseded by: gemini-3.7-flash |
| Gemini 2.5 Pro (`gemini-2.5-pro`) | ga | 2025-06-17 | 1M | $1.25 | $10.00 | Sparse mixture-of-experts multimodal transformer | Cost-efficient long-context reasoning workhorse | prev: gemini-1.5-pro → superseded by: gemini-3-pro |
| Gemma 3 27B (`gemma-3-27b-it`) | ga | 2025-03-12 | 131K | — | — | Dense decoder-only transformer with vision encoder | Open-weights on-device multimodal deployment | prev: gemma-2-27b-it → superseded by: gemma-4 |
...
| Gemini 3.1 Pro (`gemini-3.1-pro`) | preview | 2026-02-19 | 1M | $2.00 | $12.00 | Sparse mixture-of-experts multimodal transformer | Frontier multimodal reasoning and long-context problem solving | prev: gemini-3-pro → superseded by: gemini-3.5-pro-preview |
| Gemini 3.1 Pro (`gemini-3.1-pro-preview`) | preview | 2026-02-19 | 1M | $2.00 | $12.00 | Sparse mixture-of-experts multimodal transformer | Frontier reasoning, agentic coding, complex multimodal tasks | prev: gemini-3-pro → superseded by: gemini-3.1-pro |
...
| Muse Glimmer 30B (`muse-glimmer-30b`) | ga | 2026-08-10 | 131K | — | — | Dense causal transformer — ~29.6B params, 52 layers, GQA, with ~1.8B ViT-G/14 vision encoder | Local multimodal agents on one consumer GPU | — |
...
| Llama 3.3 70B Instruct (`llama-3.3-70b-instruct`) | ga | 2024-12-06 | 131K | — | — | Dense decoder-only transformer, 70B parameters, GQA | Efficient dense 70B text model for multilingual chat | prev: llama-3.1-70b-instruct → superseded by: llama-4-scout-17b-16e-instruct |
...
| Phi-4-reasoning-vision-15B (`microsoft/Phi-4-reasoning-vision-15B`) | ga | 2026-03-04 | 16K | — | — | Phi-4-reasoning backbone + SigLIP-2 vision encoder, mid-fusion | Multimodal reasoning on charts, diagrams, UI | prev: microsoft/Phi-4-multimodal-instruct |
...
| Phi-4-reasoning-plus (`microsoft/Phi-4-reasoning-plus`) | ga | 2025-04-30 | 33K | — | — | 14B dense Transformer fine-tuned from Phi-4 (SFT + RL) | Open-weight small-model reasoning for math and code | prev: microsoft/phi-4 → superseded by: microsoft/phi-4-reasoning-vision |
...
| Phi-4-mini-instruct (`microsoft/Phi-4-mini-instruct`) | ga | 2025-02-27 | 131K | $0.07 | $0.23 | 3.8B dense decoder-only Transformer | Edge and on-device chat completion | prev: microsoft/Phi-3-mini |
| Phi-4-multimodal (`Phi-4-multimodal-instruct`) | ga | 2025-02-27 | 131K | $0.08 | $0.32 | 5.6B multimodal decoder-only transformer | Small multimodal speech, vision, and text tasks | prev: Phi-3.5-vision |
...
| Phi-4 (`Phi-4`) | ga | 2024-12-12 | 16K | $0.12 | $0.50 | 14B dense decoder-only transformer | Small model reasoning, math, and code on-device | prev: Phi-3.5 → superseded by: phi-4-reasoning |
...
| MAI-Thinking-1 (`MAI-Thinking-1`) | preview | 2026-05-19 | 262K | $2.00 | $8.00 | Sparse Mixture-of-Experts, ~1T total parameters, ~35B active | Enterprise reasoning and complex coding tasks | prev: MAI-1-preview |
...
| Mistral Medium 3.5 (`mistral-medium-latest`) | ga | 2026-04-30 | 262K | $1.50 | $7.50 | Dense 128B parameter transformer | Unified reasoning, coding, and instruction-following | prev: mistral-medium-2508 |
| Mistral Medium 3.5 (`mistral-medium-2604`) | ga | 2026-04-29 | 262K | $1.50 | $7.50 | 128B dense multimodal transformer | Balanced multimodal agentic and coding workloads | prev: mistral-medium-2505 |
| Mistral Medium 3.5 (`mistral-medium-3-5`) | ga | 2026-04-29 | 262K | $1.50 | $7.50 | 128B dense multimodal transformer | Balanced coding, reasoning, and vision tasks | prev: mistral-medium-2508 |
...
| Mistral Small 4 (`mistral-small-2603`) | ga | 2026-03-16 | 262K | $0.15 | $0.60 | 119B-parameter Mixture-of-Experts | Unified small-tier multimodal, reasoning, coding | prev: mistral-small-2503 |
| Mistral Small 4 (`mistral-small-latest`) | ga | 2026-03-16 | 262K | $0.10 | $0.30 | Hybrid mixture-of-experts, 6.5B active of 119B total | Cheap multimodal model with configurable reasoning | prev: mistral-small-2506 |
...
| Ministral 3 8B (`ministral-8b-2512`) | ga | 2025-12-02 | 262K | $0.15 | $0.15 | 8B dense transformer with vision encoder | Edge and on-device inference with reasoning | prev: ministral-8b-2410 |
...
| Mistral Large 3 (`mistral-large-latest`) | ga | 2025-12-02 | 262K | $0.50 | $1.50 | Sparse mixture-of-experts, 41B active of 675B total, 2.5B vision encoder | Flagship multimodal reasoning and enterprise workflows | prev: mistral-large-2411 |
...
| Codestral (`codestral-latest`) | ga | 2025-08-01 | 262K | $0.30 | $0.90 | Dense transformer specialized for code | Code generation and IDE completion across 80+ languages | prev: codestral-2501 |
...
| Devstral 2 (`devstral-2-2512`) | deprecated | 2025-12-09 | 262K | $0.40 | $2.00 | 123B dense transformer | Agentic coding - multi-file edits and long agents | prev: devstral-medium-2507 → superseded by: devstral-2-25-12 |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K3 (`kimi-k3`) | ga | 2026-07-16 | 1M | $3.00 | $15.00 | 2.8T-parameter Mixture-of-Experts with Kimi Delta Attention (KDA) and Attention Residuals; ~104B active parameters | Frontier agentic coding and multimodal reasoning | prev: kimi-k2.6 |
| Kimi K2.7 Code (`kimi-k2.7-code`) | ga | 2026-06-12 | 262K | $0.95 | $4.00 | Mixture-of-Experts (~1T total, ~32B active) multimodal, thinking-mode default | Long-horizon agentic coding tasks | prev: kimi-k2.6 |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262K | $0.95 | $4.00 | 1T-parameter Mixture-of-Experts with 32B active per token; 384 experts (8 selected + 1 shared), 61 layers, Multi-head Latent Attention (MLA) | General-purpose multimodal agentic workflows | prev: kimi-k2.5 → superseded by: kimi-k3 |
| Kimi K2.5 (`kimi-k2.5`) | ga | 2026-01-27 | 262K | $0.60 | $3.00 | 1T-parameter MoE (K2 family), 32B activated parameters | Lower-cost general-purpose Kimi tier | prev: kimi-k2-thinking → superseded by: kimi-k2.6 |
| Kimi K2 Thinking (`kimi-k2-thinking`) | ga | 2025-11-06 | 262K | $0.60 | $2.50 | Sparse MoE — 1T total / 32B active per token; native int4 quantization | Interleaved reasoning with tool use at low cost | prev: kimi-k2-0905-preview → superseded by: kimi-k3 |
...
| Moonshot v1 (8k/32k/128k) (`moonshot-v1-128k`) | deprecated | 2024-01-31 | 131K | $2.00 | $5.00 | Dense transformer (not disclosed in detail) | Legacy long-context chat before K2/K3 | prev: moonshot-v1-32k → superseded by: kimi-k2.6 |
...
| Nemotron Nano 9B v2 (`nvidia/nemotron-nano-9b-v2`) | ga | 2025-08-18 | 131K | — | — | Hybrid Mamba-2 / Transformer (Nemotron-H) | Efficient on-device reasoning with thinking budget | — |
...
| GPT-5.6 Luna (`gpt-5.6-luna`) | ga | 2026-07-09 | 1.1M | $0.20 | $1.20 | GPT-5.6 series cost-efficient model | High-volume, latency-sensitive, cost-efficient tasks | prev: gpt-5-nano |
| GPT-5.6 Sol (`gpt-5.6-sol`) | ga | 2026-07-09 | 1.1M | $5.00 | $30.00 | GPT-5.6 series flagship reasoning model | Frontier reasoning, coding, and agentic workflows | prev: gpt-5.5 |
| GPT-5.6 Terra (`gpt-5.6-terra`) | ga | 2026-07-09 | 1.1M | $2.00 | $12.00 | GPT-5.6 series balanced reasoning model | Balanced everyday work at moderate cost | prev: gpt-5.5 |
...
| GPT-5.5 (`gpt-5.5`) | ga | 2026-04-24 | 1.1M | $5.00 | $30.00 | First full retrain since GPT-4.5; frontier reasoning model | Prior-generation agentic coding and computer use | prev: gpt-5 → superseded by: gpt-5.6-sol |
