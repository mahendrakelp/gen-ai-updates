...
_Last refreshed: 2026-06-23 by genai-model-catalog routine._

**Coverage:** 14 providers · 107 models.
...
| Qwen3.5-Omni-Plus (`qwen3.5-omni-plus`) | ga | 2026-03-30 | 262.1K | $0.40 | $4.80 | Hybrid-Attention Mixture-of-Experts (30B total, 3B active) | Native omni-modal text, audio, image, video | prev: `qwen3-omni` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| North Mini Code 1.0 (`north-mini-code-1.0`) | ga | 2026-06-09 | 262.1K | — | — | Sparse Mixture-of-Experts - 30B total / 3B active parameters | Open-weights agentic coding on a single H100 | — |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Gemini 3 Flash (`gemini-3-flash`) | ga | 2026-06-22 | 1.05M | $0.50 | $3.00 | Sparse mixture-of-experts transformer with thinking | Frontier reasoning at Flash speed and cost | prev: `gemini-2.5-flash` |
| Gemini 3.5 Flash (`gemini-3.5-flash`) | ga | 2026-05-19 | 1.05M | $1.50 | $9.00 | Sparse mixture-of-experts transformer with thinking | Frontier agents and coding at Flash speed | prev: `gemini-3-flash` |
| Gemini 3.1 Flash-Lite (`gemini-3.1-flash-lite`) | ga | 2026-05-07 | 1.05M | $0.25 | $1.50 | Distilled sparse mixture-of-experts | Cost-efficient high-volume multimodal tasks | prev: `gemini-2.5-flash-lite` |
| Gemini 3.1 Pro (`gemini-3.1-pro`) | ga | 2026-02-19 | 1.05M | $2.00 | $12.00 | Sparse mixture-of-experts transformer with thinking | Deep reasoning, long-context, agentic coding | prev: `gemini-2.5-pro` |
| Gemini 3.5 Pro (`gemini-3.5-pro-preview`) | preview | 2026-05-20 | 2.1M | — | — | — | Frontier reasoning, deep multimodal, very long context | prev: `gemini-3.1-pro-preview` |
...
| Gemini 3.1 Pro (`gemini-3.1-pro-preview`) | preview | 2026-02-19 | 1.05M | $2.00 | $12.00 | Sparse mixture-of-experts transformer with thinking | Deep reasoning, long-context, agentic coding | prev: `gemini-2.5-pro` |
| Gemini 3.1 Flash Lite (`gemini-3.1-flash-lite-preview`) | deprecated | 2026-03-03 | 1.05M | $0.25 | $1.50 | Distilled sparse mixture-of-experts | Highest-volume, cost-sensitive multimodal tasks | prev: `gemini-2.5-flash-lite` → superseded by: `gemini-3.1-flash-lite` |
| Gemini 2.5 Flash-Lite (`gemini-2.5-flash-lite`) | deprecated | 2025-07-22 | 1.05M | $0.10 | $0.40 | Distilled sparse mixture-of-experts | Highest-volume, lowest-latency batch workloads | prev: `gemini-2.0-flash-lite` → superseded by: `gemini-3.1-flash-lite-preview` |
| Gemini 2.5 Flash (`gemini-2.5-flash`) | deprecated | 2025-06-17 | 1.05M | $0.30 | $2.50 | Sparse mixture-of-experts transformer | Legacy low-cost multimodal Flash workloads | prev: `gemini-1.5-flash` → superseded by: `gemini-3.5-flash` |
| Gemini 2.5 Pro (`gemini-2.5-pro`) | deprecated | 2025-06-17 | 1.05M | $1.25 | $10.00 | Sparse mixture-of-experts transformer | Legacy long-context reasoning workloads | prev: `gemini-1.5-pro` → superseded by: `gemini-3.1-pro-preview` |

## Meta

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Llama 4 Maverick (`llama-4-maverick`) | ga | 2025-04-05 | 1.05M | $0.17 | $0.60 | Mixture-of-Experts (400B total, 17B active, 128 routed + 1 shared expert) | High-quality open multimodal chat and vision | prev: `llama-3.3-70b` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Phi-4-reasoning-vision-15B (`phi-4-reasoning-vision-15b`) | ga | 2026-03-04 | 16.4K | — | — | Phi-4-Reasoning backbone with SigLIP-2 vision encoder, mid-fusion | Open multimodal reasoning at compact size | prev: `phi-4-reasoning` |
...
| Phi-4-reasoning-plus (`phi-4-reasoning-plus`) | ga | 2025-04-30 | 32.8K | — | — | Dense decoder-only transformer (14B params), fine-tuned from Phi-4 | Open-weight reasoning for math and science | prev: `phi-4` → superseded by: `phi-4-reasoning-vision-15b` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Mistral Medium 3.5 (`mistral-medium-2604`) | ga | 2026-04-29 | 262.1K | $1.50 | $7.50 | Dense 128B parameter multimodal transformer with retrained vision encoder | Unified agentic, coding, and multi-step reasoning workloads | prev: `mistral-medium-2508` |
...
| Mistral Large 3 (`mistral-large-2512`) | ga | 2025-12-02 | 262.1K | $0.50 | $1.50 | Granular Mixture-of-Experts, 675B total / 41B active params, plus 2.5B vision encoder | Frontier open-weight multimodal and agentic tasks | prev: `mistral-large-2411` |
...
| Magistral Medium 1.2 (`magistral-medium-2509`) | deprecated | 2025-09-18 | 131.1K | $2.00 | $5.00 | Reasoning model trained via reinforcement learning on Mistral Medium 3 | Math and code reasoning with image input support | prev: `magistral-medium-2507` → superseded by: `mistral-medium-2604` |

## Moonshot

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K2.7 Code (`kimi-k2.7-code`) | ga | 2026-06-12 | 262.1K | $0.95 | $4.00 | Sparse MoE - 1T total / 32B active, 384 experts, MoonViT vision encoder (inherited from K2.6) | Long-horizon agentic coding and software engineering | prev: `kimi-k2.6` |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262.1K | $0.95 | $4.00 | Sparse MoE - 1T total / 32B active, 384 experts (8+1 shared), 61 layers, MLA, MoonViT vision encoder | Open-weight agentic coding and tool use | prev: `kimi-k2.5` → superseded by: `kimi-k2.7-code` |
| Kimi K2.5 (`kimi-k2.5`) | ga | 2026-01-26 | 262.1K | $0.60 | $3.00 | Sparse MoE - 1T total / 32B active, 384 experts, MoonViT vision encoder | Cost-efficient open-weight multimodal agent | prev: `kimi-k2-thinking` → superseded by: `kimi-k2.6` |
...
| gpt-oss-120b (`gpt-oss-120b`) | ga | 2025-08-05 | 131.1K | — | — | Mixture-of-Experts transformer (128 experts, 4 active per token; ~5.1B active / 117B total params) | Open-weight reasoning deployment on single GPU | — |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Grok 4.3 (`grok-4.3`) | ga | 2026-04-30 | 1M | $1.25 | $2.50 | Pre-trained model at Grok 4.20 scale with improved architecture and always-on chain-of-thought reasoning, December 2025 knowledge cutoff | Flagship reasoning and agentic workflows | prev: `grok-4.20` |
...
_Schema: see `data/models_store.json` for full per-model fields (modalities, pricing variants, benchmarks, source URLs)._
