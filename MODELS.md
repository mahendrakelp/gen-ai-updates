...
_Last refreshed: 2026-07-18 by genai-model-catalog routine._
...
| Qwen3.5-Omni-Flash (`qwen3.5-omni-flash`) | ga | 2026-03-30 | 262K | $0.10 | $0.80 | Thinker-Talker MoE 30B total / 3B active with Hybrid-Attention | Real-time omni-modal input with speech output | prev: `qwen3-omni-30b-a3b` |
| Qwen3.5-Omni-Plus (`qwen3.5-omni-plus`) | ga | 2026-03-30 | 262K | $0.40 | $4.80 | Thinker-Talker Hybrid-Attention MoE (30B total, 3B active) | Native omni-modal understanding and speech output | prev: `qwen3-omni` |
| Qwen3-Coder-Next (`qwen3-coder-next`) | ga | 2026-02-04 | 262K | $0.11 | $0.80 | Sparse MoE (80B total / 3B active, 512 experts with 10 routed + 1 shared) built on Qwen3-Next-80B-A3B-Base with Gated DeltaNet + Gated Attention hybrid | Open-weight agentic coding for local development | prev: `qwen3-coder-flash` |
| Qwen3-VL-Max (`qwen-vl-max`) | ga | 2025-09-23 | 131K | $0.52 | $2.08 | Multimodal vision-language | Advanced vision-language understanding | — |
| Qwen3-VL-Plus (`qwen3-vl-plus`) | ga | 2025-09-23 | 262K | $0.20 | $1.60 | MoE 235B total / 22B active with Interleaved-MRoPE and DeepStack | Document, chart, and GUI visual understanding | prev: `qwen-vl-plus` → superseded by: `qwen3.7-plus` |
...
| Qwen3-Max (`qwen3-max`) | deprecated | 2025-09-23 | 262K | $0.78 | $3.90 | Mixture-of-Experts Transformer, 1T+ parameters | Prior trillion-parameter flagship (Instruct and Thinking modes) | prev: `qwen2.5-max` → superseded by: `qwen3.7-max` |
...
| Nova 2 Sonic (`amazon.nova-2-sonic-v1:0`) | ga | 2025-12-02 | 1M | $0.33 | $2.75 | Speech-to-speech Transformer | Real-time speech-to-speech conversational AI | prev: `amazon.nova-sonic-v1:0` |
...
| Command A+ (`command-a-plus-05-2026`) | ga | 2026-05-19 | 128K | $2.50 | $10.00 | Sparse MoE, 218B total parameters, 25B active per token (sigmoid router) | Sovereign enterprise multimodal + agentic workloads | prev: `command-a-reasoning-08-2025` |
...
| Command A (`command-a-03-2025`) | ga | 2025-03-13 | 256K | $2.50 | $10.00 | 111B parameter dense transformer | Agentic, multilingual, and coding enterprise use | prev: `command-r-plus-08-2024` → superseded by: `command-a-plus-05-2026` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DeepSeek V4 Flash (`deepseek-v4-flash`) | ga | 2026-07-15 | 1M | $0.14 | $0.28 | Mixture-of-Experts (284B total parameters, 13B active) | High-throughput, low-cost production serving; agents; code; math; supports dual Thinking/Non-Thinking modes | prev: `deepseek-chat` |
| DeepSeek V4 Pro (`deepseek-v4-pro`) | ga | 2026-07-15 | 1M | $0.43 | $0.87 | Mixture-of-Experts (1.6T total parameters, 49B active) | Quality-sensitive reasoning, complex agent task execution, advanced math and code generation | prev: `deepseek-reasoner` |
| DeepSeek Reasoner (`deepseek-reasoner`) | deprecated | 2025-01-20 | 131K | $0.14 | $0.28 | MoE (DeepSeek R1 family) | Legacy alias; migrate to deepseek-v4-pro or deepseek-v4-flash with thinking:enabled | prev: `deepseek-r1` → superseded by: `deepseek-v4-pro` |
| DeepSeek Chat (`deepseek-chat`) | deprecated | 2024-12-26 | 131K | $0.14 | $0.28 | MoE (DeepSeek V3 family) | Legacy alias; migrate to deepseek-v4-flash | prev: `deepseek-v3.2` → superseded by: `deepseek-v4-flash` |

## Google

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Gemini 3 Flash (`gemini-3-flash`) | ga | 2026-06-22 | 1M | $0.50 | $3.00 | Multimodal transformer | Low-cost multimodal at 1M context | prev: `gemini-2.5-flash` → superseded by: `gemini-3.5-flash` |
| Gemini 3.5 Flash (`gemini-3.5-flash`) | ga | 2026-05-19 | 1M | $1.50 | $9.00 | Multimodal transformer | Default across Gemini app, AI Mode, and Enterprise | prev: `gemini-3-flash` |
| Gemini 3.1 Flash-Lite (`gemini-3.1-flash-lite`) | ga | 2026-05-07 | 1M | $0.25 | $1.50 | Multimodal transformer | High-volume, low-latency multimodal workloads | prev: `gemini-2.5-flash-lite` |
| Gemini 3.1 Flash (`gemini-3.1-flash`) | ga | 2026-03-19 | 1M | $0.50 | $3.00 | Sparse mixture-of-experts transformer with thinking | Balanced Flash tier for cost-efficient reasoning | prev: `gemini-3-flash-preview` |
...
| Gemini 3.1 Pro (`gemini-3.1-pro-preview`) | preview | 2026-02-19 | 1M | $2.00 | $12.00 | Transformer-based Mixture-of-Experts | Frontier reasoning over long, multimodal contexts | prev: `gemini-3-pro-preview` |
...
| Gemini 2.5 Flash (`gemini-2.5-flash`) | deprecated | 2025-06-17 | 1M | $0.30 | $2.50 | Sparse mixture-of-experts transformer | Legacy fast general-purpose workloads | prev: `gemini-1.5-flash` → superseded by: `gemini-3.5-flash` |
| Gemini 2.5 Pro (`gemini-2.5-pro`) | deprecated | 2025-03-25 | 1M | $1.25 | $10.00 | Transformer-based Mixture-of-Experts | Legacy high-accuracy reasoning workloads | prev: `gemini-1.5-pro` → superseded by: `gemini-3.1-pro-preview` |

## Meta

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Llama 4 Maverick (`meta-llama/Llama-4-Maverick-17B-128E-Instruct`) | ga | 2025-04-05 | 1M | — | — | Mixture-of-Experts (17B active, 128 experts + 1 shared expert, ~400B total) with early-fusion multimodality | Open-weight flagship multimodal workhorse for chat, coding, and agents | prev: `llama-3.3-70b` |
...
| Llama 3.3 70B Instruct (`llama-3.3-70b`) | ga | 2024-12-06 | 128K | $0.20 | $0.20 | Dense transformer, 70B parameters, 128K context | Dense 70B text-only workhorse with strong instruction following | prev: `llama-3.1-70b` → superseded by: `meta-llama/Llama-4-Maverick-17B-128E-Instruct` |
| Muse Spark 1.1 (`muse-spark-1.1`) | preview | 2026-07-09 | 1M | $1.25 | $4.25 | Natively multimodal reasoning model, agentic tool-use optimized | Multimodal agentic reasoning, tool use, and long-context workloads via Meta Model API | prev: `muse-spark` |
...
| Muse Spark (`muse-spark`) | deprecated | 2026-04-08 | 262K | — | — | Natively multimodal reasoning model | Initial Meta Superintelligence Labs closed model | prev: `llama-4-maverick-17b-128e` → superseded by: `muse-spark-1.1` |
...
| Llama 4 Maverick (legacy ID) (`llama-4-maverick-17b-128e-instruct`) | deprecated | 2025-04-05 | 1M | $0.15 | $0.60 | Mixture-of-Experts, 17B active / 400B total, 128 experts | Multimodal reasoning and general-purpose enterprise workloads | prev: `llama-3.3-70b-instruct` → superseded by: `meta-llama/Llama-4-Maverick-17B-128E-Instruct` |
...
| Llama 4 Scout (legacy ID) (`llama-4-scout-17b-16e-instruct`) | deprecated | 2025-04-05 | 10M | $0.08 | $0.30 | Mixture-of-Experts, 17B active / 109B total, 16 experts | Long-context multimodal tasks on a single H100 | prev: `llama-3.2-90b-vision-instruct` → superseded by: `meta-llama/Llama-4-Scout-17B-16E-Instruct` |
...
| Phi-4-reasoning-plus (`phi-4-reasoning-plus`) | ga | 2025-04-30 | 33K | — | — | 14B dense decoder-only transformer, reasoning-tuned Phi-4 with GRPO reinforcement learning | Small open reasoning model rivaling much larger LLMs | prev: `phi-4` → superseded by: `phi-4-reasoning-vision-15b` |
...
| Phi-4-multimodal-instruct (`phi-4-multimodal-instruct`) | ga | 2025-02-27 | 131K | $0.08 | $0.32 | multimodal SLM (text + audio + vision) | unified speech, vision, and text on small model | — |
| Phi-4 (`phi-4`) | ga | 2024-12-12 | 16K | $0.07 | $0.14 | 14B dense decoder-only transformer, trained on ~9.8T tokens with heavy synthetic data | Small dense general-purpose LLM base | prev: `phi-3.5` → superseded by: `phi-4-reasoning` |
| MAI-Code-1-Flash (`mai-code-1-flash`) | preview | 2026-06-02 | 262K | $0.75 | $4.50 | Sparse Mixture-of-Experts (137B total / 5B active), Copilot-tuned | Fast, cheap coding for GitHub Copilot workflows | — |
...
| MAI-Thinking-1 (`mai-thinking-1`) | preview | 2026-06-02 | 262K | — | — | Sparse Mixture-of-Experts, ~1T total / 35B active parameters, trained from scratch | Microsoft first-party frontier reasoning at low token cost | prev: `mai-1-preview` |
...
| Mistral Small 4 (`mistral-small-2603`) | ga | 2026-03-16 | 262K | $0.15 | $0.60 | Sparse Mixture-of-Experts, 119B total / 6B active parameters | high-volume agentic and coding at low cost | prev: `mistral-small-2506` |
| Mistral Large 3 (`mistral-large-2512`) | ga | 2025-12-02 | 262K | $0.50 | $1.50 | Sparse Mixture-of-Experts, 675B total / 41B active parameters | flagship multimodal agentic and coding tasks | prev: `mistral-large-2411` |
| Codestral 2508 (`codestral-2508`) | ga | 2025-07-30 | 262K | $0.30 | $0.90 | Dense transformer optimized for code (parameter count not disclosed) | code completion, generation, and refactoring | prev: `codestral-2501` |
...
| Magistral Medium 1.2 (`magistral-medium-2509`) | deprecated | 2025-09-18 | 131K | $2.00 | $5.00 | Dense transformer reasoning model with vision encoder, closed weights | Transparent multilingual chain-of-thought reasoning with vision | prev: `magistral-medium-2507` → superseded by: `mistral-medium-2604` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K3 (`kimi-k3`) | ga | 2026-07-16 | 1M | $3.00 | $15.00 | Sparse MoE, ~2.8T total parameters, 16 of 896 experts active per token, Kimi Delta Attention (KDA) + Attention Residuals (AttnRes), native vision | Frontier open-lab reasoning, 1M-token long-context research and agentic workloads | prev: `kimi-k2.7-code` |
| Kimi K2.7 Code (`kimi-k2.7-code`) | ga | 2026-06-12 | 262K | $0.95 | $4.00 | MoE, 1T total / 32B active, 384 experts (8+1 shared), 61 layers, MLA + MoonViT | agentic coding with lower reasoning-token overhead | prev: `kimi-k2.6` |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262K | $0.95 | $4.00 | MoE, 1T total / 32B active, 384 experts (8+1 shared), 61 layers, MLA + MoonViT vision encoder | multimodal agentic coding and long-horizon agent swarms | prev: `kimi-k2.5` → superseded by: `kimi-k2.7-code` |
| Kimi K2.5 (`kimi-k2.5`) | ga | 2026-01-27 | 262K | $0.60 | $3.00 | MoE, 1T total / 32B active, 384 experts, 61 layers, MLA | cost-tier multimodal agentic model | prev: `kimi-k2` → superseded by: `kimi-k2.6` |
...
| Nemotron 3 Nano 4B (`nvidia/nemotron-3-nano-4b`) | ga | 2026-03-17 | 262K | — | — | Hybrid Mamba-2 + MLP with 4 attention layers (dense, ~3.97B params, compressed from Nano 9B v2) | Edge and on-device agentic AI on Jetson and RTX | prev: `nvidia/nvidia-nemotron-nano-9b-v2` |
| Nemotron 3 Super (`nvidia/nemotron-3-super-120b-a12b`) | ga | 2026-03-11 | 1M | $0.15 | $0.65 | Hybrid Mamba2-Transformer LatentMoE, 120B total / 12B active, native NVFP4 pretraining, multi-token prediction | Efficient agentic workloads and complex multi-agent apps | prev: `nvidia/nemotron-2-super` |
...
| Nemotron Nano 9B V2 (`nvidia/nvidia-nemotron-nano-9b-v2`) | ga | 2025-08-18 | 131K | $0.04 | $0.16 | Dense hybrid Mamba-Transformer (9B) | Small reasoning model with thinking budget control | superseded by: `nvidia/nemotron-3-nano-30b-a3b` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| GPT-5.6 Luna (`gpt-5.6-luna`) | ga | 2026-07-09 | 1M | $1.00 | $6.00 | Transformer reasoning model | fast low-cost agentic and bulk workloads | prev: `gpt-5.4-mini` |
| GPT-5.6 Sol (`gpt-5.6-sol`) | ga | 2026-07-09 | 1M | $5.00 | $30.00 | Transformer reasoning model | frontier agentic coding and long-horizon reasoning | prev: `gpt-5.5` |
| GPT-5.6 Terra (`gpt-5.6-terra`) | ga | 2026-07-09 | 1M | $2.50 | $15.00 | Transformer reasoning model | balanced everyday production workloads | prev: `gpt-5.4` |
...
| GPT-5.5 (`gpt-5.5`) | ga | 2026-04-23 | 1M | $5.00 | $30.00 | Transformer reasoning model | general-purpose flagship writing, coding, analysis | prev: `gpt-5` → superseded by: `gpt-5.6-sol` |
...
| gpt-oss-120b (`gpt-oss-120b`) | ga | 2025-08-05 | 131K | $0.03 | $0.15 | Mixture-of-Experts, 117B total parameters, 5.1B active per forward pass, native MXFP4 quantization | Self-hostable open-weights reasoning at low cost | — |
...
| Grok 4.20 (`grok-4.20`) | ga | 2026-03-10 | 2M | $2.00 | $6.00 | reasoning transformer with configurable reasoning effort and 2M context | long-context agentic tool calling at high throughput | prev: `grok-4.1` → superseded by: `grok-4.3` |
...
| Grok 4 Fast Non-Reasoning (`grok-4-fast-non-reasoning`) | deprecated | — | 2M | $0.20 | $0.50 | — | Cheap high-throughput non-reasoning tasks with 2M context | superseded by: `grok-4.3` |
| Grok 4 Fast Reasoning (`grok-4-fast-reasoning`) | deprecated | — | 2M | $0.20 | $0.50 | — | Fast, cheap reasoning with 2M context | superseded by: `grok-4.3` |
| Grok Code Fast 1 (`grok-code-fast-1`) | deprecated | — | 256K | $0.20 | $1.50 | — | Agentic coding across TypeScript/Python/Go/Rust | superseded by: `grok-build-0.1` |
