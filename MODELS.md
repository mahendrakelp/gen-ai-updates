...
| Nova Premier (`amazon.nova-premier-v1:0`) | deprecated | 2025-10-31 | 1M | $2.50 | $12.50 | Transformer, multimodal foundation model | Complex reasoning, agentic workflows, model distillation | prev: `amazon.nova-pro-v1:0` → superseded by: `amazon.nova-2-pro-preview-20251202-v1:0` |
...
| Gemini 3.6 Flash (`gemini-3.6-flash`) | ga | 2026-07-21 | 1M | $1.50 | $7.50 | Sparse Mixture-of-Experts transformer with native multimodal encoders | Default Flash-tier for fast frontier work | prev: `gemini-3.5-flash` |
...
| Gemini 3.5 Flash (`gemini-3.5-flash`) | deprecated | 2026-05-01 | 1M | $1.50 | $9.00 | Sparse Mixture-of-Experts transformer with native multimodal encoders | Legacy Flash tier, migrate to 3.6 Flash | prev: `gemini-3-flash-preview` → superseded by: `gemini-3.6-flash` |
...
| Muse Image (`muse-image`) | preview | 2026-07-07 | — | — | — | Agentic image generation model with tool-use and self-refinement | Instruction-faithful image generation and editing | — |
...
| Mistral Medium 3.5 (`mistral-medium-2604`) | ga | 2026-04-29 | 262K | $1.50 | $7.50 | Dense 128B multimodal transformer with configurable reasoning | Unified agentic coding, reasoning, and multimodal mid-tier | prev: `mistral-medium-2505` |
...
| Mistral Small 4 (`mistral-small-2603`) | ga | 2026-03-16 | 262K | $0.15 | $0.60 | Mixture-of-experts, ~119B total / ~6.5B active parameters, multimodal with configurable reasoning | Unified small model: reasoning, vision, coding | prev: `mistral-small-2506` |
...
| Codestral 25.08 (`codestral-2508`) | ga | 2025-08-01 | 256K | $0.30 | $0.90 | Dense transformer specialized for code generation | Low-latency code completion, FIM and refactors | prev: `codestral-2501` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K3 (`kimi-k3`) | ga | 2026-07-16 | 1M | $3.00 | $15.00 | Sparse MoE, 2.8T total / 104B active, 16 of 896 experts per token, 93 layers (69 Kimi Delta Attention + 24 Gated MLA), MXFP4 weights | Frontier open-weight reasoning, long context, agentic tasks | prev: `kimi-k2.6` |
...
| Kimi K2 Thinking (`kimi-k2-thinking`) | ga | 2025-11-06 | 262K | $0.60 | $2.50 | Mixture-of-Experts, 1T total / 32B active, INT4 native | Long-horizon agentic reasoning with sustained tool use | prev: `kimi-k2` → superseded by: `kimi-k3` |
...
| Nemotron 3 Super 120B A12B (`nvidia/nemotron-3-super-120b-a12b`) | ga | 2026-03-11 | 1M | $0.09 | $0.45 | LatentMoE hybrid Mamba-2 + MoE + Attention with Multi-Token Prediction (~120B total, 12B active) | High-accuracy reasoning for multi-agent apps | prev: `nvidia/llama-3_3-nemotron-super-49b-v1_5` |
...
| Grok 4.5 (`grok-4.5`) | ga | 2026-07-08 | 500K | $2.00 | $6.00 | 1.5T-parameter V9 foundation with configurable reasoning | Coding, agentic and knowledge work | prev: `grok-4.3` |
