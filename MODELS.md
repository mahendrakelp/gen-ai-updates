...
_Last refreshed: 2026-08-17 by genai-model-catalog routine._
...
| Qwen3-VL-Plus (`qwen3-vl-plus`) | ga | 2025-09-23 | 262.1K | $0.21 | $0.88 | Vision-language transformer (hosted variant of Qwen3-VL series, up to 235B-A22B MoE) | Vision-language understanding for images and video | prev: qwen-vl-plus → superseded by: qwen3.7-plus |
...
| Command A+ (`command-a-plus-05-2026`) | ga | 2026-05-20 | 128K | $2.50 | $10.00 | Decoder-only Sparse Mixture-of-Experts Transformer, 218B total / 25B active parameters, 128 experts (8 active per token) plus one shared expert | Enterprise agentic tasks with grounded citations | prev: command-a-03-2025 |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DeepSeek V4 Pro (`deepseek-v4-pro`) | ga | 2026-08-13 | 1.0M | $1.74 | $3.48 | MoE 1.6T total / 49B active, DeepSeek Sparse Attention | Agentic coding and long-context reasoning | prev: deepseek-v3.2 |
...
| DeepSeek V4 Flash (`deepseek-v4-flash`) | ga | 2026-07-31 | 1.0M | $0.14 | $0.28 | MoE 284B total / 13B active, DeepSeek Sparse Attention | High-throughput, cost-sensitive 1M-context tasks | prev: deepseek-chat |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Gemini 3.7 Flash (`gemini-3.7-flash`) | ga | 2026-08-13 | 1.0M | $0.75 | $3.75 | Sparse mixture-of-experts, natively multimodal reasoning model (Gemini 3 series) | High-throughput coding and agent workflows | prev: gemini-3.6-flash |
| Gemini 3.5 Flash-Lite (`gemini-3.5-flash-lite`) | ga | 2026-07-21 | 1.0M | $0.30 | $2.50 | Distilled Gemini 3-family mixture-of-experts | High-volume agentic subagents and translation | prev: gemini-3.1-flash-lite |
...
| Gemini 3.1 Pro (`gemini-3.1-pro-preview`) | preview | 2026-02-19 | 1.0M | $2.00 | $12.00 | Sparse mixture-of-experts multimodal transformer with hybrid reasoning | Frontier reasoning, multimodal analysis, agentic workflows | prev: gemini-2.5-pro |
...
| Llama 4 Maverick (`meta-llama/Llama-4-Maverick-17B-128E-Instruct`) | ga | 2025-04-05 | 1M | $0.27 | $0.85 | 17B active / 400B total Mixture-of-Experts with 128 experts, early-fusion multimodal transformer | Flagship multimodal general-purpose workhorse | prev: meta-llama/Llama-3.3-70B-Instruct |
...
| Llama 4 Scout (`meta-llama/Llama-4-Scout-17B-16E-Instruct`) | ga | 2025-04-05 | 10M | $0.10 | $0.30 | 17B active / 109B total Mixture-of-Experts with 16 experts, early-fusion multimodal transformer | Long-context multimodal on a single GPU | prev: meta-llama/Llama-3.3-70B-Instruct |
...
| Phi-4-reasoning-vision-15B (`microsoft/phi-4-reasoning-vision-15B`) | ga | 2026-03-04 | 16.4K | — | — | Mid-fusion: SigLIP-2 Naflex vision encoder + Phi-4-Reasoning backbone, 15B parameters | Compact multimodal reasoning for math, science, UI | prev: microsoft/phi-4-multimodal-instruct |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K3 (`kimi-k3`) | ga | 2026-07-16 | 1.0M | $3.00 | $15.00 | 2.8T-parameter MoE with Kimi Delta Attention (KDA) hybrid linear/full attention, ~104B active parameters per token (16 of 896 experts) | Frontier reasoning, agentic tasks, long-context work | prev: kimi-k2.7-code |
...
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262.1K | $0.95 | $4.00 | 1T-parameter MoE with 32B active parameters per token, 384 experts (8+1 shared), 61 layers, Multi-head Latent Attention (MLA), 400M MoonViT vision encoder | Balanced everyday agentic and multimodal workloads | prev: kimi-k2.5 → superseded by: kimi-k3 |
...
| Nemotron 3 Ultra (`nvidia/nemotron-3-ultra-550b-a55b`) | ga | 2026-06-04 | 1M | $0.50 | $2.20 | Hybrid LatentMoE Mamba-2/Transformer with Multi-Token Prediction (MTP), NVFP4 pre-training | Frontier agentic reasoning and orchestration | prev: nvidia/llama-3.1-nemotron-ultra-253b-v1 |
...
| Nemotron 3 Super (`nvidia/nemotron-3-super-120b-a12b`) | ga | 2026-03-11 | 1M | $0.09 | $0.45 | Hybrid LatentMoE Mamba-2/Transformer with Multi-Token Prediction (MTP), NVFP4 pre-training | Efficient multi-agent and coding workloads | prev: nvidia/llama-3.3-nemotron-super-49b-v1 → superseded by: nvidia/nemotron-3-ultra-550b-a55b |
...
| GPT-5.6 Luna (`gpt-5.6-luna`) | ga | 2026-07-09 | 1.1M | $0.20 | $1.20 | Fast, cost-efficient variant of the GPT-5.6 family | High-volume, low-cost everyday tasks | prev: gpt-5.4-nano |
| GPT-5.6 Sol (`gpt-5.6-sol`) | ga | 2026-07-09 | 1.1M | $5.00 | $30.00 | Frontier multimodal reasoning model with extended thinking | Hardest coding, reasoning, and agentic tasks | prev: gpt-5.5 |
| GPT-5.6 Terra (`gpt-5.6-terra`) | ga | 2026-07-09 | 1.1M | $2.00 | $12.00 | Mid-tier variant of the GPT-5.6 family | Balanced production workloads at moderate cost | prev: gpt-5.5 |
...
| Sonar Deep Research (`sonar-deep-research`) | deprecated | 2025-03-07 | 128K | $2.00 | $8.00 | Deep research agent | Exhaustive research; migrate to Agent API high | → superseded by: agent-api-high |
| Sonar Reasoning Pro (`sonar-reasoning-pro`) | deprecated | 2025-01-28 | 128K | $2.00 | $8.00 | Reasoning search LLM | Analytical reasoning; migrate to Agent API medium | prev: sonar-reasoning → superseded by: agent-api-medium |
| Sonar (`sonar`) | deprecated | 2025-01-27 | 128K | $1.00 | $1.00 | Search-grounded LLM | Fast grounded search; migrate to Agent API | → superseded by: agent-api-fast |
| Sonar Pro (`sonar-pro`) | deprecated | 2025-01-21 | 200K | $3.00 | $15.00 | Search-grounded LLM | Multi-source queries; migrate to Agent API low | prev: sonar → superseded by: agent-api-low |
| Sonar Reasoning (`sonar-reasoning`) | deprecated | 2025-01-21 | 128K | $1.00 | $5.00 | Reasoning search LLM | Chain-of-thought reasoning (retired) | → superseded by: sonar-reasoning-pro |
