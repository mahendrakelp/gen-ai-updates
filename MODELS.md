...
_Last refreshed: 2026-08-14 by genai-model-catalog routine._
...
| Qwen3.7-Max (`qwen3.7-max`) | ga | 2026-05-21 | 262.1K | $1.65 | $4.95 | Mixture-of-Experts frontier model | Latest flagship reasoning and enterprise chat | prev: qwen3-max → superseded by: qwen3.8-max |
...
| Qwen3-Max (`qwen3-max`) | ga | 2025-09-23 | 262.1K | $1.20 | $6.00 | Mixture-of-Experts — over 1T total parameters | Flagship general-purpose reasoning and chat | prev: qwen-max → superseded by: qwen3.7-max |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DeepSeek V4-Pro-0813 (`deepseek-v4-pro-0813`) | ga | 2026-08-13 | 1M | $0.43 | $0.87 | Mixture-of-Experts — 1.6T total / 49B active, hybrid Compressed Sparse Attention + Heavily Compressed Attention | Agentic coding, tool use, and long-context reasoning | prev: deepseek-v4-pro |
...
| DeepSeek V4 Flash (`deepseek-v4-flash`) | ga | 2026-07-31 | 1M | $0.14 | $0.28 | Sparse MoE with Compressed Sparse Attention — 284B total / 13B active | Cheap, fast reasoning and agent workflows | prev: deepseek-v3.2 |
| DeepSeek V4 Pro (`deepseek-v4-pro`) | ga | 2026-04-24 | 1M | $0.43 | $0.87 | Mixture-of-Experts — 1.6T total / 49B active, hybrid attention | Flagship coding, reasoning, and agentic work | prev: deepseek-v3.2 |
...
| DeepSeek Reasoner (legacy alias) (`deepseek-reasoner`) | deprecated | 2025-01-20 | 1M | $0.14 | $0.28 | Alias — routed to V4 Flash thinking mode | Legacy thinking-mode routing label | prev: deepseek-r1 → superseded by: deepseek-v4-flash |
| DeepSeek Chat (legacy alias) (`deepseek-chat`) | deprecated | 2024-12-26 | 1M | $0.14 | $0.28 | Alias — routed to V4 Flash non-thinking mode | Legacy non-thinking chat routing label | prev: deepseek-v3.2 → superseded by: deepseek-v4-flash |

## Google

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Gemini 3.7 Flash (`gemini-3.7-flash`) | ga | 2026-08-13 | 1M | $0.75 | $3.75 | Refinement of Gemini 3.6 Flash reasoning foundation | Coding and agents workhorse | prev: gemini-3.6-flash |
| Gemini 3.6 Flash (`gemini-3.6-flash`) | ga | 2026-07-21 | 1M | $1.50 | $7.50 | Sparse Mixture-of-Experts transformer | High-throughput agents, coding, and multimodal workflows | prev: gemini-3.5-flash → superseded by: gemini-3.7-flash |
| Gemini 3.5 Flash-Lite (`gemini-3.5-flash-lite`) | ga | 2026-07-21 | 1M | $0.30 | $2.50 | Sparse Mixture-of-Experts transformer | High-volume low-latency search, translation, extraction | prev: gemini-2.5-flash-lite |
...
| Gemini 3 Pro (`gemini-3-pro`) | ga | 2025-11-18 | 1M | $2.00 | $12.00 | Sparse Mixture-of-Experts transformer | General flagship reasoning and multimodal agentic use | prev: gemini-2.5-pro → superseded by: gemini-3.1-pro |
| Gemini 2.5 Flash-Lite (`gemini-2.5-flash-lite`) | ga | 2025-09-25 | 1M | $0.10 | $0.40 | Sparse mixture-of-experts transformer, most efficient of the 2.5 family | Ultra-cheap high-throughput classification and extraction | prev: gemini-2.0-flash-lite → superseded by: gemini-3.1-flash-lite |
| Gemini 2.5 Flash (`gemini-2.5-flash`) | ga | 2025-05-20 | 1M | $0.30 | $2.50 | Sparse mixture-of-experts transformer with hybrid reasoning (thinking on/off) | High-volume production workloads with hybrid reasoning | prev: gemini-2.0-flash → superseded by: gemini-3.6-flash |
...
| Gemini 3.1 Pro (`gemini-3.1-pro-preview`) | preview | 2026-02-01 | 1M | $2.00 | $12.00 | Sparse Mixture-of-Experts transformer | Frontier reasoning, coding, and agentic tasks | prev: gemini-3-pro |
...
| Gemini 2.5 Pro (`gemini-2.5-pro`) | deprecated | 2025-06-17 | 1M | $1.25 | $10.00 | Sparse Mixture-of-Experts transformer | Legacy production workloads before Gemini 3 migration | prev: gemini-1.5-pro → superseded by: gemini-3.1-pro-preview |
...
| Muse Spark 1.2 (`meta/muse-spark-1.2`) | preview | 2026-08-05 | 1M | $1.25 | $4.25 | — | agentic multimodal reasoning and coding tasks | prev: meta/muse-spark-1.1 |
...
| MAI-Code-1.1-Flash (`mai-code-1.1-flash`) | preview | 2026-08-11 | 256K | $0.20 | $1.20 | Sparse MoE transformer — 138B total / 5B active parameters | Cheap fast coding with native image understanding | prev: mai-code-1-flash |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K3 (`kimi-k3`) | ga | 2026-07-16 | 1M | $3.00 | $15.00 | MoE — 2.8T total with Stable LatentMoE (16 of 896 experts active) | Long-context agentic coding and multimodal reasoning | prev: kimi-k2-thinking |
| Kimi K2.7-Code (`kimi-k2.7-code`) | ga | 2026-06-12 | 262.1K | $0.95 | $4.00 | MoE — 1T total / 32B active across 384 experts | Cost-efficient agentic coding and repo-scale tasks | prev: kimi-k2.6 |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262.1K | $0.95 | $4.00 | MoE — 1T total / 32B active, 384 experts (8+1 shared), 61 layers, MLA | Value-tier general-purpose multimodal reasoning | prev: kimi-k2-thinking → superseded by: kimi-k3 |
...
| Kimi K2 Thinking (`kimi-k2-thinking`) | deprecated | 2025-11-06 | 262.1K | $0.60 | $2.50 | MoE — 1T total / 32B active per forward pass | Legacy reasoning workloads; migrate to kimi-k3 | prev: kimi-k2-0905 → superseded by: kimi-k3 |
...
| GPT-5.6 Terra (`gpt-5.6-terra`) | ga | 2026-07-09 | 1.1M | $2.00 | $12.00 | Mid-tier variant of the GPT-5.6 family | Balanced everyday coding, reasoning, and agentic work | prev: gpt-5.5 |
| GPT-5.6 Sol (`gpt-5.6-sol`) | ga | 2026-07-09 | 1.1M | $5.00 | $30.00 | Frontier multimodal reasoning model with extended thinking | Frontier reasoning, agentic coding, long-horizon tasks | prev: gpt-5.5 |
| GPT-5.6 Luna (`gpt-5.6-luna`) | ga | 2026-07-09 | 1.1M | $0.20 | $1.20 | Fast, cost-efficient variant of the GPT-5.6 family | High-volume, latency-sensitive chat and classification | prev: gpt-5.5 |
...
| GPT-5.5 Pro (`gpt-5.5-pro`) | ga | 2026-04-23 | 1.1M | $30.00 | $180.00 | Pro variant of GPT-5.5 with extended reasoning compute | Highest-effort reasoning on hardest problems | prev: gpt-5.4-pro → superseded by: gpt-5.6-sol |
