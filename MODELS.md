...
_Last refreshed: 2026-06-29 by genai-model-catalog routine._

Total models tracked: **114** across 14 providers.

## Alibaba

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Qwen3.7-Plus (`qwen3.7-plus`) | ga | 2026-06-01 | 1M | $0.40 | $1.60 | Multimodal MoE with early-fusion vision-language training... | Low-cost multimodal agent with vision and video | prev: `qwen3-vl-plus` |
| Qwen3.7-Max (`qwen3.7-max`) | ga | 2026-05-21 | 1M | $2.50 | $7.50 | Hybrid attention Mixture-of-Experts (~1.6T total paramete... | Flagship agentic reasoning and long-horizon coding | prev: `qwen3-max` |
...
| Qwen3.5-Omni-Plus (`qwen3.5-omni-plus`) | ga | 2026-03-30 | 262.144K | $0.40 | $4.80 | Hybrid-Attention Mixture-of-Experts (30B total, 3B active) | Native omni-modal text, audio, image, video | prev: `qwen3-omni` |
| Qwen3-Coder-Next (`qwen3-coder-next`) | ga | 2026-02-04 | 262.144K | $0.11 | $0.80 | Sparse MoE (80B total, 3B active) | Open-weight agentic coding for local development | prev: `qwen3-coder-flash` |
| Qwen3-Coder-Plus (`qwen3-coder-plus`) | ga | 2025-09-23 | 1M | $1.00 | $5.00 | Sparse MoE (480B total, 35B active, 160 experts with 8 ro... | Repository-scale agentic coding with 1M context | prev: `qwen2.5-coder` |
...
| Amazon Nova 2 Sonic (`amazon.nova-2-sonic-v1:0`) | ga | 2025-12-02 | 1M | $3.00 | $12.00 | Unified speech-to-speech transformer with bidirectional s... | Real-time conversational speech-to-speech AI | prev: `amazon.nova-sonic-v1:0` |
| Amazon Nova 2 Pro (Preview) (`amazon.nova-2-pro-preview-20251202-v1:0`) | preview | 2025-12-02 | 1M | $2.19 | $17.50 | Multimodal reasoning transformer with adjustable reasonin... | Complex agentic coding and long-range planning | prev: `amazon.nova-pro-v1:0` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| North Mini Code 1.0 (`north-mini-code-1.0`) | ga | 2026-06-09 | 262.144K | — | — | Sparse Mixture-of-Experts - 30B total / 3B active parameters | Open-weights agentic coding on a single H100 | — |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Gemini 3.5 Flash (`gemini-3.5-flash`) | ga | 2026-05-19 | 1.04858M | $1.50 | $9.00 | Sparse mixture-of-experts transformer with thinking | Frontier agents and coding at Flash speed | prev: `gemini-3-flash` |
| Gemini 3.1 Flash-Lite (`gemini-3.1-flash-lite`) | ga | 2026-05-07 | 1.04858M | $0.25 | $1.50 | Distilled sparse mixture-of-experts | Cost-efficient high-volume multimodal tasks | prev: `gemini-2.5-flash-lite` |
| Gemini 3.1 Pro (`gemini-3.1-pro`) | ga | 2026-02-19 | 1.04858M | $2.00 | $12.00 | Sparse mixture-of-experts transformer with thinking | Deep reasoning, long-context, agentic coding | prev: `gemini-2.5-pro` |
...
| Gemini 3 Flash (`gemini-3-flash-preview`) | preview | 2026-06-22 | 1.04858M | $0.50 | $3.00 | Sparse mixture-of-experts transformer with thinking | Computer Use agents and budget-friendly preview workloads | prev: `gemini-2.5-flash` → superseded by: `gemini-3.5-flash` |
| Gemini 3.5 Pro (`gemini-3.5-pro-preview`) | preview | 2026-05-19 | 2.09715M | — | — | Sparse mixture-of-experts transformer with thinking | Frontier reasoning, deep multimodal, very long context | prev: `gemini-3.1-pro` |
...
| Gemini 3.1 Flash Lite (`gemini-3.1-flash-lite-preview`) | deprecated | 2026-03-03 | 1.04858M | $0.25 | $1.50 | Distilled sparse mixture-of-experts | Highest-volume, cost-sensitive multimodal tasks | prev: `gemini-2.5-flash-lite` → superseded by: `gemini-3.1-flash-lite` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Llama 4 Maverick (`llama-4-maverick`) | ga | 2025-04-05 | 1.04858M | $0.17 | $0.60 | Mixture-of-Experts (400B total, 17B active, 128 routed + ... | High-quality open multimodal chat and vision | prev: `llama-3.3-70b` |
...
| Llama 3.3 70B Instruct (`llama-3.3-70b`) | ga | 2024-12-06 | 128K | $0.23 | $0.40 | Dense transformer with Grouped-Query Attention (70B param... | Efficient open-weight multilingual text generation | prev: `llama-3.1-70b` → superseded by: `llama-4-scout` |
| Muse Spark (`muse-spark`) | preview | 2026-04-08 | 1M | — | — | Natively multimodal reasoning model with multi-agent infe... | Meta's frontier proprietary multimodal reasoning model | — |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| MAI-Code-1-Flash (`mai-code-1-flash`) | ga | 2026-06-02 | 256K | $0.75 | $4.50 | Sparse Mixture-of-Experts transformer (~137B total / 5B a... | Fast, low-cost coding inside Copilot and Foundry | — |
| Phi-4-reasoning-vision-15B (`phi-4-reasoning-vision-15b`) | ga | 2026-03-04 | 16.384K | — | — | Phi-4-Reasoning backbone with SigLIP-2 vision encoder, mi... | Open multimodal reasoning at compact size | prev: `phi-4-reasoning` |
...
| Phi-4-reasoning-plus (`phi-4-reasoning-plus`) | ga | 2025-04-30 | 32.768K | — | — | Dense decoder-only transformer (14B params), fine-tuned f... | Open-weight reasoning for math and science | prev: `phi-4` → superseded by: `phi-4-reasoning-vision-15b` |
...
| Phi-4-multimodal (`phi-4-multimodal-instruct`) | ga | 2025-02-26 | 131.072K | $0.05 | $0.10 | Dense decoder-only transformer with mixture-of-LoRAs | Compact unified text, vision, and speech model | — |
| Phi-4 (`phi-4`) | ga | 2024-12-12 | 16.384K | $0.07 | $0.14 | Dense decoder-only transformer | Cost-efficient small language model for general tasks | prev: `phi-3.5` |
...
| MAI-Thinking-1 (`mai-thinking-1`) | preview | 2026-06-02 | 256K | — | — | Sparse Mixture-of-Experts transformer (~35B active / ~1T ... | Advanced reasoning, math, and coding at lower cost | prev: `mai-1-preview` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Mistral Medium 3.5 (`mistral-medium-2604`) | ga | 2026-04-29 | 262.144K | $1.50 | $7.50 | Dense 128B parameter multimodal transformer with retraine... | Unified agentic, coding, and multi-step reasoning workloads | prev: `mistral-medium-2508` |
| Mistral Small 4 (`mistral-small-2603`) | ga | 2026-03-16 | 262.144K | $0.15 | $0.60 | Mixture-of-Experts, 119B total / 6.5B active parameters (... | Low-cost hybrid reasoning, vision, and coding workloads | prev: `mistral-small-2506` |
| Devstral 2 (`devstral-2-2512`) | ga | 2025-12-09 | 262.144K | $0.40 | $2.00 | Dense transformer, 123B parameters | Agentic coding and multi-file edits | prev: `devstral-medium-2507` |
| Devstral Small 2 (`devstral-small-2-2512`) | ga | 2025-12-09 | 262.144K | $0.10 | $0.30 | Dense transformer, 24B parameters | Local low-cost agentic coding on consumer hardware | prev: `devstral-small-2507` |
| Mistral Large 3 (`mistral-large-2512`) | ga | 2025-12-02 | 262.144K | $0.50 | $1.50 | Granular Mixture-of-Experts, 675B total / 41B active para... | Frontier open-weight multimodal and agentic tasks | prev: `mistral-large-2411` |
...
| Magistral Medium 1.2 (`magistral-medium-2509`) | deprecated | 2025-09-18 | 131.072K | $2.00 | $5.00 | Reasoning model trained via reinforcement learning on Mis... | Math and code reasoning with image input support | prev: `magistral-medium-2507` → superseded by: `mistral-medium-2604` |
...
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262.144K | $0.95 | $4.00 | Sparse MoE - 1T total / 32B active, 384 experts (8+1 shar... | Open-weight agentic coding, general chat, and tool use | prev: `kimi-k2.5` → superseded by: `kimi-k2.7-code` |
| Kimi K2.5 (`kimi-k2.5`) | ga | 2026-01-26 | 262.144K | $0.60 | $3.00 | Sparse MoE - 1T total / 32B active, 384 experts, MoonViT ... | Cost-efficient open-weight multimodal agent | prev: `kimi-k2-thinking` → superseded by: `kimi-k2.6` |
...
| GPT-5.5 Pro (`gpt-5.5-pro`) | ga | 2026-04-24 | 1.05M | $30.00 | $180.00 | — | Highest-stakes reasoning and expert engineering | prev: `gpt-5.4-pro` |
| GPT-5.5 (`gpt-5.5`) | ga | 2026-04-23 | 1.05M | $5.00 | $30.00 | — | Agentic coding and complex reasoning | prev: `gpt-5.4` |
...
| gpt-oss-120b (`gpt-oss-120b`) | ga | 2025-08-05 | 131.072K | — | — | Mixture-of-Experts transformer (128 experts, 4 active per... | Open-weight reasoning deployment on single GPU | — |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Grok 4.3 (`grok-4.3`) | ga | 2026-04-30 | 1M | $1.25 | $2.50 | Pre-trained model at Grok 4.20 scale with improved archit... | Flagship reasoning and agentic workflows | prev: `grok-4.20` |
| Grok Voice Think Fast 1.0 (`grok-voice-think-fast-1.0`) | ga | 2026-04-23 | — | — | — | Voice-native model with background reasoning for real-tim... | Full-duplex voice agents for enterprise workflows | — |
| Grok 4.20 (`grok-4.20`) | ga | 2026-03-10 | 2M | $2.00 | $6.00 | Multi-variant LLM with reasoning, non-reasoning, and mult... | Long-context reasoning over 2M tokens | prev: `grok-4-0709` → superseded by: `grok-4.3` |
...
| Grok 4.20 Multi-Agent Beta (`grok-4.20-multi-agent-beta-0309`) | preview | 2026-03-09 | 2M | $2.00 | $6.00 | Four-agent collaborative architecture (Grok, Harper, Benj... | Collaborative multi-agent reasoning and research | prev: `grok-4.20` |
...
_Generated from `data/models_store.json`. Each row's `source_url` field in the JSON store points to the official source for the data._
