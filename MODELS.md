...
_Last refreshed: 2026-07-12 by genai-model-catalog routine._
...
| Gemini 3 Flash (`gemini-3-flash`) | deprecated | 2026-06-22 | 1.0M | $0.50 | $3.00 | Sparse mixture-of-experts transformer with thinking | Legacy Flash-tier reasoning; migrate to 3.1 Flash | prev: gemini-2.5-flash → superseded by: gemini-3.5-flash |
...
| Muse Spark (`muse-spark`) | deprecated | 2026-04-08 | 262.1K | — | — | Natively multimodal early-fusion frontier model (active/total parameters undisclosed); Contemplating mode spawns parallel reasoning agents | First-generation Meta Superintelligence Labs frontier reasoning model (legacy) | prev: llama-4-maverick-17b-128e → superseded by: muse-spark-1.1 |
...
| Phi-4-reasoning-vision-15B (`phi-4-reasoning-vision-15b`) | ga | 2026-03-04 | 16.4K | — | — | Mid-fusion: SigLIP-2 vision encoder + Phi-4-Reasoning 14B backbone (~15B total) | Small-model multimodal reasoning and computer-use agents | prev: phi-4-reasoning |
...
| Mistral Medium 3.5 (`mistral-medium-2604`) | ga | 2026-04-29 | 262.1K | $1.50 | $7.50 | Dense transformer, 128B parameters, native multimodal vision encoder | Enterprise agentic workflows, coding and complex multi-step reasoning | prev: mistral-medium-2508 |
| Mistral Small 4 (`mistral-small-2603`) | ga | 2026-03-16 | 262.1K | $0.15 | $0.60 | Sparse Mixture-of-Experts, 119B total / 6.5B active parameters, native multimodal | Cost-efficient multimodal reasoning and coding at small-tier price | prev: mistral-small-2506 |
| Devstral 2 (`devstral-2512`) | ga | 2025-12-09 | 262.1K | $0.40 | $0.90 | Dense 123B transformer optimized for agentic coding | Agentic coding - multi-file edits and long-running coding agents | prev: devstral-medium-2507 |
...
| Mistral Large 3 (`mistral-large-2512`) | ga | 2025-12-02 | 262.1K | $0.50 | $1.50 | Sparse Mixture-of-Experts, 675B total / 41B active parameters, native vision encoder (2.5B) | Flagship multimodal reasoning and agentic tasks with open weights | prev: mistral-large-2411 |
...
| Codestral 2508 (`codestral-2508`) | ga | 2025-08-01 | 262.1K | $0.30 | $0.90 | Dense transformer optimized for code (parameter count not disclosed) | Low-latency code completion and fill-in-the-middle across 80+ languages | prev: codestral-2501 |
...
| Nemotron 3 Super 120B-A12B (`nvidia/nemotron-3-super-120b-a12b`) | ga | 2026-03-11 | 1M | $0.09 | $0.45 | Hybrid Mamba-2 + Transformer Latent Mixture-of-Experts with Multi-Token Prediction (120B total / 12B active) | Efficient open agentic reasoning on single-node deployments | prev: nvidia/llama-3_3-nemotron-super-49b-v1_5 |
| Nemotron 3 Nano 30B-A3B (`nvidia/nemotron-3-nano-30b-a3b`) | ga | 2025-12-15 | 1M | $0.05 | $0.20 | Hybrid Mamba-2 + Transformer Mixture-of-Experts (31.6B total / 3.2B active, 23 Mamba-2 + 23 MoE + 6 GQA layers) | Efficient on-device and edge agentic reasoning at long context | prev: nvidia/nvidia-nemotron-nano-9b-v2 |
