...
_Last refreshed: 2026-08-13 by genai-model-catalog routine._
...
| Qwen-Plus (`qwen-plus`) | ga | — | 131.1K | $0.40 | $1.20 | — | Balanced cost and performance for general tasks | — |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DeepSeek V4-Pro-0813 (`deepseek-v4-pro-0813`) | ga | 2026-08-13 | 1.0M | $0.43 | $0.87 | Mixture-of-Experts — 1.6T total / 49B active, hybrid Compressed Sparse Attention + Heavily Compressed Attention | Agentic coding, tool use, and long-context reasoning | prev: `deepseek-v4-pro` |
| DeepSeek V4 Flash (`deepseek-v4-flash`) | ga | 2026-07-31 | 1.0M | $0.14 | $0.28 | Sparse MoE with Compressed Sparse Attention — 284B total / 13B active | Cheap, fast reasoning and agent workflows | prev: `deepseek-v3.2` |
| DeepSeek V4-Flash-0731 (`deepseek-v4-flash-0731`) | ga | 2026-07-31 | 1.0M | $0.14 | $0.28 | Sparse Mixture-of-Experts, 284B total / 13B active parameters | Cheap 1M-context reasoning at scale | prev: `deepseek-v4-flash` |
| DeepSeek V4 Pro (`deepseek-v4-pro`) | ga | 2026-04-24 | 1.0M | $0.43 | $0.87 | Mixture-of-Experts — 1.6T total / 49B active, hybrid attention | Flagship coding, reasoning, and agentic work | prev: `deepseek-v3.2` |
...
| DeepSeek Reasoner (legacy alias) (`deepseek-reasoner`) | deprecated | 2025-01-20 | 1.0M | $0.14 | $0.28 | Alias — routed to V4 Flash thinking mode | Legacy thinking-mode routing label | prev: `deepseek-r1` → superseded by: `deepseek-v4-flash` |
| DeepSeek Chat (legacy alias) (`deepseek-chat`) | deprecated | 2024-12-26 | 1.0M | $0.14 | $0.28 | Alias — routed to V4 Flash non-thinking mode | Legacy non-thinking chat routing label | prev: `deepseek-v3.2` → superseded by: `deepseek-v4-flash` |

## Google

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Gemini 3.7 Flash (`gemini-3.7-flash`) | ga | 2026-08-13 | 1.0M | $0.75 | $3.75 | Refinement of Gemini 3.6 Flash reasoning foundation | Coding and agents workhorse | prev: `gemini-3.6-flash` |
| Gemini 3.5 Flash-Lite (`gemini-3.5-flash-lite`) | ga | 2026-07-21 | 1.0M | $0.30 | $2.50 | Sparse Mixture-of-Experts transformer | High-volume low-latency search, translation, extraction | prev: `gemini-2.5-flash-lite` |
| Gemini 3.6 Flash (`gemini-3.6-flash`) | ga | 2026-07-21 | 1.0M | $1.50 | $7.50 | Sparse Mixture-of-Experts transformer | High-throughput agents, coding, and multimodal workflows | prev: `gemini-3.5-flash` → superseded by: `gemini-3.7-flash` |
...
| Gemini 3.1 Flash-Lite (`gemini-3.1-flash-lite`) | ga | 2026-03-03 | 1.0M | $0.25 | $1.50 | Gemini 3 Flash-Lite efficiency-optimized variant | Most cost-effective Gemini for volume workloads | prev: `gemini-2.5-flash-lite` → superseded by: `gemini-3.5-flash-lite` |
| Gemini 3 Pro (`gemini-3-pro`) | ga | 2025-11-18 | 1.0M | $2.00 | $12.00 | Sparse Mixture-of-Experts transformer | General flagship reasoning and multimodal agentic use | prev: `gemini-2.5-pro` → superseded by: `gemini-3.1-pro` |
...
| Gemini 3.1 Pro (`gemini-3.1-pro-preview`) | preview | 2026-02-01 | 1.0M | $2.00 | $12.00 | Sparse Mixture-of-Experts transformer | Frontier reasoning, coding, and agentic tasks | prev: `gemini-3-pro` |
...
| Gemini 2.5 Pro (`gemini-2.5-pro`) | deprecated | 2025-06-17 | 1.0M | $1.25 | $10.00 | Sparse Mixture-of-Experts transformer | Legacy production workloads before Gemini 3 migration | prev: `gemini-1.5-pro` → superseded by: `gemini-3.1-pro-preview` |

## Meta

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Muse Glimmer 30B (`meta/muse-glimmer-30b`) | ga | 2026-08-10 | 131.1K | — | — | 30B dense causal LM with ~1.8B perception encoder; hybrid attention (3 sliding-window layers per global layer); distilled from Muse Spark 1.2 | Local agentic workflows on consumer hardware | — |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K3 (`kimi-k3`) | ga | 2026-07-16 | 1.0M | $3.00 | $15.00 | MoE — 2.8T total with Stable LatentMoE (16 of 896 experts active) | Long-context agentic coding and multimodal reasoning | prev: `kimi-k2-thinking` |
