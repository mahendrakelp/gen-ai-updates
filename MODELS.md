...
_Last refreshed: 2026-08-23 by genai-model-catalog routine._
...
| Qwen3-Coder-Plus (`qwen3-coder-plus`) | ga | 2025-09-23 | 1M | $1.00 | $5.00 | MoE (proprietary variant of Qwen3-Coder-480B-A35B: 480B total / 35B active) | Autonomous coding agents with tool use | prev: `qwen3-coder-480b-a35b-instruct` → superseded by: `qwen3-coder-next` |
...
| Qwen3-VL-Plus (`qwen3-vl-plus`) | ga | 2025-09-23 | 262.1K | $0.80 | $2.40 | Vision-Language MoE (Qwen3-VL series) | Document/image/video understanding at scale | prev: `qwen-vl-plus` → superseded by: `qwen3.5-plus` |
...
| Qwen-Flash (`qwen-flash`) | ga | 2025-07-28 | 1.05M | $0.10 | $0.40 | MoE (Qwen3-Flash generation), replaces qwen-turbo | High-volume low-latency simple tasks | prev: `qwen-turbo` |
| Qwen-Plus (`qwen-plus`) | ga | 2025-07-28 | 1.05M | $0.40 | $1.20 | MoE (Qwen3-Plus generation) | Balanced cost/quality with hybrid thinking | prev: `qwen-plus-2025-04-28` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Amazon Nova 2 Lite (`amazon.nova-2-lite-v1:0`) | ga | 2025-12-02 | 1M | $0.30 | $2.50 | Multimodal transformer with hybrid extended-thinking reasoning | Cost-effective multimodal reasoning and agentic workloads | prev: `amazon.nova-lite-v1:0` |
| Amazon Nova 2 Sonic (`amazon.nova-2-sonic-v1:0`) | ga | 2025-12-02 | 1M | $0.33 | $2.75 | speech-to-speech foundation model | Real-time speech-to-speech conversational AI | prev: `amazon.nova-sonic-v1:0` |
| Amazon Nova Lite (`amazon.nova-lite-v1:0`) | ga | 2024-12-03 | 300K | $0.06 | $0.24 | Multimodal transformer | Low-cost multimodal processing at very high throughput | → superseded by: `amazon.nova-2-lite-v1:0` |
| Amazon Nova Micro (`amazon.nova-micro-v1:0`) | ga | 2024-12-03 | 128K | $0.04 | $0.14 | Text-only transformer | Cheapest, lowest-latency text tasks at scale | → superseded by: `amazon.nova-2-lite-v1:0` |
...
| Amazon Nova 2 Omni (Preview) (`amazon.nova-2-omni-preview-20251202-v1:0`) | preview | 2025-12-02 | 1M | $0.30 | $2.50 | Any-to-any multimodal foundation model | All-in-one multimodal understanding plus image generation | — |
| Amazon Nova 2 Pro (Preview) (`amazon.nova-2-pro-preview-20251202-v1:0`) | preview | 2025-12-02 | 1M | $2.19 | $17.50 | Multimodal reasoning foundation model with extended thinking | Complex multistep reasoning and agentic workflows | prev: `amazon.nova-pro-v1:0` |
...
| Claude Sonnet 5 (`claude-sonnet-5`) | ga | 2026-06-30 | 1M | $2.00 | $10.00 | Sonnet-class agentic model with adaptive thinking | Best combination of speed and intelligence | prev: `claude-sonnet-4-6` |
| Claude Fable 5 (`claude-fable-5`) | ga | 2026-06-09 | 1M | $10.00 | $50.00 | Mythos-class frontier model with newer tokenizer | Next-gen intelligence for long-running agents | prev: `claude-opus-4-8` |
...
| Command A+ (`command-a-plus-05-2026`) | ga | 2026-05-20 | 128K | $2.50 | $10.00 | decoder-only sparse Mixture-of-Experts Transformer (218B total / 25B active, 128 experts, 8 active per token) | Frontier agentic, multilingual, multimodal enterprise workloads | prev: `command-a-03-2025` |
...
| Command A Translate (`command-a-translate-08-2025`) | ga | 2025-08-28 | 16K | — | — | decoder-only Transformer specialized for translation, built on Command A | Private, secure enterprise translation across 23 languages | prev: `command-a-03-2025` |
| Command A Reasoning (`command-a-reasoning-08-2025`) | ga | 2025-08-01 | 256K | $2.50 | $10.00 | decoder-only dense Transformer (111B parameters) tuned for reasoning | Multi-step reasoning, agentic workflows, document review | prev: `command-a-03-2025` → superseded by: `command-a-plus-05-2026` |
| Command A Vision (`command-a-vision-07-2025`) | ga | 2025-07-01 | 128K | $2.50 | $10.00 | multimodal decoder-only Transformer built on Command A | Enterprise document, chart, and OCR understanding | prev: `command-a-03-2025` → superseded by: `command-a-plus-05-2026` |
| Embed v4 (`embed-v4.0`) | ga | 2025-04-15 | 128K | $0.12 | — | multimodal embedding Transformer with Matryoshka output dimensions (256/512/1024/1536) | Multimodal RAG and semantic search embeddings | prev: `embed-english-v3.0` |
| Command A (`command-a-03-2025`) | ga | 2025-03-13 | 256K | $2.50 | $10.00 | decoder-only dense Transformer (111B parameters) | General-purpose agentic, multilingual, coding tasks | prev: `command-r-plus-08-2024` → superseded by: `command-a-plus-05-2026` |
| Command R7B (`command-r7b-12-2024`) | ga | 2024-12-13 | 128K | $0.04 | $0.15 | decoder-only dense Transformer (7B parameters) | Low-cost fast RAG, tool use, on-device deployment | prev: `command-r-08-2024` |
...
| Rerank v3.5 (`rerank-v3.5`) | deprecated | 2024-12-03 | 4.1K | — | — | cross-encoder reranker | Reordering retrieved passages for RAG relevance | prev: `rerank-english-v3.0` → superseded by: `rerank-v4.0-pro` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DeepSeek V4-Pro-0813 (`deepseek-v4-pro-0813`) | ga | 2026-08-13 | 1.05M | $0.66 | $1.98 | Sparse MoE — 1.6T total / 49B active | Version-pinned V4 Pro snapshot for production | prev: `deepseek-v4-pro` |
| DeepSeek V4-Flash-0731 (`deepseek-v4-flash-0731`) | ga | 2026-07-31 | 1.05M | $0.22 | $0.66 | Sparse MoE — 284B total / 13B active | Pinned snapshot for cheap 1M-context inference | prev: `deepseek-v4-flash` |
| DeepSeek V4-Flash-Vision-Exp (`deepseek-v4-flash-vision-exp`) | preview | 2026-08-21 | 1.05M | $0.22 | $0.66 | Sparse MoE — 284B total / 13B active (multimodal) | — | prev: `deepseek-v4-flash-0731` |
| DeepSeek V4-Flash (`deepseek-v4-flash`) | deprecated | 2026-04-24 | 1.05M | $0.22 | $0.66 | Sparse MoE — 284B total / 13B active | Low-cost high-throughput agents and long-context coding | prev: `deepseek-ai/DeepSeek-V3.2` → superseded by: `deepseek-v4-flash-0731` |
| DeepSeek V4-Pro (`deepseek-v4-pro`) | deprecated | 2026-04-24 | 1.05M | $0.66 | $1.98 | Sparse MoE — 1.6T total / 49B active | Flagship reasoning, agentic tool-use, long-context coding | prev: `deepseek-reasoner` → superseded by: `deepseek-v4-pro-0813` |
...
| DeepSeek Reasoner (legacy alias) (`deepseek-reasoner`) | deprecated | 2025-05-28 | 128K | $0.55 | $2.19 | Sparse MoE — 671B total / 37B active | Legacy reasoning alias (retired) | prev: `deepseek-r1` → superseded by: `deepseek-v4-pro` |
| DeepSeek Chat (legacy alias) (`deepseek-chat`) | deprecated | 2024-12-26 | 1.05M | $0.14 | $0.28 | Sparse MoE — 671B total / 37B active | Legacy non-thinking chat (retired) | prev: `deepseek-v3.2` → superseded by: `deepseek-v4-flash` |

## Google

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Gemini 3.7 Flash (`gemini-3.7-flash`) | ga | 2026-08-13 | 1.05M | $0.75 | $3.75 | Refinement of Gemini 3.6 Flash with algorithmic improvements to the core reasoning foundation | Coding and agentic workhorse Flash | prev: `gemini-3.6-flash` |
| Gemini 3.5 Flash-Lite (`gemini-3.5-flash-lite`) | ga | 2026-07-21 | 1.05M | $0.30 | $2.50 | Distilled Flash-Lite multimodal | Very cheap high-throughput Flash | prev: `gemini-3.1-flash-lite` |
| Gemini 3.6 Flash (`gemini-3.6-flash`) | ga | 2026-07-21 | 1.05M | $0.75 | $3.75 | Sparse mixture-of-experts multimodal transformer with hybrid reasoning | Token-efficient multimodal workhorse | prev: `gemini-3.5-flash` → superseded by: `gemini-3.7-flash` |
| Gemini 3.5 Flash (`gemini-3.5-flash`) | ga | 2026-05-19 | 1.05M | $1.50 | $9.00 | Sparse mixture-of-experts (MoE) transformer with thinking-levels; based on Gemini 3 Flash | Coding and agentic Flash workhorse | prev: `gemini-3.1-flash` → superseded by: `gemini-3.6-flash` |
...
| Gemini 2.5 Flash-Lite (`gemini-2.5-flash-lite`) | ga | 2025-09-25 | 1.05M | $0.10 | $0.40 | Sparse mixture-of-experts transformer, most efficient of the 2.5 family | Ultra-cheap high-throughput inference | prev: `gemini-2.0-flash-lite` → superseded by: `gemini-3.5-flash-lite` |
| Gemini 2.5 Flash (`gemini-2.5-flash`) | ga | 2025-05-20 | 1.05M | $0.30 | $2.50 | Sparse mixture-of-experts transformer with hybrid reasoning (thinking on/off) | General-purpose reasoning at low cost | prev: `gemini-2.0-flash` → superseded by: `gemini-3.7-flash` |
...
| Gemini 3.5 Flash Cyber (`gemini-3.5-flash-cyber`) | preview | 2026-07-21 | 1.05M | — | — | — | Security vulnerability discovery and fixes | prev: `gemini-3.5-flash` |
...
| Gemini 3.1 Pro (`gemini-3.1-pro`) | preview | 2026-02-19 | 1.05M | $2.00 | $12.00 | Sparse mixture-of-experts (MoE) transformer, natively multimodal; based on Gemini 3 Pro | Advanced reasoning and agentic tasks | prev: `gemini-3-pro` → superseded by: `gemini-3.5-pro-preview` |
| Gemini 3.1 Pro Preview (`gemini-3.1-pro-preview`) | preview | 2026-02-19 | 1.05M | $2.00 | $12.00 | sparse mixture-of-experts transformer with thinking (chain-of-thought) inference | Preview endpoint for 3.1 Pro | prev: `gemini-3-pro` → superseded by: `gemini-3.1-pro` |
| Gemini 3 Flash (`gemini-3-flash`) | deprecated | 2026-06-22 | 1.05M | $0.50 | $3.00 | Multimodal transformer | Superseded Flash generation | prev: `gemini-2.5-flash` → superseded by: `gemini-3.5-flash` |
| Gemini 3.1 Flash-Lite (`gemini-3.1-flash-lite`) | deprecated | 2026-05-07 | 1.05M | $0.25 | $1.50 | Distilled Gemini 3-family mixture-of-experts | Prior generation Flash-Lite | prev: `gemini-2.5-flash-lite` → superseded by: `gemini-3.5-flash-lite` |
| Gemini 3.1 Flash (`gemini-3.1-flash`) | deprecated | 2026-03-19 | 1.05M | $0.50 | $3.00 | Sparse mixture-of-experts transformer with thinking | Superseded workhorse Flash | prev: `gemini-3-flash` → superseded by: `gemini-3.5-flash` |
| Gemini 3.1 Flash-Lite (Preview) (`gemini-3.1-flash-lite-preview`) | deprecated | 2026-03-03 | 1.05M | $0.25 | $1.50 | Distilled sparse mixture-of-experts | Retired preview endpoint | prev: `gemini-2.5-flash-lite` → superseded by: `gemini-3.1-flash-lite` |
| Gemini 3 Flash Preview (`gemini-3-flash-preview`) | deprecated | 2025-12-17 | 1.05M | $0.50 | $3.00 | Sparse mixture-of-experts transformer with thinking | Retired preview endpoint | prev: `gemini-2.5-flash` → superseded by: `gemini-3-flash` |
| Gemini 3 Pro (`gemini-3-pro`) | deprecated | 2025-11-18 | 1.05M | $2.00 | $12.00 | Natively multimodal reasoning model | Prior Pro flagship | prev: `gemini-2.5-pro` → superseded by: `gemini-3.1-pro` |
...
| Gemini 2.5 Pro (`gemini-2.5-pro`) | deprecated | 2025-06-17 | 1.05M | $1.25 | $10.00 | sparse mixture-of-experts transformer with thinking | Legacy flagship reasoning model | prev: `gemini-1.5-pro` → superseded by: `gemini-3.1-pro` |
| Gemini 2.0 Flash (`gemini-2.0-flash`) | deprecated | 2025-02-05 | 1.05M | $0.15 | $0.60 | — | Legacy low-cost multimodal workhorse | prev: `gemini-1.5-flash` → superseded by: `gemini-2.5-flash` |
...
| Muse Spark 1.2 (`meta/muse-spark-1.2`) | ga | 2026-08-05 | 1.05M | $1.25 | $4.25 | Proprietary — undisclosed (goal-conditioned agentic multimodal model) | Frontier agentic coding, long-horizon software engineering, and multimodal reasoning | prev: `meta/muse-spark-1.1` |
| Muse Image (`muse-image`) | ga | 2026-07-07 | — | — | — | Proprietary text-to-image diffusion model | Text-to-image generation from Meta Superintelligence Labs | — |
...
| Muse Video (`muse-video`) | preview | 2026-07-07 | — | — | — | Proprietary text/image-to-video diffusion model | Text-to-video and image-to-video generation | — |
...
| MAI-Code-1-Flash (`mai-code-1-flash`) | ga | 2026-06-02 | 256K | $0.75 | $4.50 | Sparse Mixture-of-Experts, 137B total parameters with 5B active | Low-latency coding in Copilot and IDEs | → superseded by: `mai-code-1.1-flash` |
...
| MAI-Voice-1 | ga | 2026-04-06 | — | $22.00 | $22.00 | generative text-to-speech neural model | Low-latency expressive voice generation for agents | → superseded by: `mai-voice-2` |
...
| Phi-4-multimodal-instruct (`phi-4-multimodal-instruct`) | ga | 2025-02-26 | 131.1K | $0.08 | $0.32 | Multimodal Transformer (text, vision, speech) with mixture-of-LoRAs, 5.6B parameters | Compact multimodal text/vision/audio processing | prev: `phi-3.5-vision` |
| Phi-4-mini (`microsoft/phi-4-mini`) | ga | 2025-02-01 | 128K | — | — | — | Document classification and routing at production scale | — |
| Phi-4 (`phi-4`) | ga | 2024-12-12 | 16.4K | $0.12 | $0.50 | Dense decoder-only Transformer, 14B parameters | Efficient 14B SLM for math and reasoning | prev: `phi-3` → superseded by: `phi-4-reasoning` |
...
| MAI-Thinking-1 (`mai-thinking-1`) | preview | 2026-06-02 | 262.1K | $2.00 | $8.00 | Mixture-of-Experts, ~1T total parameters with 35B active parameters | Enterprise reasoning, math, and code at scale | prev: `mai-1-preview` |
...
| MAI-1-preview (`mai-1-preview`) | deprecated | 2025-08-28 | — | — | — | Mixture-of-Experts foundation model | instruction following and everyday queries | → superseded by: `mai-thinking-1` |

## Mistral

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Mistral OCR 4 (`mistral-ocr-4-0`) | ga | 2026-06-23 | — | — | — | Purpose-built OCR / document understanding model | Structure-aware document parsing and OCR | prev: `mistral-ocr-3` |
| Mistral Medium 3.5 (`mistral-medium-2604`) | ga | 2026-04-29 | 262.1K | $1.50 | $7.50 | 128B dense multimodal transformer | Agentic harnesses, coding, multi-step reasoning | prev: `mistral-medium-2508` |
...
| Mistral Small 4 (`mistral-small-2603`) | ga | 2026-03-16 | 262.1K | $0.15 | $0.60 | mixture-of-experts, 119B total / ~6B active parameters (128 experts, 4 active) | Budget-friendly hybrid chat, coding, and reasoning | prev: `mistral-small-2506` |
...
| Ministral 3 14B (`ministral-14b-2512`) | ga | 2025-12-02 | 262.1K | $0.20 | $0.20 | 14B dense transformer with vision encoder | Edge and on-device deployment | prev: `ministral-8b-2410` |
...
| Mistral Large 3 (`mistral-large-2512`) | ga | 2025-12-02 | 262.1K | $0.50 | $1.50 | sparse mixture-of-experts, 675B total / 41B active parameters | Flagship reasoning, agentic workflows, multimodal analysis | prev: `mistral-large-2411` |
...
| Codestral 2508 (`codestral-2508`) | ga | 2025-07-30 | 256K | $0.30 | $0.90 | Code-specialized transformer | Low-latency code completion, FIM, and test generation | prev: `codestral-2501` |
...
| Devstral 2 (`devstral-2512`) | deprecated | 2025-12-09 | 262.1K | $0.90 | $0.90 | 123B dense transformer | Agentic multi-file coding and autonomous SWE tasks | prev: `devstral-medium-2507` → superseded by: `devstral-2-25-12` |
...
| Magistral Medium (`magistral-medium-latest`) | deprecated | 2025-06-10 | — | $2.00 | $5.00 | — | Chain-of-thought reasoning for complex problems | → superseded by: `magistral-medium-2509` |
...
| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kimi K3 (`kimi-k3`) | ga | 2026-07-16 | 1.05M | $3.00 | $15.00 | Mixture-of-Experts (~2.8T total, 16 of 896 experts active per token) with Kimi Delta Attention (hybrid linear attention) and Attention Residuals; native multimodal | Frontier reasoning, long-context agentic coding | prev: `kimi-k2.7-code` |
| Kimi K2.7 Code (`kimi-k2.7-code`) | ga | 2026-06-12 | 262.1K | $0.95 | $4.00 | 1T-parameter Mixture-of-Experts (32B active, 384 experts) with Multi-head Latent Attention (MLA); coding-specialised, thinking-only | End-to-end agentic coding over long contexts | prev: `kimi-k2.6` |
| Kimi K2.6 (`kimi-k2.6`) | ga | 2026-04-20 | 262.1K | $0.95 | $4.00 | 1T-parameter Mixture-of-Experts (32B active per token) with Multi-head Latent Attention | General-purpose multimodal + agentic tasks | prev: `kimi-k2.5` → superseded by: `kimi-k3` |
| Kimi K2 Thinking (`kimi-k2-thinking`) | ga | 2025-11-06 | 262.1K | $0.60 | $2.50 | 1T-parameter Mixture-of-Experts (32B active per token) with always-on thinking; native INT4 inference | Persistent step-by-step reasoning with tools | prev: `kimi-k2-instruct-0905` → superseded by: `kimi-k3` |
...
| Kimi K2.5 (`kimi-k2.5`) | deprecated | 2026-01-27 | 262.1K | $0.60 | $3.00 | 1T-parameter native-multimodal Mixture-of-Experts (32B active, 384 experts, 8 selected per token) with MoonViT (400M) vision encoder | Legacy cost-optimized reasoning workloads | prev: `kimi-k2-thinking` → superseded by: `kimi-k2.6` |
| Kimi K2 Instruct 0905 (`kimi-k2-instruct-0905`) | deprecated | 2025-09-09 | 256K | — | — | 1T-parameter Mixture-of-Experts (32B active, 384 experts, 8 selected per token); 61 layers, 64 attention heads | Legacy agentic coding and long-context workflows | prev: `moonshot-v1-128k` → superseded by: `kimi-k2-thinking` |
| Moonshot v1 128K (`moonshot-v1-128k`) | deprecated | — | 131.1K | $2.00 | $5.00 | — | legacy chat/completion integrations | prev: `moonshot-v1-32k` → superseded by: `kimi-k2-instruct-0905` |
...
| Nemotron 3 Ultra (`nvidia/nemotron-3-ultra-550b-a55b`) | ga | 2026-06-04 | 1M | $0.50 | $2.20 | Hybrid Latent Mixture-of-Experts (LatentMoE) with interleaved Mamba-2 and MoE layers, select Attention layers, and MTP layers; 550B total / 55B active parameters, NVFP4 pre-trained | Frontier agentic reasoning and long-context analytical workloads | prev: `nvidia/llama-3.1-nemotron-ultra-253b-v1` |
...
| Nemotron 3 Super (`nvidia/nemotron-3-super-120b-a12b`) | ga | 2026-03-11 | 1M | $0.09 | $0.45 | Hybrid Mamba-Transformer Mixture-of-Experts; 120B total / 12B active parameters | High-accuracy multi-GPU agentic reasoning at balanced cost | prev: `nvidia/llama-3.3-nemotron-super-49b-v1.5` → superseded by: `nvidia/nemotron-3-ultra-550b-a55b` |
...
| Nemotron 3 Nano (`nvidia/nemotron-3-nano-30b-a3b`) | ga | 2025-12-15 | 1M | $0.05 | $0.20 | Hybrid Mamba-2 and MoE architecture with 52 layers (23 Mamba-2, 23 MoE); 31.6B total / 3.2B active parameters, 6 of 128 experts routed | Efficient single-GPU agentic reasoning and tool use | prev: `nvidia/nvidia-nemotron-nano-9b-v2` → superseded by: `nvidia/nemotron-3-super-120b-a12b` |
...
| Llama 3.3 Nemotron Super 49B v1.5 (`nvidia/llama-3.3-nemotron-super-49b-v1.5`) | deprecated | 2025-10-10 | 131.1K | $0.10 | $0.40 | Llama 3.3 based Nemotron dense transformer, 49B parameters | Dense reasoning + tool-calling on single H100/H200 | prev: `nvidia/llama-3.3-nemotron-super-49b-v1` → superseded by: `nvidia/nemotron-3-super-120b-a12b` |
| Llama 3.1 Nemotron Ultra 253B v1 (`nvidia/llama-3.1-nemotron-ultra-253b-v1`) | deprecated | 2025-04-08 | 128K | $0.60 | $1.80 | Llama 3.1 based Nemotron dense transformer, 253B parameters | Highest-accuracy complex agentic tasks (legacy tier) | → superseded by: `nvidia/nemotron-3-ultra-550b-a55b` |
| Llama 3.3 Nemotron Super 49B v1 (`nvidia/llama-3.3-nemotron-super-49b-v1`) | deprecated | 2025-03-18 | 131.1K | $0.10 | $0.40 | Llama 3.3 based Nemotron dense transformer, 49B parameters | Legacy mid-tier Nemotron reasoning | → superseded by: `nvidia/llama-3.3-nemotron-super-49b-v1.5` |
...
| GPT-5.6 Luna (`gpt-5.6-luna`) | ga | 2026-07-09 | 1.05M | $0.20 | $1.20 | Reasoning model, shared GPT-5.6 family stack | High-volume, cost-sensitive workloads | prev: `gpt-5.4-mini` |
| GPT-5.6 Sol (`gpt-5.6-sol`) | ga | 2026-07-09 | 1.05M | $4.00 | $20.00 | Reasoning model with optional max and ultra multi-agent modes | Flagship reasoning, agentic coding, research, computer use | prev: `gpt-5.5-pro` |
| GPT-5.6 Terra (`gpt-5.6-terra`) | ga | 2026-07-09 | 1.05M | $2.00 | $12.00 | Reasoning model, shared GPT-5.6 family stack | Balanced everyday work at mid-tier price | prev: `gpt-5.5` |
| gpt-realtime-2.1 | ga | 2026-07-06 | 128K | $4.00 | $24.00 | Realtime speech-to-speech transformer with configurable reasoning tokens | Low-latency voice and multimodal agents | prev: `gpt-realtime-2` |
...
| GPT-5.5 Pro (`gpt-5.5-pro`) | ga | 2026-04-23 | 1.05M | $30.00 | $180.00 | Reasoning model tuned for deep deliberation | High-stakes deep reasoning and long-horizon agents | prev: `o3-pro` → superseded by: `gpt-5.6-sol` |
...
| gpt-oss-120b | ga | 2025-08-05 | 128K | $0.03 | $0.15 | Mixture-of-Experts, 120B total / ~5.1B active parameters per token | Self-hosted open-weight reasoning and tool use | — |
| o3-pro | ga | 2025-06-10 | 200K | $20.00 | $80.00 | — | Highest-effort deep reasoning tasks | prev: `o1-pro` → superseded by: `gpt-5.6-sol` |
| o4-mini | ga | 2025-04-16 | 200K | $1.10 | $4.40 | small o-series reasoning model | Cost-efficient reasoning with strong math and coding | prev: `o3-mini` → superseded by: `gpt-5.6-luna` |
...
| o3 | deprecated | 2025-04-16 | 200K | $2.00 | $8.00 | Reasoning model (o-series) | Legacy reasoning workloads pending migration | prev: `o1` → superseded by: `gpt-5.5` |
...
| Sonar Deep Research (`sonar-deep-research`) | deprecated | 2025-03-07 | 128K | $2.00 | $8.00 | Perplexity deep-research agent with web search | Autonomous multi-search research reports | → superseded by: `agent-api` |
| Sonar Reasoning Pro (`sonar-reasoning-pro`) | deprecated | 2025-02-18 | 128K | $2.00 | $8.00 | Built on DeepSeek R1 (R1-1776), fine-tuned by Perplexity | Multi-step reasoning with grounded web search | prev: `sonar-reasoning` → superseded by: `agent-api` |
| Sonar Reasoning (`sonar-reasoning`) | deprecated | 2025-01-27 | 127K | $1.00 | $5.00 | DeepSeek-R1 (1776) fine-tune with live web search | Affordable chain-of-thought web search | → superseded by: `sonar-reasoning-pro` |
| Sonar (`sonar`) | deprecated | 2025-01-21 | 128K | $1.00 | $1.00 | Built on Meta Llama 3.3 70B, fine-tuned by Perplexity | Fast, low-cost web-grounded Q&A with citations | → superseded by: `agent-api` |
| Sonar Pro (`sonar-pro`) | deprecated | 2025-01-21 | 200K | $3.00 | $15.00 | Perplexity fine-tuned model with live web search | Advanced grounded search with deeper retrieval | prev: `sonar` → superseded by: `agent-api` |

## xAI

| Model | Status | Released | Context | Input $/1M | Output $/1M | Architecture | Best for | Lineage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Grok 4.6 (`grok-4.6`) | ga | 2026-08-12 | 500K | $2.00 | $6.00 | Mixture-of-experts foundation model with reasoning post-training | flagship multimodal reasoning, long-running agents, coding | prev: `grok-4.5` |
...
| Grok 4.5 (`grok-4.5`) | ga | 2026-07-08 | 500K | $2.00 | $6.00 | 1.5T-parameter V9 mixture-of-experts foundation | agentic coding and knowledge work | prev: `grok-4.3` → superseded by: `grok-4.6` |
| Grok 4.3 (`grok-4.3`) | ga | 2026-04-30 | 1M | $1.25 | $2.50 | Reasoning-first transformer with prompt caching | cost-efficient long-context workloads | prev: `grok-4.20` → superseded by: `grok-4.5` |
